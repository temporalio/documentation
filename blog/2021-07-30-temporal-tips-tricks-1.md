...
One of the lesser known but extremely useful features of [Temporal Web](/web-ui#stack-trace) is the ability to view stack traces.
...
You can export the event history via [`tctl`](https://docs.temporal.io/devtools/tctl#show-workflow-history) or the [Web UI](/web-ui#recent-workflows):
