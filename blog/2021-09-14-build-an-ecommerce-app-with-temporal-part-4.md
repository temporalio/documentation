...
Thus far, you've only worked with the Temporal SDK via [starters](/docs/go/hello-world-tutorial/#workflow-starter) and [unit tests](/docs/go/how-to-test-workflow-definitions-in-go), which invoke the Temporal SDK directly.
