...
5. We can both expose and query the value of this counter using either the Admin CLI or the Temporal SDK through the use of the [synchronous queries feature.](https://docs.temporal.io/docs/go-queries/#synchronous-query)
