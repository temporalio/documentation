...
You, as the developer are responsible for implementing [Workflows](https://docs.temporal.io/go/workflows) and [Activities](https://docs.temporal.io/next/application-development-guide/#develop-activities) as normal Go code.
