---
id: temporal-platform-limits-sheet
title: Temporal Platform limits sheet
sidebar_label: Limits sheet
description: Running into limits can cause unexpected failures. Knowing the limits of Temporal can prevent that.
tags:
  - error
  - warn
  - limits
