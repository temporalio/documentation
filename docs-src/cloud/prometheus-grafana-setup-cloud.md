...
See the example Grafana configuration described in the [Prometheus and Grafana setup for open-source Temporal Cluster](/production-readiness/monitoring#grafana-configuration) article.
