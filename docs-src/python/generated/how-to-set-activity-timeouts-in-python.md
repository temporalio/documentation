...
THIS FILE IS GENERATED from https://github.com/temporalio/documentation-samples-python/blob/develop-patching/activity_timeouts_retires/your_workflows_dacx.py. -->
