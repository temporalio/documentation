...
description: The TypeScript SDK Patching API let you change Workflow Definitions without causing non-deterministic behavior in current long-running Workflows.
...
Patching APIs let you change Workflow Definitions without causing [non-deterministic behavior](/concepts/what-is-a-workflow-definition#non-deterministic-change) in current long-running Workflows.
