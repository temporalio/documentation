---
id: how-to-implement-interceptors-in-typescript
title: How to implement interceptors in TypeScript
description: Interceptors are a mechanism for modifying inbound and outbound SDK calls, commonly used to add tracing and authorization.
