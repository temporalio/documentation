...
title: How to troubleshoot common issues in the TypeScript SDK
description: This guide helps you troubleshoot various common issues with code that uses the TypeScript SDK.
sidebar_label: Troubleshoot common issues
tags:
  - guide-context
---
...
- If you are running Temporal Server yourself, check your [server metrics](/self-hosted/scaling-and-metrics) to ensure it's not overloaded.
