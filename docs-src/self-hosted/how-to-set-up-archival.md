...
- **Custom**: If you want to use a provider that is not currently supported, you can [create your own archiver](/self-hosted/how-to-create-a-custom-archiver) to support it.
