...
description: The Temporal Cluster and SDKs emit metrics that can be used to monitor performance and troubleshoot issues. To collect and aggregate these metrics, you can use Prometheus and Grafana.
tags:
  - prometheus
  - grafana
  - how-to
...
[Golang](/go/features/metrics/metrics)
