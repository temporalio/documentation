...
If you're self-hosting your Temporal Cluster, verify whether your [Visibility database](/self-hosted/how-to-set-up-visibility-in-a-temporal-cluster) version supports advanced Visibility features.
