...
| ---------------------------------------------------------------- | ----------------------------------------------------- | ---- | ---------- | ------ | ---- | --- |
| [Workflow Definitions](/concepts/what-is-a-workflow-definition)  | [Yes](/go/how-to-develop-a-workflow-definition-in-go) | Yes  | Yes        | Yes    | Yes  | Yes |
| [Activity Definitions](/concepts/what-is-an-activity-definition) | Yes                                                   | Yes  | Yes        | Yes    | Yes  | Yes |

A Workflow Definition is essentially Workflow code, which orchestrates the execution of Activities, persisting the results.
[Learn more](/concepts/what-is-a-workflow-definition) in the concepts.
...
[Learn more](/concepts/what-is-an-activity-definition) in the concepts
...
Build ID dispatch is a feature in Temporal that allows running different versions of Workflow and Activity code on the same task queue. It works by associating a build ID (typically a version number or git commit hash) with each deployment of Worker code. Learn more ->
