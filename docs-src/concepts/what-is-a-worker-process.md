...
The Temporal Cluster has [internal workers](https://temporal.io/blog/workflow-engine-principles/#system-workflows-1910) for system Workflow Executions; however, these internal workers are not visible to the developer.
