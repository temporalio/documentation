...
While data transferred in Event Histories is [secured by mTLS](/self-hosted/security-intro#encryption-in-transit-with-mtls), by default, it is still readable at rest in the Temporal Cluster.
