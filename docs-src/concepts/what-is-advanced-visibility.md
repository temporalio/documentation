...
- On Temporal Cloud, advanced Visibility is enabled by default for all users through the [Read-Only role](/cloud/how-to-get-started-with-temporal-cloud#invite-users)
