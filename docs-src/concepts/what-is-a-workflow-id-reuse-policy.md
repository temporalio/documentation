...
For example, a Workflow Id Reuse Policy can only check the Workflow Id of the spawning Workflow Execution against the Closed Workflow Executions for the last 30 days given a default Retention Period.
