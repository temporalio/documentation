...
It ships with every [Temporal CLI](/concepts/what-is-the-temporal-cli) release and [Docker Compose](/cluster-deployment-guide#docker--docker-compose) update and is available with [Temporal Cloud](/cloud).
