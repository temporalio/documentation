...
| identity                           | The Id of the [Client](/self-hosted/security-intro#client-connections) or parent Workflow [Worker](/concepts/what-is-a-worker) that requested the start of this Workflow. |
...
This [Event](/concepts/what-is-an-event) type indicates that a request to [cancel](/concepts/what-is-an-activity-execution#cancellation) the [Activity](/concepts/what-is-an-activity) has occurred.
...
This [Event](/concepts/what-is-an-event) type indicates that the [Activity](/concepts/what-is-an-activity) has been [canceled](/concepts/what-is-an-activity-execution#cancellation).
