...
Use this field to provide a [list of domains](/docs-src/references/web-ui-server-env-vars#temporaladdress) that are authorized to access the UI Server APIs.
