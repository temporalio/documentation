...
async function generateTabString(h3_section) {
  ...
  tab_string =
    `${tab_string}values={[{label: 'Go', value: 'go'},{label: 'Java', value: 'java'},{label: 'PHP', value: 'php'},{label: 'Typescript', value: 'typescript'},]}>\n\n`;
...
async function frontmatter(guide_config) {
  ...
  guide_string =
    `${guide_string}sidebar_label: ${guide_config.sidebar_label}\n`;
  guide_string = `${guide_string}description: ${guide_config.description}\n`;
  guide_string =
    `${guide_string}toc_max_heading_level: ${guide_config.toc_max_heading_level}\n`;
  guide_string = `${guide_string}---\n\n`;
  guide_string =
    `${guide_string}<!-- THIS FILE IS GENERATED. DO NOT EDIT THIS FILE DIRECTLY -->\n\n`;
