...
export function makeHistoryReplaySteps({ lines }) {
  return numbered([
    ...
    },
    {
      ...
      note: 'The Worker invokes the Workflow code and runs it one statement at a time. The first few lines are internal steps that do not interact with the Temporal Service.',
    },
    {
