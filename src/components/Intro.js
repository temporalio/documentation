    ...
    <section className="mt-10 mb-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 my-10">
        <div className="bg-[color:var(--ifm-card-background-color)] shadow rounded-lg p-5">
          ...
          <p className="text-xl font-semibold mb-4">SDKs</p>
            ...
            <Link to={useBaseUrl("/docs/node/introduction")}>
              <div className="flex space-x-3 items-center hover:underline">
                <img
                  ...
                  alt="Node js logo"
                />
                <p className="font-semibold">Node.js (alpha)</p>
              </div>
            </Link>
        ...
        <div className="bg-[color:var(--ifm-card-background-color)] flex flex-col shadow rounded-lg p-5">
          ...
          <Link
            ...
            className="hover:underline flex mt-5 hover:space-x-2"
          >
            <span>Register for Temporal Cloud</span>
            <svg
              className="ml-1 mt-0.5 h-5 w-5"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <div className="bg-[color:var(--ifm-card-background-color)] flex flex-col shadow rounded-lg p-5">
          ...
          <p>interact with the Temporal system and visualize its state</p>
          <div className="mt-7">
