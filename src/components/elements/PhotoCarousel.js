...
//   // Measure and set initial dimensions, adding extra space for captions
//   useEffect(() => {
//     if (carouselRef.current && images.length > 0) {
//       const setCarouselDimensions = () => {
//         const { offsetWidth, offsetHeight } = carouselRef.current;
//         if (offsetWidth && offsetHeight) {
//           // Add extra height for captions (accommodate 3-4 lines of text)
//           const extraCaptionHeight = 70; // pixels for 3-4 lines of text
//           setDimensions({
//             width: `${offsetWidth}px`,
//             height: `${offsetHeight + extraCaptionHeight}px`
//           });
//         }
//       };

//       // Wait for the first image to load to get proper dimensions
//       const img = new Image();
//       img.src = images[0];
//       img.onload = setCarouselDimensions;

//       // Fallback in case image doesn't load
//       setTimeout(setCarouselDimensions, 500);
//     }
//   }, [images]);
...
//           .carousel img {
//             width: 100%;
//             max-height: calc(100% - 120px); /* Allow space for caption */
//             object-fit: contain;
//             display: block;
//             border-radius: 10px;
//           }
