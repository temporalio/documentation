...
const STEPS = [
  ...
  },
  {
    ...
    body: 'The rules apply independently per <a href="/encyclopedia/workers/task-queues">Task Queue</a>. Workers on the same Task Queue share the same dispatch ordering. Workers on separate Task Queues are unaffected by each other.',
  },
];
