      ...
      <div className="leadership-container">
        <ul className="leadership-list">
          <li className="leadership-list-item">
            <span className="leadership-name">Maxim Fateev<br/>CEO</span>
            <br/>
            <img
          ...
          <li className="leadership-list-item">
            <span className="leadership-name">Charles Zedlewski<br/>CPO</span>
            <br/>
            <img
              className="leadership-image"
          ...
          <li className="leadership-list-item">
            <span className="leadership-name">Samar Abbas<br/>CTO</span>
            <br/>
            <img
              className="leadership-image"
              alt="Samar Abbas"
          ...
          <li className="leadership-list-item">
            <span className="leadership-name">
              Ryland Goldstein<br/>Head of Product
            </span>
            <br/>
            <img
              className="leadership-image"
