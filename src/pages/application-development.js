        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className={clsx('col col-4', styles.textFeature)}>
              ...
              <p>
                If you are interested in using an "unofficial" SDK, we recommend that you reach out to any of us at
                Temporal.
              </p>
              <ul>
                <li>
              ...
              <p>
                We are very excited by the community's enthusiasm and strongly believe in collaborating on open source
                projects. Our goal is to make sure there is maintenance leadership in place to care for the developer
