    ...
    >
      <main className="container margin-vert--lg">
        ...
        <div className="margin-bottom--lg">
          ...
          <p>Temporal is constantly working to improve and expand its documentation. As a result, some components may change without notice. Page slugs (URLs), menu labels, and the location of information are a few of the items you can expect to see altered as we aim to try and give our users the best experience possible.</p>
          <p>Visit <a href="https://community.temporal.io">community.temporal.io</a> for help if the information you are looking for appears to be missing.</p>
          <p>View the <a href="https://github.com/temporalio/documentation-legacy">source repository README</a> for contribution guidelines if you are looking to help improve the Temporal documentation experience.</p>
        </div>
        <div className="margin-bottom--lg">
          <h2 id="next">MIT License</h2>
          <pre>
          <p>Copyright (c) 2020 Temporal Technologies Inc.  All rights reserved.</p>
