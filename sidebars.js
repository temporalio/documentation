    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          'develop/nexus/temporal-operation-handler',
          'develop/nexus/client-code-generator',
          'develop/nexus/activity-backed-operations',
          {
            type: 'category',
            label: 'Microservice Development Walkthrough',
            collapsed: true,
            link: {
              type: 'doc',
