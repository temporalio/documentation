...
If you're using Temporal Cloud, create a [support ticket](https://docs.temporal.io/cloud/support#support-ticket) with as much information as possible, including the Namespace Name and the Workflow Ids of some Workflow Executions in which the issue occurs.
