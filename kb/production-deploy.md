...
- See [Platform limits](/cloud/introduction/operating-envelope#limits-sheet) for other limits you will want to keep in mind when doing system design, including event history length.

Please see the dedicated docs on [Tuning and Scaling Workers](/dev-guide/worker-performance).
