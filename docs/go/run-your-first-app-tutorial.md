...
Basically, make sure the Temporal Server is running (using [Docker is the fastest way](https://docs.temporal.io/docs/clusters/quick-install)), and your Go version is above v1.14.
