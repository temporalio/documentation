...
Archival is a feature that automatically backs up [Event Histories](/docs/workflows/#event-history) from Temporal Cluster persistence to a custom blob store after the Closed [Workflow Execution](/docs/workflows/#workflow-executions) retention period is reached.
