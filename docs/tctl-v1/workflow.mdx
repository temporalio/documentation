...
The `tctl workflow observe` command shows the progress of the [Event History](/workflow-execution#event-history) of a [Workflow Execution](/workflow-execution).
...
The `tctl workflow observeid` command shows the progress of the [Event History](/workflow-execution#event-history) of a [Workflow Execution](/workflow-execution) for the specified [Workflow Id](/workflows#workflow-id) and optional [Run Id](/workflows#run-id).
...
The `tctl workflow show` command shows the [Event History](/workflow-execution#event-history) for the specified [Workflow Execution](/workflow-execution).
