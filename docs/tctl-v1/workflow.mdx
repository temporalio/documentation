...
The `tctl workflow signal` command [Signals](/encyclopedia/sending-messages#sending-signals) a [Workflow Execution](/workflows#workflow-execution).
...
Specify the name of a [Signal](/encyclopedia/sending-messages#sending-signals).
...
Pass input for the [Signal](/encyclopedia/sending-messages#sending-signals).
Input must be in JSON format.
...
Pass input for the [Signal](/encyclopedia/sending-messages#sending-signals) from a JSON file.
