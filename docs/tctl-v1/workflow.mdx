...
A new [Workflow Task](/workers#workflow-task) will be scheduled.
...
The `tctl workflow query` command sends a [Query](/encyclopedia/application-message-passing#queries) to a [Workflow Execution](/workflows#workflow-execution).
...
Specify the [Start-To-Close Timeout](/encyclopedia/detecting-activity-failures#start-to-close-timeout) of the [Workflow Task](/workers#workflow-task) in seconds.
...
The `tctl workflow signal` command [Signals](/encyclopedia/application-message-passing#signals) a [Workflow Execution](/workflows#workflow-execution).
...
Specify the name of a [Signal](/encyclopedia/application-message-passing#signals).
...
Pass input for the [Signal](/encyclopedia/application-message-passing#signals).
Input must be in JSON format.
...
Pass input for the [Signal](/encyclopedia/application-message-passing#signals) from a JSON file.
...
No more [Workflow Task](/workers#workflow-task) will be scheduled.
