...
The `tctl workflow describeid` command shows information about a [Workflow Execution](/workflow-execution) for the specified [Workflow Id](/workflows#workflow-id) and optional [Run Id](/workflows#run-id).
...
The `tctl workflow observe` command shows the progress of the [Event History](/workflows#event-history) of a [Workflow Execution](/workflow-execution).
...
The `tctl workflow observeid` command shows the progress of the [Event History](/workflows#event-history) of a [Workflow Execution](/workflow-execution) for the specified [Workflow Id](/workflows#workflow-id) and optional [Run Id](/workflows#run-id).
...
Indicate that a [Workflow Execution](/workflow-execution) should be skipped if the current Run is open for the same [Workflow Id](/workflows#workflow-id) as the base Run.
...
Configure if the same [Workflow Id](/workflows#workflow-id) is allowed for use in new [Workflow Execution](/workflow-execution).
...
The `tctl workflow show` command shows the [Event History](/workflows#event-history) for the specified [Workflow Execution](/workflow-execution).
...
Show the History of a [Workflow Execution](/workflow-execution) by specifying a [Workflow Id](/workflows#workflow-id).
...
Show the History of a [Workflow Execution](/workflow-execution) by specifying a [Run Id](/workflows#run-id).
