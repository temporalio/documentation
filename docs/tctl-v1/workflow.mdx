...
The `tctl workflow query` command sends a [Query](/sending-messages#sending-queries) to a [Workflow Execution](/workflows#workflow-execution).
...
The `tctl workflow signal` command [Signals](/sending-messages#sending-signals) a [Workflow Execution](/workflows#workflow-execution).
