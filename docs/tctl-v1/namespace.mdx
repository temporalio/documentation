...
Specify the name of the active [Temporal Service](/clusters) when registering a [Namespace](/namespaces).
...
Specify a list of [Temporal Services](/clusters) when registering a [Namespace](/namespaces).
...
Specify the name of the active [Temporal Service](/clusters) when updating a [Namespace](/namespaces).
...
Specify a list of [Temporal Services](/clusters) when updating a [Namespace](/namespaces).
