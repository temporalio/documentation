...
Example results for a [Multi-region Namespace](/namespaces#multi-region-namespace)
...
This value changes for Multi-region Namespace when a failover occurs.
...
Specifies whether a [Namespace](/namespaces) is a [Multi-region Namespace](/namespaces#multi-region-namespace).
...
<!--Will probably want to update this. Check with CLI team.-->
```bash
