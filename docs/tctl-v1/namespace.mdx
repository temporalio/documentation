...
description: "Introducing Temporal CLI, a public preview now available. Manage Namespaces with commands like `tctl namespace describe`, `tctl namespace list`, `tctl namespace register`, and `tctl namespace update`, featuring modifiers for customization and control."
