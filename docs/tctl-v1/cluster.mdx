...
description: "Temporal CLI is now available for public preview, with tctl cluster command enabling Temporal Cluster operations, including listing Search Attributes and checking Frontend Service health."
