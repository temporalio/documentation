---
id: temporal-service
title: tctl v1.17 temporal-service command reference
sidebar_label: temporal-service
description: Explore the tctl Temporal Service commands, which can get all Search Attributes and check the health of the Frontend Service.
...
The `tctl cluster` command enables [Temporal Service](/temporal-service) operations.
