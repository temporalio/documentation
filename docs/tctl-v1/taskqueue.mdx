...
description: "Temporal CLI is now available in public preview, with tctl taskqueue commands for describing and listing Task Queue information, including poller details and partitions."
