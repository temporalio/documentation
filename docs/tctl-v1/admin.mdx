...
#### --skip_schema_update {/* #--skip_schema_update */}
...
### remove_remote_cluster {/* #remove_remote_cluster */}
...
#### --lower_shard_bound {/* #--lower_shard_bound */}

The minimum amount (inclusive) of corrupt shards to handle.

Default: 0

#### --upper_shard_bound {/* #--upper_shard_bound */}
...
#### --tls_disable_host_verification {/* #--tls_disable_host_verification */}
...
#### --lower_shard_bound value {/* #--lower_shard_bound-value */}

The minimum amount (inclusive) of corrupt shards to handle.

Default: 0

#### --upper_shard_bound {/* #--upper_shard_bound-1 */}

The maximum amount (exclusive) of corrupt shards to handle.

Default: 16384

#### --starting_rps {/* #--starting_rps-1 */}
...
#### --tls_cert_path {/* #--tls_cert_path-1 */}

Where the tls client cert is located.

#### --tls_key_path {/* #--tls_key_path-1 */}

Where the tls key is located.

#### --tls_ca_path {/* #--tls_ca_path-1 */}

Where the tls ca is located.

#### --tls_server_name {/* #--tls_server_name-1 */}

The name of the Db tls server.

#### --tls_disable_host_verification {/* #--tls_disable_host_verification-1 */}
...
#### --last_message_id {/* #--last_message_id-2 */}
...
#### --heartbeated_within {/* #--heartbeated_within */}
...
#### tctl admin shard commands {/* #tctl-admin-shard-commands */}
...
#### --tls_cert_path {/* #--tls_cert_path-2 */}

DB tls client cert path.

Note: tls must be enabled

#### --tls_server_name {/* #--tls_server_name-2 */}

DB tls server name

Note: tls must be enabled

#### --tls_disable_host_verification {/* #--tls_disable_host_verification-2 */}
...
#### --shard_id value {/* #--shard_id-value-1 */}
...
#### --target_cluster value {/* #--target_cluster-value */}

Temporal cluster to use.
Default: "active"

#### --shard_id value {/* #--shard_id-value-2 */}
...
#### --min_visibility_ts value {/* #--min_visibility_ts-value */}
...
#### --max_visibility_ts value {/* #--max_visibility_ts-value */}
...
#### --shard_id value {/* #--shard_id-value-3 */}
...
#### --task_type value {/* #--task_type-value-1 */}
...
#### --task_timestamp value {/* #--task_timestamp-value */}
...
#### --db_engine value {/* #--db_engine-value */}
...
#### --db_address value {/* #--db_address-value */}

Persistence address for the database.

Default: 127.0.0.1

#### --db_port value {/* #--db_port-value */}
...
#### --es-username value {/* #--es-username-value */}

Username for the Elasticsearch cluster.

#### --es-password value {/* #--es-password-value */}
...
#### --tls_cert_path value {/* #--tls_cert_path-value */}

DB tls client cert path.

Note: tls must be enabled

#### --tls_key_path value {/* #--tls_key_path-value */}

DB tls client key path

Note: tls must be enabled

#### --tls_ca_path value {/* #--tls_ca_path-value */}

DB tls client ca path

Note: tls must be enabled

#### --tls_server_name value {/* #--tls_server_name-value */}

DB tls server name

Note: tls must be enabled

#### --tls_disable_host_verification {/* #--tls_disable_host_verification-3 */}
...
#### --workflow_id value {/* #--workflow_id-value-1 */}

Alias: `-w`

The Id of the current Workflow.

#### --run_id value {/* #--run_id-value-1 */}
...
#### --workflow_id value {/* #--workflow_id-value-2 */}

Alias: `-w`

The Id of the current Workflow.

#### --run_id value {/* #--run_id-value-2 */}
...
#### --workflow_id value {/* #--workflow_id-value-3 */}

Alias: `-w`

The current Workflow.

#### --run_id value {/* #--run_id-value-3 */}

Alias: `-r`

The current RunId.

#### --min_event_id value {/* #--min_event_id-value */}

The minimum Event Id to include in the history.

Default: 0

#### --max_event_id value {/* #--max_event_id-value */}

The maximum Event Id to include in the history.

Default: 0

#### --min_event_version value {/* #--min_event_version-value */}

The start Event version to be included in the history.

Default: 0

#### --max_event_version value {/* #--max_event_version-value */}

The end Event version to be included in the history.

Default: 0

#### --output_filename value {/* #--output_filename-value */}
