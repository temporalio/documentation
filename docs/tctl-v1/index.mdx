...
sidebar_position: 9
description: The Temporal CLI (tctl) is a legacy command-line tool that you can use to interact with a Temporal Service.
slug: /tctl-v1
...
The Temporal CLI (tctl) is a command-line tool that you can use to interact with a Temporal Service.
...
- [tctl cluster](/tctl-v1/temporal-service)
