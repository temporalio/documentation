...
description: "Temporal CLI now available, previewing tctl Activity Execution commands for completing and failing Activity Executions with modifiers for workflow ID, run ID, activity ID, result, reason, detail, and operator identity."
