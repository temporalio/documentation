...
description: "Temporal CLI is now available for public preview, enabling you to create, manage, and backfill schedules for your workflows, with features including backfill, create, delete, describe, list, toggle, trigger, and update options."
