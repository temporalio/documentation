...
While testing, also pay attention to your [metrics capacity and cardinality](/production-deployment/cloud/metrics/openmetrics/api-reference#managing-high-cardinality).
:::
