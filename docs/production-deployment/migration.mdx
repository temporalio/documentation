...
Both a [Signal](/encyclopedia/sending-messages#sending-signals) and a [Query](/encyclopedia/workflow-message-passing#sending-queries) will be executed during the course of the migration.
