...
Both a [Signal](/encyclopedia/application-message-passing#signals) and a [Query](/encyclopedia/application-message-passing#queries) will be executed during the course of the migration.
