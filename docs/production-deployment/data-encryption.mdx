...
description: "Temporal Server stores and persists workflow execution data, ensuring secure handling through encryption. This guide provides instructions on configuring custom encryption and decoding logic using a Codec Server, including API contract requirements, CORS configuration, and authorization settings."
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">Remote data encoding architecture</p>
  </div>
  <div className="tdiiw" height="1183">
    <img
      className="img_ev3q"
      src="/diagrams/remote-data-encoding.svg"
      alt="Remote data encoding architecture"
    />
  </div>
</div>
