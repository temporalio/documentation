...
- Inputs and outputs/results in your [Workflow](/workflows#workflow-execution), [Activity](/activities#activity-execution), and [Child Workflow](/child-workflows)
...
- Results of [Local Activities](/local-activity) and [Side Effects](/workflows#side-effect)
