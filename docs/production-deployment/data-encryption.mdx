...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Remote data encoding architecture</p>
  </div>
  <div class="tdiiw" height="1183">
    <img class="img_ev3q" src="/diagrams/remote-data-encoding.svg" alt="Remote data encoding architecture" />
  </div>
</div>
...
On self-hosted Temporal Services, configure [authorization in the Web UI configuration](/references/web-ui-configuration#auth) in your Temporal Service setup.
...
Note that with self-hosted Temporal Services, you must explicitly configure authorization specifications for the Web UI and CLI.
...
On Temporal Cloud and self-hosted Temporal Services, you can configure a Codec Server endpoint to be used for a Namespace in the Web UI.

<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Codec Server endpoint Namespace setting</p>
  </div>
  <div class="tdiiw" height="840">
    <img class="img_ev3q" src="/img/set-codec-endpoint-form.png" alt="Codec Server endpoint Namespace setting" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Codec Server endpoint browser setting</p>
  </div>
  <div class="tdiiw" height="333">
    <img class="img_ev3q" src="/img/data-encoder-button.png" alt="Codec Server endpoint browser setting" />
  </div>
</div>
...
In self-hosted Temporal Services with dedicated UI Server configuration, you can also set the codec endpoint in the UI server [configuration file](/references/web-ui-configuration#codec):
