...
In particular, do not enable Worker Versioning for worker-specific Task Queues. See [Task Queue limits](/cloud/limits#max-task-queues-in-deployment-version-limits).
