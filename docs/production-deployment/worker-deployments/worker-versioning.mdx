...
A **blue-green** deploy is a kind of rainbow deploy with two builds, "blue" and "green," that is used to gradually roll out a new update.
...
- The [Versioning Behavior](#definition), either `pinned` or `auto-upgrade`.
