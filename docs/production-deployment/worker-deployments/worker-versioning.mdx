...
import * as WV from '@site/src/components/elements/AnnotatedCode/annotations/workerVersioning';
...
<SdkTabs.Go>
<AnnotatedCode annotations={WV.go}>
```go
...
<SdkTabs.Java>
<AnnotatedCode annotations={WV.java}>
```java
...
<SdkTabs.Python>
<AnnotatedCode annotations={WV.python}>
```python
...
<SdkTabs.TypeScript>
<AnnotatedCode annotations={WV.typescript}>
```ts
...
<SdkTabs.DotNet>
<AnnotatedCode annotations={WV.dotnet}>
```csharp
...
<SdkTabs.Ruby>
<AnnotatedCode annotations={WV.ruby}>
```ruby
