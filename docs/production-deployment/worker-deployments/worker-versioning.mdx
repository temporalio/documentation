...
**Key Principle**: AutoUpgrade workflows never inherit versions, while Pinned workflows may inherit under specific conditions.
...
##### Resets
- Inheritance behavior follows the same rules as the execution type that would result from the reset
