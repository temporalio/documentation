...
## Configuring a Worker for Versioning {/* #configuring-a-worker-for-versioning */}
...
### Default Versioning Behavior Considerations {/* #default-versioning-behavior-considerations */}
...
## Marking a Workflow Type as Pinned {/* #marking-a-workflow-type-as-pinned */}
...
## Migrating a Workflow from Pinned to Auto-Upgrade {/* #migrating-a-workflow-from-pinned-to-auto-upgrade */}
...
### Adding a pre-deployment test {/* #adding-a-pre-deployment-test */}
