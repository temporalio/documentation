...
- The [Go SDK](/develop/go/core-application) (`go.temporal.io/sdk`)
...
For details on configuration options, Lambda-tuned defaults, and the invocation lifecycle, see [Serverless Workers - Go SDK](/develop/go/serverless-workers).
