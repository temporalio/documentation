...
### Step 1: Update your Worker code {/* #step-1-update-your-worker-code */}
...
### Step 2: Deploy your versioned Worker {/* #step-2-deploy-your-versioned-worker */}
...
### Step 3: Gradually ramp traffic (optional, but recommended) {/* #step-3-gradually-ramp-traffic-optional-but-recommended */}
...
### Step 4: Set the versioned Worker as Current {/* #step-4-set-the-versioned-worker-as-current */}
...
### Step 5: Migrate unversioned in-flight Workflows {/* #step-5-migrate-unversioned-in-flight-workflows */}
...
### Step 6: Scale down and clean up unversioned Workers {/* #step-6-scale-down-and-clean-up-unversioned-workers */}
