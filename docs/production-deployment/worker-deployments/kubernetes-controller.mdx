...
As you ship new deployment versions, the Worker Controller automatically detects them and gradually makthat version the new **Current Version** of the worker deployment it is a part of.
