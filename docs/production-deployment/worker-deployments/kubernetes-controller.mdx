...
### Why adopt the Worker Controller? {/* #why-adopt-the-worker-controller */}
...
## Autoscaling versioned Workers {/* #autoscaling-versioned-workers */}
...
### TemporalWorkerOwnedResource {/* #temporalworkerownedresource */}
...
### Why use this instead of KEDA? {/* #why-use-this-instead-of-keda */}
...
## Configuring Worker Lifecycles {/* #configuring-worker-lifecycles */}
...
## Running the Temporal Worker Controller {/* #running-the-temporal-worker-controller */}
