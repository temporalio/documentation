...
## Write your Worker code {/* #write-your-worker-code */}
...
## Containerize the Worker for Kubernetes {/* #containerize-the-worker-for-kubernetes */}
...
## Publish the Worker Image to Amazon ECR {/* #publish-the-worker-image-to-amazon-ecr */}
...
## Deploy the Workers to EKS {/* #deploy-the-workers-to-eks */}
...
## Verify that the Workers are Connected {/* #verify-that-the-workers-are-connected */}
