...
## 1. Configure CLI access to your Namespace {/* #configure-cli */}
...
## 2. Deploy the Worker to a Cloud Run worker pool {/* #deploy-worker-pool */}
...
### i. Build the Worker container image {/* #build-worker-image */}
...
### ii. Store the TLS credentials in Secret Manager {/* #store-tls-secrets */}
...
### iii. Create and configure the worker pool {/* #create-worker-pool */}
...
### iv. Verify the worker pool {/* #verify-worker-pool */}
...
## 3. Create the Worker Deployment {/* #create-worker-deployment */}
