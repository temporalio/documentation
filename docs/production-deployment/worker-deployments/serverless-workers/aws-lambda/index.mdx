...
- The [Go SDK](/develop/go), [Python SDK](/develop/python), or [TypeScript SDK](/develop/typescript), depending on which
  ...
  If you are exploring the Serverless Worker feature and don't have a Workflow ready, you can use a sample from the
...
[Troubleshoot Serverless Workers on AWS Lambda](/troubleshooting/serverless-workers/aws-lambda#check-wci-detecting-tasks)
if the Task Queue binding is not established.
