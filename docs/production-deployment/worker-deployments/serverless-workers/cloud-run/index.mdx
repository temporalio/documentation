...
{/* TODO(lenny): Add the Go standard-Worker + WorkerDeploymentVersion setup. Verify the exact API against the Go SDK
before publishing; the Python tab is the only one dogfooded so far. */}

</SdkTabs.Go>
<SdkTabs.TypeScript>

{/* TODO(lenny): Add the TypeScript standard-Worker + workerDeploymentOptions setup. Verify against the TS SDK before
publishing. */}
...
{/* TODO(lenny): Go Dockerfile (multi-stage build to a static binary). */}

</SdkTabs.Go>
<SdkTabs.TypeScript>

{/* TODO(lenny): TypeScript Dockerfile. */}
