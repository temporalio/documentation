...
- The **invoker service account** is the identity Temporal impersonates to read and scale the pool. This module creates
  it, and its email is the `invoker_email` output you give Temporal in [Step 4](#create-worker-deployment-version).
