...
The Temporal Cloud UI provides pre-filled CloudFormation and Terraform templates on the **Create Worker Deployment**
page. You can also create the role manually using the templates below.
