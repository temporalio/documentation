...
If you used the CLI, set the version as current.
...
To view the Worker Controller Instance (WCI) workflow that manages scaling for your deployment, filter workflows in the Temporal UI or CLI with:
