...
The shadow JAR is a valid zip archive and can be uploaded directly to Lambda.
...
| `--zip-file`      | Path to the shadow JAR. Shadow JARs are valid zip archives and can be uploaded directly.                                       |
