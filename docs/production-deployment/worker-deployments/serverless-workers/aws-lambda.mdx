...
| `temporal_cloud_principals`   | List of Temporal Cloud AWS IAM role ARNs permitted to assume this role. Provided by Temporal Cloud during account setup.                                                                                           | Yes      |
...
module "serverless_worker_lambda" {
  ...
  temporal_cloud_principals = ["<PROVIDED_BY_TEMPORAL_CLOUD>"]
