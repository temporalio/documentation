...
- [Safe Deploys](/production-deployment/worker-deployments/safe-deploys) allows you to pin Workflows to individual versions of your workers, which are called Worker Deployment Versions.
- The [Temporal Worker Controller](/production-deployment/worker-deployments/kubernetes-controller) helps configure these features for a sample Kubernetes deployment.
