...
**Q: What does the `Generate API Key` button on a Namespace details page do?**

A: The `Generate API Key` button on a Namespace details page generates an API key with permissions to the given Namespace.
