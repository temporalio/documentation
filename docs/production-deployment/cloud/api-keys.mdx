...
- API Keys used for Cloud Operations Tools (tcld, API, Terraform) are in [Public Preview](/evaluate/release-stages#public-preview)
- API Keys used for Namespace Authentication are in [Pre Release](/evaluate/release-stages#pre-release)
  :::
