...
For [Namespaces with High Availability Features](/cloud/high-availability) with API key authentication enabled, use the gRPC endpoint format `<namespace>.<account>.tmprl.cloud:7233`.
