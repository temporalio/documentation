...
1. Allow both keys to be active at the same time.
1. Switch to the new key and start using it.
1. Verify the new key works and the old key is no longer being used.
