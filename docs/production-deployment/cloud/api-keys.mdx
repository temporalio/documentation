...
**Q: What does the `Generate API Key` button on a Namespace page do?**

A: The `Generate API Key` button on a Namespace page generates an API key with permissions for the given Namespace.
