...
For [multi-region Namespaces](/cloud/high-availability) with API key authentication enabled, use the gRPC endpoint format `<namespace>.<account>.tmprl.cloud:7233`.
