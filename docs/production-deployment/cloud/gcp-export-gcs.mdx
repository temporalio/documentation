...
3. After inputting the necessary values, click on **Verify**.
   ...
   - If you just created the GCS bucket and granted permission for your service account, it may take some time for the permission to propagate. You may need to wait several minutes (up to 5 minutes) before clicking the **Verify** button to verify the connection.
...
1. Download the latest version of tcld from [https://docs.temporal.io/cloud/tcld/#install-tcld].
