...
![Usage graph showing increasing APS usage for one month, with occasional spikes, and a rising APS limit](/static/img/cloud/provisioned-capacity/usage_graph.png)
...
![Manage Capacity button in the Temporal UI](/static/img/cloud/provisioned-capacity/manage_capacity_button.png)
...
![Manage Capacity panel in the Temporal UI](/static/img/cloud/provisioned-capacity/manage_capacity_panel.png)
