...
1. There are two ways to configure the service account to write to the Pub/Sub sink.
   Select **Manual** to configure the account manually, or **Deploy with Terraform** to use Terraform.
