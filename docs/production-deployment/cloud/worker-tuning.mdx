...
1. Create monitors and alerts for the [temporal_worker_task_slots_available](/references/sdk-metrics#temporal_worker_task_slots_available) SDK metric.
   See the [Detect misconfigured Workers section] for appropriate responses based on the value.

- Alert at 0 for your p99 value

2. Create monitors for the [temporal_sticky_cache_size](/references/sdk-metrics#temporal_sticky_cache_size) SDK metric.
...
3. Create monitors for the [temporal_sticky_cache_total_forced_eviction](/references/sdk-metrics#temporal_sticky_cache_total_forced_eviction) SDK metric.
