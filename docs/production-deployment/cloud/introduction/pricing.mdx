...
You will require sufficient administrative permissions to access this section.


**What happens if I exceed my available credits?**

Temporal will automatically invoice customers who purchased credits to reload their credit balance.
This invoice amount is calculated by annualizing the most recent month’s usage total.
Customers who are issued free credits as part of the startup program or offer will be invoiced at the end of the month for their consumption once their credit balance is exhausted.


**Do credits expire?**

Customers who purchased credits through the sales team, these credits will not expire.
For customers who received credits through the startup program or an offer, will have an expiry date, which will be stated as part of the sign up.
...
No.
When your account is canceled, all of your account data is deleted and cannot be restored.
If a customer wants to return to Temporal Cloud, they must sign up again and be assigned a new Temporal account, effectively being treated as a new customer.
