...
Temporal Cloud limits each Namespace to 5,000 concurrent Task pollers. This limit is by operation so, by default, the Activity and Workflow Tasks inherit the same 5,000 limit.
