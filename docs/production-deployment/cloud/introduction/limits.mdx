...
The [Retention Period](/temporal-service#retention-period) is set per Namespace.
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Choose your Namespace and select Edit</p>
  </div>
  <div class="tdiiw" height="462">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Update the Retention Period</p>
  </div>
  <div class="tdiiw" height="482">
    <img class="img_ev3q" src="/img/cloud-guide/edit-retention-period.png" alt="Update the Retention Period" />
  </div>
</div>
