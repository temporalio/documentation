...
description: "Discover the limits of the Temporal Cloud system, including account, namespace, and programming model level constraints, and learn how to request increases and configure settings for optimal performance."
slug: /cloud/limits
