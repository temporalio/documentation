...
description: Temporal Cloud provides robust security features, including namespace isolation, gRPC and HTTPS endpoints, and encryption for data transmission and storage.
slug: /cloud/security
