...
sidebar_label: SLA
description: Temporal Cloud's Service Level Agreement (SLA) guarantees 99.9% uptime, with a 99.99% availability commitment, and defines service errors, excluding specific codes, to calculate the service-error rate, averaged monthly and reset quarterly.
slug: /cloud/sla
