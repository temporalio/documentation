...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">High-level system topology</p>
  </div>
  <div class="tdiiw" height="761">
    <img class="img_ev3q" src="/diagrams/high-level-system-topology.svg" alt="High-level system topology" />
  </div>
</div>
