...
Connectivity rules are currently in [Pre-release](/evaluate/development-production-features/release-stages#pre-release).

[Contact support](/cloud/support#support-ticket) to request access.
...
See [our AWS](/cloud/connectivity/aws-connectivity#configuring-private-dns-for-aws-privatelink) or [our GCP](/cloud/connectivity/gcp-connectivity#configuring-private-dns-for-gcp-private-service-connect) docs for exactly how to update your environment and/or your client configuration.
