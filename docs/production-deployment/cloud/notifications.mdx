...
| Why email is sent | Who receives email |
|------------------ | -------------------|
...
| Sign up credit expiring in 30 days | Account Owner |
| Sign up credit expiring in 14 days | Account Owner |
| Sign up credit expiring in  7 days | Account Owner |
| Sign up credit expiring in  1 days | Account Owner |
| Sign up credit is 50% consumed     | Account Owner |
| Sign up credit is 90% consumed     | Account Owner |
