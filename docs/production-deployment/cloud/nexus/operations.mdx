...
However this requires knowing the Endpoint’s target namespace and manual steps, which is why we’ve created [bi-directional linking for Nexus Operations](\#bi-directional-linking-(coming-soon-…)) to navigate forwards and backwards across workflow event histories, via the Nexus Operations and underlying Temporal primitives they may create.
...
###### *Bi-directional Linking (coming soon …)* {#bi-directional-linking-(coming-soon-…)}
