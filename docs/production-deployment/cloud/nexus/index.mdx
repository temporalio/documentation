...
id: index
slug: /cloud/nexus
title: Temporal Nexus - Deploy to Production with Temporal Cloud 
...
A Nexus Endpoint is an API Proxy or Gateway, that can act as a central point of control for these concerns. Temporal Cloud supports built-in rate-limiting and an Endpoint allowlist \- with a roadmap to support finer-grained rate-limiting and access-control policies suitable for external callers.
