...
1. Creating a [Nexus Endpoint](/nexus/registry-endpoints#nexus-endpoints) in the [Nexus Registry](/nexus/registry-endpoints#nexus-registry) that:
   1. Targets the handler Namespace.
   2. Allows the caller Namespace.
2. Creating a [Nexus Service](/nexus/services-operations) in a Worker within a handler Namespace.
