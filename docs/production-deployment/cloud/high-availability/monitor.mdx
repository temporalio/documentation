...
- [Service health and latency metrics](#metrics)
  ...
  - [Operational events in the audit log](#auditing)
...
Temporal Cloud strives to maintain a <ToolTipTerm term="P95" tooltip="P95 refers to the 95th percentile of a data set. It identifies values that are greater than or equal to 95% of that set." /> replication lag of less than 1 minute.
