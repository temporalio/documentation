...
This section provides how-to instructions monitoring the health of your deployment when using Namespaces with High Availability features:
...
- **Data synchronization issues:** The replica fails to stay in sync with the primary due to network or performance problems.
