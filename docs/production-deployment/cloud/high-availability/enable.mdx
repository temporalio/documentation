...
- **Multi-region Replication**: Workflows are seamlessly replicated to a different [region](/cloud/regions) that you choose.
  ...
  This option is a good fit if your application is architected to be multi-region within the same cloud provider.
- **Multi-cloud Replication**: Workflows are seamlessly replicated to a different cloud provider and region that you choose.
