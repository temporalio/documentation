...
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Temporal&nbsp;Cloud&nbsp;Web&nbsp;UI** | 1. Visit Temporal Cloud in your Web browser. <br /> 2. During Namespace creation, specify the primary region for the Namespace. <br /> 3. Select "Add a replica". <ul><li>Adding a replica in the same region enables Same-region Replication.</li><li>Adding a replica in a different region (within the same continent) replicates across regions for Multi-region Replication.</li></ul>                                                                                                                                                                                                                                                                                                        |
...
2. Wait through the required seven-day waiting period.
