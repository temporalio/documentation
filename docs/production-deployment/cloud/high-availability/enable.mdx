...
- For Workers and Clients that use API keys, requires connecting to the Namespace using the published [regional endpoint](/cloud/regions) for the Namespace's region.
...
1. If using API keys on this Namespace, configure Workers and Clients that use API keys to [connect with the regional Temporal Cloud endpoint](/cloud/api-keys#namespace-authentication) for the Namespace's primary region.
...
First, if using API keys on this Namespace, configure Workers and Clients that use API keys to [connect with the regional Temporal Cloud endpoint](/cloud/api-keys#namespace-authentication) for the Namespace's primary region.
