...
Always check the <Components.ToolTipTerm term="replication lag" /> before initiating a failover.
...
Failover testing (also known as "<Components.ToolTipTerm term="trigger testing" />)" can:
