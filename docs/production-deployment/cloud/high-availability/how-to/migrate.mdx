...
2. Wait for the replica to become active. The Cloud UI will display a time estimate, and you will receive an email when the replica is active.
3. If your workers are using API key authentication: ensure your workers can [use the regional endpoint of the new replica](/cloud/namespaces#access-namespaces).
