...
- [Secure routing for failovers](#routing)
...
Always check the [metric replication lag](/production-deployment/cloud/metrics/reference#replication-lag) before initiating a failover.
