...
This allows you to switch between primary Namespaces and their replicas, testing the failover mechanism or just stay ahead of Temporal's automatic failovers when it matters.
