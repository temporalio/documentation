...
This allows you to switch between primary Namespaces ("the primary") and their replicas, testing the failover mechanism or just staying ahead of Temporal's automatic failovers when it matters.
