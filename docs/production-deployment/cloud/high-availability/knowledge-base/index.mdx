...
[**Resolving DNS**](/cloud/high-availability/secure-routing) and
[**Setting up AWS PrivateLink for High Availability routing**](/cloud/high-availability/private-link):

- Resolving a Namespace’s DNS record correctly is an important skill when your Namespace's region or isolation domain will change after failover.
