...
slug: /cloud/replication/best-practices
...
- [Preparing Worker deployment](/cloud/replication/best-practices#worker-deployment)
- [Set up secure routing for failovers](/cloud/replication/best-practices#routing)
- [PrivateLink routing](/cloud/replication/best-practices#privatelink-routing)
- [High availability Failover testing](/cloud/replication/best-practices#testing)
- [Monitoring replication lag metrics](/cloud/replication/best-practices#metrics)
- [Viewing operational events](/cloud/replication/best-practices#events)
...
More details are available in the [Routing](/cloud/replication/best-practices#routing) section.
...
You may notice that replicated Namespaces shows twice (2x) the Action count in `temporal_cloud_v0_total_action_count`.
