...
Temporal’s replication and automated failover features ensure high availability by automatically switching the Temporal Service between a primary and its replica when needed.
...
For the highest level of reliability, distribute your dependencies across regions, and choose our Multi-region Namespace feature.
