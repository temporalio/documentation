...
description: Temporal Cloud's Namespace with High Availability features offer automated failover, synchronized data, and replication for workloads requiring disaster-tolerant deployment and 99.99% uptime.
tags:
  - Temporal Cloud
  - Production
  - High availability
