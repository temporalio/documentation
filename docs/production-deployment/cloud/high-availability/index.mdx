...
High Availability features improve reliability and reduce risk by deploying a primary Namespace and its replica to different cells, that is separate isolation domains.
