---
id: audit-logs-aws
title: Audit Logs - AWS Kinesis
sidebar_label: Amazon Kinesis
description: Audit Logs in Temporal Cloud provides forensic information, integrating with AWS Kinesis for secure data handling and supporting key Admin and API Key operations. This streamlines audit and compliance processes.
