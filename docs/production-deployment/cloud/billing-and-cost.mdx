...
On the **Usage** page, you can find cost breakdown by namespace. View [Cost Details](#cost-details)
...
As an Account Owner, you will have access to the cost column under the Usage page. This column will allow you to see cost per namespace. Note that the cost details are unavailable for the last 90 or 120 days time period filters. To view cost per namespace, you must select Current Period, Last Month, Two Months Ago, or Three Months Ago. 
