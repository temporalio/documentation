...
The [Usage](https://cloud.temporal.io/usage) page shows the cost breakdown by Namespace for Account Owners, Global Admins and Finance Admins.
If your organization separates projects by Namespace -- for architectural reasons, for development/production differentiation, for different products, etc -- holders of administrative roles can view individual costs for each Namespace.
...
Account Owners, Global Admins and Finance Admins can access a cost column on the Usage page.
If your organization separates projects by Namespace -- for architectural reasons, for development/production differentiation, for different products, etc -- holders of administrative roles can view individual costs for each Namespace.
...
![Billing page showing the Plan tab. The contents on the tab include "Manage Payment Method" and "Delete Account" buttons. The "Delete Account" button is placed below text asking "No longer using Temporal Cloud?"](/img/billing/billing-cancel.png)
