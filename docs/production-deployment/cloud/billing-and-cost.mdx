...
2. Select **Billing** from the menu options.
3. In the Invoices section, locate and download the invoice you wish to review.
...
- Credits Purchased Amount - Amount paid for credits purchase
