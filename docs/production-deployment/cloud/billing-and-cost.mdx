...
The [Billing](https://cloud.temporal.io/billing) page includes all or some of the following information, based on your plan:
...
The [Usage](https://cloud.temporal.io/usage) page provides an overview of your usage across your Namespaces.
