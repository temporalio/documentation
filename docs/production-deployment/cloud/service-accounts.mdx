...
By clicking on the `Generate API Key` button, a Namespace Scoped Service Account will be automatically created for the given Namespace and an associated API key will be displayed.
