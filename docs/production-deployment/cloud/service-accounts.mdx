...
Note that you can change the Namespace Permission after creation using [Service Account Update](#update).
...
Note that the Account Role is omitted here, since Namespace Scoped Service Accounts always have a `Read` Account Role.
