...
1. Specify an **Okta administrator** to configure the SCIM integration.
   The administrator will receive an email with a configuration link.
...
1. Your Okta administrator opens the supplied link.
   The link leads to step-by-step instructions, to configure the integration.
