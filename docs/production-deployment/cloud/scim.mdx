...
Supported upstream IDP vendors: Okta, Microsoft Entra ID (Azure AD), Google Workspace, OneLogin, CyberArk, JumpCloud, PingFederate, and Custom SCIM 2.0 providers. 
