...
- Namespace
  ...
  - `UpdateNamespaceAPI`: Update Namespace (includes change retention period, edit replicas, update authentication methods, update custom search attributes)
- Nexus Endpoint
...
- API Keys
  - `CloudCreateAPIKey`: Cloud Create API Key
  - `CloudDeleteAPIKey`: Cloud Delete API Key
  - `CloudUpdateAPIKey`: Cloud Update API Key
