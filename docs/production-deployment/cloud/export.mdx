...
description: "Configure Temporal Cloud's Workflow History Export feature to preserve complete workflow data and enable data warehousing for analytics, with automated and manual setup options."
slug: /cloud/export
