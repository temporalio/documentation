...
<span style={{ backgroundColor: 'rgb(255, 255, 102)', fontWeight: 'bold' }}>Updated page name as requested but left sidebar_label unchanged and plural per docs site standards; Does the new title work for you or would you like to reword?</span>
...
<span style={{ backgroundColor: 'rgb(255, 255, 102)', fontWeight: 'bold' }}>Updated this section to incorporate text from Irina's writeup--please check.</span>
...
Once your multi-region Namespace is ready, all account admins will receive an email alert.
...
Once your multi-region Namespace is ready, all admins will receive an email update.
