...
Temporal Cloud will return a "Service unavailable error", which will be retried by SDKs.
...
During this period, existing Workflows stop progress.
Temporal Cloud will return a "Service unavailable error", which will be retried by the SDKs.
