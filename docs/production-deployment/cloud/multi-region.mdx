...
Temporal Cloud's multi-region Namespace feature provides our most stringent Service Level Agreement ([SLA](https://docs.temporal.io/cloud/sla)).
MRNs provide 99.99% availability and 99.99% guarantee against service errors.
...
* Multi-region Namespaces offer a 99.99% contractual SLA for workloads requiring high availability.
