...
Even though Temporal's contractual SLA for single-region Namespaces is 99.9%, Temporal Cloud itself provides the highest level of availability. 
...
For pricing details, please visit Temporal Cloud's [Pricing page](/cloud/pricing).
