...
After Temporal-initiated failovers, Temporal Cloud restores your Namespace to its original active region once the incident is resolved and the Namespace data is fully reconciled.
