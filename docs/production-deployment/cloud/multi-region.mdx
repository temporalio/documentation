...
Temporal Cloud's multi-region Namespace feature provides our highest levels of service availability and error guarantees.
Our MRN Service Level Agreement ([SLA](https://docs.temporal.io/cloud/sla)) provides 99.99% availability and 99.99% guarantee against service errors.
...
Our standard contractual Service Level Agreement ([SLA](https://docs.temporal.io/cloud/sla)) provides a 99.9% guarantee against service errors.
...
Multi-region Namespaces offer 99.99% availability, enforced by our [service error rates SLA](https://docs.temporal.io/cloud/sla).
...
- Always check the [metric replication lag](https://temporal-documentation-clljyhxqv.preview.thundergun.io/production-deployment/cloud/metrics/reference#temporal_cloud_v0_replication_lag_bucket) before initiating a failover.
...
Temporal Cloud emits three replication lag-specific [metrics](https://temporal-documentation-clljyhxqv.preview.thundergun.io/production-deployment/cloud/metrics/reference#temporal_cloud_v0_replication_lag_bucket).
