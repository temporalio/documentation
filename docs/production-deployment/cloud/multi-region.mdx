...
* YES [Relative anchor](#multi-region-intro)
* YES [Page ref on page](/cloud/multi-region#multi-region-intro)
* N/A Cannot test fully specified URL  as that will go to real site

### Broken versions

* BREAKS BUILD `[Relative anchor](#multi-region-introxx)`
* BREAKS BUILD `[Page ref on page](/cloud/multi-region#multi-region-introxx)`
* Cannot test fully specified URL as that will go to real site

## Internal to docs site

* YES [Page ref on page](/cloud/pricing#pricing-faq)
* N/A Cannot test fully specified URL  as that will go to real site

### Broken versions

* BREAKS BUILD `[Page ref on page](/cloud/pricing#pricing-faqxx)`
* BREAKS BUILD `[Page ref on page](/cloud/pricing#doesntexist)`
* Cannot test fully specified URL  as that will go to real site

## External over to the learn site
