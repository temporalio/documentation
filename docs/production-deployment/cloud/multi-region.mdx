...
MRN adds seamless failover capabilities to your production work, ensuring continuous operation without manual intervention​​.
...
The Temporal Cloud Service handles the complexity of replicating data from the active region to the standby region and transferring control to the standby region when needed.
...
#### After failover
After any failover, whether triggered by you or by Temporal, information about the event appears in both the [Temporal Cloud Web UI](https://cloud.temporal.io/namespaces) on the Namespace detail page and in your audit logs.
