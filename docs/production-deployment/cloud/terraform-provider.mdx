...
Temporal Cloud’s Terraform provider currently does not support [multi-region Namespaces](/cloud/high-availability) or [GCP regions](https://docs.temporal.io/cloud/service-availability#gcp).
