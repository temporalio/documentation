...
description: "Manage Temporal Cloud resources with Terraform, a tool for infrastructure as code. The Temporal Cloud Terraform provider allows you to automate management of Namespaces, users, and more. Learn how to set up and use the provider, create and manage Namespaces, and manage users with Terraform."
tags:
  - temporal cloud
  - terraform
ssdi:
