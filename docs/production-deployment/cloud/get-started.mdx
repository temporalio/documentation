...
description: Start using Temporal Cloud by signing up, having the Account Owner or Global Admin role, setting up CA certificates, creating a Namespace, inviting users, and connecting your Temporal Client and Workers.
