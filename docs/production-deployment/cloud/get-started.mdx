...
description: "Get started with Temporal Cloud by signing up, accepting Global Admin permissions, setting up CA certificates, creating a Namespace, inviting users, and connecting to Temporal Cloud using your preferred SDK or language."
