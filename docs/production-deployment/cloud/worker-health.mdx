...
If you are setting the [Schedule-To-Start Timeout](/encyclopedia/detecting-activity-failures#schedule-to-start-timeout) value in your Activity Options, it will skew your observations if you are not following the guidance [here](/encyclopedia/detecting-activity-failures#schedule-to-start-timeout).
