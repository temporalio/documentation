...
description: "Monitor and troubleshoot your Temporal Cloud application's performance with this guide, covering detecting task backlogs, greedy worker resources, misconfigured workers, and configuring sticky cache. Learn how to set up alerts and queries to identify issues and optimize your application's efficiency."
