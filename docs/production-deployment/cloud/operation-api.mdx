...
description: "Manage Temporal Cloud resources programmatically with the Cloud Operations API, a public gRPC API for automating user, namespace, and account management tasks, featuring flexible integration and authentication using API keys."
slug: /ops
...
- Temporal Cloud Operations API is in [Public Preview](/evaluate/release-stages#public-preview) for Temporal Cloud.
