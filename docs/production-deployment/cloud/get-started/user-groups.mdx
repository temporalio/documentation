...
Only users with the Account Owner or Global Admin account-level [role](#account-level-roles) can manage user groups.
...
To create a user group, a user must have the Account Owner or Global Admin account-level [role](#account-level-roles).
...
To assign roles to a user group, a user must have the Account Owner or Global Admin account-level [role](#account-level-roles).
...
To manage users in a user group, a user must have the Account Owner or Global Admin account-level [role](#account-level-roles).
