...
Temporal Cloud sends courtesy emails 15 days, 10 days, and 5 days prior to certificate expiry. Emails are sent to Global and Namespace Admins.
...
The contents of the generated `ca.pem` should be pasted into the "Authentication" section of your Namespace settings page.
...
To help you remember to do so, Temporal Cloud sends email notifications to users who have the Account Owner or Global Admin [roles](/cloud/users#account-level-roles) or the Namespace Admin [permission](/cloud/users#namespace-level-permissions) 15 days, 10 days and 5 days before expiration.
