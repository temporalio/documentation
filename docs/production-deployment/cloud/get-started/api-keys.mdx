...
[How to connect to Temporal Cloud using an API Key with the PHP SDK](/develop/php/temporal-clients#connect-to-temporal-cloud-api-key)
...
[How to connect to Temporal Cloud using an API Key with the .NET SDK](/develop/dotnet/temporal-clients#connect-to-temporal-cloud-api-key)
