...
This view currently is limited to Global Administrators and Account Owners.
Namespace Admins can generate an API key for a scoped Service Account using `tcld` or by following the steps [here](/cloud/service-accounts#scoped-ui).
