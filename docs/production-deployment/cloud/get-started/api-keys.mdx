...
1. Find the API key. Use the vertical ellipsis in the table row and select the Disable/Enable option to perform the action.
...
1. Locate the API key. Use the vertical ellipsis in the table row and select the Delete option.
