...
- Namespace Admins can create, delete, and update access to API keys for Namespace-scoped Service Accounts they administer.
...
Namespace Admins can manage and generate API keys for Namespace-scoped Service Accounts they administer.

This is different for users, who manage and generate their own API keys.
