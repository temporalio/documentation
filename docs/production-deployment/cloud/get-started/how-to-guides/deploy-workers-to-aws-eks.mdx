...
The example in this post uses Temporal’s Python SDK.
You can apply this content to both Temporal OSS and Temporal Cloud Workflows.
...
In normal deployment, tune your resources for production workloads.
