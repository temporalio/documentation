...
When a Service Account is deleted, all associated API keys are automatically deleted as well.
Therefore, you do not need to manually remove API keys after deleting a Serivce Account.
