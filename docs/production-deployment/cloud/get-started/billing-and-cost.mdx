...
- [Plan](#plans): Your current plan, usage pricing, and entitlements, with the ability to manage upgrades and downgrades, payment method, and account deletion
...
- **For accounts created through our self-signup portal**. <br />
  ...
  - Deleted accounts will immediately cease billing and be scheduled for full deletion within 72 hours.
