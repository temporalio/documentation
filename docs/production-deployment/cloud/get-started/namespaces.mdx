...
Requiring both API key and mTLS is in [pre-release](/evaluate/development-production-features/release-stages), and doesn't currently support [High Availability features](/cloud/high-availability).
