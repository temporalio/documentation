...
However, those using Google/Miscrosoft SSO or email and password authentication need to accept the invitation link for their initial login to Temporal Cloud.
...
* If you prefer to use Google or Microsoft SSO instead, ask your Account Owner to delete your existing account and re-invite you.
