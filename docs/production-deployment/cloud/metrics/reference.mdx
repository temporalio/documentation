...
#### temporal_cloud_v0_operations_count

Approximate count of Temporal Cloud [operations](/references/operation-list) attempted excluding rate-limited attempts.

#### temporal_cloud_v0_operations_throttled_count

Approximate count of Temporal Cloud [operations](/references/operation-list) throttled.
...
The possible operations can vary by metric.

For `temporal_cloud_v0_operations_count` and `temporal_cloud_v0_operations_throttled_count` see the Temporal Cloud [operations list](/references/operation-list).

For all other metrics, Temporal Cloud includes the following operations labels:
