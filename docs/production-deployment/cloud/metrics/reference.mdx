...
A histogram of [replication lag](/cloud/multi-region#replication-lag) during a specific time interval for a [Namespace with high availability](/cloud/high-availability/operations).

#### temporal_cloud_v0_replication_lag_count

The [replication lag](/cloud/multi-region#replication-lag) count during a specific time interval for a [Namespace with high availability](/cloud/high-availability/operations).

#### temporal_cloud_v0_replication_lag_sum

The sum of [replication lag](/cloud/multi-region#replication-lag) during a specific time interval for a [Namespace with high availability](/cloud/high-availability/operations).
