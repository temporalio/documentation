...
description: "Learn how to configure a metrics endpoint using the Temporal Cloud UI or tcld CLI, including assigning a certificate and generating the endpoint URL for observability tools like Grafana."
tags:
  - observability
  - metrics
  - temporal-cloud
