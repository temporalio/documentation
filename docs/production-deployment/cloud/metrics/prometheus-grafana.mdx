...
1. In the **TLS Settings** section, select **TLS Client Authentication**:
   ...
   <div style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
      ...
      <img
        src="/img/cloud/add-prometheus-api-endpoint.png"
        alt="A screenshot showing the data source configuration in Grafana"
        style={{
          width: '20%',
          cursor: 'pointer',
        ...
        onClick={(e) => {
          const img = e.target;
          img.style.width = img.style.width === '100%' ? '20%' : '100%';
        }}
      />
    </div>
