...
- Set up your connections to Temporal Cloud using an SDK of your choice and have some Workflows running on Temporal Cloud. See Connect to a Temporal Service for details.
  ...
  - [PHP](/dev-guide/php/foundations#connect-to-a-dev-temporal-service)
...
3. Add your metrics queries:
   - For Temporal Cloud metrics, expand the **Metrics browser** and select the metrics you want to see.
     ...
     The documentation on [Cloud metrics](/cloud/metrics/#available-metrics) lists metrics emitted from Temporal Cloud.
