...
Before implementing observability for Temporal Cloud, decide what you need to measure for your use case. There are two primary use cases for metrics:
...
SDK metrics are for monitoring individual workers and your code's behavior.
Cloud metrics are for monitoring Temporal behavior.
