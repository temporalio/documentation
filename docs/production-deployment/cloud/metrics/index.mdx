...
When used together, Temporal Cloud and SDK metrics measure the health and performance of their full Temporal infrastructure, including the Temporal Cloud Service and user-supplied Temporal Workers. 
