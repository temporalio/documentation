...
description: "Monitor and analyze your Temporal Cloud Namespaces with real-time metrics, available via an endpoint queryable with your own observability tool, with seven-day retention and CA-certified security."
slug: /cloud/metrics/
