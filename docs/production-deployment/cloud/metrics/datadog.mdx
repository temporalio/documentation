...
- Minikube for running a [local Kubernetes Temporal Service](https://minikube.sigs.k8s.io/docs/start/).
...
While this is using Minikube, you can deploy to any Kubernetes Temporal Service, with your environment specific configuration.
