...
* **During Public Preview**: Both endpoints run in parallel with no changes required.
* **GA Release [TBA]**: OpenMetrics endpoint becomes production-ready.
* **6 months after GA Release**: Prometheus query endpoint deprecated and eventually removed.
