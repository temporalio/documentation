...
To use Entra ID as your SAML IdP, create an Microsoft Entra ID Enterprise application.
...
1. On the **Browse Manage Microsoft Entra ID Gallery** page near the top, select **Create your own application**.
...
To finish setting up Manage Microsoft Entra ID as your SAML IdP, see [Finish SAML configuration](#finish-saml-configuration).
