...
sidebar_label: SAML
description: Configure SAML authentication for your Temporal Cloud account by connecting an identity provider (IdP) via Security Assertion Markup Language (SAML) 2.0, requiring Account Id and entity identifier setup.
slug: /cloud/saml
