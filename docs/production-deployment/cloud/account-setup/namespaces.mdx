...
- For [Namespaces with High Availability Features](/cloud/high-availability) use the gRPC Namespace endpoint `<namespace>.<account>.tmprl.cloud:7233` regardless of your authentication method, because it allows automated failover without needing to switch your endpoint.
