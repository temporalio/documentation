...
- For [multi-region Namespaces](/cloud/high-availability) use the endpoint format `<namespace>.<account>.tmprl.cloud:7233` regardless of authentication method, because it allows automated failover without needing to switch endpoints.
