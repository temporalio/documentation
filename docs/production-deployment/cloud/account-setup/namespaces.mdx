...
- Allow list, for outgoing network requests from your Clients and Workers, the IP address ranges of the Cloud Provider region in which your Namespace is located.
