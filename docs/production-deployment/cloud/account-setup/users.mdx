...
In addition there's one role that the Global Admin cannot assign:
...
- Associate an actual person’s email address to the Account Owner, not a shared or generic one, so Temporal Support can contact the right person in urgent situations.
...
| Permission                     | Read-only | Developer | Global Admin | Account Owner |
| ------------------------------ | --------- | --------- | ------------ | ------------- |
| CountIdentities                | ✔         | ✔         | ✔            | ✔             |
| CreateAPIKey                   | ✔         | ✔         | ✔            | ✔             |
| CreateNamespace                |           | ✔         | ✔            | ✔             |
