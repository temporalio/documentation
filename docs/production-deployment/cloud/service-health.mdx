...
Temporal Cloud metrics help you to monitor the Service health of your production deployments. This documentation addresses some common best practices for monitoring Service health.
