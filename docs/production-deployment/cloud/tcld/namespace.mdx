...
Enrolling a second region upgrades the Namespace to [High Availability features](/cloud/high-availability).
...
When two `--region` flags are provided, your Namespace is provisioned to use Temporal Cloud [multi-region Namespace](/cloud/high-availability) (MRN) service.
