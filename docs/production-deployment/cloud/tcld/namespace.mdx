...
The [retention period](/cloud/namespaces#retention-period) in days for closed Workflow Executions.
...
A [tag](/cloud/namespaces#tags) in the form "_key_=_value_". Can be specified more than once.
