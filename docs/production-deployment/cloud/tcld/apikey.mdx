...
description: "Temporal Cloud API Key management commands: create, get, list, delete, disable, and enable API Keys with options for name, description, duration, expiry, and request-id."
