...
If you have Docker and Docker Compose installed, all you need to do is clone the [temporalio/samples-server](https://github.com/temporalio/samples-server) repo and run the `docker compose up` command from the `compose` folder.
