...
To migrate your Visibility database, [set up a secondary Visibility store](/self-hosted-guide/visibility/dual-visibility#dual-visibility) to enable
...
1. In your Temporal Service configuration,
   ...
   details, see [secondary Visibility database schema and setup](/self-hosted-guide/visibility/dual-visibility#dual-visibility).
