...
description: A Visibility store is essential for your Temporal Cluster, supporting features like batch operations and custom Search Attributes for filtering Workflow Executions. Upgrade to PostgreSQL 12, MySQL 8.0.17, or SQLite 3.31.0 with Temporal Server 1.20+ for advanced Visibility
...
To manage your custom Search Attributes on self-hosted Temporal Clusters, use Temporal CLI. With self-hosted Temporal Cluster, you can create and remove custom Search Attributes.
...
Add custom Search Attributes to your Visibility store using the Temporal CLI for a self-hosted Temporal Cluster and `tcld` for Temporal Cloud.
...
If you're self-hosting your Temporal Cluster, verify whether your [Visibility database](/self-hosted-guide/visibility) version supports advanced Visibility features.
...
To remove a Search Attribute key from your self-hosted Temporal Cluster Visibility store, use the command `temporal operator search-attribute remove`.
