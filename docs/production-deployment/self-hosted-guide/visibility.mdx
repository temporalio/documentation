...
The following example shows how to set up an Elasticsearch Visibility store with a PostgresSQL persistence store using
...
databases). For setup examples, refer to the [samples-server repository](https://github.com/temporalio/samples-server)
