...
To manage custom Search Attributes on Temporal Cloud, use the [`tcld`](/cloud/tcld) CLI tool.
...
To manage custom Search Attributes on a self-hosted Temporal Service, use the [Temporal CLI](/cli).
With a self-hosted Temporal Service, you can create and remove custom Search Attributes.

If you're self-hosting, verify whether your [Visibility database](/self-hosted-guide/visibility#current-and-legacy-visibility-support) version supports custom Search Attributes before proceeding. 
