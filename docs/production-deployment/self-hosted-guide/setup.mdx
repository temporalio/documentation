...
sidebar_label: Setup
description: Self-host Temporal Service using Docker, Kubernetes, or Helm charts. Requires a database like Cassandra, MySQL, or PostgreSQL. Customize setup for your infrastructure and tooling.
