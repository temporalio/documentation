...
sidebar_label: Setup
description: "Self-host a Temporal Cluster with ease: choose from Docker, Docker Compose, or Helm charts, and select from PostgreSQL, MySQL, Cassandra, or SQLite databases."
...
Local [Temporal Clients](/encyclopedia/temporal-sdks#temporal-client) and [Workers](/workers) can connect to the Cluster running in Docker at 127.0.0.1:7233 (default connection for most SDKs) and the Temporal Web UI at 127.0.0.1:8080.
