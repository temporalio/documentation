...
While it's usually easiest to interact with [Temporal Server](/temporal-service#temporal-server) via a [Client SDK](/temporal#temporal-client) or the [Temporal CLI](https://docs.temporal.io/cli), you can also use its gRPC API.
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">ListWorkflowExecutions</p>
  </div>
  <div class="tdiiw" height="1716">
    <img class="img_ev3q" src="/img/ListWorkflowExecutions.png" alt="ListWorkflowExecutions" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">DescribeTaskQueue</p>
  </div>
  <div class="tdiiw" height="1282">
    <img class="img_ev3q" src="/img/DescribeTaskQueue.png" alt="DescribeTaskQueue" />
  </div>
</div>
