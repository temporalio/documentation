...
description: "Use the Temporal gRPC API for direct interaction, with API reference available at api-docs.temporal.io, or generate gRPC client stubs in your preferred language."
