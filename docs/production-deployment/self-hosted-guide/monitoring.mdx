...
The [Temporal Service Metrics reference](/references/temporal-service-metrics) describes a few metrics and queries that you can get started with.
...
3. In the **Metrics** field, use any of the queries listed in the [Temporal Service Metrics reference](/references/temporal-service-metrics).
...
The [Frontend Service](/temporal-service#frontend-service) supports TCP or [gRPC](https://github.com/grpc/grpc/blob/875066b61e3b57af4bb1d6e36aabe95a4f6ba4f7/src/proto/grpc/health/v1/health.proto#L45) health checks on port 7233.
