...
description: "Learn how to monitor and troubleshoot your self-hosted Temporal Platform using metrics and health checks. Discover how to set up Prometheus and Grafana to collect and visualize metrics from your Temporal Cluster and SDKs, and how to enable health checks for your Frontend Service."
