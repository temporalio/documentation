...
If you are using [Temporal Cloud](/evaluate/cloud), you can also [integrate Datadog directly](https://docs.datadoghq.com/integrations/temporal-cloud/), without needing to use Prometheus.
