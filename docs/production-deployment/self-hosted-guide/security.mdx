...
### Encryption in transit with mTLS {/* #encryption-in-transit-with-mtls */}
...
#### Default JWT ClaimMapper {/* #default-jwt-claimmapper */}
...
#### Token key provider {/* #token-key-provider */}
...
#### JSON Web Token format {/* #json-web-token-format */}
...
##### Example of a payload for the default JWT ClaimMapper {/* #example-of-a-payload-for-the-default-jwt-claimmapper */}
...
## Configuration Options for Restricting and Securing Access {/* #configuration-options-for-restricting-and-securing-access */}
