...
If you are building a new Temporal Application, you might only need a
[development server](/cli/setup-cli#run-a-local-development-server) available through the
[Temporal CLI](/cli).
