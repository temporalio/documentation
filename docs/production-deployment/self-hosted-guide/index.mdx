...
description: "Get started with self-hosting Temporal Service, an open-source infrastructure software for durable applications, with this comprehensive guide covering defaults, production checklist, security, monitoring, visibility, data encryption, upgrading, and more."
