...
description: Temporal Failures represent various system errors, including Application Failures, Workflow and Activity Task Failures, and errors that originate in the Cluster.
