...
This error indicates that the [Workflow Task](/workers#workflow-task) failed to validate a [ContinueAsNew](/references/commands/#continueasnew) attribute.
...
This error indicates that the [Workflow Task](/workers#workflow-task) failed while trying to cancel an [external Workflow](/workflows/#external-workflows).
