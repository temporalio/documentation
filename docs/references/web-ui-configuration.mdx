...
description: "Configure the Temporal Web UI Server's settings through a YAML configuration file, including Temporal Cluster address, port, public path, and more."
