...
All metrics emitted by the Temporal Service is listed in [metric_defs.go](https://github.com/temporalio/temporal/blob/master/common/metrics/metric_defs.go).
