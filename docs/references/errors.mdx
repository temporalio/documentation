...
This error indicates unset or invalid attributes for ScheduleNexusOperation, for example if the Nexus Endpoint name used in the caller Workflow does not exist.
...
See [Per Workflow Nexus Operation Limits](#per-workflow-nexus-operation-limits) for details.
