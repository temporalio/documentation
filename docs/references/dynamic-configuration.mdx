...
Temporal Service provides [dynamic configuration](/clusters#dynamic-configuration) keys that you can update and apply to a running Temporal Service without restarting your services.
