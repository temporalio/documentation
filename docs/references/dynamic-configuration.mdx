...
| Dynamic configuration key                              | Type    | Description                                                                                                                                    | Default value                                                           |
| ------------------------------------------------------ | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `system.enableNexus`                                   | Boolean | Enables Nexus Features                                                                                                                         | `false`                                                                 |
...
| `component.callbacks.allowedAddresses.Pattern`         | String  | Defines which callback URLs are permitted to be called by the server. (the patterns is a regex or wildcard)                                    | `*`                                                                     |
