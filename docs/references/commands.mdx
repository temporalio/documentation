...
By default, you can't schedule more than 30 Nexus Operations concurrently (or in total during Public Preview since completed operations are not yet deleted), see [Limits](/#workflow-execution-nexus-operation-limits) for details.
