...
By default, you cannot schedule more than 30 Nexus Operations concurrently (or in total during public preview since completed operations are not yet deleted), see [Limits](/#workflow-execution-nexus-operation-limits) for details.
