...
The [Frontend Service](/temporal-service#frontend-service) address for the Temporal Service.
...
The documentation can be found at `/openapi/` on your Temporal Service.
...
Enables or disables notifications that appear in the UI whenever a newer version of the Temporal Service is available.
