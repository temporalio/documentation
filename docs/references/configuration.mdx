...
- `hosts`: _Required_ - "," separated Cassandra endpoints, for example "192.168.1.2,192.168.1.3,192.168.1.4".
...
- `connectAddr` - _required_ - the remote address of the database, for example "192.168.1.2".
