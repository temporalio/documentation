...
Temporal Cluster provides [dynamic configuration](/clusters#dynamic-configuration) <span id="i-c4396765-fc8a-4a43-8dd1-93fdfbb095f3" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c4396765-fc8a-4a43-8dd1-93fdfbb095f3" class="preview-modal"><div class="modal-header"><div id="x-c4396765-fc8a-4a43-8dd1-93fdfbb095f3" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#dynamic-configuration">/clusters#dynamic-configuration</a></div><div class="preview-modal-title">What is Cluster configuration?</div><div class="preview-modal-description">Cluster Configuration is the setup and configuration details of your Temporal Cluster, defined using YAML.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> keys that you can update and apply to a running Cluster without restarting your services.
...
You can define default values for Activity and Workflow [Retry Policies](/retry-policies#) <span id="i-06fe2269-347c-4f8a-8449-f3c87899f70f" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-06fe2269-347c-4f8a-8449-f3c87899f70f" class="preview-modal"><div class="modal-header"><div id="x-06fe2269-347c-4f8a-8449-f3c87899f70f" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/retry-policies#">/retry-policies#</a></div><div class="preview-modal-title">What is a Retry Policy?</div><div class="preview-modal-description">A Retry Policy is a collection of attributes that instructs the Temporal Server how to retry a failure of a Workflow Execution or an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> at the Cluster level with the following dynamic configuration keys.
