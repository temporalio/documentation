...
Temporal Cluster provides [dynamic configuration](/clusters#dynamic-configuration) <span id="i-dfcf924b-34df-4082-948f-3dff43efa60e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-dfcf924b-34df-4082-948f-3dff43efa60e" class="preview-modal"><div class="modal-header"><div id="x-dfcf924b-34df-4082-948f-3dff43efa60e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is Cluster configuration?</div><div class="preview-modal-description">Cluster Configuration is the setup and configuration details of your Temporal Cluster, defined using YAML.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> keys that you can update and apply to a running Cluster without restarting your services.
...
You can define default values for Activity and Workflow [Retry Policies](/retry-policies#) <span id="i-6f058872-5253-4ec7-8e21-3a76b87be2a5" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6f058872-5253-4ec7-8e21-3a76b87be2a5" class="preview-modal"><div class="modal-header"><div id="x-6f058872-5253-4ec7-8e21-3a76b87be2a5" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Retry Policy?</div><div class="preview-modal-description">A Retry Policy is a collection of attributes that instructs the Temporal Server how to retry a failure of a Workflow Execution or an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> at the Cluster level with the following dynamic configuration keys.
