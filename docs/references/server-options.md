...
Note, there are many ways to [run a Temporal Cluster](/kb/install-temporal-cluster-for-development) and this approach is recommended for a limited number of situations.
