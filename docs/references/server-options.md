...
Sets a low level <a class="tdlp" href="/security#authorizer-plugin">authorization mechanism<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><div class="tdlpc"><p class="tdlppt">What is an Authorizer Plugin?</p><p class="tdlppd">undefined</p><p class="tdlplm"><a href="/security#authorizer-plugin">Learn more</a></p></div></a> that determines whether to allow or deny inbound API calls.
