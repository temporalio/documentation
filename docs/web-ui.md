...
It ships with every [Temporal CLI](/cli#) release and [Docker Compose](/cluster-deployment-guide#docker--docker-compose) update and is available with [Temporal Cloud](/cloud).
