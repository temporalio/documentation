...
A customized configuration can be passed using either the [WithConfig](/references/server-options#withconfig) <span id="i-0d2c69d2-4c14-4afc-8c6a-940f3f32a358" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-0d2c69d2-4c14-4afc-8c6a-940f3f32a358" class="preview-modal"><div class="modal-header"><div id="x-0d2c69d2-4c14-4afc-8c6a-940f3f32a358" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Temporal Server options</div><div class="preview-modal-description">You can run the Temporal Server as a Go application by including the server package `go.temporal.io/server/temporal` and using it to create and start a Temporal Server.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span> <span class="preview-modal-tag">web-ui</span></div></div> or [WithConfigLoader](/references/server-options#withconfigloader) <span id="i-dc9fc36b-f5bc-472f-8229-c5b60071db74" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-dc9fc36b-f5bc-472f-8229-c5b60071db74" class="preview-modal"><div class="modal-header"><div id="x-dc9fc36b-f5bc-472f-8229-c5b60071db74" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Temporal Server options</div><div class="preview-modal-description">You can run the Temporal Server as a Go application by including the server package `go.temporal.io/server/temporal` and using it to create and start a Temporal Server.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span> <span class="preview-modal-tag">web-ui</span></div></div> Server options.
...
:::note
Information regarding [`Authorizer`](#authorizer-plugin) <span id="i-ce42bca5-b6a5-467b-a13d-1154e9ee8cfd" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-ce42bca5-b6a5-467b-a13d-1154e9ee8cfd" class="preview-modal"><div class="modal-header"><div id="x-ce42bca5-b6a5-467b-a13d-1154e9ee8cfd" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Authorizer Plugin?</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div> and [`ClaimMapper`](#claim-mapper) <span id="i-2537792a-bf84-4c47-abdf-758f57b8a902" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2537792a-bf84-4c47-abdf-758f57b8a902" class="preview-modal"><div class="modal-header"><div id="x-2537792a-bf84-4c47-abdf-758f57b8a902" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a ClaimMapper Plugin?</div><div class="preview-modal-description">The Claim Mapper component is a pluggable component that extracts Claims from JSON Web Tokens (JWTs).</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div> has been moved to another location.
:::

Temporal offers two plugin interfaces for implementing API call authorization:

- [`ClaimMapper`](#claim-mapper) <span id="i-94559d1b-bf47-432a-93ff-2e56105e7635" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-94559d1b-bf47-432a-93ff-2e56105e7635" class="preview-modal"><div class="modal-header"><div id="x-94559d1b-bf47-432a-93ff-2e56105e7635" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a ClaimMapper Plugin?</div><div class="preview-modal-description">The Claim Mapper component is a pluggable component that extracts Claims from JSON Web Tokens (JWTs).</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div>
- [`Authorizer`](#authorizer-plugin) <span id="i-dd8e3c6f-7f3f-4407-9377-4ad0a1738509" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-dd8e3c6f-7f3f-4407-9377-4ad0a1738509" class="preview-modal"><div class="modal-header"><div id="x-dd8e3c6f-7f3f-4407-9377-4ad0a1738509" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Authorizer Plugin?</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div>
...
Configure your `Authorizer` when you start the server via the [`temporal.WithAuthorizer`](/references/server-options#withauthorizer) <span id="i-bb5f89f8-68cf-4883-81bc-f5f08d85e6b0" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-bb5f89f8-68cf-4883-81bc-f5f08d85e6b0" class="preview-modal"><div class="modal-header"><div id="x-bb5f89f8-68cf-4883-81bc-f5f08d85e6b0" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Temporal Server options</div><div class="preview-modal-description">You can run the Temporal Server as a Go application by including the server package `go.temporal.io/server/temporal` and using it to create and start a Temporal Server.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span> <span class="preview-modal-tag">web-ui</span></div></div> server option.
...
Each Temporal SDK provides a [Data Converter](/dataconversion#) <span id="i-32d2d60e-95c8-495c-9251-f20d26d8018e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-32d2d60e-95c8-495c-9251-f20d26d8018e" class="preview-modal"><div class="modal-header"><div id="x-32d2d60e-95c8-495c-9251-f20d26d8018e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> that can be customized with a custom [Payload Codec](/dataconversion#payload-codec) <span id="i-3d0c6b6d-88a7-48d6-b02b-e183d79d70d2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3d0c6b6d-88a7-48d6-b02b-e183d79d70d2" class="preview-modal"><div class="modal-header"><div id="x-3d0c6b6d-88a7-48d6-b02b-e183d79d70d2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> to encode and secure your data.
...
You can use a [Codec Server](/dataconversion#codec-server) <span id="i-22a58cd1-9b21-4e45-acb9-cb80950246ce" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-22a58cd1-9b21-4e45-acb9-cb80950246ce" class="preview-modal"><div class="modal-header"><div id="x-22a58cd1-9b21-4e45-acb9-cb80950246ce" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Codec Server?</div><div class="preview-modal-description">A Codec Server is an HTTP server that uses your custom Payload Codec to encode and decode your data remotely through endpoints.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div> with your custom Payload Codec to decode the data you see on your Web UI and CLI locally through remote endpoints.
However, ensure that you consider all security implications of [remote data encoding](/dataconversion#remote-data-encoding) <span id="i-1f53dc45-8384-4198-862f-8e3afa91b13f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1f53dc45-8384-4198-862f-8e3afa91b13f" class="preview-modal"><div class="modal-header"><div id="x-1f53dc45-8384-4198-862f-8e3afa91b13f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is remote data encoding?</div><div class="preview-modal-description">Remote data encding is using your custom Data Converter to decode (and encode) your Payloads remotely through endpoints.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> before using a Codec Server.
