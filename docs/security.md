...
:::note
Information regarding [`Authorizer`](#authorizer-plugin) <span id="i-2ff15002-c658-4738-8e58-1bce88338010" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2ff15002-c658-4738-8e58-1bce88338010" class="preview-modal"><div class="modal-header"><div id="x-2ff15002-c658-4738-8e58-1bce88338010" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#authorizer-plugin">#authorizer-plugin</a></div><div class="preview-modal-title">What is an Authorizer Plugin?</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div> and [`ClaimMapper`](#claim-mapper) <span id="i-15b1e509-7037-4630-9bcf-f05e68954a25" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-15b1e509-7037-4630-9bcf-f05e68954a25" class="preview-modal"><div class="modal-header"><div id="x-15b1e509-7037-4630-9bcf-f05e68954a25" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#claim-mapper">#claim-mapper</a></div><div class="preview-modal-title">What is a ClaimMapper Plugin?</div><div class="preview-modal-description">The Claim Mapper component is a pluggable component that extracts Claims from JSON Web Tokens (JWTs).</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div> has been moved to another location.
:::

Temporal offers two plugin interfaces for implementing API call authorization:

- [`ClaimMapper`](#claim-mapper) <span id="i-3577f662-aaa2-4d3b-a90b-ef93d6d9f407" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3577f662-aaa2-4d3b-a90b-ef93d6d9f407" class="preview-modal"><div class="modal-header"><div id="x-3577f662-aaa2-4d3b-a90b-ef93d6d9f407" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#claim-mapper">#claim-mapper</a></div><div class="preview-modal-title">What is a ClaimMapper Plugin?</div><div class="preview-modal-description">The Claim Mapper component is a pluggable component that extracts Claims from JSON Web Tokens (JWTs).</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div>
- [`Authorizer`](#authorizer-plugin) <span id="i-28263af7-19aa-4ea0-9de7-716859f399b5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-28263af7-19aa-4ea0-9de7-716859f399b5" class="preview-modal"><div class="modal-header"><div id="x-28263af7-19aa-4ea0-9de7-716859f399b5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#authorizer-plugin">#authorizer-plugin</a></div><div class="preview-modal-title">What is an Authorizer Plugin?</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div>
...
Each Temporal SDK provides a [Data Converter](/dataconversion#) <span id="i-3601c8fb-6a96-43f3-9540-6bd94f86e304" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3601c8fb-6a96-43f3-9540-6bd94f86e304" class="preview-modal"><div class="modal-header"><div id="x-3601c8fb-6a96-43f3-9540-6bd94f86e304" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dataconversion#">/dataconversion#</a></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> that can be customized with a custom [Payload Codec](/dataconversion#payload-codec) <span id="i-fa8e5d2f-8beb-42b5-930c-d769d9406408" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-fa8e5d2f-8beb-42b5-930c-d769d9406408" class="preview-modal"><div class="modal-header"><div id="x-fa8e5d2f-8beb-42b5-930c-d769d9406408" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dataconversion#payload-codec">/dataconversion#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> to encode and secure your data.
...
You can use a [Codec Server](/dataconversion#codec-server) <span id="i-a3a36077-9c52-4bc7-b568-21a3034cb69e" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-a3a36077-9c52-4bc7-b568-21a3034cb69e" class="preview-modal"><div class="modal-header"><div id="x-a3a36077-9c52-4bc7-b568-21a3034cb69e" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dataconversion#codec-server">/dataconversion#codec-server</a></div><div class="preview-modal-title">What is a Codec Server?</div><div class="preview-modal-description">A Codec Server is an HTTP server that uses your custom Payload Codec to encode and decode your data remotely through endpoints.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div> with your custom Payload Codec to decode the data you see on your Web UI and CLI locally through remote endpoints.
However, ensure that you consider all security implications of [remote data encoding](/dataconversion#remote-data-encoding) <span id="i-c814dbe7-79e7-4563-b3cc-b5e768d99e94" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c814dbe7-79e7-4563-b3cc-b5e768d99e94" class="preview-modal"><div class="modal-header"><div id="x-c814dbe7-79e7-4563-b3cc-b5e768d99e94" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dataconversion#remote-data-encoding">/dataconversion#remote-data-encoding</a></div><div class="preview-modal-title">What is remote data encoding?</div><div class="preview-modal-description">Remote data encding is using your custom Data Converter to decode (and encode) your Payloads remotely through endpoints.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> before using a Codec Server.
