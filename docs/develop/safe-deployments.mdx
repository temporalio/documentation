...
## Use Replay Testing before and during your deployments {/* #use-replay-testing-before-and-during-your-deployments */}
...
## Implement a deployment-time replay test {/* #implement-a-deployment-time-replay-test */}
...
### Run a replay and real Worker with the same code {/* #run-a-replay-and-real-worker-with-the-same-code */}
...
### Use the multi-modal Worker {/* #use-the-multi-modal-worker */}
