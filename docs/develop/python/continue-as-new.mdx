---
id: continue-as-new
title: Continue-As-New - Python SDK feature guide
sidebar_label: Continue-As-New
description: Close a Workflow Execution and create a new one with the same Workflow ID, new Run ID, and fresh Event History.
