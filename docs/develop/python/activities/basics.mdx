...
description: Define an Activity with the Temporal Python SDK, pass a single parameter object within Payload size limits, and customize the Activity Type name.
