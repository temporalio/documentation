...
![Python SDK Banner](/img/banner_python-temporal.png)

:::info PYTHON SPECIFIC RESOURCES
Build [Temporal Applications](/temporal#temporal-application) with the Python SDK.
...
- [Temporal In Action: Use Cases](https://temporal.io/in-use?sdk=Python#temporal-in-action)
