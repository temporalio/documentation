...
import CustomDocCard from '../../components/LandingElements/CustomDocCard';

<CustomDocCard title = "">
<p style={{ fontSize: '1.25em' }}><center>**[Temporal Features](/evaluate/development-production-features/)** • **[Why Temporal?](/evaluate/why-temporal)** • **[Get Started with Temporal](https://learn.temporal.io/getting_started/python/)**</center></p>
<p style={{ fontSize: '1.0em' }}><center>[Temporal Python Community Slack](https://app.slack.com/client/TNWA8QCGZ) • [Python SDK Forum](https://community.temporal.io/tag/python-sdk) • [Temporal Python Meetups](https://www.meetup.com/pro/temporal-technologies/)<br />
[Temporal Replay Conference Videos](https://www.youtube.com/@Temporalio)</center></p>
<p style={{ fontSize: '1.25em' }}><center>[Python API documentation](https://python.temporal.io) •  [Python SDK Samples](https://github.com/temporalio/samples-python)</center></p>
</CustomDocCard>

## [Core Application](/develop/python/core-application)

Build reliable and scalable applications without sacrificing productivity.
Use the essential components of a Temporal Application (Workflows, Activities, and Workers) to build and run a Temporal application with Python.
