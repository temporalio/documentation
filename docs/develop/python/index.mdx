...
## [User Metadata](/develop/python/user-metadata)

Add descriptive information to workflows and events for better visibility and context in the UI.

- [Adding Metadata](/develop/python/user-metadata#adding-metadata)
- [Retrieving Metadata](/develop/python/user-metadata#retrieving-metadata)
