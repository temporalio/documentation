...
## Store and retrieve large payloads with Amazon S3 {/* #store-and-retrieve-large-payloads-with-amazon-s3 */}
...
## Implement a custom storage driver {/* #implement-a-custom-storage-driver */}
...
### 1. Extend the StorageDriver class {/* #1-extend-the-storagedriver-class */}
...
### 2. Store payloads {/* #2-store-payloads */}
...
### 3. Retrieve payloads {/* #3-retrieve-payloads */}
...
### 4. Configure the Data Converter {/* #4-configure-the-data-converter */}
...
## Use multiple storage drivers {/* #use-multiple-storage-drivers */}
...
## Multi-region durability {/* #multi-region-durability */}
