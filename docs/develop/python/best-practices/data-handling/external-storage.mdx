...
=======
   For a complete working example that includes a Worker, Codec Server, and S3 driver, see the [External Storage sample](https://github.com/temporalio/samples-python/tree/main/external_storage).
>>>>>>> Stashed changes
