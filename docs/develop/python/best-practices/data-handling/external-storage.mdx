...
- An Amazon S3 bucket that you have read and write access to. Refer to
  ...
  - The S3 driver has been validated with single-region buckets. Multi-region configurations such as AWS Multi-Region
    Access Points (MRAP) have not been validated.
