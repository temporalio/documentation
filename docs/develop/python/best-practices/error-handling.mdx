...
### Use idempotency keys {/* #use-idempotency-keys */}
...
### Design Activities to be atomic {/* #design-activities-to-be-atomic */}
...
### Fail a Workflow Execution {/* #fail-a-workflow-execution */}
...
### Trigger a Workflow Task retry {/* #trigger-a-workflow-task-retry */}
...
### Match your Retry Policy to failure types {/* #match-your-retry-policy-to-failure-types */}
...
### Use different policies for different Activities {/* #use-different-policies-for-different-activities */}
...
### Don't use Workflow Retry Policies {/* #dont-use-workflow-retry-policies */}
...
### Workflow Task vs Workflow Execution failures {/* #workflow-task-vs-workflow-execution-failures */}
