...
## The Python Asynchronous Event Loop and Blocking Calls {/* #the-python-asynchronous-event-loop-and-blocking-calls */}
...
## Python SDK Worker Execution Architecture {/* #python-sdk-worker-execution-architecture */}
...
### A Worker infrastructure option: Separate Activity and Workflow Workers {/* #a-worker-infrastructure-option-separate-activity-and-workflow-workers */}
...
## How to implement Synchronous Activities {/* #how-to-implement-synchronous-activities */}
...
### How to run Synchronous Activities on a Worker {/* #how-to-run-synchronous-activities-on-a-worker */}
...
## How to Implement Asynchronous Activities {/* #how-to-implement-asynchronous-activities */}
...
### How to run synchronous code from an asynchronous activity {/* #how-to-run-synchronous-code-from-an-asynchronous-activity */}
...
## When Should You Use Async Activities {/* #when-should-you-use-async-activities */}
