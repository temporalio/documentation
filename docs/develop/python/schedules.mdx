...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#schedule-a-workflow" className="topic-card">
      <div className="topic-title">Schedule a Workflow</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#temporal-cron-jobs" className="topic-card">
      <div className="topic-title">Use Temporal Cron Jobs</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#start-delay" className="topic-card">
      <div className="topic-title">Use Start Delay</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
