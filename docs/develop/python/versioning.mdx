...
To use [Worker Versioning](/workers#worker-versioning) for Python workers, you need to determine and assign a Build ID to your Worker code, and opt in to Worker Versioning.
