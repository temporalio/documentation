...
A [Temporal Client](/encyclopedia/architecture/temporal-sdks#temporal-client) enables you to communicate with the Temporal Service.
...
<ViewSourceCodeNotice href="https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/run_workflow_dacx.py" />
...
<ViewSourceCodeNotice href="https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/get_workflow_results_dacx.py" />
