...
#### Wait for a Signal or Update to arrive {/* #wait-for-a-signal-or-update-to-arrive */}
...
### Use `@workflow.init` to operate on Workflow input before any handler executes {/* #use-workflowinit-to-operate-on-workflow-input-before-any-handler-executes */}
