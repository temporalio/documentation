...
description: Add contextual information to workflows and events in the Temporal UI using the Python SDK.
...
### Adding Summary to Activities and Timers {/* #adding-summary-to-activities-and-timers */}
...
## Viewing Summary and Details in the UI {/* #viewing-summary-and-details-in-the-ui */}
...
### Workflow Overview Section {/* #workflow-overview-section */}
