...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#custom-payload-codec" className="topic-card">
      <div className="topic-title">Custom Payload Codec</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#payload-conversion" className="topic-card">
      <div className="topic-title">Payload conversion</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#custom-payload-converter" className="topic-card">
      <div className="topic-title">Custom Payload Converter</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#pydantic-support" className="topic-card">
      <div className="topic-title">Pydantic Support</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#custom-type-data-conversion" className="topic-card">
      <div className="topic-title">Custom Type Data Conversion</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
