...
- Install the [Temporal CLI](https://github.com/temporalio/cli/releases/tag/v1.6.1-server-1.31.0-151.2) (Standalone Activity Prerelease)


- Install the [Temporal Go SDK](https://docs.temporal.io/develop/go/core-application#install-a-temporal-sdk) (v1.40.0 or higher recommended)
