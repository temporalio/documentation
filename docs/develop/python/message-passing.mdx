...
For example, suppose your Workflow class has a `ready_for_update_to_execute` method that indicates whether your Update handler should be allowed to start executing.
