...
| OpenBox           | Governance, Observability | [docs.openbox.ai](https://docs.openbox.ai/) | [Guide](https://docs.openbox.ai/getting-started/temporal)                                |
| Parseable         | Observability   | [parseable.com](https://www.parseable.com/docs)                    | [Guide](https://github.com/parseablehq/temporal-plugin-python/blob/main/INTEGRATION.MD)                |
