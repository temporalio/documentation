...
gives your Strands agents [Durable Execution](/encyclopedia/architecture/temporal-architecture#history-service) via the Temporal platform. The plugin routes
