...
## Configure Workers to use Braintrust {/* #configure-workers-to-use-braintrust */}
...
## Trace LLM calls with wrap_openai {/* #trace-llm-calls-with-wrap_openai */}
...
## Add custom spans for application context {/* #add-custom-spans-for-application-context */}
...
## Manage prompts with load_prompt {/* #manage-prompts-with-load_prompt */}
...
## Example: Deep Research Agent {/* #example-deep-research-agent */}
