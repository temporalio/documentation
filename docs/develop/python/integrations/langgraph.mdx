...
### Define a graph and Workflow {/* #define-a-graph-and-workflow */}
...
### Set Activity options {/* #set-activity-options */}
...
### Define tasks and a Workflow {/* #define-tasks-and-a-workflow */}
...
### Configure the Worker with the Functional API {/* #configure-the-worker-with-the-functional-api */}
...
## Stores are not supported {/* #stores-are-not-supported */}
...
## Activity vs. Workflow execution {/* #activity-vs-workflow-execution */}
...
### When to use an Activity {/* #when-to-use-an-activity */}
...
### When to run in the Workflow {/* #when-to-run-in-the-workflow */}
...
### Where LangGraph primitives run {/* #where-langgraph-primitives-run */}
...
### Example: subgraph orchestration {/* #example-subgraph-orchestration */}
