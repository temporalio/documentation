...
### Register on the Client {/* #register-on-the-client */}
...
### Register on the Worker only {/* #register-on-the-worker-only */}
...
## How to implement Interceptors in Python {/* #how-to-implement-interceptors-in-python */}
...
### Implementing Client call Interceptors {/* #implementing-client-call-interceptors */}
...
### Implementing Worker call Interceptors {/* #implementing-worker-call-interceptors */}
