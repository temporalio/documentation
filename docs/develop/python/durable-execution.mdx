...
slug: /develop/python/durable-execution
...
This chapter builds on the [Construct a new Temporal Application project](/develop/python/project-setup) chapter and relies on the Background Check use case and sample applications as a means to contextualize the information.
...
[Start a new Workflow](/develop/python/project-setup#start-workflow) and after it is complete [download the Event History as a JSON object](#retrieve-event-history).
