...
title: Worker processes - TypeScript SDK
...
### Using `node:slim` images {/* #using-nodeslim-images */}
...
### Using `distroless/nodejs` images {/* #using-distrolessnodejs-images */}
...
### Properly configure Node.js memory in Docker {/* #properly-configure-nodejs-memory-in-docker */}
...
### Do not use Alpine {/* #do-not-use-alpine */}
