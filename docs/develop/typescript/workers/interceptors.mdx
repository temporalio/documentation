...
### Register via a Plugin {/* #register-via-a-plugin */}
...
### Activity and client interceptors registration {/* #activity-and-client-interceptors-registration */}
...
### Workflow interceptors registration {/* #workflow-interceptors-registration */}
...
### Nexus interceptor registration {/* #nexus-interceptor-registration */}
