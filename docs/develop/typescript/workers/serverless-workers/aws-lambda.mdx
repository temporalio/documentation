...
2. The [ADOT Collector layer](https://aws-otel.github.io/docs/getting-started/lambda) (`aws-otel-collector-amd64`) to receive Core SDK metrics and forward them to CloudWatch/X-Ray.
