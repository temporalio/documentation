...
description: Export an Activity as an async TypeScript function, type its parameters and return value, and share dependencies through dependency injection.
