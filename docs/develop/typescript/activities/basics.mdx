...
### Share dependencies in Activity functions (dependency injection) {/* #share-dependencies-in-activity-functions-dependency-injection */}
...
### Import multiple Activities simultaneously {/* #import-multiple-activities-simultaneously */}
...
### Dynamically reference Activities {/* #dynamically-reference-activities */}
