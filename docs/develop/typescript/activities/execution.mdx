---
id: execution
title: Activity execution - TypeScript SDK
description: Spawn an Activity Execution from a Workflow with the Temporal TypeScript SDK, set the required Activity Timeouts, and get the Activity's result.
