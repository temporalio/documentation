...
description: Set Activity Timeouts and a Retry Policy with the Temporal TypeScript SDK, override the next retry delay, and Heartbeat long-running Activities.
