...
:::info
The code that follows is part of a working message passing sample **TODO: URL**.
:::
...
```typescript
TODO: workflow w/ signal handler
...
```python
TODO: workflow w/ update handler
...
For example, suppose your Workflow class has a `readyForUpdateToExecute` method that indicates whether your Update handler should be allowed to start executing.
