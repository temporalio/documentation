...
- [Temporal TypeScript Community Slack](https://app.slack.com/client/TNWA8QCGZ)
- [TypeScript SDK Forum](https://community.temporal.io/tag/typescript-sdk)
- [Temporal In Action: Use Cases](https://temporal.io/in-use?sdk=TypeScript#temporal-in-action)
