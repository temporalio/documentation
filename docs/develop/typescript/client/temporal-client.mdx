...
description:
  Connect to a development Temporal Service or Temporal Cloud from TypeScript, connect a Worker with NativeConnection,
  and get Workflow Execution results.
tags:
  - Temporal Client
  - TypeScript SDK
  - Temporal SDKs
...
Workflow Executions run in a separate V8 isolate context to provide a
