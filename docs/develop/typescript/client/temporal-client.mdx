...
- Your [Temporal Cloud Namespace Id](/cloud/namespaces#temporal-cloud-namespace-id) and Account Id combination, which
  follows the format `<namespace_id>.<account_id>`.
