...
[Temporal Application](/encyclopedia/architecture/temporal-architecture#client-application) development.

An SDK provides you with the following:

- A [Temporal Client](/encyclopedia/architecture/temporal-sdks#temporal-client) to communicate with a
