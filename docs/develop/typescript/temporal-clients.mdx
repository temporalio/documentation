...
To use an [API key](/cloud/api-keys) with the Temporal TypeScript SDK, you will need to provide additional connection information:
...
Once you have the necessary info, to create an initial connection, follow these steps (note: this requires TS SDK 1.11.8+):
