...
### Logging from Activities {/* #logging-from-activities */}
...
#### Customizing Activity logging with `ActivityOutboundCallsInterceptor` {/* #customizing-activity-logging-with-activityoutboundcallsinterceptor */}

FIXME(JWH): Quick introduction to `ActivityOutboundCallsInterceptor.getLogAttributes()`.
*/}

### Logging from Workflows {/* #logging-from-workflows */}
...
#### Customizing Workflow logging using `WorkflowOutboundCallsInterceptor` {/* #customizing-workflow-logging-using-workflowoutboundcallsinterceptor */}

FIXME(JWH): Quick introduction to `WorkflowOutboundCallsInterceptor.getLogAttributes()`.
*/}

#### Limitations of Workflow logs {/* #limitations-of-workflow-logs */}
...
### What is the Runtime's Logger {/* #what-is-the-runtimes-logger */}
...
#### How to customize the Runtime's Logger {/* #how-to-customize-the-runtimes-logger */}
...
### Implementing custom Logging-like features based on Workflow Sinks {/* #implementing-custom-logging-like-features-based-on-workflow-sinks */}
...
#### Comparing Sinks and Activities {/* #comparing-sinks-and-activities */}
...
#### Declare the sink interface {/* #declare-the-sink-interface */}
...
#### Implement sinks {/* #implement-sinks */}
...
#### Proxy and call a sink function from a Workflow {/* #proxy-and-call-a-sink-function-from-a-workflow */}
...
#### Logging in Workers and Clients {/* #logging-in-workers-and-clients */}
...
#### Accumulate logs for testing and reporting {/* #accumulate-logs-for-testing-and-reporting */}
