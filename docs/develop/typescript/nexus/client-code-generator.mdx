...
title: Nexus Client Code Generator - TypeScript SDK
sidebar_label: Client Code Generator
description: How to install nexgen and generate typed Nexus models and Service definitions for TypeScript.
toc_max_heading_level: 4
slug: /develop/typescript/nexus/client-code-generator
tags:
  - Nexus
  - TypeScript SDK
---
