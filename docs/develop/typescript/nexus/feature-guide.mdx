...
[nexus-messaging/src/callerpattern/service/handler.ts](https://github.com/temporalio/samples-typescript/blob/nexus-messaging/src/callerpattern/service/handler.ts)
...
There are two examples of messaging through Nexus in the sample code, [caller pattern](https://github.com/temporalio/samples-typescript/tree/main/nexus-messaging/callerpattern/) and [on demand pattern](https://github.com/temporalio/samples-typescript/tree/main/nexus-messaging/ondemandpattern/).
