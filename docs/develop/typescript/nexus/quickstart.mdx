...
You can also define your Nexus Service contract using an IDL and generate the TypeScript service definitions with [nexus-rpc-gen](https://github.com/nexus-rpc/nexus-rpc-gen).
...
Create a file called `caller.ts` that defines a Workflow which invokes the Nexus Operation.
