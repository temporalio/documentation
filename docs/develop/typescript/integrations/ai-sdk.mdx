...
## Configure Workers to use the AI SDK {/* #configure-workers-to-use-the-ai-sdk */}
...
## Develop a Simple Haiku Agent {/* #develop-a-simple-haiku-agent */}
...
## Provide your durable agent with tools {/* #provide-your-durable-agent-with-tools */}
...
## Integrate with Model Context Protocol (MCP) servers {/* #integrate-with-model-context-protocol-mcp-servers */}
