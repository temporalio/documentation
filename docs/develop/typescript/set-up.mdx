...
## Install the Temporal TypeScript SDK {/* #install-the-temporal-typescript-sdk */}
...
## Install Temporal CLI {/* #install-temporal-cli */}
...
### 3. Create and Run the Worker {/* #3-create-and-run-the-worker */}
