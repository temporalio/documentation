...
Because of that requirement, the Temporal TypeScript SDK offers two dedicated versioning features: Workflow Patching APIs and Worker Versioning. 
...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    ...
    <a href="#patching" className="topic-card">
      <div className="topic-title">Use TypeScript SDK Patching API</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#worker-versioning" className="topic-card">
      <div className="topic-title">Use Worker Versioning</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
