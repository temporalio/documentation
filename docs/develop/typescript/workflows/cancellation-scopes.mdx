...
title: Cancellation scopes - TypeScript SDK
description: Shows cancellation scopes with the TypeScript SDK
...
### Internal cancellation example {/* #internal-cancellation-example */}
...
### External cancellation example {/* #external-cancellation-example */}
...
### nonCancellable example {/* #noncancellable-example */}
...
### withTimeout example {/* #withtimeout-example */}
...
### scope.cancelRequested {/* #scopecancelrequested */}
...
### Cancellation scopes and callbacks {/* #cancellation-scopes-and-callbacks */}
...
### Nesting cancellation scopes {/* #nesting-cancellation-scopes */}
...
### Sharing promises between scopes {/* #sharing-promises-between-scopes */}
