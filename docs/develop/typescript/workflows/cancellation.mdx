---
id: cancellation
title: Cancel a Workflow - TypeScript SDK
...
tags:
  ...
  - TypeScript SDK
  - Temporal SDKs
description: Cancel a TypeScript Activity from a Workflow using Heartbeats and a Heartbeat Timeout, and reset a Workflow Execution from its Event History.
---
