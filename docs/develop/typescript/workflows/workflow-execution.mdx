...
title: Workflow execution - TypeScript SDK
...
within another Workflow Execution, use either the [Child Workflow](/develop/typescript/workflows/child-workflows) or External
Workflow APIs.
