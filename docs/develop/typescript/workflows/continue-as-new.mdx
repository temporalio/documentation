...
This page covers the following for TypeScript developers:
...
## Use Continue-As-New with the TypeScript SDK {/* #how */}
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-typescript/blob/main/message-passing/safe-message-handlers/src/workflows.ts" />
```typescript
...
## When is it right to Continue-As-New with the TypeScript SDK? {/* #when */}
...
## Test Continue-As-New with the TypeScript SDK {/* #how-to-test */}
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-typescript/blob/main/message-passing/safe-message-handlers/src/client.ts" />
