...
description: Learn how to set Workflow and Activity Timeouts, implement Retry Policies, and manage Activity Heartbeats using the Temporal TypeScript SDK for efficient Workflow Execution.
...
To Heartbeat an Activity Execution in TypeScript, use the [`heartbeat()`](https://typescript.temporal.io/api/namespaces/activity#heartbeat) function in your Activity implementation.
