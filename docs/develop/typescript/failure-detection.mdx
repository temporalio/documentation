...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    ...
    <a href="#activity-next-retry-delay" className="topic-card">
      <div className="topic-title">Activity next Retry delay</div>
      <div className="topic-arrow">→</div>
    </a>
    ...
    <a href="#activity-heartbeat-timeout" className="topic-card">
      <div className="topic-title">Activity Heartbeat Timeout</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
