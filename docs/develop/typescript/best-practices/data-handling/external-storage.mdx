...
The [external-storage sample](https://github.com/temporalio/samples-typescript/tree/main/external-storage) implements a
...
[external-storage/src/filesystem-storage-driver.ts](https://github.com/temporalio/samples-typescript/blob/main/external-storage/src/filesystem-storage-driver.ts)
```ts
...
[the full driver](https://github.com/temporalio/samples-typescript/blob/main/external-storage/src/filesystem-storage-driver.ts)
...
[external-storage/src/data-converter.ts](https://github.com/temporalio/samples-typescript/blob/main/external-storage/src/data-converter.ts)
```ts
