...
## Payload Converter and Payload Codec Summary {/* #payload-converter-and-payload-codec-summary */}
...
### Operational Chain {/* #operational-chain */}
...
## Use custom payload conversion {/* #use-custom-payload-conversion */}
