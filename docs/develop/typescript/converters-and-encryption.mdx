...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#payload-converter-and-payload-codec-summary" className="topic-card">
      <div className="topic-title">Payload Converter and Payload Codec Summary</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#payload-codec" className="topic-card">
      <div className="topic-title">Payload Codec</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#use-custom-payload-conversion" className="topic-card">
      <div className="topic-title">Use custom payload conversion</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#composite-data-converters" className="topic-card">
      <div className="topic-title">Composite Data Converters</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#custom-payload-conversion" className="topic-card">
      <div className="topic-title">Custom Payload Converter</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
