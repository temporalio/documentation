...
description: How to install nexgen and generate typed Nexus models, validators, and Service definitions for Go, Java, Python, and TypeScript.
toc_max_heading_level: 4
slug: /develop/nexus/client-code-generator
tags:
  - Nexus
  - Temporal SDKs
---
...
This page covers installation, schema authoring, generation, and using the output.
