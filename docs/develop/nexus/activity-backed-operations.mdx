...
title: Activity-backed Nexus Operations
sidebar_label: Activity-backed Operations
description: How to back a Nexus Operation with a Standalone Activity using TemporalOperationHandler.
toc_max_heading_level: 4
slug: /develop/nexus/activity-backed-operations
tags:
  - Nexus
  - Temporal SDKs
  - Activities
...
This page shows how to implement Activity-backed Operations with `TemporalOperationHandler` in each SDK.
...
- [Temporal Operation Handler](/develop/nexus/temporal-operation-handler) for the handler type and the Nexus-aware Client.
