...
description:
  Use Temporal Nexus Service Handler within the Java SDK to connect Durable Executions within and across Namespaces
  using a Nexus Endpoint, a Nexus Service contract, and Nexus Operations.
