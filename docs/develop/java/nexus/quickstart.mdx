...
This guide refers to "Callers" and "Handlers". The handler is the existing `SayHelloWorkflow`, which will be exposed through Nexus and handle the operation.
The caller is a new Workflow in a second Namespace that invokes the handler through Nexus.
The Nexus Service is the contract that exposes the handler to callers.
...
<CodeSnippet language="java" title="SayHelloNexusService.java">
...
<CodeSnippet language="java" title="SayHelloNexusServiceImpl.java">
{`package helloworkflow;
...
## Implement the Nexus Operation Handler
...
<CodeSnippet language="java" title="SayHelloWorker.java">
{`package helloworkflow;
...
<CodeSnippet language="java" title="NexusCallerWorkflow.java">
{`package helloworkflow;
...
<CodeSnippet language="java" title="NexusCallerWorkflowImpl.java">
{`package helloworkflow;
...
## Create a Caller Namespace and Nexus Endpoint
...
<CodeSnippet language="java" title="NexusCallerStarter.java">
{`package helloworkflow;
