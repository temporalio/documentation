...
title: Nexus Client Code Generator - Java SDK
sidebar_label: Client Code Generator
description: How to install nexgen and generate typed Nexus models and Service definitions for Java.
toc_max_heading_level: 4
slug: /develop/java/nexus/client-code-generator
tags:
  - Nexus
  - Java SDK
---
...
This page covers installation, schema authoring, and generating and using Java output.
...
This page covers the Java output from `nexgen`.
