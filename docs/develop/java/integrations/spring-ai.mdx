...
## Call a chat model from a Workflow {/* #call-a-chat-model-from-a-workflow */}
...
### Nexus service stubs {/* #nexus-service-stubs */}
...
## Activity options and retry behavior {/* #activity-options-and-retry-behavior */}
...
## Media in messages {/* #media-in-messages */}
...
## Use vector stores, embeddings, and MCP {/* #use-vector-stores-embeddings-and-mcp */}
