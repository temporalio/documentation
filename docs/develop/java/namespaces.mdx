...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#register-namespace" className="topic-card">
      <div className="topic-title">Register a Namespace</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#manage-namespaces" className="topic-card">
      <div className="topic-title">Manage Namespaces</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
