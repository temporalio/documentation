...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#workflow-timeouts" className="topic-card">
      <div className="topic-title">Set Workflow timeouts</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#workflow-retries" className="topic-card">
      <div className="topic-title">Set a Workflow Retry Policy</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#activity-timeouts" className="topic-card">
      <div className="topic-title">Set Activity timeouts</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#activity-retries" className="topic-card">
      <div className="topic-title">Set a custom Activity Retry Policy</div>
      <div className="topic-arrow">→</div>
    </a>
    ...
    <a href="#heartbeat-timeout" className="topic-card">
      <div className="topic-title">Set a Heartbeat Timeout</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
