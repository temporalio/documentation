...
tags:
  - timers
description: A Workflow sets a durable Timer for delayed execution. Even if the Worker or Temporal Cluster is down, the Timer resumes once back up. Efficient and scalable.
---
