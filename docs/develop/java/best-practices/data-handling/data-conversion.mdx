...
You can also use [specific implementation classes](https://www.javadoc.io/static/io.temporal/temporal-sdk/latest/io/temporal/common/converter/package-summary.html) provided in the Java SDK.
