...
### Setup testing dependency {/* #setup-testing-dependency */}
...
### Testing with JUnit4 {/* #testing-with-junit4 */}
...
### Testing with JUnit5 {/* #testing-with-junit5 */}
...
#### Mocking Nexus handlers with JUnit4 {/* #mocking-nexus-handlers-with-junit4 */}
...
#### Mocking Nexus handlers with JUnit5 {/* #mocking-nexus-handlers-with-junit5 */}
...
#### Mocking the Nexus Service with JUnit4 {/* #mocking-the-nexus-service-with-junit4 */}
...
#### Mocking the Nexus Service with JUnit5 {/* #mocking-the-nexus-service-with-junit5 */}
