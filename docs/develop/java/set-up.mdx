...
public class SayHelloWorker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SayHelloWorker started for task queue 'my-task-queue'");
    }
...
Create a file within a `worker` subdirectory called `SayHelloWorker.java`:
...
<p>Then run: <code>mvn exec:java -Dexec.mainClass="helloworkflow.Starter"</code></p>
</div>
