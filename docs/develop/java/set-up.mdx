...
## Install the Java JDK {/* #install-the-java-jdk */}
...
## Add Temporal Java SDK Dependencies {/* #add-temporal-java-sdk-dependencies */}
...
### 1. Create the Activity Interface {/* #1-create-the-activity-interface */}
...
### 2. Create the Activity Implementation {/* #2-create-the-activity-implementation */}
...
### 3. Create the Workflow {/* #3-create-the-workflow */}
...
### 4. Create the Workflow Implementation {/* #4-create-the-workflow-implementation */}
...
### 5. Create and Run the Worker {/* #5-create-and-run-the-worker */}
...
### 6. Execute the Workflow {/* #6-execute-the-workflow */}
