...
Activities contain your business logic. Create a file called `GreetActivities.java`:
...
Workflows orchestrate Activities and contain the application logic. Create a file called `SayHelloWorkflow.java`:
...
The Worker hosts your Workflows and Activities. Create a file called `SayHelloWorker.java`:
