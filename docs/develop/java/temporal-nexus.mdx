...
## Unit Testing Nexus Code

Please refer to [How to mock Nexus Operations](/develop/java/testing-suite#mock-nexus-operations) for information and examples of how to mock and test Nexus services.
You can also find example unit tests for Nexus in the [Temporal Java samples](https://github.com/temporalio/samples-java) repository in [this test package](https://github.com/temporalio/samples-java/tree/main/core/src/test/java/io/temporal/samples/nexus/caller).
