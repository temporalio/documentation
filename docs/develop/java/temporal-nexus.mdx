...
In a polyglot environment, Protobuf and JSON are common choices. This example uses Java classes serialized into JSON.
...
The `io.temporal.nexus.WorkflowClientOperationHandlers` package has builders to create Nexus Operations:
