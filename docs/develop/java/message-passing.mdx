...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#writing-message-handlers" className="topic-card">
      <div className="topic-title">Write message handlers</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#send-messages" className="topic-card">
      <div className="topic-title">Send messages</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#message-handler-patterns" className="topic-card">
      <div className="topic-title">Message handler patterns</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#message-handler-troubleshooting" className="topic-card">
      <div className="topic-title">Message handler troubleshooting</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#dynamic-handler" className="topic-card">
      <div className="topic-title">Dynamic components</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
