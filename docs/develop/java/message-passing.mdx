...
To obtain the update result directly, use the `executeUpdateWithStart`(https://javadoc.io/docs/io.temporal/temporal-sdk/latest/io/temporal/client/WorkflowClient.html#executeUpdateWithStart(io.temporal.workflow.Functions.Func,io.temporal.client.UpdateOptions,io.temporal.client.WithStartWorkflowOperation) WorkflowClient API.
