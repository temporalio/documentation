...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#connect-to-development-service" className="topic-card">
      <div className="topic-title">Initialize a Temporal Client for the Temporal CLI development service</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#connect-to-custom-namespace" className="topic-card">
      <div className="topic-title">Initialize a Temporal Client to connect to a custom Namespace</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#connect-to-temporal-cloud" className="topic-card">
      <div className="topic-title">Initialize a Temporal Client to connect to Temporal Cloud</div>
      <div className="topic-arrow">→</div>
    </a>
