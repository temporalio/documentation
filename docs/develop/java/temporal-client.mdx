...
To use an [API key](/cloud/api-keys) with the Temporal Java SDK, you will need to provide additional connection information:
...
### How to connect a Temporal Client to Temporal Cloud using TLS {#connect-to-temporal-cloud-tls}
