...
description: Master the Temporal Java Client with our comprehensive guide that covers everything from initialization to Workflow Execution.
keywords:
  - temporal java client
  - connect java client to temporal service
  - initialize temporal client
  - temporal SDK java guide
  - start workflow execution java
  - temporal cloud connection
  - java client for temporal cli
...
To spawn Workflow Executions from within another Workflow Execution, use either the [Child Workflow](/dev-guide/java/features#child-workflows) or External Workflow APIs.

See the [Customize Workflow Type](/dev-guide/java/foundations#workflow-type) section to see how to customize the name of the Workflow Type.
