...
This page covers the following for Java developers:
...
## Use Continue-As-New with the Java SDK {/* #how */}
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-java/blob/main/core/src/main/java/io/temporal/samples/safemessagepassing/ClusterManagerWorkflow.java" />
```java
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-java/blob/main/core/src/main/java/io/temporal/samples/safemessagepassing/ClusterManagerWorkflowImpl.java" />
```java
...
## When is it right to Continue-As-New with the Java SDK? {/* #when */}
...
## Test Continue-As-New with the Java SDK {/* #how-to-test */}
