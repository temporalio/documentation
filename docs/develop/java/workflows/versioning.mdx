...
### Patching with GetVersion {/* #patching-with-getversion */}
...
### Adding support for versioned Workflow visibility in the Event History {/* #adding-support-for-versioned-workflow-visibility-in-the-event-history */}
...
#### Enable automatic upsert (Java SDK v1.30.0+) {/* #enable-automatic-upsert-java-sdk-v1300 */}
...
#### Upsert manually {/* #upsert-manually */}
...
### Workflow cutovers {/* #workflow-cutovers */}
...
### Testing a Workflow for replay safety {/* #testing-a-workflow-for-replay-safety */}
