---
id: core-application
title: Core application - Temporal Java SDK feature guide
...
Each Activity has a Type called the Activity 'name'.
This name appears in the Workflow Execution Event History Summary, listed for each Activity Task.
...
- Method Name: `sendMessage`
- Outcome: `Messaging_SendMessage`
- Method Name: `composeGreeting`
- Outcome: `Messaging_ComposeGreeting`

The Activity Type method name is capitalized, even when using a prefix.
...
Systems like Prometheus may ignore metrics with tags using unsupported characters.
