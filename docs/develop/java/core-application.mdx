...
keywords:
  ...
  - activity
  - worker
description: The Foundations section of the Temporal Developer's guide introduces essential concepts for building and running a Temporal Application using the Java SDK.
tags:
  - Activities
  - Temporal Client
  - Task Queues
...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#develop-workflows" className="topic-card">
      <div className="topic-title">Develop a Workflow Definition</div>
    ...
    <a href="#run-a-dev-worker" className="topic-card">
      <div className="topic-title">Run a Development Worker</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
