...
<div className="topics-covered-section">
  <h2 className="topics-covered-title">Setup steps</h2>
  <div className="topics-grid">
    <a href="#install-the-java-jdk" className="topic-card">
      <div className="topic-title">Install the Java JDK</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#add-temporal-java-sdk-dependencies" className="topic-card">
      <div className="topic-title">Add Temporal Java SDK Dependencies</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#install-temporal-cli" className="topic-card">
      <div className="topic-title">Install Temporal CLI</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#start-the-development-server" className="topic-card">
      <div className="topic-title">Start the development server</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
