...
- [Workflow libraries](#workflow-librarires)
...
Therefore, as you make changes, you need to use [patching](https://docs.temporal.io/patching) and [replay testing](https://docs.temporal.io/develop/python/testing-suite#replay) to make sure that you’re not causing non-determinism errors for your users.
...
The primary use case for integrations so far is setting a `DataConverter`, like in the [Data Converter example](#data-converter).
