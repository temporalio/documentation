...
## What you can provide to users in a plugin {/* #what-you-can-provide-to-users-in-a-plugin */}
...
### Built-in Activity {/* #built-in-activity */}
...
#### Timeouts and retry policies {/* #timeouts-and-retry-policies */}
...
#### Making changes to your library {/* #making-changes-to-your-library */}
...
#### Example of a Workflow library that uses a Plugin in Python {/* #example-of-a-workflow-library-that-uses-a-plugin-in-python */}
...
### Special considerations for different languages {/* #special-considerations-for-different-languages */}
...
### Versioning tests {/* #versioning-tests */}
...
### Side effects tests {/* #side-effects-tests */}
