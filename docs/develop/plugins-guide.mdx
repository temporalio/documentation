...
A **Plugin** is an abstraction that will let your users add your feature to their Temporal primitives, like Workflows and Activities, in one line. It makes it seamless for platform engineers to add their own custom functionality to many primitives. Using plugins, you can build reusable open source libraries or build add-ons for engineers at your company.
