...
|                           | [PayloadConverter](/develop/ruby/best-practices/data-handling/data-conversion) | [PayloadCodec](/develop/ruby/best-practices/data-handling/data-encryption) |
| ------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------- |
