...
description: Use a custom Payload Codec and Converter in the Ruby SDK to modify Temporal Data Conversion behavior, including examples for encryption and formatting.
keywords:
  - sdk
  - ruby
  - data encryption
...
### Using a Codec Server {/* #using-a-codec-server */}
