...
**How to develop a basic Workflow using the Temporal Ruby SDK**
...
**How to customize your Workflow Type name using the Temporal Ruby SDK**
...
This is basically a safe wrapper around `Fiber.schedule` for starting and `Workflow.wait_condition` for waiting.

Nothing uses futures by default, but they work with all workflow code/constructs.
...
**How to start an Activity Execution using the Temporal Ruby SDK**
...
**How to get the results of an Activity Execution using the Temporal Ruby SDK**

The Activity result is the returned from the `execute_activity` call.

## Run Worker Process

**How to create and run a Worker Process using the Temporal Ruby SDK**
...
**How to set a Dynamic Workflow using the Temporal Ruby SDK**
...
**How to set a Dynamic Activity using the Temporal Ruby SDK**
