...
- [Ruby API Documentation](https://ruby.temporal.io/api/)
...
- [Temporal Ruby Community Slack](https://temporalio.slack.com/archives/C012SHMPDDZ)
...
## [Interrupt a Workflow](/develop/ruby/cancellation)

Interrupt a Workflow Execution with a Cancel or Terminate action.

- [Cancel a Workflow](/develop/ruby/cancellation#cancellation): Interrupt a Workflow Execution and its Activities through Workflow cancellation.
- [Terminate a Workflow](/develop/ruby/cancellation#termination): Interrupt a Workflow Execution and its Activities through Workflow termination.
...
- [Debug in a development production](/develop/ruby/debugging#debug-in-a-development-production): Debug production Workflows using the Web UI, the Temporal CLI, Replays, Tracing, or Logging.
