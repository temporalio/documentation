---
id: cancellation
title: Cancellation - Ruby SDK
sidebar_label: Cancellation
description: Handle Cancellation in Ruby Workflows and Activities, request Cancellation from a Client, and choose between Cancellation, termination, and reset.
...
the workflow as well (for example, Timers, Activities, etc) and therefore cancellation is propagated to them to be handled and
bubble out.
