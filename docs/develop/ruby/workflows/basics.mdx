...
Temporal Workflow Definitions [must be deterministic](/workflow-definition#deterministic-constraints), which includes
...
- Do any threading
- Do anything using the system clock (for example, `Time.Now`)
