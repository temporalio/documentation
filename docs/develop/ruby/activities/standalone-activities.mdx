...
Activity directly from a [`Temporalio::Client`](https://github.com/temporalio/sdk-ruby).
...
[`Temporalio::EnvConfig::ClientConfig.load_client_connect_options`](https://github.com/temporalio/sdk-ruby)
...
Use [`Temporalio::Client#execute_activity`](https://github.com/temporalio/sdk-ruby) to execute a
...
Use [`Temporalio::Client#start_activity`](https://github.com/temporalio/sdk-ruby) to start a
...
Use `client.activity_handle` to create a handle to a previously started Standalone Activity:
...
Use [`Temporalio::Client#list_activities`](https://github.com/temporalio/sdk-ruby) to list
...
Use [`Temporalio::Client#count_activities`](https://github.com/temporalio/sdk-ruby) to count
