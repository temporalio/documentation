...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#test-setup" className="topic-card">
      <div className="topic-title">Test setup</div>
    ...
    <a href="#mock-and-override-activities" className="topic-card">
      <div className="topic-title">Mock and override Activities</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#mock-and-override-nexus-operations" className="topic-card">
      <div className="topic-title">Mock and override Nexus operations</div>
      <div className="topic-arrow">→</div>
    </a>
    ...
    <a href="#replay" className="topic-card">
      <div className="topic-title">How to Replay a Workflow Execution</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
