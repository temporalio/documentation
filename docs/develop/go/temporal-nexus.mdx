...
<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/service/api.go">
...
The `temporalnexus.NewSyncOperation` builder function is for exposing simple RPC handlers. It’s handler function is provided with an SDK client that can be used for signaling, querying, and listing Workflows, but implementations are free to make arbitrary calls to other services or databases, or perform computations such as this one:

<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/handler/app.go">
    View the source code
  </a>{' '}
  in the context of the rest of the application code.
</div>
...
[sample-apps/go/nexus/handler/worker/main.go](https://github.com/temporalio/documentation/blob/main/sample-apps/go/nexus/handler/worker/main.go)
```go
package main
...
[sample-apps/go/nexus/caller/workflows.go](https://github.com/temporalio/documentation/blob/main/sample-apps/go/nexus/caller/workflows.go)
```go
package caller
...
[sample-apps/go/nexus/caller/worker/main.go](https://github.com/temporalio/documentation/blob/main/sample-apps/go/nexus/caller/worker/main.go)
```go
package main
...
[sample-apps/go/nexus/caller/starter/main.go](https://github.com/temporalio/documentation/blob/main/sample-apps/go/nexus/caller/starter/main.go)
```go
package main
