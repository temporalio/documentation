...
<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/handler/worker/main.go">
    View the source code
  </a>{' '}
  in the context of the rest of the application code.
</div>
...
<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/caller/workflows.go">
    View the source code
  </a>{' '}
  in the context of the rest of the application code.
</div>
...
<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/caller/worker/main.go">
    View the source code
  </a>{' '}
  in the context of the rest of the application code.
</div>
...
<div className="copycode-notice-container">
  <a href="https://github.com/temporalio/samples-go/blob/main/nexus/caller/starter/main.go">
    View the source code
  </a>{' '}
  in the context of the rest of the application code.
</div>
