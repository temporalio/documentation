...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#enable-sessions" className="topic-card">
      <div className="topic-title">Enable Worker Sessions</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#max-concurrent-sessions" className="topic-card">
      <div className="topic-title">Change the maximum concurrent Sessions of a Worker</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#create-a-session" className="topic-card">
      <div className="topic-title">Create a Worker Session</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#session-metadata" className="topic-card">
      <div className="topic-title">Additional Session usage information</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
