...
- **Update failed.**
    ...
    Update failures are like [Workflow failure](/references/failures#errors-in-workflows).
...
1. **Query failed.**
    You'll receive a [`QueryFailed`](https://pkg.go.dev/go.temporal.io/api/serviceerror#QueryFailed).
