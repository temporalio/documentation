...
[Update-with-Start](/encyclopedia/workflow-message-passing#update-with-start)
lets you send an Update that checks whether an already-running Workflow with that ID exists:
