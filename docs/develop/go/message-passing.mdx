...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#handling-messages" className="topic-card">
      <div className="topic-title">Handle Messages</div>
    ...
    <a href="#troubleshooting" className="topic-card">
      <div className="topic-title">Troubleshooting</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
