...
title: Failure detection - Temporal Go SDK feature guide
...
tags:
  - failure-detection
description: Learn how to configure Workflow timeouts, set Retry Policies, and manage Activity timeouts and Heartbeats using Temporal's Go SDK for optimized execution control.
---
