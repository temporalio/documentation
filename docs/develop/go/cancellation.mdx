...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#handle-cancellation-in-workflow" className="topic-card">
      <div className="topic-title">How to handle a Cancellation request within a Workflow</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#handle-cancellation-in-an-activity" className="topic-card">
      <div className="topic-title">How to set an Activity Heartbeat Timeout</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#handle-cancellation-in-an-activity" className="topic-card">
      <div className="topic-title">How to listen for and handle a Cancellation request within an Activity</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#request-cancellation" className="topic-card">
      <div className="topic-title">How to send a Cancellation request from a Temporal Client</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
