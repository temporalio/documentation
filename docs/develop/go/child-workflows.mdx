...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#child-workflows" className="topic-card">
      <div className="topic-title">Start a Child Workflow Execution</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#parent-close-policy" className="topic-card">
      <div className="topic-title">Set a Parent Close Policy</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#child-workflows" className="topic-card">
      <div className="topic-title">Async Child Workflows</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
