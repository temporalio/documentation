...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#api-example" className="topic-card">
      <div className="topic-title">Full API example</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#use-selectors-with-futures" className="topic-card">
      <div className="topic-title">Use Selectors with Futures</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#use-selectors-with-timers" className="topic-card">
      <div className="topic-title">Use Selectors with Timers</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#use-selectors-with-channels" className="topic-card">
      <div className="topic-title">Use Selectors with Channels</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#query-selector-state" className="topic-card">
      <div className="topic-title">Query Selector state</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
