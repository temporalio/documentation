...
### Assign a Build ID to your Worker and opt in to Worker Versioning {/* #assign-a-build-id-to-your-worker-and-opt-in-to-worker-versioning */}
...
### Specify versions for Activities, Child Workflows, and Continue-as-New Workflows {/* #specify-versions-for-activities-child-workflows-and-continue-as-new-workflows */}
...
#### Specifying versions for Continue-As-New {/* #specifying-versions-for-continue-as-new */}
...
### Tell the Task Queue about your Worker's Build ID (Deprecated) {/* #tell-the-task-queue-about-your-workers-build-id-deprecated */}
