...
title: Nexus Client Code Generator - Go SDK
sidebar_label: Client Code Generator
description: How to install nexgen and generate typed Nexus models and Service definitions for Go.
toc_max_heading_level: 4
slug: /develop/go/nexus/client-code-generator
tags:
  - Nexus
  - Go SDK
---
...
This page covers installation, schema authoring, and generating and using Go output.
...
This page covers the Go output from `nexgen`.
