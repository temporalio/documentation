...
- An Amazon S3 bucket that you have read and write access to. Refer to [lifecycle management](/external-storage#lifecycle)
  ...
  [Durable External Storage with Amazon S3](/external-storage#durable-s3).
...
[Durable External Storage with Amazon S3](/external-storage#durable-s3) for the full pattern, trade-offs, and how it
relates to Temporal Cloud High Availability.
