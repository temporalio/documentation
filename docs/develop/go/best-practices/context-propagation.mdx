...
If you want to propagate tracing context, check if there is a [built-in tracing interceptor](/develop/go/workers/observability#tracing) for your library before building a custom context propagator.
