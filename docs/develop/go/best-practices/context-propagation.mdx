...
## Implement a context propagator {/* #implement-a-context-propagator */}
...
## Register the propagator and set context values {/* #register-the-propagator-and-set-context-values */}
...
## Access propagated values {/* #access-propagated-values */}
...
## Context propagation over Nexus {/* #context-propagation-over-nexus */}
