...
Mocking the execution to return a desired value or error isolates Workflow logic for testing. However, sometimes we want to replace the Activity with an alternate implementation
