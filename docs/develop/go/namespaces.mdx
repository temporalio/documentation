---
id: namespaces
title: Namespaces - Temporal Go SDK feature guide
...
tags:
  - namespaces
description: Learn how to register and manage Namespaces in Temporal using CLI or SDK APIs. Isolate Workflow Executions, match development lifecycles, and secure Namespace workflows.
---
...
**How to register Namespaces using the Go SDK**
