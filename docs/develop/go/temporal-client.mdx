...
* You can see the _namespace account id_ combination your URL or anywhere that you manage namespaces.
It follows the format `<namespace_id>.<account_id>`.
* The _endpoint_ will vary. The most common endpoint used is the regional endpoint, which you can find on the namespace management page.
