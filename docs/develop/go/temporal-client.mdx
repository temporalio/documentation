...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#connect-to-development-service" className="topic-card">
      <div className="topic-title">Connect to a local development Temporal Service</div>
    ...
    <a href="/develop/go/temporal-clients#start-workflow-execution" className="topic-card">
      <div className="topic-title">How to start a Workflow Execution</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
