...
When upserting search attributes in existing workflows, use versioning to prevent failures caused by [nondeterminism errors](/workflows#non-deterministic-change) 
```go
