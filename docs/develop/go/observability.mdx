...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#metrics" className="topic-card">
      <div className="topic-title">Metrics</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#tracing-and-context-propogation" className="topic-card">
      <div className="topic-title">Tracing</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#logging" className="topic-card">
      <div className="topic-title">Logging</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#visibility" className="topic-card">
      <div className="topic-title">Visibility</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
