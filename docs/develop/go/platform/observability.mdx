...
New metrics setups should use the
[OpenTelemetry v2 integration](/develop/go/integrations/opentelemetry-v2#export-temporal-sdk-metrics) instead. It
...
New tracing setups should use the
[OpenTelemetry v2 integration](/develop/go/integrations/opentelemetry-v2) instead. It uses the Go SDK Plugin API to
