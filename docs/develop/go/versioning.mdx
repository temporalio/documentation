...
Because of that requirement, the Temporal Go SDK offers two dedicated versioning features: Workflow Patching APIs and Worker Versioning.

<div className="topics-covered-section">
  <h2 className="topics-covered-title">Topics covered in this section</h2>
  <div className="topics-grid">
    <a href="#patching" className="topic-card">
      <div className="topic-title">Workflow Patching APIs</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#worker-versioning" className="topic-card">
      <div className="topic-title">Worker Versioning</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#sanity-checking" className="topic-card">
      <div className="topic-title">Sanity checking</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
