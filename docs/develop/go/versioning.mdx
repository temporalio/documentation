---
id: versioning
title: Versioning - Temporal Go SDK feature guide
...
To use Worker Versioning for Go workers, you need to determine and assign a Build ID to your Worker code, and opt in to Worker Versioning.
