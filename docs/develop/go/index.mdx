...
<div style={{
  ...
  <div style={{
    ...
    <a href="https://pkg.go.dev/go.temporal.io/sdk" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Go API Documentation</span>
    </a>
    
    <a href="https://github.com/temporalio/samples-go" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e0e7ff'}
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Go SDK Code Samples</span>
    </a>
    
    <a href="https://github.com/temporalio/sdk-go" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e0e7ff'}
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Go SDK GitHub</span>
    </a>
    
    <a href="https://temporalio.slack.com/archives/CTDTU3J4T" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e0e7ff'}
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Temporal Go Community Slack</span>
    </a>
    
    <a href="https://community.temporal.io/tag/go-sdk" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e0e7ff'}
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Go SDK Forum</span>
    </a>

    <a href="https://temporal.io/in-use?sdk=Go#temporal-in-action" target="_blank" style={{
      display: 'flex',
      alignItems: 'center',
      padding: '1rem', 
      borderRadius: '0.5rem', 
    ...
    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e0e7ff'}
    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f0f5ff'}>
      <span style={{ textAlign: 'left' }}>Temporal In Action: Use Cases with Go</span>
    </a>
  </div>
</div>
