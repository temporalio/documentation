...
description: Spawn an Activity Execution from a Go Workflow, get its result, and set every ActivityOptions field, from Timeouts and Task Queue to Retry Policy.
