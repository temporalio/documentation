...
slug: /develop/php/temporal-client
...
tags:
  ...
  - Temporal SDKs
  - Certificates
description: Connect a Temporal Client to a Temporal Service and start Workflow Executions. This guide covers communication, including sending signals and queries.
---
