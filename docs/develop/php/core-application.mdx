...
keywords:
  ...
  - activity
  - worker
description: The Foundations section of the Temporal Developer's guide introduces essential concepts for building and running a Temporal Application using the PHP SDK.
tags:
  - Activities
  - Temporal Client
  - Task Queues
