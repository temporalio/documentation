...
<SetupStep code={
  <>
    <p><strong>Create an Activity file (GreetActivity.php):</strong></p>
...
Activities contain your business logic. Create a file called `GreetActivity.php` in an `Activities` submodule:
...
Workflows orchestrate Activities and contain the application logic. Create a file called `SayHelloWorkflow.php` in your `Workflows` submodule:
...
The Worker hosts your Workflows and Activities. Create a file called `worker.php`:
