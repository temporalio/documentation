...
## Add Temporal PHP SDK and Configure Autoloading {/* #add-temporal-php-sdk-and-configure-autoloading */}
...
## Install RoadRunner application server {/* #install-roadrunner-application-server */}
...
## Install Temporal CLI and start the development server {/* #install-temporal-cli-and-start-the-development-server */}
...
### DLoad package manager {/* #dload-package-manager */}
...
## Run Hello World: Test Your Installation {/* #run-hello-world-test-your-installation */}
...
### 1. Create the Activity {/* #1-create-the-activity */}
...
### 2. Create the Workflow {/* #2-create-the-workflow */}
...
### 3. Create a Worker file {/* #3-create-a-worker-file */}
