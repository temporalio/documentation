...
A [Signal](/encyclopedia/sending-messages#sending-signals) is a message sent to a running Workflow Execution.
...
Workflows can answer synchronous [Queries](/encyclopedia/workflow-message-passing#sending-queries) and receive [Signals](/encyclopedia/sending-messages#sending-signals).
