...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#signals" className="topic-card">
      <div className="topic-title">Develop with Signals</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#queries" className="topic-card">
      <div className="topic-title">Develop with Queries</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#updates" className="topic-card">
      <div className="topic-title">Develop with Updates</div>
      <div className="topic-arrow">→</div>
    </a>
