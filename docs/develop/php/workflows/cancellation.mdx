---
id: cancellation
title: Cancel a Workflow - PHP SDK
...
tags:
  ...
  - PHP SDK
  - Temporal SDKs
description: Cancel a PHP Activity from a Workflow using Heartbeats and a Heartbeat Timeout, and reset a Workflow Execution from its Event History.
---
