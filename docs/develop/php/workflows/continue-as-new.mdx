...
description: Use Temporal's Continue-As-New in PHP to manage large Event Histories by atomically creating new Workflow Executions with the same Workflow Id and fresh parameters.
...
## Use Continue-As-New with the PHP SDK {/* #how */}
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-php/blob/master/app/src/SafeMessageHandlers/MessageHandlerWorkflowInterface.php" />
```php
...
<ViewSourceCodeNotice href="https://github.com/temporalio/samples-php/blob/master/app/src/SafeMessageHandlers/MessageHandlerWorkflow.php" />
```php
...
## When is it right to Continue-As-New with the PHP SDK? {/* #when */}
...
## Test Continue-As-New with the PHP SDK {/* #how-to-test */}
