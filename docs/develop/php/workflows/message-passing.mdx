...
tags:
  ...
  - PHP SDK
  - Temporal SDKs
description: Develop with Signals, Queries, and Updates in Temporal Workflows. Define, handle, and send Signals or Queries, and validate updates from a Temporal Client.
---
...
### Add wait conditions to block {/* #add-wait-conditions-to-block */}
...
### Use wait conditions in handlers {/* #use-wait-conditions-in-handlers */}
...
### Use `#[WorkflowInit]` to operate on Workflow input before any handler executes {/* #use-workflowinit-to-operate-on-workflow-input-before-any-handler-executes */}
