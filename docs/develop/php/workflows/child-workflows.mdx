...
tags:
  ...
  - PHP SDK
  - Temporal SDKs
description: Start a Child Workflow Execution in PHP, configure ChildWorkflowOptions, set a Parent Close Policy, and call children asynchronously with promises.
---
