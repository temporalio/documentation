...
description: Implement an Activity behind a PHP interface, define its parameters and return values, and set a custom name for the Activity Type.
...
The following examples set a custom name for your Activity Type.
