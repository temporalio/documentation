...
Build [Temporal Applications](/temporal#temporal-application) with the PHP SDK.
...
- [Temporal PHP Community Slack](https://app.slack.com/client/TNWA8QCGZ)
- [PHP SDK Forum](https://community.temporal.io/tag/php-sdk)
- [Temporal In Action: Use Cases](https://temporal.io/in-use?sdk=PHP#temporal-in-action)
