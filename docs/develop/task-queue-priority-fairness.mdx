...
Fairness will be a __paid__ feature in Temporal Cloud and billing will be enabled in the near future and there will be pricing implications. You can find more details about the pricing structure for Fairness [here](/cloud/actions#fairness).
