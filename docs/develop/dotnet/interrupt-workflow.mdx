...
description: Learn how to interrupt Workflow Execution using the Temporal SDK. Cancel for graceful stops; terminate for forceful stops.
...
**How to Terminate a Workflow Execution using the Temporal .NET SDK**
