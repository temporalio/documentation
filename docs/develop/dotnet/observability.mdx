...
description: Learn how to emit metrics, set up tracing, log from a Workflow, and use Visibility APIs using the Temporal .NET SDK to monitor and observe your applications.
...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#metrics" className="topic-card">
      <div className="topic-title">Emit metrics</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#tracing" className="topic-card">
      <div className="topic-title">Setup Tracing</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#logging" className="topic-card">
      <div className="topic-title">Log from a Workflow</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#visibility" className="topic-card">
      <div className="topic-title">Use Visibility APIs</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
