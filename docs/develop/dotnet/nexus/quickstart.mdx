...
## 1. Define the Nexus Service {/* #1-define-the-nexus-service */}
...
## 2. Define the Nexus Operation handler {/* #2-define-the-nexus-operation-handler */}
...
## 3. Register the Nexus Service handler in a Worker {/* #3-register-the-nexus-service-handler-in-a-worker */}
...
## 4. Develop the caller Workflow {/* #4-develop-the-caller-workflow */}
...
## 5. Create the caller Namespace and Nexus Endpoint {/* #5-create-the-caller-namespace-and-nexus-endpoint */}
...
## 6. Add the caller project {/* #6-add-the-caller-project */}
...
## 7. Create the caller starter {/* #7-create-the-caller-starter */}
