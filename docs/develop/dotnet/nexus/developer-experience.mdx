...
description: Build a Nexus Service in .NET with the pre-release APIs - the Temporal Operation Handler, Activity-backed Operations, and a single Service contract.
