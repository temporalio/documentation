...
description: Cancel a Workflow Execution and its Activities using the .NET SDK.
...
- [Terminate](#terminate): Terminating a Workflow forcefully stops Workflow Execution.
