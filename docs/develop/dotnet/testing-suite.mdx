---
id: testing-suite
title: Testing suite - .NET SDK
sidebar_label: Testing suite
slug: /develop/dotnet/testing-suite
description: Learn how to test Workflows and Activities using the Temporal .NET SDK. Includes unit testing, integration testing, time skipping, and Workflow replay testing.
...
The Testing section of the Temporal Developer's guide describes the frameworks that facilitate Workflow and Activity testing.

In the context of Temporal, you can create these types of tests:
...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#test-frameworks" className="topic-card">
      <div className="topic-title">Test frameworks</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#testing-workflows" className="topic-card">
    ...
    <a href="#replay-test" className="topic-card">
      <div className="topic-title">Replay test</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
