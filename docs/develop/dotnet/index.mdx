...
- [Create a Temporal Client](/develop/dotnet/temporal-client#create-a-client): Instantiate and configure a client to interact with the Temporal Service.
...
## [Workflow message passing](/develop/dotnet/message-passing)
...
## [Durable Timers](/develop/dotnet/durable-timers)
...
The [Temporal Nexus](/develop/dotnet/nexus) feature guide shows how to use Temporal Nexus to connect Durable Executions within and across Namespaces using a Nexus Endpoint, a Nexus Service contract, and Nexus Operations.
...
## [Enriching the User Interface](/develop/dotnet/enriching-ui)
