...
- [.NET API Documentation](https://docs.temporal.io/docs/dotnet)
...
- [Temporal .NET Community Slack](https://app.slack.com/client/TNWA8QCGZ)
- [.NET SDK Forum](https://community.temporal.io/tag/dotnet-sdk)
- [Temporal In Action: Use Cases](https://temporal.io/in-use?sdk=Dotnet#temporal-in-action)
- [Temporal Meetups](https://www.meetup.com/pro/temporal-technologies/)
:::
