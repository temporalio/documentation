...
The [Interrupt a Workflow feature guide](/develop/dotnet/interrupt-workflow) shows how to interrupt a Workflow Execution with a Cancel or Terminate action.

- [Cancel a Workflow](/develop/dotnet/interrupt-workflow#cancellation): Interrupt a Workflow Execution and its Activities through Workflow cancellation.
- [Terminate a Workflow](/develop/dotnet/interrupt-workflow#termination): Interrupt a Workflow Execution and its Activities through Workflow termination.
