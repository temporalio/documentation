...
The [Testing suite feature guide](/develop/dotnet/testing-suite) shows how to setup the testing suite and test Workflows and Activities.
...
The [Application messages feature guide](/develop/dotnet/message-passing) shows how to send messages to and read the state of Workflow Executions.
...
The [Heartbeat feature guide](/develop/dotnet/heartbeat) shows how to Heartbeat an Activity and set an Heartbeat Timeout.

- [Heartbeat an Activity](/develop/dotnet/heartbeat#activity-heartbeat): An Activity Heartbeat is a ping from the Worker that is executing the Activity to the Temporal Cluster.
- [Set a Heartbeat Timeout](/develop/dotnet/heartbeat#heartbeat-timeout): A Heartbeat Timeout works in conjunction with Activity Heartbeats. 
