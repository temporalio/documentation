...
<div className="topics-covered-section">
  ...
  <div className="topics-grid">
    <a href="#create-a-client" className="topic-card">
      <div className="topic-title">Create a Temporal Client</div>
    ...
    <a href="#start-workflow" className="topic-card">
      <div className="topic-title">Start a Workflow</div>
      <div className="topic-arrow">→</div>
    </a>
    <a href="#get-workflow-results" className="topic-card">
      <div className="topic-title">Get Workflow results</div>
      <div className="topic-arrow">→</div>
    </a>
  </div>
</div>
