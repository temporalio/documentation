...
dotnet new console -n temporaliodotnet
</CodeSnippet>
<CodeSnippet language="bash">
cd temporaliodotnet
</CodeSnippet>
...
```bash
# Install dependencies (from the root of the solution)
...
<CallToAction href="https://learn.temporal.io/getting_started/dotnet/first_program_in_dotneet/">
