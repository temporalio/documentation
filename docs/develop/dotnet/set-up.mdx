...
mkdir temporalidotnethelloworld
cd temporalidotnethelloworld

dotnet new sln -n temporalidotnethelloworld
...
dotnet sln temporalidotnethelloworld.sln add Workflow/Workflow.csproj Worker/Worker.csproj Client/Client.csproj
