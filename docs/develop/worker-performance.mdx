...
- Python SDK - use something like `request_eager_start` in your Workflow-Start-Options
- .NET SDK - use something like `request_eager_start` in your Workflow-Start-Options
