...
### Eager task execution {/* #eager-task-execution */}
...
#### Eager Activity Start {/* #eager-activity-start */}
...
### Executor slot options {/* #executor-slot-options */}
...
### "Large value" drawbacks {/* #large-value-drawbacks */}
...
#### When to use resource-based slot suppliers {/* #when-to-use-resource-based-slot-suppliers */}
...
#### When to use custom slot suppliers {/* #when-to-use-custom-slot-suppliers */}
...
### Slot supplier throttles {/* #slot-supplier-throttles */}
...
## Workflow Cache Tuning {/* #workflow-cache-tuning */}
...
### Hosts and Resources provisioning {/* #hosts-and-resources-provisioning */}
...
### Worker Executor Slots sizing {/* #worker-executor-slots-sizing */}
