...
import { CaptionedImage, ReleaseNoteHeader, SdkTabs, AnnotatedCode } from '@site/src/components';
import { LANGUAGE_TAB_GROUP, getLanguageLabel } from '@site/src/constants/languageTabs';
import * as Poller from '@site/src/components/elements/AnnotatedCode/annotations/pollerAutoscaling';
...
<AnnotatedCode annotations={Poller.go}>
```go
...
<AnnotatedCode annotations={Poller.java}>
```java
...
<AnnotatedCode annotations={Poller.python}>
```python
worker = Worker(
    client,
...
<AnnotatedCode annotations={Poller.typescript}>
```ts
...
<AnnotatedCode annotations={Poller.dotnet}>
```csharp
...
<AnnotatedCode annotations={Poller.ruby}>
```ruby
