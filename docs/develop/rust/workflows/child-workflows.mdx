...
### Specify Child Workflow options {/* #specify-child-workflow-options */}
...
### Execute multiple Child Workflows in parallel {/* #execute-multiple-child-workflows-in-parallel */}
...
### Parent Close Policy Options {/* #parent-close-policy-options */}
