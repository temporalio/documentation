...
## Add Temporal Rust SDK Dependencies {/* #add-temporal-rust-sdk-dependencies */}
...
### 1. Define Your Activity {/* #1-define-your-activity */}
...
### 2. Define Your Workflow {/* #2-define-your-workflow */}
...
### 3. Create and Run a Worker {/* #3-create-and-run-a-worker */}
...
### 4. Start a Workflow {/* #4-start-a-workflow */}
