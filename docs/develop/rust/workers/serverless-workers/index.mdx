---
id: index
title: Serverless Workers - Rust SDK
sidebar_label: Serverless Workers
description: Write Temporal Workers that run on serverless compute using the Rust SDK.
slug: /develop/rust/workers/serverless-workers
