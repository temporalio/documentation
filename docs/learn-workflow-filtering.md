...
2. Get the Temporal Docker compose file. Run `curl -L https://github.com/temporalio/temporal/releases/download/v0.23.0/docker.tar.gz | tar -xz --strip-components 1 docker/docker-compose-es.yml`
