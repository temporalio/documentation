...
- [`tctl cluster add-search-attributes`](/tctl-next/cluster#add-search-attributes)
- [`tctl cluster get-search-attributes`](/tctl-next/cluster#get-search-attributes)
- [`tctl cluster health`](/tctl-next/cluster#health)
- [`tctl cluster list-search-attributes`](/tctl-next/cluster#get-search-attributes)
- [`tctl cluster remove-search-attributes`](/tctl-next/cluster#remove-search-attributes)

## get-search-attributes

The `tctl cluster get-search-attributes` command lists all [Search Attributes](/visibility#search-attribute) that can be used in the `--query` modifier of the [`tctl workflow list`](/tctl-next/workflow#list) command.
