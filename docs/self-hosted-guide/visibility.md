...
You can configure any of the [supported databases](#supported-databases) as your secondary store.
...
Before you begin, verify [supported databases and versions](#supported-databases) for a Visibility store.
