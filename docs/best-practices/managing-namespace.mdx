...
### Use lowercase and hyphens {/* #use-lowercase-and-hyphens */}
...
### Follow a consistent naming pattern {/* #follow-a-consistent-naming-pattern */}
...
### Choose your Namespace boundary intentionally {/* #choose-your-namespace-boundary-intentionally */}
...
### Pattern 1: Namespace per use case and environment {/* #pattern-1-namespace-per-use-case-and-environment */}
...
### Pattern 2: Namespace per use case, service, and environment {/* #pattern-2-namespace-per-use-case-service-and-environment */}
...
### Pattern 3: Namespace per use case, domain, and environment {/* #pattern-3-namespace-per-use-case-domain-and-environment */}
...
### Pattern 4: Namespace per tenant {/* #pattern-4-namespace-per-tenant */}
...
### What should cause you to split a Namespace later? {/* #what-should-cause-you-to-split-a-namespace-later */}
...
### Recommended tag categories {/* #recommended-tag-categories */}
...
## SDK Client Configuration {/* #sdk-client-configuration */}
