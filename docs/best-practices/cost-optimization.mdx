...
[Storage costs](/cloud/pricing#storage) are divided into Active Storage (open Workflows) and Retained Storage (closed Event History during retention period).
...
Retained Storage applies to closed Event History during the retention period.
