...
#### 1. Enable [SAML Single Sign-on](https://docs.temporal.io/cloud/saml) (SSO) for User Access {/* #1-enable-saml-single-sign-on-sso-for-user-access */}
...
#### 2. Use Least-Privilege Roles for Temporal Cloud Users {/* #2-use-least-privilege-roles-for-temporal-cloud-users */}
...
#### 3. Leverage SCIM or Automated User Provisioning {/* #3-leverage-scim-or-automated-user-provisioning */}
...
#### Use Service Accounts for Automation {/* #use-service-accounts-for-automation */}
...
## Secure Application Authentication and API Access {/* #secure-application-authentication-and-api-access */}
...
#### 1. Using Mutual TLS (mTLS) provides comprehensive security {/* #1-using-mutual-tls-mtls-provides-comprehensive-security */}
...
#### 2. Proactively manage and rotate certificates {/* #2-proactively-manage-and-rotate-certificates */}
...
#### 3. If you’re using API Keys, handle them with strict care {/* #3-if-youre-using-api-keys-handle-them-with-strict-care */}
...
## Network Configuration and Isolation {/* #network-configuration-and-isolation */}
...
#### 1. Use Private Connectivity {/* #1-use-private-connectivity */}
...
#### 2. Separate environments by Namespace {/* #2-separate-environments-by-namespace */}
...
#### 1. Enable Client-Side Encryption for Workflow Data {/* #1-enable-client-side-encryption-for-workflow-data */}
...
#### 2. Encode Workflow Failure Details with a [Failure Converter](https://docs.temporal.io/failure-converter) {/* #2-encode-workflow-failure-details-with-a-failure-converter */}
...
#### 3. Leverage Namespace Data Retention Policies {/* #3-leverage-namespace-data-retention-policies */}
...
#### 1. Identify Availability-sensitive Namespaces {/* #1-identify-availability-sensitive-namespaces */}
...
#### 2. Enable High Availability for business critical use cases {/* #2-enable-high-availability-for-business-critical-use-cases */}
