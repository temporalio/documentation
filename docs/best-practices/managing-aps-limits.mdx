...
## Understanding Actions in Temporal {/* #understanding-actions-in-temporal */}

Before we dive into why customers hit APS limits, let's talk about what actions are.

### What Counts as an Action? {/* #what-counts-as-an-action */}
...
### The Action Multiplier Effect {/* #the-action-multiplier-effect */}
...
### The Effect of Rate Limiting {/* #the-effect-of-rate-limiting */}
...
## Common Reasons Customers Hit APS Limits {/* #common-reasons-customers-hit-aps-limits */}
...
### Cascading Workflows and Fan-Out Patterns {/* #cascading-workflows-and-fan-out-patterns */}
...
### Human-in-the-Loop Processes at Scale {/* #human-in-the-loop-processes-at-scale */}
...
### Real-Time SLAs and Deadline Management {/* #real-time-slas-and-deadline-management */}
...
### Many Small Activities {/* #many-small-activities */}
...
### Multiple Use Cases in One Namespace {/* #multiple-use-cases-in-one-namespace */}
...
#### How to Mitigate {/* #how-to-mitigate-5 */}
...
## Provisioned Capacity and TRUs {/* #provisioned-capacity-and-trus */}
...
## Knowing if You're Hitting APS Limits {/* #knowing-if-youre-hitting-aps-limits */}
...
### Monitoring for TRU Decisions {/* #monitoring-for-tru-decisions */}
