...
[Cloud Billing API](/cloud/billing-api), [Billing Center](/cloud/billing), [Usage Dashboards](/evaluate/cloud/actions-usage),
...
| [Usage Dashboards](/evaluate/cloud/actions-usage) | Namespace, by Action category | At-a-glance usage in the Cloud UI | Account Owners, Finance Admins, and Global Admins at account level; anyone with Namespace access at Namespace level |
| [Actions in Event History](/evaluate/cloud/actions-usage#actions-in-workflows) | Per Workflow Execution | Estimating Actions for a specific execution | Account Owners, Global Admins, Namespace Admins, Developers, and Read-Only users |
...
Temporal Cloud bills primarily on [Actions](/evaluate/cloud/actions), which are billable operations such as starting a
