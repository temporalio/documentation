...
### Establish clear guidelines on authentication methods {/* #establish-clear-guidelines-on-authentication-methods */}
...
### Default operating model for service accounts and API keys {/* #default-operating-model-for-service-accounts-and-api-keys */}
...
### Use access boundaries that match your Namespace boundaries {/* #use-access-boundaries-that-match-your-namespace-boundaries */}
...
### Rotate credentials without downtime {/* #rotate-credentials-without-downtime */}
...
### Use Certificate Filters to restrict access when using shared CAs (e.g., `dev` vs `prod`) {/* #use-certificate-filters-to-restrict-access-when-using-shared-cas-eg-dev-vs-prod */}
