...
### Kill all Workers, then restart them {/* #kill-all-workers-then-restart-them */}
...
### Frequent Worker restart {/* #frequent-worker-restart */}
...
### Pre-load test setup: expectations for success {/* #pre-load-test-setup-expectations-for-success */}
...
### Validate downstream load capacity {/* #validate-downstream-load-capacity */}
...
### Validate rate limiting behavior {/* #validate-rate-limiting-behavior */}
...
## Failover and availability {/* #failover-and-availability */}
...
### Test region failover {/* #test-region-failover */}
...
## Dependency and downstream testing {/* #dependency-and-downstream-testing */}

### Break the things your Workflows call {/* #break-the-things-your-workflows-call */}
...
## Deployment and code-level testing {/* #deployment-and-code-level-testing */}

### Deploy a Workflow change with versioning {/* #deploy-a-workflow-change-with-versioning */}
...
### Deploy a version that causes NDEs, then recover {/* #deploy-a-version-that-causes-ndes-then-recover */}
...
## Network-level testing {/* #network-level-testing */}
...
### Remove network connectivity to a Namespace {/* #remove-network-connectivity-to-a-namespace */}
...
## Game day runbook {/* #game-day-runbook */}
