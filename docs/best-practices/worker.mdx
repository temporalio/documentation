...
## Deployment and lifecycle management {/* #deployment-and-lifecycle-management */}
...
### Package and configure Workers for flexibility {/* #package-and-configure-workers-for-flexibility */}
...
### Separate Task Queues logically {/* #separate-task-queues-logically */}
...
### Use Worker Versioning to safely deploy new Workflow code {/* #use-worker-versioning-to-safely-deploy-new-workflow-code */}
...
### Manage Event History growth {/* #manage-event-history-growth */}
...
## Scaling, monitoring, and tuning {/* #scaling-monitoring-and-tuning */}
...
### Actively tune Worker options instead of relying on defaults {/* #actively-tune-worker-options-instead-of-relying-on-defaults */}
...
### Interpret metrics as a whole {/* #interpret-metrics-as-a-whole */}
...
### Optimize Worker cache {/* #optimize-worker-cache */}
...
### Manage scale-down safely {/* #manage-scale-down-safely */}
