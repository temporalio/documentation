...
To get the most out of this guide, you should be familiar with [Temporal architecture](/encyclopedia/architecture/temporal-architecture), [Workflows](/workflows), [Activities](/activities), and [Task Queues](/task-queue).
