...
## Task processing metrics {/* #task-processing-metrics */}
...
### `temporal_workflow_task_schedule_to_start_latency` spike {/* #temporal_workflow_task_schedule_to_start_latency-spike */}
...
### `temporal_activity_schedule_to_start_latency` spike {/* #temporal_activity_schedule_to_start_latency-spike */}
...
### `temporal_workflow_endtoend_latency` spike {/* #temporal_workflow_endtoend_latency-spike */}
...
### High `temporal_workflow_task_execution_latency` {/* #high-temporal_workflow_task_execution_latency */}
...
### High `workflow_task_replay_latency` {/* #high-workflow_task_replay_latency */}
...
### `temporal_activity_execution_latency` spike {/* #temporal_activity_execution_latency-spike */}
...
### Depletion of `temporal_worker_task_slots_available` for `WorkflowWorker` {/* #depletion-of-temporal_worker_task_slots_available-for-workflowworker */}
...
### Depletion of `temporal_worker_task_slots_available` for `ActivityWorker` {/* #depletion-of-temporal_worker_task_slots_available-for-activityworker */}
...
### High `temporal_long_request_failure` {/* #high-temporal_long_request_failure */}
...
### High `temporal_request_failure_total` {/* #high-temporal_request_failure_total */}
...
### High `temporal_request_latency` {/* #high-temporal_request_latency */}
...
### `rate(temporal_long_request_total{operation="PollActivityTaskQueue"})` {/* #ratetemporal_long_request_totaloperationpollactivitytaskqueue */}
...
### `rate(temporal_long_request_total{operation="PollWorkflowTaskQueue"})` {/* #ratetemporal_long_request_totaloperationpollworkflowtaskqueue */}
...
### `temporal_sticky_cache_size` {/* #temporal_sticky_cache_size */}
...
### `temporal_sticky_cache_hit_total` and `temporal_sticky_cache_miss_total` {/* #temporal_sticky_cache_hit_total-and-temporal_sticky_cache_miss_total */}
...
### `temporal_sticky_cache_total_forced_eviction_total` {/* #temporal_sticky_cache_total_forced_eviction_total */}
