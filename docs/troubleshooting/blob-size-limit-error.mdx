...
Temporal enforces size limits on the data that passes between Workers and the Temporal Service. There are two distinct limits, each producing different error messages and behaviors.
