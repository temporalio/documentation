...
### Verify TLS certification expiration date {/* #verify-tls-certification-expiration-date */}
...
### Renew TLS certification {/* #renew-tls-certification */}
...
### Update the CA certification in the server configuration {/* #update-the-ca-certification-in-the-server-configuration */}
