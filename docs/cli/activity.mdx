...
|------|----------|-------------|
| `--activity-id`, `-a` | Yes | **string** Activity ID to complete. |
...
| Flag | Required | Description |
|------|----------|-------------|
| `--activity-id`, `-a` | Yes | **string** Activity ID to fail. |
...
| `--activity-type` | No | **string** Activities of the given `activity-type` will be paused. Mutually exclusive with `activity-id`. Note: Pausing Activity by Type is an experimental feature and may change in the future. |
...
| `--activity-type` | No | **string** Activities of the given `activity-type` will be reset. Mutually exclusive with --match-all and `activity-id`. Note: Resetting Activity by Type is an experimental feature and may change in the future. |
...
| `--activity-type` | No | **string** Activities of the given `activity-type` will be unpaused. Mutually exclusive with `activity-id` and --match-all. Note: Unpausing Activity by Type is an experimental feature and may change in the future. |
| `--headers` | No | **string[]** Temporal workflow headers in 'KEY=VALUE' format. Keys must be identifiers, and values must be JSON values. May be passed multiple times to set multiple Temporal headers. Note: These are workflow headers, not gRPC headers. |
