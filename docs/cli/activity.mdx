...
To use the CLI with Standalone Activities, see the CLI commands in the [Go](/docs/develop/go/standalone-activities.mdx) and [Python](/develop/python/activities/standalone-activities.mdx) Standalone Activity guides.
