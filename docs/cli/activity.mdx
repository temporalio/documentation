...
description: "Manage Activity Executions with Temporal commands: Complete or fail activities, set results, and customize behavior with various options, including activity ID, namespace, and more."
