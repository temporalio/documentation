...
Use in Temporal Cloud or with Temporal Server version [Temporal Server version 1.28](https://github.com/temporalio/temporal/releases/tag/v1.28.0)

[CLI version v1.4](https://github.com/temporalio/cli/releases/tag/v1.4.0) or higher is recommended.
...
If both are provided, Activity Type will be used, and Activity ID will be ignored.
...
The Activity ID to pause.

**--activity-type**, **-g** _string_

Pause all activities of the given Activity Type.
...
Recommended Temporal Server version [1.28](https://github.com/temporalio/temporal/releases/tag/v1.28.0)
Recommended CLI version [1.4](https://github.com/temporalio/cli/releases/tag/v1.4.0)
...
The Activity Type to pause. Exclusive with `--activity-id`.
...
The Activity ID to unpause on a specific Workflow specified by --workflow-id.
...
Modifies the [Backoff Coefficient](https://docs.temporal.io/encyclopedia/retry-policies#backoff-coefficient)
