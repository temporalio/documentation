...
sidebar_label: env
description: Configure Temporal environments using the `env` command, which sets, gets, or deletes environment properties for a Temporal Server instance, with options for customization.
