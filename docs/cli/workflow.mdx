...
Canceling a running Workflow Execution records a [`WorkflowExecutionCancelRequested` event](/references/events#workflowexecutioncancelrequested) in the [Event History](/workflow-execution#event-history).
...
A reset resumes the Workflow from a certain point without losing your parameters or [Event History](/workflow-execution#event-history).
...
Resetting a [Workflow](/workflows) resumes it from a certain point without losing your parameters or [Event History](/workflow-execution#event-history).
...
The `temporal workflow show` command provides the [Event History](/workflow-execution#event-history) for a [Workflow Execution](/workflow-execution).
...
Terminating a running Workflow Execution records a [`WorkflowExecutionTerminated` event](/references/events#workflowexecutionterminated) as the closing Event in the [Event History](/workflow-execution#event-history).
