...
description: "Manage and operate on Namespaces, Search Attributes, and Temporal Clusters using the temporal operator command-line interface, with options for describing, listing, creating, updating, and removing entities, as well as searching and filtering data."
