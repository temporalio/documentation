...
Operator commands enable actions on [Namespaces](/namespaces), [Search Attributes](/visibility#search-attribute), and [Temporal Services](/clusters).
...
Temporal Service commands enable actions on [Temporal Services](/clusters).
...
The `temporal operator cluster describe` command shows information about the [Temporal Service](/clusters).
...
A successful execution returns a list of [Temporal Service](/clusters) metrics.
...
The `temporal operator cluster remove` command removes a remote [Temporal Service](/clusters) from the system.
...
The `temporal operator cluster system` command provides information about the system the [Temporal Service](/clusters) is running on.
...
The `temporal operator cluster upsert` command allows the user to add or update a remote [Temporal Service](/clusters).
...
Namespace commands perform operations on [Namespaces](/namespaces) contained in the [Temporal Service](/clusters).
...
The Namespace can be created on the active [Temporal Service](/clusters), or any named Temporal Service within the system.
...
Namespaces can be assigned a different active [Temporal Service](/clusters).
