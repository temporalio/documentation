...
The `temporal operator search-attribute list` command displays a list of all [Search Attributes](/search-attribute) that can be used in [Queries](/encyclopedia/workflow-message-passing#sending-queries).
