...
Send a [Signal](/encyclopedia/workflow-message-passing/sending-messages#sending-signals) to a running Workflow.

[Query](/encyclopedia/workflow-message-passing/sending-messages#sending-queries) a running Workflow for its current state.
...
Create a [Schedule](/encyclopedia/workflow/schedule) that starts a Workflow on an interval.
