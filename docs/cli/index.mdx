...
### Fish auto-completion {/* #fish-auto-completion */}
...
#### Setting up proxy support {/* #setting-up-proxy-support */}
...
### Customize your environment variables {/* #customize-your-environment-variables */}
