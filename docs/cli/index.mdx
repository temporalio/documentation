...
The Temporal CLI includes a distribution of a Temporal Service, comprised of the [Temporal Server](/clusters#temporal-server), SQLite persistence, and the [Temporal Web UI](/web-ui).
