...
The Temporal CLI, evolving from its precursor [tctl](https://github.com/temporalio/tctl), provides developers with direct CLI access to a Temporal Service.
...
Run the following command to install the Temporal CLI using Scoop on Windows:
