...
```shell
temporal env set prod.namespace production.abc45
temporal env set prod.address production.abc45.tmprl.cloud:7233
...
$ temporal env get prod
  ...
  address        production.abc45.tmprl.cloud:7233
  namespace      production.abc45
