...
- <a class="tdlp" href="/cli/cmd-options#no-fold">--no-fold<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">temporal  no-fold</span><br /><br /><span class="tdlppd">Disable folding. All Child Workflows within the set depth will be fetched and displayed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/cli/cmd-options#no-fold">Learn more</a></span></span></a>
