...
description: "Manage the Temporal Server from the command line with various options for starting, configuring, and customizing the server, including controlling the database, frontend service, and logging."
