...
description: "Manage schedules in Temporal workflows using commands for creating, updating, deleting, describing, listing, toggling, and triggering schedules, with options for customization and automation."
