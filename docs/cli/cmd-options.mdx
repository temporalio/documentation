...
keywords:
  ...
  - continue-as-new
  - cron
  - cross-Temporal Service-connection
  - data converters
  - endpoint
  - environment
  - event
...
Enable cross-Temporal Service connection.
...
Frontend address of the remote Temporal Service.
