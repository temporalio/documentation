...
## activity-jitter {/* #activity-jitter */}
...
## codec-auth {/* #codec-auth */}

Sets the authorization header on requests to the Codec Server.

## codec-endpoint {/* #codec-endpoint */}
...
## enable-connection {/* #enable-connection */}
...
## existing-compatible-build-id {/* #existing-compatible-build-id */}
...
## first-execution-run-id {/* #first-execution-run-id */}
...
## history-archival-state {/* #history-archival-state */}
...
## id-reuse-policy {/* #id-reuse-policy */}
...
## input-parallelism {/* #input-parallelism */}
...
## no-json-shorthand-payloads {/* #no-json-shorthand-payloads */}
...
## reachability-type {/* #reachability-type */}
...
## reject-condition {/* #reject-condition */}
...
## retry-maximum-attempts {/* #retry-maximum-attempts */}
...
## tls-disable-host-verification {/* #tls-disable-host-verification */}
...
## ui-asset-path {/* #ui-asset-path */}

UI Custom Assets path.

## ui-codec-endpoint {/* #ui-codec-endpoint */}
...
## visibility-archival-state {/* #visibility-archival-state */}

Visibility Archival state. Valid values: "disabled", "enabled".

## visibility-uri {/* #visibility-uri */}
