...
description: "Manage Task Queues with Temporal's command-line interface, including describing poller information, listing partitions, fetching build IDs, and checking reachability and updating build IDs."
