...
- Inputs and outputs/results in your [Workflow](/workflows#workflow-execution) <span id="i-1d74a3ca-81ce-4bf3-870e-ca07ed578dd8" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1d74a3ca-81ce-4bf3-870e-ca07ed578dd8" class="preview-modal"><div class="modal-header"><div id="x-1d74a3ca-81ce-4bf3-870e-ca07ed578dd8" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Execution?</div><div class="preview-modal-description">A Temporal Workflow Execution is a durable, scalable, reliable, and reactive function execution. It is the main unit of execution of a Temporal Application.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>, [Activity](/activities#activity-execution) <span id="i-49c1e112-85d5-4dd3-9e2e-c847382a9a38" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-49c1e112-85d5-4dd3-9e2e-c847382a9a38" class="preview-modal"><div class="modal-header"><div id="x-49c1e112-85d5-4dd3-9e2e-c847382a9a38" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>, and [Child Workflow](/workflows#child-workflow) <span id="i-3442b688-893f-4119-923a-06d87d21e76e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3442b688-893f-4119-923a-06d87d21e76e" class="preview-modal"><div class="modal-header"><div id="x-3442b688-893f-4119-923a-06d87d21e76e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Child Workflow Execution?</div><div class="preview-modal-description">A Child Workflow Execution is a Workflow Execution that is spawned from within another Workflow.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">child-workflow</span></div></div>
- [Signal](/workflows#signal) <span id="i-09960699-4c21-4e66-a3ca-3e9be0a3fc17" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-09960699-4c21-4e66-a3ca-3e9be0a3fc17" class="preview-modal"><div class="modal-header"><div id="x-09960699-4c21-4e66-a3ca-3e9be0a3fc17" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Signal?</div><div class="preview-modal-description">A Signal is an asynchronous request to a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">signals</span> <span class="preview-modal-tag">explanation</span></div></div> inputs
- [Memo](/workflows#memo) <span id="i-1370ae28-8e0c-4e55-8624-7cd85caa81c2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1370ae28-8e0c-4e55-8624-7cd85caa81c2" class="preview-modal"><div class="modal-header"><div id="x-1370ae28-8e0c-4e55-8624-7cd85caa81c2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Memo?</div><div class="preview-modal-description">A Memo is a non-indexed user-supplied set of Workflow Execution metadata that is returned when you describe or list Workflow Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>
- Headers (verify if applicable to your SDK)
- [Query](/workflows#query) <span id="i-0796028c-dc99-4393-b2f4-0016bf14ad89" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-0796028c-dc99-4393-b2f4-0016bf14ad89" class="preview-modal"><div class="modal-header"><div id="x-0796028c-dc99-4393-b2f4-0016bf14ad89" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Query?</div><div class="preview-modal-description">A Query is a synchronous operation that is used to report the state of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">queries</span> <span class="preview-modal-tag">explanation</span></div></div> inputs and results
- Results of [Local Activities](/activities#local-activity) <span id="i-f1fb5ddc-4d2b-4d6a-a310-233126abfc1f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-f1fb5ddc-4d2b-4d6a-a310-233126abfc1f" class="preview-modal"><div class="modal-header"><div id="x-f1fb5ddc-4d2b-4d6a-a310-233126abfc1f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Local Activity?</div><div class="preview-modal-description">A Local Activity is an Activity Execution that executes in the same process as the Workflow Execution that spawns it.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and [Side Effects](/workflows#side-effect) <span id="i-a0293b9e-952b-4764-b9f2-1905691507a2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a0293b9e-952b-4764-b9f2-1905691507a2" class="preview-modal"><div class="modal-header"><div id="x-a0293b9e-952b-4764-b9f2-1905691507a2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Side Effect?</div><div class="preview-modal-description">A Side Effect is a way to execute a short, non-deterministic code snippet, such as generating a UUID, that executes the provided function once and records its result into the Workflow Execution Event History.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>
- [Application errors and failures](/kb/failures)

  Failure messages and stack traces are not encoded as codec-capable Payloads by default; you must explicitly enable encoding these common attributes on failures. For more details, see [Failure Converter](/dataconversion#failure-converter) <span id="i-661d3f06-00ba-47a8-a42b-39f59d1f7d8c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-661d3f06-00ba-47a8-a42b-39f59d1f7d8c" class="preview-modal"><div class="modal-header"><div id="x-661d3f06-00ba-47a8-a42b-39f59d1f7d8c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Failure Converter?</div><div class="preview-modal-description">A Failure Converter converts error objects to proto Failures and back.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
By default, your data is serialized to a [Payload](/dataconversion#payload) <span id="i-93a48383-295e-4432-89ff-1b108375a15b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-93a48383-295e-4432-89ff-1b108375a15b" class="preview-modal"><div class="modal-header"><div id="x-93a48383-295e-4432-89ff-1b108375a15b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">payloads</span> <span class="preview-modal-tag">explanation</span></div></div> by a [Data Converter](/dataconversion#) <span id="i-1be038bf-698f-4fa7-be54-906562f9bfa0" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1be038bf-698f-4fa7-be54-906562f9bfa0" class="preview-modal"><div class="modal-header"><div id="x-1be038bf-698f-4fa7-be54-906562f9bfa0" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
To encrypt your Payload, configure your custom encryption logic with a [Payload Codec](/dataconversion#payload-codec) <span id="i-eeffd0e1-259d-4a18-898e-56258a26b872" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-eeffd0e1-259d-4a18-898e-56258a26b872" class="preview-modal"><div class="modal-header"><div id="x-eeffd0e1-259d-4a18-898e-56258a26b872" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and set it with a [custom Data Converter](/dataconversion#custom-data-converter) <span id="i-111f221b-84e5-4657-951b-8c8f92f9fbbf" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-111f221b-84e5-4657-951b-8c8f92f9fbbf" class="preview-modal"><div class="modal-header"><div id="x-111f221b-84e5-4657-951b-8c8f92f9fbbf" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a custom Data Converter?</div><div class="preview-modal-description">A custom Data Converter extends the default Data Converter with custom logic for Payload conversion or Payload encryption.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.

A Payload Codec does byte-to-byte conversion to transform your Payload (for example, by implementing compression and/or encryption and decryption) and is an optional step that happens between the wire and the [Payload Converter](/dataconversion#payload-converter) <span id="i-adcb19ce-7e12-4a46-919a-f88cdae4b53d" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-adcb19ce-7e12-4a46-919a-f88cdae4b53d" class="preview-modal"><div class="modal-header"><div id="x-adcb19ce-7e12-4a46-919a-f88cdae4b53d" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload Converter?</div><div class="preview-modal-description">A Payload Converter serializes data, converting objects or values to bytes and back.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>:

```bash
User code <--> Payload Converter <--> Payload Codec <--> Wire <--> Temporal Server
```

You can run your Payload Codec with a [Codec Server](/dataconversion#codec-server) <span id="i-ee570495-6a77-4741-b9ee-20a419605492" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-ee570495-6a77-4741-b9ee-20a419605492" class="preview-modal"><div class="modal-header"><div id="x-ee570495-6a77-4741-b9ee-20a419605492" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Codec Server?</div><div class="preview-modal-description">A Codec Server is an HTTP server that uses your custom Payload Codec to encode and decode your data remotely through endpoints.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div> and use the Codec Server endpoints in Web UI and tctl to decode your encrypted Payload locally.
For details on how to set up a Codec Server, see [Codec Server setup](#codec-server-setup) <span id="i-834dfdd7-4a28-4e20-bdd7-bd78bd5fbe4e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-834dfdd7-4a28-4e20-bdd7-bd78bd5fbe4e" class="preview-modal"><div class="modal-header"><div id="x-834dfdd7-4a28-4e20-bdd7-bd78bd5fbe4e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Codec Server setup</div><div class="preview-modal-description">Run a Codec Server with your Payload Codec and then configure the Web UI and CLI to use the server endpoints.</div><div class="preview-modal-tags"><span class="preview-modal-tag">security</span> <span class="preview-modal-tag">how-to</span></div></div>.

However, if you plan to set up [remote data encoding](/dataconversion#remote-data-encoding) <span id="i-4ea8fc24-2764-40cb-a856-2a09cacb77ba" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4ea8fc24-2764-40cb-a856-2a09cacb77ba" class="preview-modal"><div class="modal-header"><div id="x-4ea8fc24-2764-40cb-a856-2a09cacb77ba" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is remote data encoding?</div><div class="preview-modal-description">Remote data encding is using your custom Data Converter to decode (and encode) your Payloads remotely through endpoints.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> for your data, ensure that you consider all security implications of running encryption remotely before implementing it.
...
It must be used in an instance of [CodecDataConverter](https://pkg.go.dev/go.temporal.io/sdk/converter#CodecDataConverter) that wraps a Data Converter to do the [Payload](/dataconversion#payload) <span id="i-88a0c3b1-94a7-43d6-8e34-c76482c21c0c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-88a0c3b1-94a7-43d6-8e34-c76482c21c0c" class="preview-modal"><div class="modal-header"><div id="x-88a0c3b1-94a7-43d6-8e34-c76482c21c0c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">payloads</span> <span class="preview-modal-tag">explanation</span></div></div> conversions, and applies the custom encoding and decoding in `PayloadCodec` to the converted Payloads.
...
Use a Codec Server to decode your encoded [payloads](/dataconversion#payload) <span id="i-481494db-445d-43e1-a820-5ec251cc1736" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-481494db-445d-43e1-a820-5ec251cc1736" class="preview-modal"><div class="modal-header"><div id="x-481494db-445d-43e1-a820-5ec251cc1736" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">payloads</span> <span class="preview-modal-tag">explanation</span></div></div> and integrate it with the Temporal Web UI and CLI commands when debugging your Workflows.

A Codec Server is an HTTP or HTTPS Server that you create and host.
It must be configured to use a [Payload Codec](/dataconversion#payload-codec) <span id="i-b304a06d-d222-466d-8241-dcc65da7b3b5" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-b304a06d-d222-466d-8241-dcc65da7b3b5" class="preview-modal"><div class="modal-header"><div id="x-b304a06d-d222-466d-8241-dcc65da7b3b5" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> with the required decode logic and encryption keys.
...
- A [Payload Codec](/dataconversion#payload-codec) <span id="i-3a3acb3f-9dbc-41a0-b928-01a22830e43c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3a3acb3f-9dbc-41a0-b928-01a22830e43c" class="preview-modal"><div class="modal-header"><div id="x-3a3acb3f-9dbc-41a0-b928-01a22830e43c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> with the requisite keys and logic to decode your encrypted payloads.
...
On self-hosted Temporal Clusters, configure [authorization in the Web UI configuration](/references/web-ui-configuration#auth) <span id="i-53707d26-8332-4d85-a98d-796e8e6bcf0c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-53707d26-8332-4d85-a98d-796e8e6bcf0c" class="preview-modal"><div class="modal-header"><div id="x-53707d26-8332-4d85-a98d-796e8e6bcf0c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Temporal Web UI configuration reference</div><div class="preview-modal-description">The Temporal Web UI Server uses a configuration file for many of the UI's settings.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span> <span class="preview-modal-tag">web-ui</span></div></div> in your Temporal Cluster setup.
...
In self-hosted Temporal Clusters where you set up your UI Server, you can also set the codec endpoint in the UI server [configuration file](/references/web-ui-configuration#codec) <span id="i-d69e42eb-6992-4464-ac7a-3e507fb07018" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d69e42eb-6992-4464-ac7a-3e507fb07018" class="preview-modal"><div class="modal-header"><div id="x-d69e42eb-6992-4464-ac7a-3e507fb07018" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">Temporal Web UI configuration reference</div><div class="preview-modal-description">The Temporal Web UI Server uses a configuration file for many of the UI's settings.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span> <span class="preview-modal-tag">web-ui</span></div></div>, as shown in the following example.
