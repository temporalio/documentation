...
Read more in the [Choose a development Temporal Service](#choose-dev-temporal-service) section.

In this chapter you will do the following:

1. Download the Temporal CLI.
2. Choose your development Temporal Service.
3. Create a Namespace on your development Temporal Service.
