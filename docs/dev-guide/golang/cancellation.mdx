...
description: "Learn how to handle workflow cancellation requests, set activity heartbeat timeouts, and request cancellation of workflows and activities in Go with Temporal."
