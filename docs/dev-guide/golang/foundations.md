...
A [Temporal SDK](/temporal#temporal-sdk) <span id="i-3b717be5-a2b8-499a-ace6-82b22c269594" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3b717be5-a2b8-499a-ace6-82b22c269594" class="preview-modal"><div class="modal-header"><div id="x-3b717be5-a2b8-499a-ace6-82b22c269594" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-sdk">/temporal#temporal-sdk</a></div><div class="preview-modal-title">What is a Temporal SDK?</div><div class="preview-modal-description">A Temporal SDK is a language-specific library that offers APIs to construct and use a Temporal Client to communicate with a Temporal Cluster, develop Workflow Definitions, and develop Worker Programs.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> provides a framework for [Temporal Application](/temporal#temporal-application) <span id="i-fb70c908-1d33-422a-9453-873f7846c68b" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-fb70c908-1d33-422a-9453-873f7846c68b" class="preview-modal"><div class="modal-header"><div id="x-fb70c908-1d33-422a-9453-873f7846c68b" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-application">/temporal#temporal-application</a></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> development.

An SDK provides you with the following:

- A [Temporal Client](/temporal#temporal-client) <span id="i-156cb56d-3c5e-4ac1-9920-a11c4d2d4e98" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-156cb56d-3c5e-4ac1-9920-a11c4d2d4e98" class="preview-modal"><div class="modal-header"><div id="x-156cb56d-3c5e-4ac1-9920-a11c4d2d4e98" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-client">/temporal#temporal-client</a></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> to communicate with a [Temporal Cluster](/clusters#) <span id="i-4ec2af9f-bb58-4d54-8e5b-19689239ee26" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4ec2af9f-bb58-4d54-8e5b-19689239ee26" class="preview-modal"><div class="modal-header"><div id="x-4ec2af9f-bb58-4d54-8e5b-19689239ee26" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#">/clusters#</a></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to develop [Workflows](/workflows#) <span id="i-f8f77c4f-1552-40cb-9fcd-15a44394ea67" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f8f77c4f-1552-40cb-9fcd-15a44394ea67" class="preview-modal"><div class="modal-header"><div id="x-f8f77c4f-1552-40cb-9fcd-15a44394ea67" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#">/workflows#</a></div><div class="preview-modal-title">What is a Workflow?</div><div class="preview-modal-description">In day-to-day conversations, the term "Workflow" frequently denotes either a Workflow Type, a Workflow Definition, or a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to create and manage [Worker Processes](/workers#worker) <span id="i-208ba010-3115-4e31-87ec-9abacc86c042" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-208ba010-3115-4e31-87ec-9abacc86c042" class="preview-modal"><div class="modal-header"><div id="x-208ba010-3115-4e31-87ec-9abacc86c042" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker">/workers#worker</a></div><div class="preview-modal-title">What is a Worker?</div><div class="preview-modal-description">In day-to-day conversations, the term Worker is used to denote both a Worker Program and a Worker Process. Temporal documentation aims to be explicit and differentiate between them.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to author [Activities](/activities#activity-definition) <span id="i-aa1aac12-7fd1-4be4-94e8-510f6051a91f" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-aa1aac12-7fd1-4be4-94e8-510f6051a91f" class="preview-modal"><div class="modal-header"><div id="x-aa1aac12-7fd1-4be4-94e8-510f6051a91f" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
A [Temporal Client](/temporal#temporal-client) <span id="i-e2b480bb-4b35-4ab6-948c-3dc87c9b17f2" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e2b480bb-4b35-4ab6-948c-3dc87c9b17f2" class="preview-modal"><div class="modal-header"><div id="x-e2b480bb-4b35-4ab6-948c-3dc87c9b17f2" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-client">/temporal#temporal-client</a></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> enables you to communicate with the [Temporal Cluster](/clusters#) <span id="i-244d8315-51df-438f-8974-738cd050d2e7" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-244d8315-51df-438f-8974-738cd050d2e7" class="preview-modal"><div class="modal-header"><div id="x-244d8315-51df-438f-8974-738cd050d2e7" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#">/clusters#</a></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-bb9b7553-c9ed-45a9-99cc-334d449ab9ca" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-bb9b7553-c9ed-45a9-99cc-334d449ab9ca" class="preview-modal"><div class="modal-header"><div id="x-bb9b7553-c9ed-45a9-99cc-334d449ab9ca" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/namespaces#">/namespaces#</a></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-444d54d3-94a4-4fe8-977b-ffc293f17933" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-444d54d3-94a4-4fe8-977b-ffc293f17933" class="preview-modal"><div class="modal-header"><div id="x-444d54d3-94a4-4fe8-977b-ffc293f17933" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
- A compatible mTLS CA certificate and mTLS private key that has been added to your Namespace.
  See [certificate requirements](/cloud/account-setup/certificates#certificate-requirements) <span id="i-3960dde8-9f08-4ed8-b5df-ee1dd5fa1712" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3960dde8-9f08-4ed8-b5df-ee1dd5fa1712" class="preview-modal"><div class="modal-header"><div id="x-3960dde8-9f08-4ed8-b5df-ee1dd5fa1712" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#certificate-requirements">/cloud/account-setup/certificates#certificate-requirements</a></div><div class="preview-modal-title">Requirements for CA certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates provided to Temporal for your Namespaces must meet certain requirements.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
- Your [Temporal Cloud Namespace Id](/cloud/account-setup/namespaces#temporal-cloud-namespace-id) <span id="i-28499a0b-6d1d-4f72-b051-f789deb0173a" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-28499a0b-6d1d-4f72-b051-f789deb0173a" class="preview-modal"><div class="modal-header"><div id="x-28499a0b-6d1d-4f72-b051-f789deb0173a" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-namespace-id">/cloud/account-setup/namespaces#temporal-cloud-namespace-id</a></div><div class="preview-modal-title">What is a Cloud Namespace Id?</div><div class="preview-modal-description">A Cloud Namespace Id is a globally unique identifier for a Namespace in Temporal Cloud.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>, which includes your [Temporal Cloud Namespace Name](/cloud/account-setup/namespaces#temporal-cloud-namespace-name) <span id="i-2725da8e-4c4b-4daf-9ce2-7599aa500fca" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2725da8e-4c4b-4daf-9ce2-7599aa500fca" class="preview-modal"><div class="modal-header"><div id="x-2725da8e-4c4b-4daf-9ce2-7599aa500fca" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-namespace-name">/cloud/account-setup/namespaces#temporal-cloud-namespace-name</a></div><div class="preview-modal-title">What is a Cloud Namespace Name?</div><div class="preview-modal-description">A Cloud Namespace Name is a customer-supplied name for a Namespace in Temporal Cloud.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and the unique five- or six-digit [Temporal Cloud Account Id](/cloud/account-setup/namespaces#temporal-cloud-account-id) <span id="i-4abc4dd6-cd98-48a6-86b8-412ef7a2c5d0" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4abc4dd6-cd98-48a6-86b8-412ef7a2c5d0" class="preview-modal"><div class="modal-header"><div id="x-4abc4dd6-cd98-48a6-86b8-412ef7a2c5d0" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-account-id">/cloud/account-setup/namespaces#temporal-cloud-account-id</a></div><div class="preview-modal-title">What is a Temporal Cloud Account Id?</div><div class="preview-modal-description">A Temporal Cloud Account Id is a unique identifier for a customer.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> that is appended to it.
...
For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-9f252d0d-2d92-435b-ab54-44052a71a815" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-9f252d0d-2d92-435b-ab54-44052a71a815" class="preview-modal"><div class="modal-header"><div id="x-9f252d0d-2d92-435b-ab54-44052a71a815" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a [Workflow Definition](/workflows#workflow-definition) <span id="i-340d5b79-7290-4e51-965d-860f26706b77" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-340d5b79-7290-4e51-965d-860f26706b77" class="preview-modal"><div class="modal-header"><div id="x-340d5b79-7290-4e51-965d-860f26706b77" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-definition">/workflows#workflow-definition</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
In the Temporal Go SDK programming model, a [Workflow Definition](/workflows#workflow-definition) <span id="i-914494e3-d45f-4846-a4aa-dd11cdab0673" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-914494e3-d45f-4846-a4aa-dd11cdab0673" class="preview-modal"><div class="modal-header"><div id="x-914494e3-d45f-4846-a4aa-dd11cdab0673" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-definition">/workflows#workflow-definition</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> is an exportable function.
...
To customize the Workflow Type, set the `Name` parameter with `RegisterOptions` when registering your Workflow with a [Worker](#develop-worker) <span id="i-f9df7fbb-229a-493a-8f6b-a676678afcae" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f9df7fbb-229a-493a-8f6b-a676678afcae" class="preview-modal"><div class="modal-header"><div id="x-f9df7fbb-229a-493a-8f6b-a676678afcae" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#develop-worker">#develop-worker</a></div><div class="preview-modal-title">How to develop a Worker in Go</div><div class="preview-modal-description">Develop an instance of a Worker by calling worker.New(), available via the go.temporal.io/sdk/worker package.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go-sdk">go-sdk</a> <a class="preview-modal-tag" href="/tags/code-sample">code-sample</a> <a class="preview-modal-tag" href="/tags/worker">worker</a></div></div>.
...
Workflow logic is constrained by [deterministic execution requirements](/workflows#deterministic-constraints) <span id="i-8be2fb8f-1a82-4a86-860d-eab3e0faa027" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-8be2fb8f-1a82-4a86-860d-eab3e0faa027" class="preview-modal"><div class="modal-header"><div id="x-8be2fb8f-1a82-4a86-860d-eab3e0faa027" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#deterministic-constraints">/workflows#deterministic-constraints</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
There is no explicit limit to the total number of parameters that an [Activity Definition](/activities#activity-definition) <span id="i-2fa4a3b0-a34a-41f4-83fd-ee4a6346aabb" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2fa4a3b0-a34a-41f4-83fd-ee4a6346aabb" class="preview-modal"><div class="modal-header"><div id="x-2fa4a3b0-a34a-41f4-83fd-ee4a6346aabb" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> may support.
...
Also, keep in mind that all Payload data is recorded in the [Workflow Execution Event History](/workflows#event-history) <span id="i-6e6802ef-41ce-4770-b18f-06c141bc6dd9" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-6e6802ef-41ce-4770-b18f-06c141bc6dd9" class="preview-modal"><div class="modal-header"><div id="x-6e6802ef-41ce-4770-b18f-06c141bc6dd9" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#event-history">/workflows#event-history</a></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and large Event Histories can affect Worker performance.
This is because the entire Event History could be transferred to a Worker Process with a [Workflow Task](/workers#workflow-task) <span id="i-908ced8c-5b13-4395-a6b7-88346dc52f1c" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-908ced8c-5b13-4395-a6b7-88346dc52f1c" class="preview-modal"><div class="modal-header"><div id="x-908ced8c-5b13-4395-a6b7-88346dc52f1c" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#workflow-task">/workers#workflow-task</a></div><div class="preview-modal-title">What is a Workflow Task?</div><div class="preview-modal-description">A Workflow Task is a Task that contains the context needed to make progress with a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
There is no explicit limit to the amount of data that can be returned by an Activity, but keep in mind that all return values are recorded in a [Workflow Execution Event History](/workflows#event-history) <span id="i-6bd39bc4-1210-46f9-be07-53e16e0dfcf1" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-6bd39bc4-1210-46f9-be07-53e16e0dfcf1" class="preview-modal"><div class="modal-header"><div id="x-6bd39bc4-1210-46f9-be07-53e16e0dfcf1" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#event-history">/workflows#event-history</a></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
Calls to spawn [Activity Executions](/activities#activity-execution) <span id="i-2f7f1ccd-7c59-4ac3-b16d-0d3d7f89c290" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2f7f1ccd-7c59-4ac3-b16d-0d3d7f89c290" class="preview-modal"><div class="modal-header"><div id="x-2f7f1ccd-7c59-4ac3-b16d-0d3d7f89c290" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-execution">/activities#activity-execution</a></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> are written within a [Workflow Definition](/workflows#workflow-definition) <span id="i-aeeabbc4-5128-4887-addd-8da151d0de7e" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-aeeabbc4-5128-4887-addd-8da151d0de7e" class="preview-modal"><div class="modal-header"><div id="x-aeeabbc4-5128-4887-addd-8da151d0de7e" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-definition">/workflows#workflow-definition</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
The call to spawn an Activity Execution generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command.
This results in the set of three [Activity Task](/workers#activity-task) <span id="i-c8a4dd4c-dd5c-44f4-bcb5-74c68e8c6c3e" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c8a4dd4c-dd5c-44f4-bcb5-74c68e8c6c3e" class="preview-modal"><div class="modal-header"><div id="x-c8a4dd4c-dd5c-44f4-bcb5-74c68e8c6c3e" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#activity-task">/workers#activity-task</a></div><div class="preview-modal-title">What is an Activity Task?</div><div class="preview-modal-description">An Activity Task contains the context needed to make an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> related Events ([ActivityTaskScheduled](/references/events/#activitytaskscheduled), [ActivityTaskStarted](/references/events/#activitytaskstarted), and ActivityTask[Closed])in your Workflow Execution Event History.
...
THIS FILE IS GENERATED from https://github.com/temporalio/documentation-samples-go/blob/main/yourapp/your_workflow_definition_dacx.go. -->
    ...
    To spawn an [Activity Execution](/activities#activity-execution) <span id="i-c3376433-1eb1-4b06-957f-7128ff705575" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c3376433-1eb1-4b06-957f-7128ff705575" class="preview-modal"><div class="modal-header"><div id="x-c3376433-1eb1-4b06-957f-7128ff705575" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-execution">/activities#activity-execution</a></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>, call [`ExecuteActivity()`](https://pkg.go.dev/go.temporal.io/workflow#ExecuteActivity) inside your Workflow Definition.
...
The only required value that needs to be set is either a [Schedule-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-e5166ca5-6fcd-4b6d-b0ba-8170640d7382" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e5166ca5-6fcd-4b6d-b0ba-8170640d7382" class="preview-modal"><div class="modal-header"><div id="x-e5166ca5-6fcd-4b6d-b0ba-8170640d7382" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#start-to-close-timeout">/activities#start-to-close-timeout</a></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div> or a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-f56ee4c2-9de5-486c-8cad-31ceb6444cff" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f56ee4c2-9de5-486c-8cad-31ceb6444cff" class="preview-modal"><div class="modal-header"><div id="x-f56ee4c2-9de5-486c-8cad-31ceb6444cff" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#start-to-close-timeout">/activities#start-to-close-timeout</a></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div>.
...
- [What is an Activity Id](/activities#activity-id) <span id="i-36009e09-2339-4169-9dbf-61e6d16fac8c" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-36009e09-2339-4169-9dbf-61e6d16fac8c" class="preview-modal"><div class="modal-header"><div id="x-36009e09-2339-4169-9dbf-61e6d16fac8c" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-id">/activities#activity-id</a></div><div class="preview-modal-title">What is an Activity Id?</div><div class="preview-modal-description">A unique identifier for an Activity Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>
...
To set a [Schedule-To-Start Timeout](/activities#schedule-to-start-timeout) <span id="i-a5b627c8-711d-4884-b6b7-2db163d02143" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-a5b627c8-711d-4884-b6b7-2db163d02143" class="preview-modal"><div class="modal-header"><div id="x-a5b627c8-711d-4884-b6b7-2db163d02143" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#schedule-to-start-timeout">/activities#schedule-to-start-timeout</a></div><div class="preview-modal-title">What is a Schedule-To-Start Timeout?</div><div class="preview-modal-description">A Schedule-To-Start Timeout is the maximum amount of time that is allowed from when an Activity Task is placed in a Task Queue to when a Worker picks it up from the Task Queue.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div>, create an instance of `ActivityOptions` from the `go.temporal.io/sdk/workflow` package, set the `ScheduleToStartTimeout` field, and then use the `WithActivityOptions()` API to apply the options to the instance of `workflow.Context`.
...
To set a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-37f45e64-a1b4-4fc8-93ed-1cfd47a795be" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-37f45e64-a1b4-4fc8-93ed-1cfd47a795be" class="preview-modal"><div class="modal-header"><div id="x-37f45e64-a1b4-4fc8-93ed-1cfd47a795be" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#start-to-close-timeout">/activities#start-to-close-timeout</a></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div>, create an instance of `ActivityOptions` from the `go.temporal.io/sdk/workflow` package, set the `StartToCloseTimeout` field, and then use the `WithActivityOptions()` API to apply the options to the instance of `workflow.Context`.
...
The call to spawn an [Activity Execution](/activities#activity-execution) <span id="i-7ed66c91-e818-4ac5-af59-377bec000596" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-7ed66c91-e818-4ac5-af59-377bec000596" class="preview-modal"><div class="modal-header"><div id="x-7ed66c91-e818-4ac5-af59-377bec000596" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-execution">/activities#activity-execution</a></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command and provides the Workflow with an Awaitable.
...
Set the maximum concurrent [Local Activity Executions](/activities#local-activity) <span id="i-0a44e0ab-f391-4715-9f8c-c489c1db35ff" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-0a44e0ab-f391-4715-9f8c-c489c1db35ff" class="preview-modal"><div class="modal-header"><div id="x-0a44e0ab-f391-4715-9f8c-c489c1db35ff" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#local-activity">/activities#local-activity</a></div><div class="preview-modal-title">What is a Local Activity?</div><div class="preview-modal-description">A Local Activity is an Activity Execution that executes in the same process as the Workflow Execution that spawns it.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> for the Worker.
...
- [How to develop an Activity Definition using the Go SDK](#activity-definition) <span id="i-3b5606de-64fc-4dbb-a1f2-04193f3b2770" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3b5606de-64fc-4dbb-a1f2-04193f3b2770" class="preview-modal"><div class="modal-header"><div id="x-3b5606de-64fc-4dbb-a1f2-04193f3b2770" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#activity-definition">#activity-definition</a></div><div class="preview-modal-title">How to develop an Activity Definition in Go</div><div class="preview-modal-description">In the Temporal Go SDK programming model, an Activity Definition is an exportable function or a `struct` method.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go-sdk">go-sdk</a> <a class="preview-modal-tag" href="/tags/code-sample">code-sample</a> <a class="preview-modal-tag" href="/tags/activity">activity</a></div></div>
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-fc84070a-ca97-4a55-badd-8b529d108fa5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-fc84070a-ca97-4a55-badd-8b529d108fa5" class="preview-modal"><div class="modal-header"><div id="x-fc84070a-ca97-4a55-badd-8b529d108fa5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/namespaces#">/namespaces#</a></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-4d36c420-3969-4391-8c0b-05e0cb4c0ee6" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4d36c420-3969-4391-8c0b-05e0cb4c0ee6" class="preview-modal"><div class="modal-header"><div id="x-4d36c420-3969-4391-8c0b-05e0cb4c0ee6" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
- A compatible mTLS CA certificate and mTLS private key that has been added to your Namespace.
  See [certificate requirements](/cloud/account-setup/certificates#certificate-requirements) <span id="i-59709e89-3a99-41b7-af93-4a81f73744b0" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-59709e89-3a99-41b7-af93-4a81f73744b0" class="preview-modal"><div class="modal-header"><div id="x-59709e89-3a99-41b7-af93-4a81f73744b0" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#certificate-requirements">/cloud/account-setup/certificates#certificate-requirements</a></div><div class="preview-modal-title">Requirements for CA certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates provided to Temporal for your Namespaces must meet certain requirements.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
- Your [Temporal Cloud Namespace Id](/cloud/account-setup/namespaces#temporal-cloud-namespace-id) <span id="i-98ccc700-08dd-4082-ae50-6209191b0561" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-98ccc700-08dd-4082-ae50-6209191b0561" class="preview-modal"><div class="modal-header"><div id="x-98ccc700-08dd-4082-ae50-6209191b0561" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-namespace-id">/cloud/account-setup/namespaces#temporal-cloud-namespace-id</a></div><div class="preview-modal-title">What is a Cloud Namespace Id?</div><div class="preview-modal-description">A Cloud Namespace Id is a globally unique identifier for a Namespace in Temporal Cloud.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>, which includes your [Temporal Cloud Namespace Name](/cloud/account-setup/namespaces#temporal-cloud-namespace-name) <span id="i-cbaf116e-d559-4332-b0ba-bf808c29ffe7" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-cbaf116e-d559-4332-b0ba-bf808c29ffe7" class="preview-modal"><div class="modal-header"><div id="x-cbaf116e-d559-4332-b0ba-bf808c29ffe7" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-namespace-name">/cloud/account-setup/namespaces#temporal-cloud-namespace-name</a></div><div class="preview-modal-title">What is a Cloud Namespace Name?</div><div class="preview-modal-description">A Cloud Namespace Name is a customer-supplied name for a Namespace in Temporal Cloud.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and the unique five- or six-digit [Temporal Cloud Account Id](/cloud/account-setup/namespaces#temporal-cloud-account-id) <span id="i-2961e6c1-981c-47f2-b165-af3485e0a872" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2961e6c1-981c-47f2-b165-af3485e0a872" class="preview-modal"><div class="modal-header"><div id="x-2961e6c1-981c-47f2-b165-af3485e0a872" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/namespaces#temporal-cloud-account-id">/cloud/account-setup/namespaces#temporal-cloud-account-id</a></div><div class="preview-modal-title">What is a Temporal Cloud Account Id?</div><div class="preview-modal-description">A Temporal Cloud Account Id is a unique identifier for a customer.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> that is appended to it.
  This information can be found in the URL of your Namespace; for example, `https://cloud.temporal.io/namespaces/yournamespace.a2fx6/`.
  Remember that the Namespace Id must include the Account Id: `yournamespace.a2fx6`.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-94bff7c5-fcec-42fc-8b13-018bb81277ea" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-94bff7c5-fcec-42fc-8b13-018bb81277ea" class="preview-modal"><div class="modal-header"><div id="x-94bff7c5-fcec-42fc-8b13-018bb81277ea" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
Per [Activity Definition](#activity-definition) <span id="i-0e41a588-bc59-4033-925b-e25d250f68ea" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-0e41a588-bc59-4033-925b-e25d250f68ea" class="preview-modal"><div class="modal-header"><div id="x-0e41a588-bc59-4033-925b-e25d250f68ea" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#activity-definition">#activity-definition</a></div><div class="preview-modal-title">How to develop an Activity Definition in Go</div><div class="preview-modal-description">In the Temporal Go SDK programming model, an Activity Definition is an exportable function or a `struct` method.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go-sdk">go-sdk</a> <a class="preview-modal-tag" href="/tags/code-sample">code-sample</a> <a class="preview-modal-tag" href="/tags/activity">activity</a></div></div> best practices, you might have an Activity struct that has multiple methods and fields.
...
See [How to customize a Workflow Type in Go](#customize-workflow-type) <span id="i-d6005c0e-2472-47eb-ac70-54420c39808e" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-d6005c0e-2472-47eb-ac70-54420c39808e" class="preview-modal"><div class="modal-header"><div id="x-d6005c0e-2472-47eb-ac70-54420c39808e" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#customize-workflow-type">#customize-workflow-type</a></div><div class="preview-modal-title">How to customize Workflow Type in Go</div><div class="preview-modal-description">To customize the Workflow Type set the Name parameter with RegisterOptions when registering your Workflow with a Worker.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go-sdk">go-sdk</a> <a class="preview-modal-tag" href="/tags/code-sample">code-sample</a> <a class="preview-modal-tag" href="/tags/worker">worker</a></div></div>
...
See [How to customize Activity Type in Go](#customize-activity-type) <span id="i-f48e1c1d-be2d-4037-8927-314a647dd615" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f48e1c1d-be2d-4037-8927-314a647dd615" class="preview-modal"><div class="modal-header"><div id="x-f48e1c1d-be2d-4037-8927-314a647dd615" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#customize-activity-type">#customize-activity-type</a></div><div class="preview-modal-title">How to customize Activity Type in Go</div><div class="preview-modal-description">To customize the Workflow Type set the Name parameter with RegisterOptions when registering your Workflow with a Worker.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go-sdk">go-sdk</a> <a class="preview-modal-tag" href="/tags/code-sample">code-sample</a> <a class="preview-modal-tag" href="/tags/worker">worker</a></div></div>.
...
In most SDKs, the only Workflow Option that must be set is the name of the [Task Queue](/workers#task-queue) <span id="i-04d54331-a2da-4df6-9e6d-d010f5efc7bd" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-04d54331-a2da-4df6-9e6d-d010f5efc7bd" class="preview-modal"><div class="modal-header"><div id="x-04d54331-a2da-4df6-9e6d-d010f5efc7bd" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#task-queue">/workers#task-queue</a></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
Although it is not required, we recommend providing your own [Workflow Id](/workflows#workflow-id) <span id="i-17272299-0d38-4049-ad57-27fcc1b0b52f" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-17272299-0d38-4049-ad57-27fcc1b0b52f" class="preview-modal"><div class="modal-header"><div id="x-17272299-0d38-4049-ad57-27fcc1b0b52f" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-id">/workflows#workflow-id</a></div><div class="preview-modal-title">What is a Workflow Id?</div><div class="preview-modal-description">A Workflow Id is a customizable, application-level identifier for a Workflow Execution that is unique to an Open Workflow Execution within a Namespace.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> that maps to a business process or business entity identifier, such as an order identifier or customer identifier.
...
Although it is not required, we recommend providing your own [Workflow Id](/workflows#workflow-id) <span id="i-f36afc68-09af-4741-b696-e5b363db0214" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f36afc68-09af-4741-b696-e5b363db0214" class="preview-modal"><div class="modal-header"><div id="x-f36afc68-09af-4741-b696-e5b363db0214" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-id">/workflows#workflow-id</a></div><div class="preview-modal-title">What is a Workflow Id?</div><div class="preview-modal-description">A Workflow Id is a customizable, application-level identifier for a Workflow Execution that is unique to an Open Workflow Execution within a Namespace.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> that maps to a business process or business entity identifier, such as an order identifier or customer identifier.
...
In the case of a [Temporal Cron Job](/workflows#temporal-cron-job) <span id="i-e5d26394-e8ac-4fd6-abab-18af6d2a70a5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e5d26394-e8ac-4fd6-abab-18af6d2a70a5" class="preview-modal"><div class="modal-header"><div id="x-e5d26394-e8ac-4fd6-abab-18af6d2a70a5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#temporal-cron-job">/workflows#temporal-cron-job</a></div><div class="preview-modal-title">What is a Temporal Cron Job?</div><div class="preview-modal-description">A Temporal Cron Job is the series of Workflow Executions that occur when a Cron Schedule is provided in the call to spawn a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>, you might need to get the result of the previous Workflow Run and use it in the current Workflow Run.
