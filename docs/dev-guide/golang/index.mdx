...
- [Choose a development Temporal Service](/dev-guide/go/project-setup#choose-dev-temporal-service): Discover which development Temporal Service you should choose
...
- [How to install Temporal CLI and run a development server](/dev-guide/typescript/foundations#run-a-development-server): How to install Temporal CLI and run a development Temporal Service.
...
- [How to connect a Temporal Client to a Temporal Service](/dev-guide/go/foundations#connect-to-a-dev-temporal-service): When connecting a Temporal Client to a Temporal Service, you must provide the address and port number of the Temporal Service.
