...
This section contains the following feature guidance for the Temporal Go SDK.
...
- [How to install Temporal CLI and run a development server](/dev-guide/typescript/foundations#run-a-development-server): How to install the Temporal CLI and run a development Temporal Service.
...
- [How to connect a Temporal Client to a Temporal Service](/develop/go/temporal-client#connect-to-development-service): When connecting a Temporal Client to a Temporal Service, you must provide the address and port number of the Temporal Service.
...
- [How to Heartbeat an Activity](/dev-guide/go/features#activity-heartbeats): An Activity Heartbeat is a ping from the Worker that is executing the Activity to the Temporal Service.
...
- [How to use Visibility APIs](/dev-guide/go/observability#visibility): The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Temporal Service.
