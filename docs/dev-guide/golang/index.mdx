...
- [Choose a development Temporal Service](/dev-guide/go/project-setup#choose-dev-cluster): Discover which development Temporal Service you should choose
...
- [How to connect a Temporal Client to a Temporal Service](/dev-guide/go/foundations#connect-to-a-dev-cluster): When connecting a Temporal Client to a Temporal Service, you must provide the address and port number of the Temporal Service.
