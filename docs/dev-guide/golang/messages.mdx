...
Before completing the Workflow or using [Continue-As-New](/dev-guide/go/features#continue-as-new), make sure to do an asynchronous drain on the Signal channel.
