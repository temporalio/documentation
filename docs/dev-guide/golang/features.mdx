...
You can create, update, deprecate or delete your [Namespaces](/namespaces) using either temporal CLI or SDK APIs.
...
On self-hosted Temporal Cluster, you can register and manage your Namespaces using temporal CLI (recommended) or programmatically using APIs. Note that these APIs and temporal CLI commands will not work with Temporal Cloud.
...
You can also [register Namespaces using the temporal CLI command-line tool](/cli/operator#register).
...
To update your Namespace using temporal CLI, use the [temporal operator namespace update](/cli/operator#update) command.
...
On self-hosted Temporal Cluster, you can manage your registered Namespaces using temporal CLI (recommended) or programmatically using APIs. Note that these APIs and temporal CLI commands will not work with Temporal Cloud.
