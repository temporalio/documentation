...
- [Run a development Temporal Service](/dev-guide/go/project-setup#install-cli)
...
## How to connect a Temporal Client to a Temporal Service {#connect-to-a-dev-temporal-service}
...
<div class="copycode-notice-container">
  <a href="https://github.com/temporalio/documentation/blob/main/sample-apps/go/yourapp/gateway/main_dacx.go">
...
<div class="copycode-notice-container">
  <a href="https://github.com/temporalio/documentation/blob/main/sample-apps/go/cloud/client/main_dacx.go">
    View the source code
  </a>{" "}
  in the context of the rest of the application code.
</div>
...
- `workflow.Context` This is a replacement for `context.Context`.
  See [Tracing](/dev-guide/go/observability#tracing-and-context-propogation) for more information about context propagation.
