...
`RegisterDelayedCallback` can also be used to send [Signals](/workflows#signal) <span id="i-246b232b-7e19-4e2b-ad3f-dae955b97d16" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-246b232b-7e19-4e2b-ad3f-dae955b97d16" class="preview-modal"><div class="modal-header"><div id="x-246b232b-7e19-4e2b-ad3f-dae955b97d16" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#signal">/workflows#signal</a></div><div class="preview-modal-title">What is a Signal?</div><div class="preview-modal-description">A Signal is an asynchronous request to a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/signals">signals</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
