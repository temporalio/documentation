...
- A [Temporal Client](/temporal#temporal-client) to communicate with a [Temporal Service](/clusters).
...
A [Temporal Client](/temporal#temporal-client) enables you to communicate with the [Temporal Service](/clusters).
