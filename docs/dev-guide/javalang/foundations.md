...
The Foundations section of the Temporal Developer's guide covers the minimum set of concepts and implementation details needed to build and run a [Temporal Application](/temporal#temporal-application) <span id="i-2b523154-dc09-42e5-a622-3978b39cbaf7" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2b523154-dc09-42e5-a622-3978b39cbaf7" class="preview-modal"><div class="modal-header"><div id="x-2b523154-dc09-42e5-a622-3978b39cbaf7" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>—that is, all the relevant steps to start a [Workflow Execution](#develop-workflows) that executes an [Activity](#develop-activities).

In this section you can find the following:

- [Run a development Cluster](#run-a-development-server) <span id="i-5e08f715-f7d6-494a-981e-5e6910b277d9" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-5e08f715-f7d6-494a-981e-5e6910b277d9" class="preview-modal"><div class="modal-header"><div id="x-5e08f715-f7d6-494a-981e-5e6910b277d9" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to install Temporal CLI and run a development server</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><span class="preview-modal-tag">cli-feature</span> <span class="preview-modal-tag">developer-guide-doc-type</span> <span class="preview-modal-tag">how-to-doc-type</span> <span class="preview-modal-tag">cli</span></div></div>
- [Install your SDK](#install-a-temporal-sdk) <span id="i-2cee5467-d3c6-4e5f-8fdc-1fbfd803e4ce" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2cee5467-d3c6-4e5f-8fdc-1fbfd803e4ce" class="preview-modal"><div class="modal-header"><div id="x-2cee5467-d3c6-4e5f-8fdc-1fbfd803e4ce" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to install a Temporal SDK</div><div class="preview-modal-description">A Temporal SDK provides a framework for Temporal Application development.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Connect to a dev Cluster](#connect-to-a-dev-cluster) <span id="i-11403662-3bda-4316-a6aa-41dde5e0300f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-11403662-3bda-4316-a6aa-41dde5e0300f" class="preview-modal"><div class="modal-header"><div id="x-11403662-3bda-4316-a6aa-41dde5e0300f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to create a Temporal Client in Java</div><div class="preview-modal-description">To initialize a Workflow Client, create an instance of a `WorkflowClient`, create a client-side `WorkflowStub`, and then call a Workflow method (annotated with the `@WorkflowMethod` annotation).</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>
- [Develop a Workflow](#develop-workflows) <span id="i-4a64aa7d-6299-432c-b344-f7180bd1a83d" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4a64aa7d-6299-432c-b344-f7180bd1a83d" class="preview-modal"><div class="modal-header"><div id="x-4a64aa7d-6299-432c-b344-f7180bd1a83d" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a Workflow Definition in Java</div><div class="preview-modal-description">In the Temporal Java SDK programming model, a Workflow is a class which implements a Workflow interface.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>
- [Develop an Activity](#develop-activities) <span id="i-ca1ca89e-d983-4c2e-bbb1-6fec970bc515" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-ca1ca89e-d983-4c2e-bbb1-6fec970bc515" class="preview-modal"><div class="modal-header"><div id="x-ca1ca89e-d983-4c2e-bbb1-6fec970bc515" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a basic Activity</div><div class="preview-modal-description">One of the primary things that Workflows do is orchestrate the execution of Activities.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Start an Activity Execution](#activity-execution) <span id="i-d3485a7c-ca8c-4f79-b9b3-ffe218f7df7c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d3485a7c-ca8c-4f79-b9b3-ffe218f7df7c" class="preview-modal"><div class="modal-header"><div id="x-d3485a7c-ca8c-4f79-b9b3-ffe218f7df7c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to start an Activity Execution</div><div class="preview-modal-description">Calls to spawn Activity Executions are written within a Workflow Definition.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Run a dev Worker](#run-a-dev-worker) <span id="i-256313e0-abbb-44ca-97ca-96b59c1fc466" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-256313e0-abbb-44ca-97ca-96b59c1fc466" class="preview-modal"><div class="modal-header"><div id="x-256313e0-abbb-44ca-97ca-96b59c1fc466" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a Worker Program in Java</div><div class="preview-modal-description">Use the `newWorker` method on an instance of a `WorkerFactory` to create a new Worker in Java.</div><div class="preview-modal-tags"><span class="preview-modal-tag">developer-guide</span> <span class="preview-modal-tag">java</span> <span class="preview-modal-tag">workers</span></div></div>
- [Start a Workflow Execution](#start-workflow-execution) <span id="i-c0c63668-6de4-476b-91c8-94c650afb7d1" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-c0c63668-6de4-476b-91c8-94c650afb7d1" class="preview-modal"><div class="modal-header"><div id="x-c0c63668-6de4-476b-91c8-94c650afb7d1" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to spawn a Workflow Execution in Java</div><div class="preview-modal-description">Use `WorkflowStub` to start a Workflow Execution from within a Client, and `ExternalWorkflowStub` to start a different Workflow Execution from within a Workflow.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>
...
A [Temporal SDK](/temporal#temporal-sdk) <span id="i-7e7036fb-a1b3-4065-ac1b-972a98e74670" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-7e7036fb-a1b3-4065-ac1b-972a98e74670" class="preview-modal"><div class="modal-header"><div id="x-7e7036fb-a1b3-4065-ac1b-972a98e74670" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal SDK?</div><div class="preview-modal-description">A Temporal SDK is a language-specific library that offers APIs to construct and use a Temporal Client to communicate with a Temporal Cluster, develop Workflow Definitions, and develop Worker Programs.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> provides a framework for [Temporal Application](/temporal#temporal-application) <span id="i-c166edce-69b3-4e3d-90b3-ef908a39395b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-c166edce-69b3-4e3d-90b3-ef908a39395b" class="preview-modal"><div class="modal-header"><div id="x-c166edce-69b3-4e3d-90b3-ef908a39395b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> development.

An SDK provides you with the following:

- A [Temporal Client](/temporal#temporal-client) <span id="i-1e61687b-bac8-4956-bc71-78accab551b2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1e61687b-bac8-4956-bc71-78accab551b2" class="preview-modal"><div class="modal-header"><div id="x-1e61687b-bac8-4956-bc71-78accab551b2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> to communicate with a [Temporal Cluster](/clusters#) <span id="i-88056503-f618-4907-bdd5-0c3eebdba8fb" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-88056503-f618-4907-bdd5-0c3eebdba8fb" class="preview-modal"><div class="modal-header"><div id="x-88056503-f618-4907-bdd5-0c3eebdba8fb" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to develop [Workflows](/workflows#) <span id="i-6dce3c6a-3f62-45cc-bc25-8685305ea5d4" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6dce3c6a-3f62-45cc-bc25-8685305ea5d4" class="preview-modal"><div class="modal-header"><div id="x-6dce3c6a-3f62-45cc-bc25-8685305ea5d4" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow?</div><div class="preview-modal-description">In day-to-day conversations, the term "Workflow" frequently denotes either a Workflow Type, a Workflow Definition, or a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to create and manage [Worker Processes](/workers#worker) <span id="i-b4577158-3eec-4378-841a-e5875c6a9385" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-b4577158-3eec-4378-841a-e5875c6a9385" class="preview-modal"><div class="modal-header"><div id="x-b4577158-3eec-4378-841a-e5875c6a9385" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker?</div><div class="preview-modal-description">In day-to-day conversations, the term Worker is used to denote both a Worker Program and a Worker Process. Temporal documentation aims to be explicit and differentiate between them.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to author [Activities](/activities#activity-definition) <span id="i-b3dadf9c-7076-493d-995c-7569f9877595" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-b3dadf9c-7076-493d-995c-7569f9877595" class="preview-modal"><div class="modal-header"><div id="x-b3dadf9c-7076-493d-995c-7569f9877595" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
A [Temporal Client](/temporal#temporal-client) <span id="i-51bded45-80d8-431c-aea6-fa6e2032de58" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-51bded45-80d8-431c-aea6-fa6e2032de58" class="preview-modal"><div class="modal-header"><div id="x-51bded45-80d8-431c-aea6-fa6e2032de58" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> enables you to communicate with the [Temporal Cluster](/clusters#) <span id="i-343bdc01-8cbf-4f01-9c61-6d28bf7c93b6" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-343bdc01-8cbf-4f01-9c61-6d28bf7c93b6" class="preview-modal"><div class="modal-header"><div id="x-343bdc01-8cbf-4f01-9c61-6d28bf7c93b6" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
- [How to spawn a Workflow Execution in Java](#start-workflow-execution) <span id="i-d7d4a9d5-afdb-4af1-be9a-86780412be1e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d7d4a9d5-afdb-4af1-be9a-86780412be1e" class="preview-modal"><div class="modal-header"><div id="x-d7d4a9d5-afdb-4af1-be9a-86780412be1e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to spawn a Workflow Execution in Java</div><div class="preview-modal-description">Use `WorkflowStub` to start a Workflow Execution from within a Client, and `ExternalWorkflowStub` to start a different Workflow Execution from within a Workflow.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>

## How to develop a Workflow Definition in Java {#develop-workflows}

Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a [Workflow Definition](/workflows#workflow-definition) <span id="i-2180b381-0837-4b30-a838-a2ab393e0cf2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2180b381-0837-4b30-a838-a2ab393e0cf2" class="preview-modal"><div class="modal-header"><div id="x-2180b381-0837-4b30-a838-a2ab393e0cf2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
- [Data Converter](/dataconversion#) <span id="i-6797246f-8f11-4f12-b644-8522f488b701" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6797246f-8f11-4f12-b644-8522f488b701" class="preview-modal"><div class="modal-header"><div id="x-6797246f-8f11-4f12-b644-8522f488b701" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>
...
Workflow logic is constrained by [deterministic execution requirements](/workflows#deterministic-constraints) <span id="i-9ca36d29-c4f5-4f2f-bee2-dc8d2a88c10e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-9ca36d29-c4f5-4f2f-bee2-dc8d2a88c10e" class="preview-modal"><div class="modal-header"><div id="x-9ca36d29-c4f5-4f2f-bee2-dc8d2a88c10e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
For the Workflow to be able to execute the Activity, we must define the [Activity Definition](/activities#activity-definition) <span id="i-dea4b07c-0323-424f-ae02-aea2f250e092" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-dea4b07c-0323-424f-ae02-aea2f250e092" class="preview-modal"><div class="modal-header"><div id="x-dea4b07c-0323-424f-ae02-aea2f250e092" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.

An [Activity Definition](/activities#) <span id="i-945d3dbe-60b5-47b7-8271-b524e65b5c27" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-945d3dbe-60b5-47b7-8271-b524e65b5c27" class="preview-modal"><div class="modal-header"><div id="x-945d3dbe-60b5-47b7-8271-b524e65b5c27" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity?</div><div class="preview-modal-description">In day-to-day conversation, the term "Activity" denotes an Activity Type, Activity Definition, or Activity Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is a combination of the Temporal Java SDK [Activity](https://www.javadoc.io/static/io.temporal/temporal-sdk/0.19.0/io/temporal/activity/Activity.html) Class implementing a specially annotated interface.
...
There is no explicit limit to the total number of parameters that an [Activity Definition](/activities#activity-definition) <span id="i-4effb6d4-b2f0-470f-a8f2-a480e88db47f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4effb6d4-b2f0-470f-a8f2-a480e88db47f" class="preview-modal"><div class="modal-header"><div id="x-4effb6d4-b2f0-470f-a8f2-a480e88db47f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> may support.
...
Also, keep in mind that all Payload data is recorded in the [Workflow Execution Event History](/workflows#event-history) <span id="i-120f494a-450b-4f87-9923-6dad5d9d2b47" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-120f494a-450b-4f87-9923-6dad5d9d2b47" class="preview-modal"><div class="modal-header"><div id="x-120f494a-450b-4f87-9923-6dad5d9d2b47" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and large Event Histories can affect Worker performance.
This is because the entire Event History could be transferred to a Worker Process with a [Workflow Task](/workers#workflow-task) <span id="i-190c5827-f5b2-4cc1-9364-b8b372d5449a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-190c5827-f5b2-4cc1-9364-b8b372d5449a" class="preview-modal"><div class="modal-header"><div id="x-190c5827-f5b2-4cc1-9364-b8b372d5449a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Task?</div><div class="preview-modal-description">A Workflow Task is a Task that contains the context needed to make progress with a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
There is no explicit limit to the amount of data that can be returned by an Activity, but keep in mind that all return values are recorded in a [Workflow Execution Event History](/workflows#event-history) <span id="i-46f43a1a-0ab9-467b-9c09-a88c52ca85ce" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-46f43a1a-0ab9-467b-9c09-a88c52ca85ce" class="preview-modal"><div class="modal-header"><div id="x-46f43a1a-0ab9-467b-9c09-a88c52ca85ce" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
- [Data Converter](/dataconversion#) <span id="i-64d31ef3-8ddf-4077-8424-53fc685ff652" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-64d31ef3-8ddf-4077-8424-53fc685ff652" class="preview-modal"><div class="modal-header"><div id="x-64d31ef3-8ddf-4077-8424-53fc685ff652" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>
- Java DataConverter reference: <https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/common/converter/DataConverter.html>
...
Calls to spawn [Activity Executions](/activities#activity-execution) <span id="i-49a76444-fe20-47dc-8438-766125bbff0c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-49a76444-fe20-47dc-8438-766125bbff0c" class="preview-modal"><div class="modal-header"><div id="x-49a76444-fe20-47dc-8438-766125bbff0c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> are written within a [Workflow Definition](/workflows#workflow-definition) <span id="i-ecd55be7-1c19-41e0-a48b-c9ffb4231dcb" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-ecd55be7-1c19-41e0-a48b-c9ffb4231dcb" class="preview-modal"><div class="modal-header"><div id="x-ecd55be7-1c19-41e0-a48b-c9ffb4231dcb" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
The call to spawn an Activity Execution generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command.
This results in the set of three [Activity Task](/workers#activity-task) <span id="i-b5436bad-1e10-417f-a35c-45a7c8b10678" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-b5436bad-1e10-417f-a35c-45a7c8b10678" class="preview-modal"><div class="modal-header"><div id="x-b5436bad-1e10-417f-a35c-45a7c8b10678" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Task?</div><div class="preview-modal-description">An Activity Task contains the context needed to make an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> related Events ([ActivityTaskScheduled](/references/events/#activitytaskscheduled), [ActivityTaskStarted](/references/events/#activitytaskstarted), and ActivityTask[Closed])in your Workflow Execution Event History.
...
- Activity options (either [`setStartToCloseTimeout`](/activities#start-to-close-timeout) <span id="i-36d4a56c-4198-4b7f-814f-25a63cabc6af" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-36d4a56c-4198-4b7f-814f-25a63cabc6af" class="preview-modal"><div class="modal-header"><div id="x-36d4a56c-4198-4b7f-814f-25a63cabc6af" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div> or [`ScheduleToCloseTimeout`](/activities#schedule-to-close-timeout) <span id="i-82085452-a261-4c1d-a824-57d7e2729097" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-82085452-a261-4c1d-a824-57d7e2729097" class="preview-modal"><div class="modal-header"><div id="x-82085452-a261-4c1d-a824-57d7e2729097" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Schedule-To-Close Timeout?</div><div class="preview-modal-description">A Schedule-To-Close Timeout is the maximum amount of time allowed for the overall Activity Execution, from when the first Activity Task is scheduled to when the last Activity Task, in the chain of Activity Tasks that make up the Activity Execution, reaches a Closed status.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div> are required) must be set for the Activity.
  For details, see [How to set Activity timeouts](/dev-guide/java/features#activity-timeouts) <span id="i-4439fa3a-064d-4eee-ab60-01bdfe241a60" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4439fa3a-064d-4eee-ab60-01bdfe241a60" class="preview-modal"><div class="modal-header"><div id="x-4439fa3a-064d-4eee-ab60-01bdfe241a60" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to set Activity timeouts</div><div class="preview-modal-description">Each Activity timeout controls the maximum duration of a different aspect of an Activity Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>.
- The Activity must be registered with a Worker.
  See [Worker Program](#run-a-dev-worker) <span id="i-4623f0e5-230b-4476-a7e8-e20e5a4e0ef1" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4623f0e5-230b-4476-a7e8-e20e5a4e0ef1" class="preview-modal"><div class="modal-header"><div id="x-4623f0e5-230b-4476-a7e8-e20e5a4e0ef1" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a Worker Program in Java</div><div class="preview-modal-description">Use the `newWorker` method on an instance of a `WorkerFactory` to create a new Worker in Java.</div><div class="preview-modal-tags"><span class="preview-modal-tag">developer-guide</span> <span class="preview-modal-tag">java</span> <span class="preview-modal-tag">workers</span></div></div>
...
For details on getting the results of an Activity Execution, see [Activity Execution Result](#activity-execution-result) <span id="i-87b9f896-3c98-40be-947f-7c56f013b722" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-87b9f896-3c98-40be-947f-7c56f013b722" class="preview-modal"><div class="modal-header"><div id="x-87b9f896-3c98-40be-947f-7c56f013b722" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to get the result of an Activity Execution</div><div class="preview-modal-description">To get the results of an asynchronously invoked Activity method, use the `Promise` `get` method to block until the Activity method result is available.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>.

### How to set the required Activity Timeouts {#required-timeout}

Activity Execution semantics rely on several parameters.
The only required value that needs to be set is either a [Schedule-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-4d749718-811a-4754-99ac-50fcb574d84a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4d749718-811a-4754-99ac-50fcb574d84a" class="preview-modal"><div class="modal-header"><div id="x-4d749718-811a-4754-99ac-50fcb574d84a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div> or a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-97f2e08a-7e02-4291-8a9a-721677603f7c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-97f2e08a-7e02-4291-8a9a-721677603f7c" class="preview-modal"><div class="modal-header"><div id="x-97f2e08a-7e02-4291-8a9a-721677603f7c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div>.
...
To set a [Schedule-To-Close Timeout](/activities#schedule-to-close-timeout) <span id="i-072fa657-16c7-4af0-97af-d3442c917bdf" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-072fa657-16c7-4af0-97af-d3442c917bdf" class="preview-modal"><div class="modal-header"><div id="x-072fa657-16c7-4af0-97af-d3442c917bdf" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Schedule-To-Close Timeout?</div><div class="preview-modal-description">A Schedule-To-Close Timeout is the maximum amount of time allowed for the overall Activity Execution, from when the first Activity Task is scheduled to when the last Activity Task, in the chain of Activity Tasks that make up the Activity Execution, reaches a Closed status.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div>, use [`ActivityOptions.newBuilder.setScheduleToCloseTimeout​`](https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/activity/ActivityOptions.Builder.html).
...
To set a [Schedule-To-Start Timeout](/activities#schedule-to-start-timeout) <span id="i-a6893101-11c9-440c-92e9-7a82c62ed6ec" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a6893101-11c9-440c-92e9-7a82c62ed6ec" class="preview-modal"><div class="modal-header"><div id="x-a6893101-11c9-440c-92e9-7a82c62ed6ec" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Schedule-To-Start Timeout?</div><div class="preview-modal-description">A Schedule-To-Start Timeout is the maximum amount of time that is allowed from when an Activity Task is placed in a Task Queue to when a Worker picks it up from the Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div>, use [`ActivityOptions.newBuilder.setScheduleToStartTimeout​`](https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/activity/ActivityOptions.Builder.html).
...
To set a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-a62e6677-92a2-483e-b339-cd58101330dc" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a62e6677-92a2-483e-b339-cd58101330dc" class="preview-modal"><div class="modal-header"><div id="x-a62e6677-92a2-483e-b339-cd58101330dc" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div>, use [`ActivityOptions.newBuilder.setStartToCloseTimeout​`](https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/activity/ActivityOptions.Builder.html).
...
The call to spawn an [Activity Execution](/activities#activity-execution) <span id="i-aeedd0ee-9b93-4829-b02e-32b14f6a5fdb" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-aeedd0ee-9b93-4829-b02e-32b14f6a5fdb" class="preview-modal"><div class="modal-header"><div id="x-aeedd0ee-9b93-4829-b02e-32b14f6a5fdb" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command and provides the Workflow with an Awaitable.
...
The [Worker Process](/workers#worker-process) <span id="i-34936aaa-7a3e-45cb-9414-ada170b1b02f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-34936aaa-7a3e-45cb-9414-ada170b1b02f" class="preview-modal"><div class="modal-header"><div id="x-34936aaa-7a3e-45cb-9414-ada170b1b02f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Process?</div><div class="preview-modal-description">A Worker Process is responsible for polling a Task Queue, dequeueing a Task, executing your code in response to a Task, and responding to the Temporal Server with the results.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is where Workflow Functions and Activity Functions are executed.

- Each [Worker Entity](/workers#worker-entity) <span id="i-d52f8974-ba02-434a-9754-fa3d35dcf36e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d52f8974-ba02-434a-9754-fa3d35dcf36e" class="preview-modal"><div class="modal-header"><div id="x-d52f8974-ba02-434a-9754-fa3d35dcf36e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> in the Worker Process must register the exact Workflow Types and Activity Types it may execute.
- Each Worker Entity must also associate itself with exactly one [Task Queue](/workers#task-queue) <span id="i-551969c3-806c-41ee-b2e3-acfef12795f9" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-551969c3-806c-41ee-b2e3-acfef12795f9" class="preview-modal"><div class="modal-header"><div id="x-551969c3-806c-41ee-b2e3-acfef12795f9" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- Each Worker Entity polling the same Task Queue must be registered with the same Workflow Types and Activity Types.

A [Worker Entity](/workers#worker-entity) <span id="i-4f89b5b9-4621-4b9f-87d2-96cf0adc5572" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4f89b5b9-4621-4b9f-87d2-96cf0adc5572" class="preview-modal"><div class="modal-header"><div id="x-4f89b5b9-4621-4b9f-87d2-96cf0adc5572" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is the component within a Worker Process that listens to a specific Task Queue.
...
See [`SignalwithStart`](/dev-guide/java/features#signal-with-start) <span id="i-3f2fe0cc-8980-4cba-8252-bfe1b07958ab" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3f2fe0cc-8980-4cba-8252-bfe1b07958ab" class="preview-modal"><div class="modal-header"><div id="x-3f2fe0cc-8980-4cba-8252-bfe1b07958ab" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to send a Signal-with-Start in Java</div><div class="preview-modal-description">To send Signals to a Workflow Execution whose status is unknown, use `SignalWithStart` with a `WorkflowStub` in the Client code.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div> to start a Workflow Execution to receive a Signal from within another Workflow.
...
- An untyped `WorkflowStub` does not use the Workflow interface, and is not type safe. It is more flexible because it has methods from the `WorkflowStub` interface, such as `start`, `signalWithStart`, `getResults` (sync and async), `query`, `signal`, `cancel` and `terminate`.
  ...
  For details, see [Temporal Client](#connect-to-a-dev-cluster) <span id="i-586f1469-354f-45cf-acd6-950dea680c9c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-586f1469-354f-45cf-acd6-950dea680c9c" class="preview-modal"><div class="modal-header"><div id="x-586f1469-354f-45cf-acd6-950dea680c9c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to create a Temporal Client in Java</div><div class="preview-modal-description">To initialize a Workflow Client, create an instance of a `WorkflowClient`, create a client-side `WorkflowStub`, and then call a Workflow method (annotated with the `@WorkflowMethod` annotation).</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div>.
...
See [Workflow Execution Result](#get-workflow-results) <span id="i-1b7f1a23-40cf-45b6-bf88-6ab499c06543" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1b7f1a23-40cf-45b6-bf88-6ab499c06543" class="preview-modal"><div class="modal-header"><div id="x-1b7f1a23-40cf-45b6-bf88-6ab499c06543" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to get the result of a Workflow Execution in Java</div><div class="preview-modal-description">A synchronous Workflow Execution blocks your client thread until the Workflow Execution completes (or fails) and get the results (or error in case of failure). An asynchronous Workflow Execution immediately returns a value to the caller.</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">developer-guide</span></div></div> for details on how to get the results of the Workflow Execution.
...
You can start a Workflow Execution on a regular schedule by using [`setCronSchedule`](/dev-guide/java/features#cron-schedule) <span id="i-ce3c057c-ba14-44e0-9cfa-d05a7178fb49" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-ce3c057c-ba14-44e0-9cfa-d05a7178fb49" class="preview-modal"><div class="modal-header"><div id="x-ce3c057c-ba14-44e0-9cfa-d05a7178fb49" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to set a Cron Schedule in Java</div><div class="preview-modal-description">Set the Cron Schedule with the `WorkflowStub` instance in the Client code using [`WorkflowOptions.Builder.setCronSchedule`</div><div class="preview-modal-tags"><span class="preview-modal-tag">java</span> <span class="preview-modal-tag">how-to</span> <span class="preview-modal-tag">developer-guide</span></div></div> Workflow option in the Client code.

### How to set a Workflow's Task Queue {#set-task-queue}

In most SDKs, the only Workflow Option that must be set is the name of the [Task Queue](/workers#task-queue) <span id="i-dd1177f0-3463-4ace-ac36-2fb90390e33e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-dd1177f0-3463-4ace-ac36-2fb90390e33e" class="preview-modal"><div class="modal-header"><div id="x-dd1177f0-3463-4ace-ac36-2fb90390e33e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
Although it is not required, we recommend providing your own [Workflow Id](/workflows#workflow-id) <span id="i-86ba9462-826f-4a49-9ea8-52319df38e96" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-86ba9462-826f-4a49-9ea8-52319df38e96" class="preview-modal"><div class="modal-header"><div id="x-86ba9462-826f-4a49-9ea8-52319df38e96" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Id?</div><div class="preview-modal-description">A Workflow Id is a customizable, application-level identifier for a Workflow Execution that is unique to an Open Workflow Execution within a Namespace.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> that maps to a business process or business entity identifier, such as an order identifier or customer identifier.
...
Set the [Workflow Execution Timeout](/workflows#workflow-execution-timeout) <span id="i-5811770e-f6bd-45dd-be2e-8735690380a5" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-5811770e-f6bd-45dd-be2e-8735690380a5" class="preview-modal"><div class="modal-header"><div id="x-5811770e-f6bd-45dd-be2e-8735690380a5" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Execution Timeout?</div><div class="preview-modal-description">A Workflow Execution Timeout is the maximum time that a Workflow Execution can be executing (have an Open status) including retries and any usage of Continue As New.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div> with the [`WorkflowStub`](https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/client/WorkflowStub.html) instance in the Client code using [`WorkflowOptions.Builder.setWorkflowExecutionTimeout`](https://www.javadoc.io/doc/io.temporal/temporal-sdk/latest/io/temporal/client/WorkflowOptions.Builder.html).
...
A [Temporal Cron Job](/workflows#temporal-cron-job) <span id="i-64048824-ced6-45d4-8d64-4b663988d6c3" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-64048824-ced6-45d4-8d64-4b663988d6c3" class="preview-modal"><div class="modal-header"><div id="x-64048824-ced6-45d4-8d64-4b663988d6c3" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cron Job?</div><div class="preview-modal-description">A Temporal Cron Job is the series of Workflow Executions that occur when a Cron Schedule is provided in the call to spawn a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is the series of Workflow Executions that occur when a Cron Schedule is provided in the call to spawn a Workflow Execution.
