...
- [How to create and manage Namespaces](/dev-guide/java/features#namespaces): You can create, update, deprecate or delete your Namespaces using either Temporal CLI or SDK APIs.
...
- [How to debug in a development environment](/dev-guide/java/debugging#debug-in-a-development-environment): In addition to the normal development tools of logging and a debugger, you can also see what’s happening in your Workflow by using the Web UI and Temporal CLI.
- [How to debug in a production environment](/dev-guide/java/debugging#debug-in-a-production-environment): Debug production Workflows using the Web UI, temporal CLI, Replays, Tracing, or Logging.
