...
<div class="tdiw"><div class="tditw"><p class="tdit">Select a Workflow Execution from the Workflows page</p></div><div class="tdiiw" height="1058"><img class="img_ev3q" src="/img/java/select-workflow-execution-in-ui.png" alt="Select a Workflow Execution from the Workflows page" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Copy Event History JSON object from the Web UI</p></div><div class="tdiiw" height="1178"><img class="img_ev3q" src="/img/java/copy-events-from-workflow-details-page.png" alt="Copy Event History JSON object from the Web UI" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Select the Workflow Reset Option</p></div><div class="tdiiw" height="1036"><img class="img_ev3q" src="/img/java/select-reset-web-ui.png" alt="Select the Workflow Reset Option" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Workflow Reset Points</p></div><div class="tdiiw" height="938"><img class="img_ev3q" src="/img/java/select-event-reset-web-ui.png" alt="Workflow Reset Points" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Workflow Terminated and Reset</p></div><div class="tdiiw" height="1250"><img class="img_ev3q" src="/img/java/event-terminated-and-reset.png" alt="Workflow Terminated and Reset" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">New Event History Success with Reset</p></div><div class="tdiiw" height="1716"><img class="img_ev3q" src="/img/java/new-event-history-success-with-reset.png" alt="New Event History Success with Reset" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Web UI view of a non-determinism error</p></div><div class="tdiiw" height="622"><img class="img_ev3q" src="/img/java/non-deterministic-workflow-task-failure-java.png" alt="Web UI view of a non-determinism error" /></div></div>
