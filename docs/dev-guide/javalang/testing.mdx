---
id: testing
title: Testing - Java SDK feature guide
sidebar_label: Testing
description: "Learn how to test Temporal workflows and activities with this comprehensive guide. Discover the different types of tests, including end-to-end, integration, and unit tests, and how to use mocking and skipping time to speed up testing. Explore the Temporal Java SDK's test framework, including TestWorkflowEnvironment and TestWorkflowRule, and learn how to set up and use them in your tests."
