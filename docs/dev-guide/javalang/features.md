...
On Temporal Cloud, use the [Temporal Cloud UI](/cloud/account-setup/namespaces#) or [tcld commands](https://docs.temporal.io/cloud/tcld/namespace/) to manage Namespaces.
