...
description: The Temporal TypeScript SDK is a programming model for building scalable and resilient distributed systems, requiring knowledge of JavaScript, TypeScript, and Node.js, with additional skills in object-oriented programming, testing, and distributed systems for full utilization.
