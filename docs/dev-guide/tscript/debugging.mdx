...
If you need to terminate old stale Workflows, you can do so with Temporal Web or Temporal CLI.
...
You can "rewind time" using the Temporal CLI, resetting Workflow History to some previous point in time. You can read the CLI docs on:
