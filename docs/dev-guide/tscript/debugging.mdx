...
Disable that by configuring webpack (in webpack.config.js) and it should work.
...
See [esbuild docs](https://esbuild.github.io/api/#keep-names) for more information: https://esbuild.github.io/api/#keep-names
</TabItem>
</Tabs>
