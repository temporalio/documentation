...
Versioning (known as "patching" in TypeScript) lets you update Workflow Definitions without causing [non-deterministic behavior](/workflows#non-deterministic-change) in current long-running Workflows.
