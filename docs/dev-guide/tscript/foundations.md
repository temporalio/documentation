...
The Foundations section of the Temporal Developer's guide covers the minimum set of concepts and implementation details needed to build and run a [Temporal Application](/temporal#temporal-application) <span id="i-c15af78d-3016-410b-8ed1-b7bdf4f03484" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c15af78d-3016-410b-8ed1-b7bdf4f03484" class="preview-modal"><div class="modal-header"><div id="x-c15af78d-3016-410b-8ed1-b7bdf4f03484" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-application">/temporal#temporal-application</a></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>—that is, all the relevant steps to start a [Workflow Execution](#develop-workflows) that executes an [Activity](#develop-activities).

In this section you can find the following:

- [Run a development Cluster](#run-a-development-server) <span id="i-1efbdb65-8492-46d5-afd2-ed29fc393da9" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-1efbdb65-8492-46d5-afd2-ed29fc393da9" class="preview-modal"><div class="modal-header"><div id="x-1efbdb65-8492-46d5-afd2-ed29fc393da9" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#run-a-development-server">#run-a-development-server</a></div><div class="preview-modal-title">How to install Temporal CLI and run a development server</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/cli-feature">cli-feature</a> <a class="preview-modal-tag" href="/tags/developer-guide-doc-type">developer-guide-doc-type</a> <a class="preview-modal-tag" href="/tags/how-to-doc-type">how-to-doc-type</a> <a class="preview-modal-tag" href="/tags/cli">cli</a></div></div>
- [Install your SDK](#install-a-temporal-sdk) <span id="i-43b18dcd-a2b4-4089-8218-e56f3bd066db" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-43b18dcd-a2b4-4089-8218-e56f3bd066db" class="preview-modal"><div class="modal-header"><div id="x-43b18dcd-a2b4-4089-8218-e56f3bd066db" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#install-a-temporal-sdk">#install-a-temporal-sdk</a></div><div class="preview-modal-title">How to install a Temporal SDK</div><div class="preview-modal-description">A Temporal SDK provides a framework for Temporal Application development.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Connect to a dev Cluster](#connect-to-a-dev-cluster) <span id="i-ee3a37ee-3341-4945-8cd5-d8b659c272ae" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-ee3a37ee-3341-4945-8cd5-d8b659c272ae" class="preview-modal"><div class="modal-header"><div id="x-ee3a37ee-3341-4945-8cd5-d8b659c272ae" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#connect-to-a-dev-cluster">#connect-to-a-dev-cluster</a></div><div class="preview-modal-title">How to connect a Temporal Client to a Temporal Cluster</div><div class="preview-modal-description">When connecting a Temporal Client to a Temporal Cluster, you must provide the address and port number of the Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Connect to Temporal Cloud](#connect-to-temporal-cloud) <span id="i-6038f26b-ba26-4822-a945-4fe2eb1b39dc" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-6038f26b-ba26-4822-a945-4fe2eb1b39dc" class="preview-modal"><div class="modal-header"><div id="x-6038f26b-ba26-4822-a945-4fe2eb1b39dc" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#connect-to-temporal-cloud">#connect-to-temporal-cloud</a></div><div class="preview-modal-title">How to connect to Temporal Cloud</div><div class="preview-modal-description">Use a compatible mTLS CA certificate and mTLS private key and your Cloud Namespace to connect to Temporal Cloud.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Develop a Workflow](#develop-workflows) <span id="i-9e4ae153-5d80-4ffc-975c-d147a7b0d1ba" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-9e4ae153-5d80-4ffc-975c-d147a7b0d1ba" class="preview-modal"><div class="modal-header"><div id="x-9e4ae153-5d80-4ffc-975c-d147a7b0d1ba" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#develop-workflows">#develop-workflows</a></div><div class="preview-modal-title">How to develop a basic Workflow</div><div class="preview-modal-description">Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a Workflow Definition.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Develop an Activity](#develop-activities) <span id="i-746711af-55f8-4f29-8393-ebf7d9cdbdcb" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-746711af-55f8-4f29-8393-ebf7d9cdbdcb" class="preview-modal"><div class="modal-header"><div id="x-746711af-55f8-4f29-8393-ebf7d9cdbdcb" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#develop-activities">#develop-activities</a></div><div class="preview-modal-title">How to develop a basic Activity</div><div class="preview-modal-description">One of the primary things that Workflows do is orchestrate the execution of Activities.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Start an Activity Execution](#activity-execution) <span id="i-30a8f46c-bc92-4ea7-801b-f5b2018974d5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-30a8f46c-bc92-4ea7-801b-f5b2018974d5" class="preview-modal"><div class="modal-header"><div id="x-30a8f46c-bc92-4ea7-801b-f5b2018974d5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#activity-execution">#activity-execution</a></div><div class="preview-modal-title">How to start an Activity Execution</div><div class="preview-modal-description">Calls to spawn Activity Executions are written within a Workflow Definition.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Run a dev Worker](#run-a-dev-worker) <span id="i-3769eec1-ff3f-457f-9c24-eb0c30a677c0" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3769eec1-ff3f-457f-9c24-eb0c30a677c0" class="preview-modal"><div class="modal-header"><div id="x-3769eec1-ff3f-457f-9c24-eb0c30a677c0" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#run-a-dev-worker">#run-a-dev-worker</a></div><div class="preview-modal-title">How to run Worker Processes</div><div class="preview-modal-description">The Worker Process is where Workflow Functions and Activity Functions are executed.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Run a Worker on Docker](#run-a-worker-on-docker) <span id="i-52948878-834b-44f6-934b-9809a9999ea2" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-52948878-834b-44f6-934b-9809a9999ea2" class="preview-modal"><div class="modal-header"><div id="x-52948878-834b-44f6-934b-9809a9999ea2" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#run-a-worker-on-docker">#run-a-worker-on-docker</a></div><div class="preview-modal-title">How to run a Worker on Docker in TypeScript</div><div class="preview-modal-description">Workers based on the TypeScript SDK can be deployed and run as Docker containers.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/developer-guide">developer-guide</a> <a class="preview-modal-tag" href="/tags/sdk">sdk</a> <a class="preview-modal-tag" href="/tags/typescript">typescript</a></div></div>
- [Run a Temporal Cloud Worker](#run-a-dev-worker) <span id="i-5ba3ec54-f8cf-4c16-84c2-d2b25e2b44a6" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-5ba3ec54-f8cf-4c16-84c2-d2b25e2b44a6" class="preview-modal"><div class="modal-header"><div id="x-5ba3ec54-f8cf-4c16-84c2-d2b25e2b44a6" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#run-a-dev-worker">#run-a-dev-worker</a></div><div class="preview-modal-title">How to run Worker Processes</div><div class="preview-modal-description">The Worker Process is where Workflow Functions and Activity Functions are executed.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
- [Start a Workflow Execution](#start-workflow-execution) <span id="i-2451dca8-7b65-4b2c-bfbb-593ca7eae1b8" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2451dca8-7b65-4b2c-bfbb-593ca7eae1b8" class="preview-modal"><div class="modal-header"><div id="x-2451dca8-7b65-4b2c-bfbb-593ca7eae1b8" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#start-workflow-execution">#start-workflow-execution</a></div><div class="preview-modal-title">How to start a Workflow Execution</div><div class="preview-modal-description">Workflow Execution semantics rely on several parameters—that is, to start a Workflow Execution you must supply a Task Queue that will be used for the Tasks (one that a Worker is polling), the Workflow Type, language-specific contextual data, and Workflow Function parameters.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
...
A [Temporal SDK](/temporal#temporal-sdk) <span id="i-2d008e64-0d70-4aed-a77e-ffcd7578e2f6" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2d008e64-0d70-4aed-a77e-ffcd7578e2f6" class="preview-modal"><div class="modal-header"><div id="x-2d008e64-0d70-4aed-a77e-ffcd7578e2f6" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-sdk">/temporal#temporal-sdk</a></div><div class="preview-modal-title">What is a Temporal SDK?</div><div class="preview-modal-description">A Temporal SDK is a language-specific library that offers APIs to construct and use a Temporal Client to communicate with a Temporal Cluster, develop Workflow Definitions, and develop Worker Programs.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> provides a framework for [Temporal Application](/temporal#temporal-application) <span id="i-67168fcb-1044-4d62-a06c-bddfa5cb4309" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-67168fcb-1044-4d62-a06c-bddfa5cb4309" class="preview-modal"><div class="modal-header"><div id="x-67168fcb-1044-4d62-a06c-bddfa5cb4309" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-application">/temporal#temporal-application</a></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> development.

An SDK provides you with the following:

- A [Temporal Client](/temporal#temporal-client) <span id="i-b4e1f2b7-2d5a-4faf-b0ab-57911ad6af33" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-b4e1f2b7-2d5a-4faf-b0ab-57911ad6af33" class="preview-modal"><div class="modal-header"><div id="x-b4e1f2b7-2d5a-4faf-b0ab-57911ad6af33" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-client">/temporal#temporal-client</a></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> to communicate with a [Temporal Cluster](/clusters#) <span id="i-c423beb4-aa20-4a32-b140-34ef53494c67" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c423beb4-aa20-4a32-b140-34ef53494c67" class="preview-modal"><div class="modal-header"><div id="x-c423beb4-aa20-4a32-b140-34ef53494c67" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#">/clusters#</a></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to develop [Workflows](/workflows#) <span id="i-6b728933-148b-4183-9131-9f3be8a2ac15" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-6b728933-148b-4183-9131-9f3be8a2ac15" class="preview-modal"><div class="modal-header"><div id="x-6b728933-148b-4183-9131-9f3be8a2ac15" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#">/workflows#</a></div><div class="preview-modal-title">What is a Workflow?</div><div class="preview-modal-description">In day-to-day conversations, the term "Workflow" frequently denotes either a Workflow Type, a Workflow Definition, or a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to create and manage [Worker Processes](/workers#worker) <span id="i-b5b2f4f0-3fbf-4a02-8d1a-9d6c59094e0a" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-b5b2f4f0-3fbf-4a02-8d1a-9d6c59094e0a" class="preview-modal"><div class="modal-header"><div id="x-b5b2f4f0-3fbf-4a02-8d1a-9d6c59094e0a" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker">/workers#worker</a></div><div class="preview-modal-title">What is a Worker?</div><div class="preview-modal-description">In day-to-day conversations, the term Worker is used to denote both a Worker Program and a Worker Process. Temporal documentation aims to be explicit and differentiate between them.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- APIs to author [Activities](/activities#activity-definition) <span id="i-73ad77af-bfe7-4344-9822-9e751e15a037" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-73ad77af-bfe7-4344-9822-9e751e15a037" class="preview-modal"><div class="modal-header"><div id="x-73ad77af-bfe7-4344-9822-9e751e15a037" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
A [Temporal Client](/temporal#temporal-client) <span id="i-76d59ecc-dd3b-4333-a8cb-6aa46122f5b2" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-76d59ecc-dd3b-4333-a8cb-6aa46122f5b2" class="preview-modal"><div class="modal-header"><div id="x-76d59ecc-dd3b-4333-a8cb-6aa46122f5b2" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/temporal#temporal-client">/temporal#temporal-client</a></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> enables you to communicate with the [Temporal Cluster](/clusters#) <span id="i-24a62e5b-74ee-463f-af4c-188c78e90125" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-24a62e5b-74ee-463f-af4c-188c78e90125" class="preview-modal"><div class="modal-header"><div id="x-24a62e5b-74ee-463f-af4c-188c78e90125" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#">/clusters#</a></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-1a9c0a08-42e3-4e9d-976a-6b5f99e8b0fe" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-1a9c0a08-42e3-4e9d-976a-6b5f99e8b0fe" class="preview-modal"><div class="modal-header"><div id="x-1a9c0a08-42e3-4e9d-976a-6b5f99e8b0fe" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/namespaces#">/namespaces#</a></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-d0dae21b-66ae-4b27-9fd7-a2be8c3881bd" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-d0dae21b-66ae-4b27-9fd7-a2be8c3881bd" class="preview-modal"><div class="modal-header"><div id="x-d0dae21b-66ae-4b27-9fd7-a2be8c3881bd" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a [Workflow Definition](/workflows#workflow-definition) <span id="i-105e59fc-332f-4760-8397-3ff4b641be21" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-105e59fc-332f-4760-8397-3ff4b641be21" class="preview-modal"><div class="modal-header"><div id="x-105e59fc-332f-4760-8397-3ff4b641be21" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-definition">/workflows#workflow-definition</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
Workflow logic is constrained by [deterministic execution requirements](/workflows#deterministic-constraints) <span id="i-5e67400a-47ad-45b5-9ce4-3e450f7293d9" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-5e67400a-47ad-45b5-9ce4-3e450f7293d9" class="preview-modal"><div class="modal-header"><div id="x-5e67400a-47ad-45b5-9ce4-3e450f7293d9" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#deterministic-constraints">/workflows#deterministic-constraints</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
This limitation also means that Workflow code cannot directly import the [Activity Definition](/activities#activity-definition) <span id="i-79a4cde2-2032-44a2-a33f-231daa9e62c0" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-79a4cde2-2032-44a2-a33f-231daa9e62c0" class="preview-modal"><div class="modal-header"><div id="x-79a4cde2-2032-44a2-a33f-231daa9e62c0" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
[Activity Types](/activities#activity-type) <span id="i-c29cb28e-535b-4451-98f8-b972c1e48ecb" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c29cb28e-535b-4451-98f8-b972c1e48ecb" class="preview-modal"><div class="modal-header"><div id="x-c29cb28e-535b-4451-98f8-b972c1e48ecb" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-type">/activities#activity-type</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> can be imported, so they can be invoked in a type-safe manner.
...
For the Workflow to be able to execute the Activity, we must define the [Activity Definition](/activities#activity-definition) <span id="i-b9a27697-78c0-43c3-b1af-fc5e27f7e13d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-b9a27697-78c0-43c3-b1af-fc5e27f7e13d" class="preview-modal"><div class="modal-header"><div id="x-b9a27697-78c0-43c3-b1af-fc5e27f7e13d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
There is no explicit limit to the total number of parameters that an [Activity Definition](/activities#activity-definition) <span id="i-3b256f1b-caba-41f4-85fe-bb6f721c9a06" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3b256f1b-caba-41f4-85fe-bb6f721c9a06" class="preview-modal"><div class="modal-header"><div id="x-3b256f1b-caba-41f4-85fe-bb6f721c9a06" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-definition">/activities#activity-definition</a></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> may support.
...
Also, keep in mind that all Payload data is recorded in the [Workflow Execution Event History](/workflows#event-history) <span id="i-0341cdff-d03a-4da6-8ed0-a94d7171e1de" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-0341cdff-d03a-4da6-8ed0-a94d7171e1de" class="preview-modal"><div class="modal-header"><div id="x-0341cdff-d03a-4da6-8ed0-a94d7171e1de" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#event-history">/workflows#event-history</a></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and large Event Histories can affect Worker performance.
This is because the entire Event History could be transferred to a Worker Process with a [Workflow Task](/workers#workflow-task) <span id="i-128ca400-9553-42a4-adb1-2cebaab08332" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-128ca400-9553-42a4-adb1-2cebaab08332" class="preview-modal"><div class="modal-header"><div id="x-128ca400-9553-42a4-adb1-2cebaab08332" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#workflow-task">/workers#workflow-task</a></div><div class="preview-modal-title">What is a Workflow Task?</div><div class="preview-modal-description">A Workflow Task is a Task that contains the context needed to make progress with a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
There is no explicit limit to the amount of data that can be returned by an Activity, but keep in mind that all return values are recorded in a [Workflow Execution Event History](/workflows#event-history) <span id="i-c68957c9-217b-4cdc-9d8e-c748898701aa" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c68957c9-217b-4cdc-9d8e-c748898701aa" class="preview-modal"><div class="modal-header"><div id="x-c68957c9-217b-4cdc-9d8e-c748898701aa" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#event-history">/workflows#event-history</a></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
...
Calls to spawn [Activity Executions](/activities#activity-execution) <span id="i-a03c9cda-f43f-47c7-b932-4579033b4672" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-a03c9cda-f43f-47c7-b932-4579033b4672" class="preview-modal"><div class="modal-header"><div id="x-a03c9cda-f43f-47c7-b932-4579033b4672" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-execution">/activities#activity-execution</a></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> are written within a [Workflow Definition](/workflows#workflow-definition) <span id="i-5793698a-21ef-43ce-8567-a3fee32998fd" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-5793698a-21ef-43ce-8567-a3fee32998fd" class="preview-modal"><div class="modal-header"><div id="x-5793698a-21ef-43ce-8567-a3fee32998fd" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#workflow-definition">/workflows#workflow-definition</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
The call to spawn an Activity Execution generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command.
This results in the set of three [Activity Task](/workers#activity-task) <span id="i-a66224a9-bd53-4c21-a11f-35f2c8668749" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-a66224a9-bd53-4c21-a11f-35f2c8668749" class="preview-modal"><div class="modal-header"><div id="x-a66224a9-bd53-4c21-a11f-35f2c8668749" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#activity-task">/workers#activity-task</a></div><div class="preview-modal-title">What is an Activity Task?</div><div class="preview-modal-description">An Activity Task contains the context needed to make an Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> related Events ([ActivityTaskScheduled](/references/events/#activitytaskscheduled), [ActivityTaskStarted](/references/events/#activitytaskstarted), and ActivityTask[Closed])in your Workflow Execution Event History.
...
The only required value that needs to be set is either a [Schedule-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-488cdf64-8027-47e2-a6e9-400369dd1e23" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-488cdf64-8027-47e2-a6e9-400369dd1e23" class="preview-modal"><div class="modal-header"><div id="x-488cdf64-8027-47e2-a6e9-400369dd1e23" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#start-to-close-timeout">/activities#start-to-close-timeout</a></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div> or a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-3bbb613a-484d-4ae9-af4c-47493d3ae626" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3bbb613a-484d-4ae9-af4c-47493d3ae626" class="preview-modal"><div class="modal-header"><div id="x-3bbb613a-484d-4ae9-af4c-47493d3ae626" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#start-to-close-timeout">/activities#start-to-close-timeout</a></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/timeouts">timeouts</a></div></div>.
These values are set in the Activity Options.

### How to get the results of an Activity Execution {#get-activity-results}

The call to spawn an [Activity Execution](/activities#activity-execution) <span id="i-2030771f-b046-42a4-b072-cd5746dfc50f" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-2030771f-b046-42a4-b072-cd5746dfc50f" class="preview-modal"><div class="modal-header"><div id="x-2030771f-b046-42a4-b072-cd5746dfc50f" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/activities#activity-execution">/activities#activity-execution</a></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command and provides the Workflow with an Awaitable.
...
The [Worker Process](/workers#worker-process) <span id="i-4fb03375-d323-43f9-82c1-17a9d840eef3" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4fb03375-d323-43f9-82c1-17a9d840eef3" class="preview-modal"><div class="modal-header"><div id="x-4fb03375-d323-43f9-82c1-17a9d840eef3" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-process">/workers#worker-process</a></div><div class="preview-modal-title">What is a Worker Process?</div><div class="preview-modal-description">A Worker Process is responsible for polling a Task Queue, dequeueing a Task, executing your code in response to a Task, and responding to the Temporal Server with the results.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> is where Workflow Functions and Activity Functions are executed.

- Each [Worker Entity](/workers#worker-entity) <span id="i-fb6134cb-d08b-4e1b-9e81-6622f05c1f09" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-fb6134cb-d08b-4e1b-9e81-6622f05c1f09" class="preview-modal"><div class="modal-header"><div id="x-fb6134cb-d08b-4e1b-9e81-6622f05c1f09" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-entity">/workers#worker-entity</a></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> in the Worker Process must register the exact Workflow Types and Activity Types it may execute.
- Each Worker Entity must also associate itself with exactly one [Task Queue](/workers#task-queue) <span id="i-7e99b32f-5b14-4bf6-865d-5e0a44753bfe" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-7e99b32f-5b14-4bf6-865d-5e0a44753bfe" class="preview-modal"><div class="modal-header"><div id="x-7e99b32f-5b14-4bf6-865d-5e0a44753bfe" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#task-queue">/workers#task-queue</a></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- Each Worker Entity polling the same Task Queue must be registered with the same Workflow Types and Activity Types.

A [Worker Entity](/workers#worker-entity) <span id="i-f67527d1-0374-44ec-a17f-d0759be740da" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f67527d1-0374-44ec-a17f-d0759be740da" class="preview-modal"><div class="modal-header"><div id="x-f67527d1-0374-44ec-a17f-d0759be740da" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-entity">/workers#worker-entity</a></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> is the component within a Worker Process that listens to a specific Task Queue.
...
The [Worker Process](/workers#worker-process) <span id="i-abee8942-63a2-4c95-b81b-a784c97a6e38" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-abee8942-63a2-4c95-b81b-a784c97a6e38" class="preview-modal"><div class="modal-header"><div id="x-abee8942-63a2-4c95-b81b-a784c97a6e38" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-process">/workers#worker-process</a></div><div class="preview-modal-title">What is a Worker Process?</div><div class="preview-modal-description">A Worker Process is responsible for polling a Task Queue, dequeueing a Task, executing your code in response to a Task, and responding to the Temporal Server with the results.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> is where Workflow Functions and Activity Functions are executed.

- Each [Worker Entity](/workers#worker-entity) <span id="i-cb9d2cbb-1ad7-4291-9a22-c8880da0dafc" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-cb9d2cbb-1ad7-4291-9a22-c8880da0dafc" class="preview-modal"><div class="modal-header"><div id="x-cb9d2cbb-1ad7-4291-9a22-c8880da0dafc" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-entity">/workers#worker-entity</a></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> in the Worker Process must register the exact Workflow Types and Activity Types it may execute.
- Each Worker Entity must also associate itself with exactly one [Task Queue](/workers#task-queue) <span id="i-cf84d2a7-87ae-437c-bd52-93d9563ff79d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-cf84d2a7-87ae-437c-bd52-93d9563ff79d" class="preview-modal"><div class="modal-header"><div id="x-cf84d2a7-87ae-437c-bd52-93d9563ff79d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#task-queue">/workers#task-queue</a></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
- Each Worker Entity polling the same Task Queue must be registered with the same Workflow Types and Activity Types.

A [Worker Entity](/workers#worker-entity) <span id="i-1adaaf42-1d5d-475f-b949-c2c02b8a2805" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-1adaaf42-1d5d-475f-b949-c2c02b8a2805" class="preview-modal"><div class="modal-header"><div id="x-1adaaf42-1d5d-475f-b949-c2c02b8a2805" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#worker-entity">/workers#worker-entity</a></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> is the component within a Worker Process that listens to a specific Task Queue.
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-578ba541-3a0c-4a81-9b07-49640bf17d15" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-578ba541-3a0c-4a81-9b07-49640bf17d15" class="preview-modal"><div class="modal-header"><div id="x-578ba541-3a0c-4a81-9b07-49640bf17d15" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/namespaces#">/namespaces#</a></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-712f9a49-2dcd-48ab-a7a6-33c2efb486a5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-712f9a49-2dcd-48ab-a7a6-33c2efb486a5" class="preview-modal"><div class="modal-header"><div id="x-712f9a49-2dcd-48ab-a7a6-33c2efb486a5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/cloud/account-setup/certificates#">/cloud/account-setup/certificates#</a></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/introduction">introduction</a> <a class="preview-modal-tag" href="/tags/temporal-cloud">temporal-cloud</a> <a class="preview-modal-tag" href="/tags/certificates">certificates</a></div></div>.
...
Workflow Execution run in a separate V8 isolate context in order to provide a [deterministic runtime](/workflows#deterministic-constraints) <span id="i-61396811-e963-4a7c-a199-96bb8f3ea015" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-61396811-e963-4a7c-a199-96bb8f3ea015" class="preview-modal"><div class="modal-header"><div id="x-61396811-e963-4a7c-a199-96bb8f3ea015" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workflows#deterministic-constraints">/workflows#deterministic-constraints</a></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.

### How to set a Workflow's Task Queue {#set-task-queue}

In most SDKs, the only Workflow Option that must be set is the name of the [Task Queue](/workers#task-queue) <span id="i-91638934-2aee-4198-9966-da3385ac4510" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-91638934-2aee-4198-9966-da3385ac4510" class="preview-modal"><div class="modal-header"><div id="x-91638934-2aee-4198-9966-da3385ac4510" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/workers#task-queue">/workers#task-queue</a></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
