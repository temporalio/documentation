...
The Foundations section of the Temporal Developer's guide covers the minimum set of concepts and implementation details needed to build and run a [Temporal Application](/temporal#temporal-application) <span id="i-bc741ff0-01f1-4b3d-b043-f6dde459d04e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-bc741ff0-01f1-4b3d-b043-f6dde459d04e" class="preview-modal"><div class="modal-header"><div id="x-bc741ff0-01f1-4b3d-b043-f6dde459d04e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>—that is, all the relevant steps to start a [Workflow Execution](#develop-workflows) that executes an [Activity](#develop-activities).

In this section you can find the following:

- [Run a development Cluster](#run-a-development-server) <span id="i-cd5e5dcf-00ef-40c8-805a-04db92623d50" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-cd5e5dcf-00ef-40c8-805a-04db92623d50" class="preview-modal"><div class="modal-header"><div id="x-cd5e5dcf-00ef-40c8-805a-04db92623d50" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to install Temporal CLI and run a development server</div><div class="preview-modal-description">undefined</div><div class="preview-modal-tags"><span class="preview-modal-tag">cli-feature</span> <span class="preview-modal-tag">developer-guide-doc-type</span> <span class="preview-modal-tag">how-to-doc-type</span> <span class="preview-modal-tag">cli</span></div></div>
- [Install your SDK](#install-a-temporal-sdk) <span id="i-a199a46f-7ef9-41c5-934c-95f094117032" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a199a46f-7ef9-41c5-934c-95f094117032" class="preview-modal"><div class="modal-header"><div id="x-a199a46f-7ef9-41c5-934c-95f094117032" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to install a Temporal SDK</div><div class="preview-modal-description">A Temporal SDK provides a framework for Temporal Application development.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Connect to a dev Cluster](#connect-to-a-dev-cluster) <span id="i-19f5b391-57f5-4e94-ab8c-be36e938e139" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-19f5b391-57f5-4e94-ab8c-be36e938e139" class="preview-modal"><div class="modal-header"><div id="x-19f5b391-57f5-4e94-ab8c-be36e938e139" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to connect a Temporal Client to a Temporal Cluster</div><div class="preview-modal-description">When connecting a Temporal Client to a Temporal Cluster, you must provide the address and port number of the Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Connect to Temporal Cloud](#connect-to-temporal-cloud) <span id="i-c4909e05-339e-4062-b2ca-42d34655cd72" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-c4909e05-339e-4062-b2ca-42d34655cd72" class="preview-modal"><div class="modal-header"><div id="x-c4909e05-339e-4062-b2ca-42d34655cd72" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to connect to Temporal Cloud</div><div class="preview-modal-description">Use a compatible mTLS CA certificate and mTLS private key and your Cloud Namespace to connect to Temporal Cloud.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Develop a Workflow](#develop-workflows) <span id="i-7845bc43-f2ae-487b-b050-d8bec5e86b94" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-7845bc43-f2ae-487b-b050-d8bec5e86b94" class="preview-modal"><div class="modal-header"><div id="x-7845bc43-f2ae-487b-b050-d8bec5e86b94" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a basic Workflow</div><div class="preview-modal-description">Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a Workflow Definition.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Develop an Activity](#develop-activities) <span id="i-8534a862-800e-4171-9cf7-6c898ed04cab" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8534a862-800e-4171-9cf7-6c898ed04cab" class="preview-modal"><div class="modal-header"><div id="x-8534a862-800e-4171-9cf7-6c898ed04cab" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to develop a basic Activity</div><div class="preview-modal-description">One of the primary things that Workflows do is orchestrate the execution of Activities.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Start an Activity Execution](#activity-execution) <span id="i-37423b03-ff19-49ff-98c0-c9959691a634" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-37423b03-ff19-49ff-98c0-c9959691a634" class="preview-modal"><div class="modal-header"><div id="x-37423b03-ff19-49ff-98c0-c9959691a634" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to start an Activity Execution</div><div class="preview-modal-description">Calls to spawn Activity Executions are written within a Workflow Definition.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Run a dev Worker](#run-a-dev-worker) <span id="i-9cad249b-2151-4d6a-a529-de7700e258ef" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-9cad249b-2151-4d6a-a529-de7700e258ef" class="preview-modal"><div class="modal-header"><div id="x-9cad249b-2151-4d6a-a529-de7700e258ef" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to run Worker Processes</div><div class="preview-modal-description">The Worker Process is where Workflow Functions and Activity Functions are executed.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Run a Worker on Docker](#run-a-worker-on-docker) <span id="i-38e16e8c-2ae9-4e41-8b8e-0d481f958b0a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-38e16e8c-2ae9-4e41-8b8e-0d481f958b0a" class="preview-modal"><div class="modal-header"><div id="x-38e16e8c-2ae9-4e41-8b8e-0d481f958b0a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to run a Worker on Docker in TypeScript</div><div class="preview-modal-description">Workers based on the TypeScript SDK can be deployed and run as Docker containers.</div><div class="preview-modal-tags"><span class="preview-modal-tag">developer-guide</span> <span class="preview-modal-tag">sdk</span> <span class="preview-modal-tag">typescript</span></div></div>
- [Run a Temporal Cloud Worker](#run-a-dev-worker) <span id="i-9ac16142-02a9-45e1-8240-f20d6241e745" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-9ac16142-02a9-45e1-8240-f20d6241e745" class="preview-modal"><div class="modal-header"><div id="x-9ac16142-02a9-45e1-8240-f20d6241e745" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to run Worker Processes</div><div class="preview-modal-description">The Worker Process is where Workflow Functions and Activity Functions are executed.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Start a Workflow Execution](#start-workflow-execution) <span id="i-10488708-0d58-4f2d-8ab4-c42c11aad251" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-10488708-0d58-4f2d-8ab4-c42c11aad251" class="preview-modal"><div class="modal-header"><div id="x-10488708-0d58-4f2d-8ab4-c42c11aad251" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to start a Workflow Execution</div><div class="preview-modal-description">Workflow Execution semantics rely on several parameters—that is, to start a Workflow Execution you must supply a Task Queue that will be used for the Tasks (one that a Worker is polling), the Workflow Type, language-specific contextual data, and Workflow Function parameters.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
...
A [Temporal SDK](/temporal#temporal-sdk) <span id="i-3d716303-a531-4cbe-b641-0e259ecf7ea7" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3d716303-a531-4cbe-b641-0e259ecf7ea7" class="preview-modal"><div class="modal-header"><div id="x-3d716303-a531-4cbe-b641-0e259ecf7ea7" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal SDK?</div><div class="preview-modal-description">A Temporal SDK is a language-specific library that offers APIs to construct and use a Temporal Client to communicate with a Temporal Cluster, develop Workflow Definitions, and develop Worker Programs.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> provides a framework for [Temporal Application](/temporal#temporal-application) <span id="i-d0ffb4bc-2273-43aa-8cd3-0394262f846e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d0ffb4bc-2273-43aa-8cd3-0394262f846e" class="preview-modal"><div class="modal-header"><div id="x-d0ffb4bc-2273-43aa-8cd3-0394262f846e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Application?</div><div class="preview-modal-description">A Temporal Application is a set of Workflow Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> development.

An SDK provides you with the following:

- A [Temporal Client](/temporal#temporal-client) <span id="i-d52bf2c9-9eec-49ea-b007-7a0e6ced513e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d52bf2c9-9eec-49ea-b007-7a0e6ced513e" class="preview-modal"><div class="modal-header"><div id="x-d52bf2c9-9eec-49ea-b007-7a0e6ced513e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> to communicate with a [Temporal Cluster](/clusters#) <span id="i-96d5a12a-e605-4625-8ad2-f8377e95eb65" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-96d5a12a-e605-4625-8ad2-f8377e95eb65" class="preview-modal"><div class="modal-header"><div id="x-96d5a12a-e605-4625-8ad2-f8377e95eb65" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to develop [Workflows](/workflows#) <span id="i-1bedf428-386c-4a40-b371-4b2569e6fe86" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1bedf428-386c-4a40-b371-4b2569e6fe86" class="preview-modal"><div class="modal-header"><div id="x-1bedf428-386c-4a40-b371-4b2569e6fe86" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow?</div><div class="preview-modal-description">In day-to-day conversations, the term "Workflow" frequently denotes either a Workflow Type, a Workflow Definition, or a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to create and manage [Worker Processes](/workers#worker) <span id="i-080aadc8-cde2-42ed-aad7-6e9473e4cf58" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-080aadc8-cde2-42ed-aad7-6e9473e4cf58" class="preview-modal"><div class="modal-header"><div id="x-080aadc8-cde2-42ed-aad7-6e9473e4cf58" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker?</div><div class="preview-modal-description">In day-to-day conversations, the term Worker is used to denote both a Worker Program and a Worker Process. Temporal documentation aims to be explicit and differentiate between them.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- APIs to author [Activities](/activities#activity-definition) <span id="i-cb4c2f3c-ccc5-4203-a612-5f632c6967d6" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-cb4c2f3c-ccc5-4203-a612-5f632c6967d6" class="preview-modal"><div class="modal-header"><div id="x-cb4c2f3c-ccc5-4203-a612-5f632c6967d6" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
A [Temporal Client](/temporal#temporal-client) <span id="i-3b1f890c-5f83-4a8e-a042-7a014fe9c77b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3b1f890c-5f83-4a8e-a042-7a014fe9c77b" class="preview-modal"><div class="modal-header"><div id="x-3b1f890c-5f83-4a8e-a042-7a014fe9c77b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Client?</div><div class="preview-modal-description">A Temporal Client, provided by a Temporal SDK, provides a set of APIs to communicate with a Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> enables you to communicate with the [Temporal Cluster](/clusters#) <span id="i-e87b3ab8-a976-41d1-ae0b-363eff73099d" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-e87b3ab8-a976-41d1-ae0b-363eff73099d" class="preview-modal"><div class="modal-header"><div id="x-e87b3ab8-a976-41d1-ae0b-363eff73099d" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-8b48a750-4195-4fa6-87f8-7fa929d63fdc" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8b48a750-4195-4fa6-87f8-7fa929d63fdc" class="preview-modal"><div class="modal-header"><div id="x-8b48a750-4195-4fa6-87f8-7fa929d63fdc" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-2ed5acee-ba10-430c-bdba-766766e15310" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2ed5acee-ba10-430c-bdba-766766e15310" class="preview-modal"><div class="modal-header"><div id="x-2ed5acee-ba10-430c-bdba-766766e15310" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div>.
...
Workflows are the fundamental unit of a Temporal Application, and it all starts with the development of a [Workflow Definition](/workflows#workflow-definition) <span id="i-fd414e64-0f3e-4a93-9e95-7319d7203bb2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-fd414e64-0f3e-4a93-9e95-7319d7203bb2" class="preview-modal"><div class="modal-header"><div id="x-fd414e64-0f3e-4a93-9e95-7319d7203bb2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
Workflow logic is constrained by [deterministic execution requirements](/workflows#deterministic-constraints) <span id="i-21b321a5-2ad1-4dba-a727-98f51b98831b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-21b321a5-2ad1-4dba-a727-98f51b98831b" class="preview-modal"><div class="modal-header"><div id="x-21b321a5-2ad1-4dba-a727-98f51b98831b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
This limitation also means that Workflow code cannot directly import the [Activity Definition](/activities#activity-definition) <span id="i-329165bc-4c31-4c0b-a126-08fc1d542e9c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-329165bc-4c31-4c0b-a126-08fc1d542e9c" class="preview-modal"><div class="modal-header"><div id="x-329165bc-4c31-4c0b-a126-08fc1d542e9c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
[Activity Types](/activities#activity-type) <span id="i-1d96244a-dc3a-455c-99b9-4b0834c54f34" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1d96244a-dc3a-455c-99b9-4b0834c54f34" class="preview-modal"><div class="modal-header"><div id="x-1d96244a-dc3a-455c-99b9-4b0834c54f34" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> can be imported, so they can be invoked in a type-safe manner.
...
For the Workflow to be able to execute the Activity, we must define the [Activity Definition](/activities#activity-definition) <span id="i-9338a4db-498f-491c-89c7-d7670fd0d8be" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-9338a4db-498f-491c-89c7-d7670fd0d8be" class="preview-modal"><div class="modal-header"><div id="x-9338a4db-498f-491c-89c7-d7670fd0d8be" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
There is no explicit limit to the total number of parameters that an [Activity Definition](/activities#activity-definition) <span id="i-bff51741-dbf2-49ec-b64f-9a53c820f5ae" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-bff51741-dbf2-49ec-b64f-9a53c820f5ae" class="preview-modal"><div class="modal-header"><div id="x-bff51741-dbf2-49ec-b64f-9a53c820f5ae" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Definition?</div><div class="preview-modal-description">An Activity Definition is the code that defines the constraints of an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> may support.
...
Also, keep in mind that all Payload data is recorded in the [Workflow Execution Event History](/workflows#event-history) <span id="i-2d3dcb58-8a46-4460-b790-d2e8f8079224" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2d3dcb58-8a46-4460-b790-d2e8f8079224" class="preview-modal"><div class="modal-header"><div id="x-2d3dcb58-8a46-4460-b790-d2e8f8079224" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and large Event Histories can affect Worker performance.
This is because the entire Event History could be transferred to a Worker Process with a [Workflow Task](/workers#workflow-task) <span id="i-5e19cf6a-2011-4f31-be6d-3e4ce84c8b9b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-5e19cf6a-2011-4f31-be6d-3e4ce84c8b9b" class="preview-modal"><div class="modal-header"><div id="x-5e19cf6a-2011-4f31-be6d-3e4ce84c8b9b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Task?</div><div class="preview-modal-description">A Workflow Task is a Task that contains the context needed to make progress with a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
There is no explicit limit to the amount of data that can be returned by an Activity, but keep in mind that all return values are recorded in a [Workflow Execution Event History](/workflows#event-history) <span id="i-1bd175f4-a90d-4385-b23d-bbc2aa2b7ecf" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1bd175f4-a90d-4385-b23d-bbc2aa2b7ecf" class="preview-modal"><div class="modal-header"><div id="x-1bd175f4-a90d-4385-b23d-bbc2aa2b7ecf" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Event History?</div><div class="preview-modal-description">An append-only log of Events that represents the full state a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
Calls to spawn [Activity Executions](/activities#activity-execution) <span id="i-2806bb07-e81f-4ce0-81f3-7c0d8b64f9d2" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2806bb07-e81f-4ce0-81f3-7c0d8b64f9d2" class="preview-modal"><div class="modal-header"><div id="x-2806bb07-e81f-4ce0-81f3-7c0d8b64f9d2" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> are written within a [Workflow Definition](/workflows#workflow-definition) <span id="i-0a29b8b0-4b2b-4d4e-90fa-1a7fccba4dec" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-0a29b8b0-4b2b-4d4e-90fa-1a7fccba4dec" class="preview-modal"><div class="modal-header"><div id="x-0a29b8b0-4b2b-4d4e-90fa-1a7fccba4dec" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
The call to spawn an Activity Execution generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command.
This results in the set of three [Activity Task](/workers#activity-task) <span id="i-d786bfa3-ec59-49fc-8e6a-dec5f67f9c14" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d786bfa3-ec59-49fc-8e6a-dec5f67f9c14" class="preview-modal"><div class="modal-header"><div id="x-d786bfa3-ec59-49fc-8e6a-dec5f67f9c14" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Task?</div><div class="preview-modal-description">An Activity Task contains the context needed to make an Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> related Events ([ActivityTaskScheduled](/references/events/#activitytaskscheduled), [ActivityTaskStarted](/references/events/#activitytaskstarted), and ActivityTask[Closed])in your Workflow Execution Event History.
...
The only required value that needs to be set is either a [Schedule-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-8e0f58c9-c20f-40c2-8113-54115daa8093" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8e0f58c9-c20f-40c2-8113-54115daa8093" class="preview-modal"><div class="modal-header"><div id="x-8e0f58c9-c20f-40c2-8113-54115daa8093" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div> or a [Start-To-Close Timeout](/activities#start-to-close-timeout) <span id="i-e67edec1-6da5-4cb3-8c92-ee09df5b6b72" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-e67edec1-6da5-4cb3-8c92-ee09df5b6b72" class="preview-modal"><div class="modal-header"><div id="x-e67edec1-6da5-4cb3-8c92-ee09df5b6b72" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Start-To-Close Timeout?</div><div class="preview-modal-description">A Start-To-Close Timeout is the maximum time allowed for a single Activity Task Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">timeouts</span></div></div>.
These values are set in the Activity Options.

### How to get the results of an Activity Execution {#get-activity-results}

The call to spawn an [Activity Execution](/activities#activity-execution) <span id="i-c59b8db8-9af4-4300-9878-a5ec6ae18b2f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-c59b8db8-9af4-4300-9878-a5ec6ae18b2f" class="preview-modal"><div class="modal-header"><div id="x-c59b8db8-9af4-4300-9878-a5ec6ae18b2f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is an Activity Execution?</div><div class="preview-modal-description">An Activity Execution is the full chain of Activity Task Executions.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> generates the [ScheduleActivityTask](/references/commands/#scheduleactivitytask) Command and provides the Workflow with an Awaitable.
...
The [Worker Process](/workers#worker-process) <span id="i-23866b82-cad1-4399-9d91-5a6443a7d91a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-23866b82-cad1-4399-9d91-5a6443a7d91a" class="preview-modal"><div class="modal-header"><div id="x-23866b82-cad1-4399-9d91-5a6443a7d91a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Process?</div><div class="preview-modal-description">A Worker Process is responsible for polling a Task Queue, dequeueing a Task, executing your code in response to a Task, and responding to the Temporal Server with the results.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is where Workflow Functions and Activity Functions are executed.

- Each [Worker Entity](/workers#worker-entity) <span id="i-0c3e7827-9745-4445-be20-a0cf4c8c6af8" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-0c3e7827-9745-4445-be20-a0cf4c8c6af8" class="preview-modal"><div class="modal-header"><div id="x-0c3e7827-9745-4445-be20-a0cf4c8c6af8" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> in the Worker Process must register the exact Workflow Types and Activity Types it may execute.
- Each Worker Entity must also associate itself with exactly one [Task Queue](/workers#task-queue) <span id="i-cffc2e05-f207-452d-8979-e38c8e0ececc" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-cffc2e05-f207-452d-8979-e38c8e0ececc" class="preview-modal"><div class="modal-header"><div id="x-cffc2e05-f207-452d-8979-e38c8e0ececc" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- Each Worker Entity polling the same Task Queue must be registered with the same Workflow Types and Activity Types.

A [Worker Entity](/workers#worker-entity) <span id="i-962fce36-a0e5-4802-9f7d-bc329351b303" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-962fce36-a0e5-4802-9f7d-bc329351b303" class="preview-modal"><div class="modal-header"><div id="x-962fce36-a0e5-4802-9f7d-bc329351b303" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is the component within a Worker Process that listens to a specific Task Queue.
...
The [Worker Process](/workers#worker-process) <span id="i-4c5b9bd0-7705-4aed-8e9e-0495736fb947" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4c5b9bd0-7705-4aed-8e9e-0495736fb947" class="preview-modal"><div class="modal-header"><div id="x-4c5b9bd0-7705-4aed-8e9e-0495736fb947" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Process?</div><div class="preview-modal-description">A Worker Process is responsible for polling a Task Queue, dequeueing a Task, executing your code in response to a Task, and responding to the Temporal Server with the results.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is where Workflow Functions and Activity Functions are executed.

- Each [Worker Entity](/workers#worker-entity) <span id="i-5313b200-f3b5-4eb7-a26f-8f2114cbec8a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-5313b200-f3b5-4eb7-a26f-8f2114cbec8a" class="preview-modal"><div class="modal-header"><div id="x-5313b200-f3b5-4eb7-a26f-8f2114cbec8a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> in the Worker Process must register the exact Workflow Types and Activity Types it may execute.
- Each Worker Entity must also associate itself with exactly one [Task Queue](/workers#task-queue) <span id="i-8c5bf5bd-7694-4310-aaed-ac0b510f71ad" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8c5bf5bd-7694-4310-aaed-ac0b510f71ad" class="preview-modal"><div class="modal-header"><div id="x-8c5bf5bd-7694-4310-aaed-ac0b510f71ad" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
- Each Worker Entity polling the same Task Queue must be registered with the same Workflow Types and Activity Types.

A [Worker Entity](/workers#worker-entity) <span id="i-3758d10b-bb83-4c4a-abd9-3aa75f31ad16" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-3758d10b-bb83-4c4a-abd9-3aa75f31ad16" class="preview-modal"><div class="modal-header"><div id="x-3758d10b-bb83-4c4a-abd9-3aa75f31ad16" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Worker Entity?</div><div class="preview-modal-description">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> is the component within a Worker Process that listens to a specific Task Queue.
...
- An address that includes your [Cloud Namespace Name](/namespaces#) <span id="i-81516888-4b92-4ac6-b270-fbe8a3fa3d60" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-81516888-4b92-4ac6-b270-fbe8a3fa3d60" class="preview-modal"><div class="modal-header"><div id="x-81516888-4b92-4ac6-b270-fbe8a3fa3d60" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> and a port number: `<Namespace>.<ID>.tmprl.cloud:<port>`.
- mTLS CA certificate.
- mTLS private key.

For more information about managing and generating client certificates for Temporal Cloud, see [How to manage certificates in Temporal Cloud](/cloud/account-setup/certificates#) <span id="i-bbe39f19-4cee-4ce3-901a-a778f2810372" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-bbe39f19-4cee-4ce3-901a-a778f2810372" class="preview-modal"><div class="modal-header"><div id="x-bbe39f19-4cee-4ce3-901a-a778f2810372" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div>.
...
Workflow Execution run in a separate V8 isolate context in order to provide a [deterministic runtime](/workflows#deterministic-constraints) <span id="i-266a0b35-443c-4ecf-9b0c-4a06010d82fc" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-266a0b35-443c-4ecf-9b0c-4a06010d82fc" class="preview-modal"><div class="modal-header"><div id="x-266a0b35-443c-4ecf-9b0c-4a06010d82fc" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Definition?</div><div class="preview-modal-description">A Workflow Definition is the code that defines the constraints of a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.

### How to set a Workflow's Task Queue {#set-task-queue}

In most SDKs, the only Workflow Option that must be set is the name of the [Task Queue](/workers#task-queue) <span id="i-83702e83-dbd6-49ac-93ab-760ae033c917" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-83702e83-dbd6-49ac-93ab-760ae033c917" class="preview-modal"><div class="modal-header"><div id="x-83702e83-dbd6-49ac-93ab-760ae033c917" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Task Queue?</div><div class="preview-modal-description">A Task Queue is a first-in, first-out queue that a Worker Process polls for Tasks.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
Although it is not required, we recommend providing your own [Workflow Id](/workflows#workflow-id) <span id="i-f1a889c8-b615-4384-9ae0-60d3bb7a8284" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-f1a889c8-b615-4384-9ae0-60d3bb7a8284" class="preview-modal"><div class="modal-header"><div id="x-f1a889c8-b615-4384-9ae0-60d3bb7a8284" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Id?</div><div class="preview-modal-description">A Workflow Id is a customizable, application-level identifier for a Workflow Execution that is unique to an Open Workflow Execution within a Namespace.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> that maps to a business process or business entity identifier, such as an order identifier or customer identifier.
