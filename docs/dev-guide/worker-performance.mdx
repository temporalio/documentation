...
description: "Optimize Temporal Workers performance by adjusting metrics such as worker_task_slots_available, schedule_to_start_latency, and pollers, and consider configuring workflow cache size and thread count to ensure efficient resource utilization and minimize latency."
