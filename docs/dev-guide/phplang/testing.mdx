---
id: testing
title: Testing - PHP SDK feature guide
sidebar_label: Testing
description: "Learn how to test your Temporal workflows and activities with end-to-end, integration, and unit testing frameworks, including how to mock activities and workflows, skip time, and replay workflow executions."
