---
id: debugging
title: Debugging - PHP SDK feature guide
sidebar_label: Debugging
description: "Learn how to debug and troubleshoot workflows in development and production environments using various tools including logging, debugging, Web UI, Temporal CLI, and performance metrics."
