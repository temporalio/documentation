...
description: "Master the fundamentals of Temporal Application development with this comprehensive guide, covering foundations, features, observability, testing, and debugging. Learn to install the Temporal CLI, run a development server, and develop workflows, activities, and more."
slug: /dev-guide/php
