...
- [How to connect a Temporal Client to a Temporal Service](/dev-guide/php/foundations#connect-to-a-dev-cluster): When connecting a Temporal Client to a Temporal Service, you must provide the address and port number of the Temporal Service.
