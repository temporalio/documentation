...
slug: /dev-guide/python/messages
...
After developing your Signal, you can send it from a [Temporal Client](#send-signal-from-client) or from another [Workflow Execution](#send-signal-from-workflow).

### Defining Signals {#define-signal}
...
### Handle Signals {#handle-signal}

**How to hanlde a Signal**
