...
- [How to develop with Updates](/dev-guide/python/features#updates): An Update is an operation that can mutate the state of a Workflow Execution and return a response.
