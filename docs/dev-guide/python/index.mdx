...
- [Choose a development Temporal Service](/dev-guide/python/project-setup#choose-dev-temporal-service): Discover which development Temporal Service you should choose
...
- [How to connect a Temporal Client to a Temporal Service](/dev-guide/python/foundations#connect-to-a-dev-temporal-service): When connecting a Temporal Client to a Temporal Service, you must provide the address and port number of the Temporal Service.
...
- [How to Heartbeat an Activity](/dev-guide/python/features#activity-heartbeats): An Activity Heartbeat is a ping from the Worker that is executing the Activity to the Temporal Service.
...
- [How to use Visibility APIs](/dev-guide/python/observability#visibility): The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Temporal Service.
