...
- [Use a self-hosted environment such as Docker](#self-hosted-temporal-service)
...
- [Self-hosted Temporal Service](#self-hosted-temporal-service)
...
For example, running a self-hosted Temporal Service lets you try different databases, view Temporal Service metrics, use custom [Search Attributes](/visibility#search-attribute), and even play with the [Archival](/temporal-service#archival) feature.
