...
description: "Learn how to debug your application using various tools such as the Web UI, Temporal CLI, Replay, Tracing, and Logging, as well as optimize Worker performance with metrics and guides."
