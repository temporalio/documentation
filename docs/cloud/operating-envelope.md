...
sidebar_position: 10
description: Temporal Cloud operating-envelope information, including availability, regions, throughput, and latency.
...
A Namespace has a default quota of 200 <a class="tdlp" href="/cloud/index#action">Actions<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">What is an Action?</span><br /><br /><span class="tdlppd">An Action is the fundamental pricing unit in Temporal Cloud.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/cloud/index#action">Learn more</a></span></span></a> per second with spikes up to 400 Actions per second.
