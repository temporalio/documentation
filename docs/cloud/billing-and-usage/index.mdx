...
- **[Usage Dashboards](/cloud/actions-usage):** Aggregate Actions on a Namespace level and includes Action categories that groups similar types of Actions as seen in [Actions](/evaluate/cloud/actions). Available in the Cloud UI in the usage dashboard and Namespace overview pages.
