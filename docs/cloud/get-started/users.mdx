...
:::note UpdateNamespace permission details

`UpdateNamespace` covers these namespace settings:
...
- **Namespace Admin** Required: [Custom Search Attributes](/search-attribute#custom-search-attribute)
- **Namespace Admin** Required: [Provisioned capacity (TRUs)](/cloud/capacity-modes#provisioned-capacity)
- **Namespace Admin** Required: [High Availability](/cloud/high-availability)
