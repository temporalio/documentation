...
### Option 1: You already have certificate management infrastructure {/* #option-1-you-already-have-certificate-management-infrastructure */}
...
### Option 2: You don't have certificate management infrastructure {/* #option-2-you-dont-have-certificate-management-infrastructure */}
...
#### Use tcld to generate certificates {/* #use-tcld-to-generate-certificates */}
...
#### Use step CLI to generate certificates {/* #use-step-cli-to-generate-certificates */}
...
##### 2. Set the Namespace Name {/* #2-set-the-namespace-name */}
...
##### 3. Create and Sign an End-Entity Certificate {/* #3-create-and-sign-an-end-entity-certificate */}
...
##### 4. (optional) Convert to PKCS8 Format for Java SDK {/* #4-optional-convert-to-pkcs8-format-for-java-sdk */}
...
##### 5. Use the Certificates with Temporal Cloud {/* #5-use-the-certificates-with-temporal-cloud */}
...
### Option 1: Issue a separate root certificate for each Namespace {/* #option-1-issue-a-separate-root-certificate-for-each-namespace */}
...
### Option 2: Use the same root certificate for all Namespaces but create a separate certificate filter for each Namespace {/* #option-2-use-the-same-root-certificate-for-all-namespaces-but-create-a-separate-certificate-filter-for-each-namespace */}
...
## How to handle a compromised end-entity certificate {/* #how-to-handle-a-compromised-end-entity-certificate */}
...
### 1. Generate a new CA certificate {/* #1-generate-a-new-ca-certificate */}
...
### 2. Deploy the new CA certificate to the Namespace {/* #2-deploy-the-new-ca-certificate-to-the-namespace */}
...
### 3. Regenerate end-entity certificates with the new CA certificate {/* #3-regenerate-end-entity-certificates-with-the-new-ca-certificate */}
...
### 4. Remove the compromised CA certificate {/* #4-remove-the-compromised-ca-certificate */}
...
### 5. Monitor and audit {/* #5-monitor-and-audit */}
...
### Update certificates using Temporal Cloud UI {/* #update-certificates-using-temporal-cloud-ui */}
...
### Update certificates using tcld {/* #update-certificates-using-tcld */}
...
### Manage certificate filters using Temporal Cloud UI {/* #manage-certificate-filters-using-temporal-cloud-ui */}
...
### Manage certificate filters using tcld {/* #manage-certificate-filters-using-tcld */}
