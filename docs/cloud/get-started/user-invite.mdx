...
#### Can multiple Temporal Cloud accounts share the same email domain? {/* #can-multiple-temporal-cloud-accounts-share-the-same-email-domain */}
...
#### Can the same email be used across different Temporal Cloud accounts? {/* #can-the-same-email-be-used-across-different-temporal-cloud-accounts */}
...
#### Can I use Google or Microsoft SSO after signing up with email and password? {/* #can-i-use-google-or-microsoft-sso-after-signing-up-with-email-and-password */}
