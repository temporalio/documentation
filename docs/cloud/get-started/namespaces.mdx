...
1. Optional: In **Description**, enter a short purpose note (at most 255 printable ASCII characters plus whitespace).
   This is free-text context, not a Tag.
...
This page focuses on Temporal Cloud Namespace mechanics such as naming rules, provisioning, authentication, description,
tagging, and accessing Namespace endpoints.
...
- Not a security boundary. Do not store secrets, PII, or PHI.
