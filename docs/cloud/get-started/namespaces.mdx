...
By default, each account starts with 10 Namespaces. As you actively use them, Temporal Cloud automatically raises this limit up to 100 — no action needed. To go higher, open a [support ticket](/cloud/support#support-ticket).
