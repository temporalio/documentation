...
For the operations that are supported by Custom Roles, see [this table](manage-access/permissions-reference#custom-role-permissions)

The following operations are not yet available to Custom Roles:
...
- Separating or splitting operations that are part of [UpdateNamespace](https://saas-api.tmprl.cloud/docs/httpapi.html#tag/namespaces/POST/cloud/namespaces/{namespace}).
...
For a list of available actions, see [the list of Custom Role permissions](/cloud/manage-access/permissions-reference#custom-role-permissions-reference).
