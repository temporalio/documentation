...
For the operations that are supported by Custom Roles, see [this table](/permissions-reference#custom-role-permissions)
...
For a list of available actions, see [the list of Custom Role permissions](/permissions-reference#custom-role-permissions-reference).
