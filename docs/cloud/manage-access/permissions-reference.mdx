...
### Cloud Ops API permissions {/* #cloud-ops-api-permissions */}
...
### Cloud Ops API permissions {/* #cloud-ops-api-permissions-1 */}
...
### Workflow-level permissions {/* #workflow-level-permissions */}
...
## Additional authorization behaviors {/* #additional-authorization-behaviors */}
...
### API key authorization behavior {/* #api-key-authorization-behavior */}
...
### Service account authorization behavior {/* #service-account-authorization-behavior */}
