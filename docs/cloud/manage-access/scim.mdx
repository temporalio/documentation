...
You can map SCIM groups to Temporal Cloud [roles and permissions](/cloud/manage-access/users#account-level-roles-and-namespace-level-permissions), so users automatically get the Temporal Cloud access they need based on the groups they belong to.
...
After completing these steps, you're ready to submit your [support ticket](/evaluate/cloud/support#support-ticket) to enable SCIM.
