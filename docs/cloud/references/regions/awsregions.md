...
- **Regional Endpoint**: `ap-northeast-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `ap-northeast-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `ap-south-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `ap-south-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `ap-southeast-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `ap-southeast-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `eu-central-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `eu-west-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `eu-west-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `ca-central-1.aws.api.temporal.io`
- **Same Region Replication**:  Not Available
- **Multi-Region Replication**:
  - `aws-us-east-1`
  - `aws-us-east-2`
...
- **Regional Endpoint**: `us-east-1.aws.api.temporal.io`
...
- **Regional Endpoint**: `us-east-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `us-west-2.aws.api.temporal.io`
...
- **Regional Endpoint**: `sa-east-1.aws.api.temporal.io`
