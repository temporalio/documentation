...
If your Sync Match Rate is low, contact [Temporal Cloud support](/evaluate/cloud/support#support-ticket).
...
- There is congestion caused by the environment (for example, network) hosting the worker(s) and Temporal Cloud
