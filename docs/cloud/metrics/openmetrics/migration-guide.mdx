...
### 1\. No longer use `rate()` in Prometheus queries {/* #1-no-longer-use-rate-in-prometheus-queries */}
...
### 2\. Functions that no longer apply {/* #2-functions-that-no-longer-apply */}
...
### 3\. Percentile metrics {/* #3-percentile-metrics */}
...
### Configuring Grafana \+ Prometheus {/* #configuring-grafana--prometheus */}

#### Update Prometheus Configuration {/* #update-prometheus-configuration */}
...
#### Install New Dashboards {/* #install-new-dashboards */}
...
#### Other Observability Providers {/* #other-observability-providers */}
...
### Metric Mapping Reference {/* #metric-mapping-reference */}
...
### Managing High-Cardinality {/* #managing-high-cardinality */}
...
##### Namespace/Metric filtering {/* #namespacemetric-filtering */}
...
### Q: Will metrics match between promQL and OpenMetrics endpoints? {/* #q-will-metrics-match-between-promql-and-openmetrics-endpoints */}
...
### Q: Can I still query metrics directly (e.g. with a Grafana dashboard)? {/* #q-can-i-still-query-metrics-directly-eg-with-a-grafana-dashboard */}
...
### Q: What happens to my existing dashboards and alerts? {/* #q-what-happens-to-my-existing-dashboards-and-alerts */}

During the transition period, both endpoints remain active.

### Q: Will historical data be preserved? {/* #q-will-historical-data-be-preserved */}
...
### Q: Are there limits to how frequently I can scrape or how much data will be returned? {/* #q-are-there-limits-to-how-frequently-i-can-scrape-or-how-much-data-will-be-returned */}

The limits are documented [here](/cloud/metrics/openmetrics/api-reference#api-limits).

### Q: Why are some metrics missing from my scrapes? I don’t see all the metrics documented. {/* #q-why-are-some-metrics-missing-from-my-scrapes-i-dont-see-all-the-metrics-documented */}
