...
| Value | Description |
| ----- | ----- |
| `public-preview` | The metric is in [Public Preview](/evaluate/features/release-stages#public-preview) |
| `general-availability` | The metric is in [General Availability](/evaluate/features/release-stages#general-availability) |
