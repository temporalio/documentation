...
| `nexus_caller` | Nexus request metrics | The Nexus caller name |
...
:::note Request latency compared with operation latency

Nexus request latency measures how long the handler takes to process one Nexus request. It ends when that request finishes processing, so it doesn't measure how long an asynchronous Nexus Operation takes to complete.

Nexus Operation schedule-to-close latency measures the time from when the caller schedules an Operation until the Operation reaches a terminal state. Start-to-close latency measures the time from when an asynchronous Operation starts until it reaches a terminal state.
...
The `nexus_service`, `nexus_operation`, and `nexus_caller` labels are [opt-in](#opt-in-labels) to help manage cardinality.
...
The 50th percentile time from when a Nexus Operation is scheduled until it reaches a terminal state, in seconds.
...
The 95th percentile time from when a Nexus Operation is scheduled until it reaches a terminal state, in seconds.
...
The 99th percentile time from when a Nexus Operation is scheduled until it reaches a terminal state, in seconds.
...
The 50th percentile Nexus Operation schedule-to-start latency in seconds.
...
The 95th percentile Nexus Operation schedule-to-start latency in seconds.
...
The 99th percentile Nexus Operation schedule-to-start latency in seconds.
...
The 50th percentile time from when an asynchronous Nexus Operation starts until it reaches a terminal state, in seconds.
...
The 95th percentile time from when an asynchronous Nexus Operation starts until it reaches a terminal state, in seconds.
...
The 99th percentile time from when an asynchronous Nexus Operation starts until it reaches a terminal state, in seconds.
...
| `nexus_service` | The Nexus Service name (opt-in) |
| `nexus_operation` | The Nexus Operation name (opt-in) |
| `nexus_caller` | The Nexus caller name (opt-in) |
...
The 50th percentile time the handler takes to process one Nexus request, in seconds. This metric doesn't measure how long an asynchronous Nexus Operation takes to complete.
...
The 95th percentile time the handler takes to process one Nexus request, in seconds. This metric doesn't measure how long an asynchronous Nexus Operation takes to complete.
...
The 99th percentile time the handler takes to process one Nexus request, in seconds. This metric doesn't measure how long an asynchronous Nexus Operation takes to complete.
