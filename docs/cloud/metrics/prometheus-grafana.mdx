...
title: Temporal Cloud Prometheus Grafana setup
...
**How to set up Grafana with Temporal Cloud observability to view Cloud metrics.**
...
This page describes how to set up Temporal Cloud metrics as a data source in Grafana and create dashboards to visualize them.
...
The process for setting up Temporal Cloud metrics in Grafana includes the following steps:
...
To set up Temporal Cloud metrics dashboards in Grafana, you can use the UI or configure them directly in your Grafana deployment.
