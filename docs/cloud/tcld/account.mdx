...
##### --destination-uri {/* #--destination-uri-1 */}
...
##### --destination-uri {/* #--destination-uri-2 */}
...
##### --service-account-email {/* #--service-account-email-1 */}

The service account email to impersonate to write to the sink.

Alias: `sae`

##### --sink-name {/* #--sink-name-8 */}
...
##### --service-account-email {/* #--service-account-email-2 */}

The service account email to impersonate to write to the sink.

Alias: `sae`

##### --sink-name {/* #--sink-name-9 */}
