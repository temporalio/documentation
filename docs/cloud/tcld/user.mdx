...
sidebar_label: user
description: Manage users easily in Temporal Cloud with tcld commands; delete, get info, invite, list, resend invites, set account roles, and set namespace permissions seamlessly.
...
## set-account-role {/* #set-account-role */}
...
## set-namespace-permissions {/* #set-namespace-permissions */}
...
#### --namespace-permission {/* #--namespace-permission-1 */}
