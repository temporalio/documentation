...
Active/Passive (Cold) Pattern: **Normal operation**
...
Active/Passive (Cold) Pattern: **On failover**
...
Active/Passive (Cold) Pattern: **Benefits**
...
Active/Passive (Cold) Pattern: **Tradeoffs**
...
Active/Passive (Cold) Pattern: **Recommendations and important constraints**
...
Active/Passive (Cold) Pattern: **Component behavior**
...
Active/Passive (Hot) Pattern: **Normal operation**
...
flowchart LR
    ...
    subgraph DHNSEC["<b>Secondary</b>"]
      DHNR["<b>Replica</b>"]:::ns
      DHNWP2["<b>Workers</b><br/>Standby"]:::standby
...
Active/Passive (Hot) Pattern: **On failover**
...
Active/Passive (Hot) Pattern: **Benefits**
...
Active/Passive (Hot) Pattern: **Tradeoffs**
...
Active/Passive (Hot) Pattern: **Recommendations and important constraints**
...
Active/Passive (Hot) Pattern: **Component behavior**
