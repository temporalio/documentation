...
title: Worker deployment patterns for Active-Passive and Active-Active HA/DR
sidebar_label: Worker deployment patterns
...
This page covers three main patterns — **Active/Passive (Cold)**, **Active/Passive (Hot)**, and **Active/Active** — plus a rarely needed **[Regionally Sharded Namespaces](#regionally-sharded-namespaces)** variant.
...
### Regionally Sharded Namespaces {/* #regionally-sharded-namespaces */}
...
- Each shard's Workers can use **Single-region**, **[Active/Cold](#active-cold)**, or **[Active/Hot](#active-hot)**, depending on that shard's availability and recovery-time needs.
