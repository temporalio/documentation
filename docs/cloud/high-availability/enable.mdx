...
To deploy Worker fleets in both regions that stay idle in the passive region until failover, see [Active / Passive (Hot)](/cloud/high-availability/deployment-models#active-hot).
