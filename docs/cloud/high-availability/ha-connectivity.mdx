...
## How to choose an endpoint for a Namespace with High Availability features {/* #how-to-choose-an-endpoint-for-a-namespace-with-high-availability-features */}
...
### Namespace Endpoint (recommended) {/* #namespace-endpoint-recommended */}
...
### How endpoints route on failover {/* #how-endpoints-route-on-failover */}
...
## How to use PrivateLink with High Availability features {/* #how-to-use-privatelink-with-high-availability-features */}
...
## How HA + private connectivity works {/* #how-ha--private-connectivity-works */}
...
## Single-cloud HA on AWS PrivateLink {/* #single-cloud-ha-on-aws-privatelink */}

### How Namespace DNS records work with PrivateLink {/* #how-namespace-dns-records-work-with-privatelink */}
...
### How to set up the DNS override {/* #how-to-set-up-the-dns-override */}
...
## Single-cloud HA on GCP Private Service Connect {/* #single-cloud-ha-on-gcp-private-service-connect */}
...
## Multi-cloud HA (AWS PrivateLink + GCP Private Service Connect) {/* #multi-cloud-ha-aws-privatelink--gcp-private-service-connect */}
...
### Available regions, PrivateLink endpoints, and DNS record overrides {/* #available-regions-privatelink-endpoints-and-dns-record-overrides */}
...
### AWS regions and PrivateLink endpoints {/* #aws-regions-and-privatelink-endpoints */}

<JsonTable filename="/json/privatelink_aws.json" />

### GCP regions and Private Service Connect endpoints {/* #gcp-regions-and-private-service-connect-endpoints */}
