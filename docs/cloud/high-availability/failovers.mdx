...
While the failover operation usually completes in seconds, it can take much longer in an outage to actually detect the disruption and decide to trigger a failover.
