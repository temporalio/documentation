...
- `region` (required): The ID of the region to failover to. Must be a region the Namespace is currently available in.
- `asyncOperationId` (optional): A user-defined ID for tracking the async operation.
