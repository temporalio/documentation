...
does not recover, Workflow API calls that fall within the 1 minute RPO may be permanently lost. Such a case would require
the permanent loss of multiple cloud Availability Zones and has never happened in the history of Temporal Cloud.
