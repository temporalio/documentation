...
### After a Temporal-managed failover {/* #after-a-temporal-managed-failover */}
...
### After a user-triggered failover {/* #after-a-user-triggered-failover */}
...
### How to check whether your Namespace will be automatically failed back {/* #how-to-check-whether-your-namespace-will-be-automatically-failed-back */}
