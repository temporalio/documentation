...
To run Worker fleets in both regions that rely on this forwarding, see [Active / Active](/cloud/high-availability/deployment-models#active-active).

To keep passive-region Workers idle until failover by disabling this forwarding, see [Active / Passive (Hot)](/cloud/high-availability/deployment-models#active-hot).
