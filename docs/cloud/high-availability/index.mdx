...
This extra availability comes with an enhanced [SLA](/evaluate/cloud/sla) of 99.99%, _including_ cloud provider outages.
...
Even without High Availability features, Temporal Cloud provides robust reliability and a 99.9% contractual Service Level Agreement ([SLA](/evaluate/cloud/sla)) guarantee against service errors.
...
See [Regions](/evaluate/cloud/regions) for a full list of supported replica regions.
...
Namespaces using High Availability have a 99.99% [uptime SLA](/evaluate/cloud/sla) with sub-1-minute [RPO](/cloud/rpo-rto) and 20-minute [RTO](/cloud/rpo-rto). For detailed information:

- [Service Level Agreement (SLA)](/evaluate/cloud/sla)
...
This feature is currently in [Public Preview](/evaluate/product-release-stages) in selected regions.
