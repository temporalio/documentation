...
At General Availability, other options will be available:

| Granularity | Allowed Lookback Window |
| ----- | ----- |
| Hourly | Current \+ previous monthly billing cycle |
| Daily | Current \+ previous two billing cycles |
| Monthly | Current \+ previous eleven billing cycles |
