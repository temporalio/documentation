...
Because provisioned capacity is reserved by the hour whether or not you use it, it is worth tracking how much of it you actually consume.
...
For the metrics to watch and how to alert on utilization, see [Monitoring Trends Against Limits](/cloud/service-health#rps-aps-rate-limits).
