...
## Namespace Capacity {/* #namespace-capacity */}
...
### What happens when my Actions Rate exceeds my Limit? {/* #what-happens-when-my-actions-rate-exceeds-my-limit */}
...
### What kind of throughput can I get on Temporal Cloud with On-Demand Capacity? {/* #what-kind-of-throughput-can-i-get-on-temporal-cloud-with-on-demand-capacity */}
...
### What kind of throughput can I get with Temporal Cloud with Provisioned Capacity? {/* #what-kind-of-throughput-can-i-get-with-temporal-cloud-with-provisioned-capacity */}
...
### Provisioned Capacity Availability {/* #provisioned-capacity-availability */}
...
### When should I use Provisioned Capacity? {/* #when-should-i-use-provisioned-capacity */}
...
## Setting Capacity Modes {/* #setting-capacity-modes */}
...
### Setting Capacity Modes from the UI {/* #setting-capacity-modes-from-the-ui */}
...
### Setting Capacity Modes from the CLI {/* #setting-capacity-modes-from-the-cli */}
...
### Setting Capacity Modes from the API {/* #setting-capacity-modes-from-the-api */}
