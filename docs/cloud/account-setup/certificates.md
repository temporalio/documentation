...
Temporal Cloud lets you limit access to specific end-entity certificates by using [certificate filters](#manage-certificate-filters) <span id="i-8dea144d-aa86-4195-95fb-02488a6f9733" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8dea144d-aa86-4195-95fb-02488a6f9733" class="preview-modal"><div class="modal-header"><div id="x-8dea144d-aa86-4195-95fb-02488a6f9733" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificate filters in Temporal Cloud</div><div class="preview-modal-description">To limit access to specific CA certificates, you can create certificate filters.</div><div class="preview-modal-tags"><span class="preview-modal-tag">how-to</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div>.
...
To limit access to specific [end-entity certificates](#) <span id="i-42a2f649-47bd-4beb-8d3d-4237bc64cc29" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-42a2f649-47bd-4beb-8d3d-4237bc64cc29" class="preview-modal"><div class="modal-header"><div id="x-42a2f649-47bd-4beb-8d3d-4237bc64cc29" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div>, create certificate filters.
...
- [tcld namespace certificate-filters import](/cloud/tcld/namespace#import) <span id="i-980e612e-ddb6-4558-91af-634e6c94a734" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-980e612e-ddb6-4558-91af-634e6c94a734" class="preview-modal"><div class="modal-header"><div id="x-980e612e-ddb6-4558-91af-634e6c94a734" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld namespace certificate-filters import</div><div class="preview-modal-description">How to set certificate filters for a Namespace in Temporal Cloud using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>
- [tcld namespace certificate-filters clear](/cloud/tcld/namespace#clear) <span id="i-74a8b8eb-7a6f-4def-b0d9-fbc97518450d" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-74a8b8eb-7a6f-4def-b0d9-fbc97518450d" class="preview-modal"><div class="modal-header"><div id="x-74a8b8eb-7a6f-4def-b0d9-fbc97518450d" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld namespace certificate-filters clear</div><div class="preview-modal-description">How to clear all certificate filters from a Namespace in Temporal Cloud using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>

To view the current certificate filters, use the [tcld namespace certificate-filters export](/cloud/tcld/namespace#export) <span id="i-60afbe70-6a01-4a22-baa1-792ffda9d441" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-60afbe70-6a01-4a22-baa1-792ffda9d441" class="preview-modal"><div class="modal-header"><div id="x-60afbe70-6a01-4a22-baa1-792ffda9d441" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld namespace certificate-filters export</div><div class="preview-modal-description">How to export certificate filters from a Namespace in Temporal Cloud using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div> command.
