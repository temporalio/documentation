...
Audit Logs is a feature of [Temporal Cloud](/evaluate/cloud) that provides forensic access information for a variety of operations in the Temporal Cloud Control Plane.
