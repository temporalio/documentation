...
Beyond the [metrics](/references/sdk-metrics#) <span id="i-29ddb1f6-827e-48a8-b9e8-e8296995911c" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-29ddb1f6-827e-48a8-b9e8-e8296995911c" class="preview-modal"><div class="modal-header"><div id="x-29ddb1f6-827e-48a8-b9e8-e8296995911c" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">SDK metrics</div><div class="preview-modal-description">The Temporal SDKs emit metrics from Temporal Client usage and Worker Processes.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span></div></div> provided by the Temporal SDKs, some key metrics exist only in Temporal Cloud.
...
To view and manage third-party integration settings, your user account must have the Global Admin [Role](/cloud/account-setup/users#account-level-roles) <span id="i-e784d2ef-0782-435c-8618-6c3274b94f45" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-e784d2ef-0782-435c-8618-6c3274b94f45" class="preview-modal"><div class="modal-header"><div id="x-e784d2ef-0782-435c-8618-6c3274b94f45" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What are the account-level Roles for users in Temporal Cloud?</div><div class="preview-modal-description">Account-level Roles are Global Admin, Developer, and Read-Only.</div><div class="preview-modal-tags"><span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">temporal cloud account</span> <span class="preview-modal-tag">users</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
For more information, see [Set up Grafana with Temporal Cloud](#prometheus-and-grafana-setup) <span id="i-f5272a60-572a-4769-8173-896bfd631334" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-f5272a60-572a-4769-8173-896bfd631334" class="preview-modal"><div class="modal-header"><div id="x-f5272a60-572a-4769-8173-896bfd631334" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to set up Grafana with Temporal Cloud observability to view metrics</div><div class="preview-modal-description">Temporal Cloud and SDKs generate metrics for monitoring performance and troubleshooting errors.</div><div class="preview-modal-tags"><span class="preview-modal-tag">how-to</span> <span class="preview-modal-tag">grafana</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">observability</span></div></div>.
...
To add a certificate to a metrics endpoint, use [`tcld account metrics accepted-client-ca add`](/cloud/tcld/account#add) <span id="i-e94f2e1e-1957-4a71-b306-d861ac9658eb" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-e94f2e1e-1957-4a71-b306-d861ac9658eb" class="preview-modal"><div class="modal-header"><div id="x-e94f2e1e-1957-4a71-b306-d861ac9658eb" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld account metrics accepted-client-ca add</div><div class="preview-modal-description">How to add end-entity certificates to the metrics endpoint of a Temporal Cloud account using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>.

To enable a metrics endpoint, use [`tcld account metrics enable`](/cloud/tcld/account#enable) <span id="i-acb2d194-3092-4283-86bb-d67669dc9d18" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-acb2d194-3092-4283-86bb-d67669dc9d18" class="preview-modal"><div class="modal-header"><div id="x-acb2d194-3092-4283-86bb-d67669dc9d18" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld account metrics enable</div><div class="preview-modal-description">How to enable the metrics endpoint for a Temporal Cloud account using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>.

To disable a metrics endpoint, use [`tcld account metrics disable`](/cloud/tcld/account#disable) <span id="i-a98774f7-9cbd-4f67-a1c9-cb9b282dcba3" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a98774f7-9cbd-4f67-a1c9-cb9b282dcba3" class="preview-modal"><div class="modal-header"><div id="x-a98774f7-9cbd-4f67-a1c9-cb9b282dcba3" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld account metrics disable</div><div class="preview-modal-description">How to disable the metrics endpoint for a Temporal Cloud account using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>.

For more information, see [tcld account metrics command](/cloud/tcld/account#metrics) <span id="i-951ab398-2a6f-4c8b-8d9a-6c014c304293" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-951ab398-2a6f-4c8b-8d9a-6c014c304293" class="preview-modal"><div class="modal-header"><div id="x-951ab398-2a6f-4c8b-8d9a-6c014c304293" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tcld account metrics</div><div class="preview-modal-description">How to configure the metrics endpoint for a Temporal Cloud account using tcld.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tcld</span> <span class="preview-modal-tag">cli reference</span></div></div>.
...
- Root CA certificates and end-entity certificates. See [Certificate requirements](/cloud/account-setup/certificates#certificate-requirements) <span id="i-05cc3d1f-d4eb-434c-b116-b034b247ff2b" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-05cc3d1f-d4eb-434c-b116-b034b247ff2b" class="preview-modal"><div class="modal-header"><div id="x-05cc3d1f-d4eb-434c-b116-b034b247ff2b" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div> for details.
...
- [Global Admin privileges](/cloud/account-setup/users#account-level-roles) <span id="i-a9d4fa36-492f-49a0-a733-f3ff21e1b885" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-a9d4fa36-492f-49a0-a733-f3ff21e1b885" class="preview-modal"><div class="modal-header"><div id="x-a9d4fa36-492f-49a0-a733-f3ff21e1b885" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What are the account-level Roles for users in Temporal Cloud?</div><div class="preview-modal-description">Account-level Roles are Global Admin, Developer, and Read-Only.</div><div class="preview-modal-tags"><span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">temporal cloud account</span> <span class="preview-modal-tag">users</span> <span class="preview-modal-tag">explanation</span></div></div> to the Temporal Cloud account.
- [CA certificate and key](/cloud/account-setup/certificates#) <span id="i-e73c6c69-6bde-48cc-994f-bfee80232407" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-e73c6c69-6bde-48cc-994f-bfee80232407" class="preview-modal"><div class="modal-header"><div id="x-e73c6c69-6bde-48cc-994f-bfee80232407" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to manage certificates in Temporal Cloud</div><div class="preview-modal-description">Certificates needed for Temporal Cloud and Worker Processes</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">certificates</span></div></div> for the Observability integration. You will need the certificate to set up the Observability endpoint in Temporal Cloud.
...
- [Go SDK](/dev-guide/go/observability#metrics) <span id="i-15d70f1a-9022-4861-bf3d-aa1120a5ae91" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-15d70f1a-9022-4861-bf3d-aa1120a5ae91" class="preview-modal"><div class="modal-header"><div id="x-15d70f1a-9022-4861-bf3d-aa1120a5ae91" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to emit metrics</div><div class="preview-modal-description">Each Temporal SDK is capable of emitting an optional set of metrics from either the Client or the Worker process.</div><div class="preview-modal-tags"><span class="preview-modal-tag">developer-guide-doc-type</span> <span class="preview-modal-tag">go sdk</span> <span class="preview-modal-tag">logging and metrics</span></div></div>
- [Java SDK](/dev-guide/java/observability#metrics) <span id="i-2f677d4d-74ea-419a-a2bf-1f8e0b29cf30" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-2f677d4d-74ea-419a-a2bf-1f8e0b29cf30" class="preview-modal"><div class="modal-header"><div id="x-2f677d4d-74ea-419a-a2bf-1f8e0b29cf30" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to emit metrics</div><div class="preview-modal-description">Each Temporal SDK is capable of emitting an optional set of metrics from either the Client or the Worker process.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [TypeScript SDK](/dev-guide/typescript/observability#metrics) <span id="i-d93523e2-1ceb-420c-9983-2e9162b14538" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d93523e2-1ceb-420c-9983-2e9162b14538" class="preview-modal"><div class="modal-header"><div id="x-d93523e2-1ceb-420c-9983-2e9162b14538" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to emit metrics</div><div class="preview-modal-description">Each Temporal SDK is capable of emitting an optional set of metrics from either the Client or the Worker process.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [Python](/dev-guide/python/observability#metrics) <span id="i-164b2ec4-99a9-407c-9a1e-65d1ec694c19" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-164b2ec4-99a9-407c-9a1e-65d1ec694c19" class="preview-modal"><div class="modal-header"><div id="x-164b2ec4-99a9-407c-9a1e-65d1ec694c19" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to emit metrics</div><div class="preview-modal-description">Each Temporal SDK is capable of emitting an optional set of metrics from either the Client or the Worker process.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
...
3. Add your metrics queries:
   - For Temporal Cloud metrics, expand the **Metrics browser** and select the metrics you want to see.
     ...
     The documentation on [Cloud metrics](#available-performance-metrics) <span id="i-0c231b0b-72d7-4d16-a281-2583dcf74efc" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-0c231b0b-72d7-4d16-a281-2583dcf74efc" class="preview-modal"><div class="modal-header"><div id="x-0c231b0b-72d7-4d16-a281-2583dcf74efc" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to monitor Temporal Cloud metrics</div><div class="preview-modal-description">Configure and track performance metrics for Temporal Cloud.</div><div class="preview-modal-tags"><span class="preview-modal-tag">introduction</span> <span class="preview-modal-tag">temporal cloud</span> <span class="preview-modal-tag">metrics</span></div></div> lists metrics emitted from Temporal Cloud.
   - For Temporal SDK metrics, expand the **Metrics browser** and select the metrics you want to see.
     ...
     All metrics related to SDKs are described in the [SDK metrics](/references/sdk-metrics#) <span id="i-8968d48c-04da-42a8-b7eb-e6c40b226f35" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8968d48c-04da-42a8-b7eb-e6c40b226f35" class="preview-modal"><div class="modal-header"><div id="x-8968d48c-04da-42a8-b7eb-e6c40b226f35" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">SDK metrics</div><div class="preview-modal-description">The Temporal SDKs emit metrics from Temporal Client usage and Worker Processes.</div><div class="preview-modal-tags"><span class="preview-modal-tag">reference</span></div></div> reference.
