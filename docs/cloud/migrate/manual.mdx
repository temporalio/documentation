...
- Consider the implications for [security and access to your Temporal Service](/evaluate/cloud/security).
- Review your current load with [Action estimates](/cloud/migrate/estimate-actions) and speak to your Account Executive and Solutions Architect so we can set appropriate [Namespace limits](/evaluate/cloud/limits).
...
If you have used this feature locally or you are interested in using it to migrate to Temporal Cloud, [create a support ticket](/evaluate/cloud/support) or watch this space for more information about public availability.
