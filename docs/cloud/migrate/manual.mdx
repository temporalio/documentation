...
### What to expect from a migration {/* #what-to-expect-from-a-migration */}
...
### Updating Client connection code in your Workers {/* #updating-client-connection-code-in-your-workers */}
...
### Migrating your Workflow Executions {/* #migrating-your-workflow-executions */}
...
### Considerations when resuming Workflows on a new Temporal Service or Namespace {/* #considerations-when-resuming-workflows-on-a-new-temporal-service-or-namespace */}
...
### Other considerations when migrating {/* #other-considerations-when-migrating */}
