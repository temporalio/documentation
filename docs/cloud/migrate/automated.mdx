...
### Namespace migration schedule {/* #namespace-migration-schedule */}
...
### Capture cluster configurations {/* #capture-cluster-configurations */}
...
### Capture custom search attributes {/* #capture-custom-search-attributes */}
...
### Capture Namespace metrics {/* #capture-namespace-metrics */}
...
### Prepare mTLS certificates {/* #prepare-mtls-certificates */}
...
### Create Cloud Namespaces {/* #create-cloud-namespaces */}
...
### Report collected data {/* #report-collected-data */}
...
### Verify current cluster utilization {/* #verify-current-cluster-utilization */}
...
## Phase 4: Initiate {/* #phase-4-initiate */}
...
### Handover-to-cloud {/* #handover-to-cloud */}
...
## Transfer clients to cloud {/* #transfer-clients-to-cloud */}
...
### Special dynamic configuration for Version 1.22.x-1.23.x {/* #special-dynamic-configuration-for-version-122x-123x */}
...
## How to gather self-hosted metrics {/* #how-to-gather-self-hosted-metrics */}
...
### How many Temporal Cloud accounts do I need? {/* #how-many-temporal-cloud-accounts-do-i-need */}
...
### When should I opt for auto migration? {/* #when-should-i-opt-for-auto-migration */}
...
### Can I split Workflows from a single source Namespace into multiple cloud-side Namespaces? {/* #can-i-split-workflows-from-a-single-source-namespace-into-multiple-cloud-side-namespaces */}
No. All Workflows will be migrated.

### Can I combine manual and auto migration? {/* #can-i-combine-manual-and-auto-migration */}
...
### Why does it matter if custom search attributes are used? {/* #why-does-it-matter-if-custom-search-attributes-are-used */}
...
### What Workflows are migrated by default? {/* #what-workflows-are-migrated-by-default */}
...
### What can I do to speed up an automated migration? {/* #what-can-i-do-to-speed-up-an-automated-migration */}
...
### Is the migration of Schedules supported? {/* #is-the-migration-of-schedules-supported */}
Yes. Under the hood, Schedules are essentially Workflows.

### I have a long retention period for my Workflows. Is this compatible with Temporal Cloud? {/* #i-have-a-long-retention-period-for-my-workflows-is-this-compatible-with-temporal-cloud */}
...
### I am using payload encryption in my self-hosted Temporal cluster. Is this supported in cloud? {/* #i-am-using-payload-encryption-in-my-self-hosted-temporal-cluster-is-this-supported-in-cloud */}
...
### I would like to enable payload encryption as part of the migration. Is this supported? {/* #i-would-like-to-enable-payload-encryption-as-part-of-the-migration-is-this-supported */}
