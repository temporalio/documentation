...
The `temporal` command is missing some details needed for migration when run against Version 1.28.1. If you are running that version of Temporal or older, then substitute the below
