...
After creating a Project, you can create Project-scoped resources such as Namespaces, Nexus Endpoints, Connectivity Rules within it.
...
After creating the Service Account, you can optionally create one or more API keys for it. Each API key inherits only the permissions of its associated Service Account. If the Service Account is deleted, all of its API keys are deleted automatically.
