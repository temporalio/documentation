...
Audit Logging is a feature of [Temporal Cloud](/cloud/index#) that provides forensic access information at the account level, the user level, and the [Namespace](/namespaces#) level.
