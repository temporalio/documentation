...
**SLA inclusion:** Included in the [SLA](/evaluate/cloud/sla) calculation. Any errors during an AZ outage count toward SLA
...
**SLA inclusion:** Included in the [SLA](/evaluate/cloud/sla) calculation. Any errors during a cell outage count toward SLA
...
**SLA inclusion:** Included in the [SLA](/evaluate/cloud/sla) calculation only for Namespaces that have Multi-region Replication
...
**SLA inclusion:** Included in the [SLA](/evaluate/cloud/sla) calculation only for Namespaces that have Multi-cloud Replication
...
- Even if you have robust tooling to detect an outage and trigger a failover, leaving automatic failovers
  ...
  preemptively fail over your Namespace if we detect that it may be disrupted soon, for example, by a rolling failure that has
