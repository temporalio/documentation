---
id: audit-logs-gcp
title: Audit Logs - GCP Pub/Sub
sidebar_label: GCP Pub/Sub
description: Audit Logs in Temporal Cloud provides forensic information, integrating with GCP Pub/Sub for secure data handling and supporting key Admin and API Key operations. This streamlines audit and compliance processes.
draft: false
