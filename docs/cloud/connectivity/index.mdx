...
## Private network connectivity for namespaces {/* #private-network-connectivity-for-namespaces */}
...
#### When you need a Connectivity Rule {/* #when-you-need-a-connectivity-rule */}
...
## Creating a connectivity rule {/* #creating-a-connectivity-rule */}

### Temporal Cloud CLI (tcld) {/* #temporal-cloud-cli-tcld */}
...
## Attach connectivity rules to a namespace {/* #attach-connectivity-rules-to-a-namespace */}
...
### Temporal Cloud CLI (tcld) {/* #temporal-cloud-cli-tcld-1 */}
...
## View the connectivity rules for a namespace {/* #view-the-connectivity-rules-for-a-namespace */}
...
### List connectivity rules by namespace {/* #list-connectivity-rules-by-namespace */}
...
## Update DNS or clients to use private connectivity {/* #update-dns-or-clients-to-use-private-connectivity */}
...
### Control plane hostnames {/* #control-plane-hostnames */}
...
### AWS PrivateLink connectivity to Temporal Cloud control plane {/* #aws-privatelink-connectivity-to-temporal-cloud-control-plane */}
