...
## Creating a Private Service Connect connection {/* #creating-a-private-service-connect-connection */}
...
## Configuring Private DNS for GCP Private Service Connect {/* #configuring-private-dns-for-gcp-private-service-connect */}
...
#### 1. Collect your PSC endpoint IP address {/* #1-collect-your-psc-endpoint-ip-address */}
...
#### 2. Create a Cloud DNS private zone {/* #2-create-a-cloud-dns-private-zone */}
...
#### 3. Add an A record {/* #3-add-an-a-record */}
...
#### 4. Verify DNS resolution from inside the Network {/* #4-verify-dns-resolution-from-inside-the-network */}
...
## Available GCP regions, PSC endpoints, and DNS record overrides {/* #available-gcp-regions-psc-endpoints-and-dns-record-overrides */}
