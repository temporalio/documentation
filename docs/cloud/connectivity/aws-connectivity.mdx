...
## Creating an AWS PrivateLink connection {/* #creating-an-aws-privatelink-connection */}
...
## Configuring Private DNS for AWS PrivateLink {/* #configuring-private-dns-for-aws-privatelink */}

### Why configure private DNS? {/* #why-configure-private-dns */}
...
### Choose the override domain and endpoint {/* #choose-the-override-domain-and-endpoint */}
...
#### 1. Collect your PrivateLink endpoint DNS name {/* #1-collect-your-privatelink-endpoint-dns-name */}
...
#### 2. Create a Route 53 Private Hosted Zone (do not yet attach Worker VPCs) {/* #2-create-a-route-53-private-hosted-zone-do-not-yet-attach-worker-vpcs */}
...
#### 3. Add a CNAME record {/* #3-add-a-cname-record */}
...
#### 4. Associate the PHZ with your Worker VPCs and verify {/* #4-associate-the-phz-with-your-worker-vpcs-and-verify */}
...
### Updating your workers/clients {/* #updating-your-workersclients */}
...
## Configure private DNS for Namespaces with High Availability {/* #configure-private-dns-for-namespaces-with-high-availability */}
...
## Adding PrivateLink from additional AWS accounts {/* #adding-privatelink-from-additional-aws-accounts */}
...
## Available AWS regions, PrivateLink endpoints, and DNS record overrides {/* #available-aws-regions-privatelink-endpoints-and-dns-record-overrides */}
