...
If an unforeseen event requires Temporal to add or remove a published range, Temporal gives six months of advance notice, through both targeted communication to Stable IP users and the [Temporal Cloud changelog](https://temporal.io/change-log).
