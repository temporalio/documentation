...
const selfHostedDeploymentGuide = [
  ...
  {
    path: "/cluster-deployment-guide#visibility-store",
    name: "Visibility",
  },
  {
    path: "/cluster-deployment-guide#set-up-multi-cluster-replication",
    name: "Multi-Cluster Replication",
  },
  {
    path: "/cluster-deployment-guide#upgrade-server",
    name: "Upgrade server",
  },
  {
    path: "/kb/all-the-ways-to-run-a-cluster",
    name: "Ways to run a Cluster",
  },
  {
    path: "/kb/temporal-platform-limits-sheet",
    name: "Platform limits sheet",
  },
  {
