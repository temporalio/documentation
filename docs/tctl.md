...
```
docker run --rm temporalio/tctl:0.30.0 --namespace samples-namespace namespace describe
```
...
```
docker run --network=host --rm temporalio/tctl:0.30.0 --namespace samples-namespace namespace describe
```
