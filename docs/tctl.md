...
```
docker run --rm temporalio/tctl:1.5.0 --namespace samples-namespace namespace describe
```
...
```
docker run --network=host --rm temporalio/tctl:1.5.0 --namespace samples-namespace namespace describe
```
