...
```
docker run --rm temporalio/tctl:1.2.1 --namespace samples-namespace namespace describe
```
...
```
docker run --network=host --rm temporalio/tctl:1.2.1 --namespace samples-namespace namespace describe
```
