...
```bash
docker run --rm temporalio/tctl:1.7.0 --namespace samples-namespace namespace describe
```
...
```bash
docker run --network=host --rm temporalio/tctl:1.7.0 --namespace samples-namespace namespace describe
```
