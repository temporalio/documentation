...
- On Temporal Cloud, <a class="tdlp" href="/cloud/how-to-get-started-with-temporal-cloud#issue-ca-certificates">there is a read-only role assignable at account and Namespace level<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">Get started - Certificates</span><br /><br /><span class="tdlppd">Learn requirements for CA certificates</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/cloud/how-to-get-started-with-temporal-cloud#issue-ca-certificates">Learn more</a></span></span></a> to enable Advanced Visibility.
