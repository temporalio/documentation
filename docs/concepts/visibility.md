...
The [Visibility store](/cluster-deployment-guide#visibility-store) in your Temporal Cluster stores persisted Workflow Execution Event History data and is set up as a part of your [Persistence store](/clusters#persistence) <span id="i-f84cfdc5-1fce-4326-b487-0266d11d17df" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-f84cfdc5-1fce-4326-b487-0266d11d17df" class="preview-modal"><div class="modal-header"><div id="x-f84cfdc5-1fce-4326-b487-0266d11d17df" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cluster?</div><div class="preview-modal-description">A Temporal Cluster is a Temporal Server paired with Persistence and Visibility stores.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> to enable listing and filtering details about Workflow Executions that exist on your Temporal Cluster.

- [How to set up a Visibility store](/cluster-deployment-guide#visibility-store)

With Temporal Server v1.21, you can set up [Dual Visibility](#dual-visibility) <span id="i-8d03ed92-461e-488d-a755-026bd75c1de1" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-8d03ed92-461e-488d-a755-026bd75c1de1" class="preview-modal"><div class="modal-header"><div id="x-8d03ed92-461e-488d-a755-026bd75c1de1" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is Dual Visibility?</div><div class="preview-modal-description">Dual Visibility is a feature that lets you set a secondary Visibility store in your Temporal Cluster to facilitate migrating your Visibility data from one database to another.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> to migrate your Visibility store from one database to another.
...
Visibility, within the Temporal Platform, is the subsystem and APIs that enable the listing, filtering, and sorting of [Workflow Executions](/workflows#workflow-execution) <span id="i-cacee4a6-91e9-433d-ba4e-e1e19ad33734" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-cacee4a6-91e9-433d-ba4e-e1e19ad33734" class="preview-modal"><div class="modal-header"><div id="x-cacee4a6-91e9-433d-ba4e-e1e19ad33734" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Execution?</div><div class="preview-modal-description">A Temporal Workflow Execution is a durable, scalable, reliable, and reactive function execution. It is the main unit of execution of a Temporal Application.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div> through a custom SQL-like [List Filter](#list-filter) <span id="i-171fddf0-f63f-4e21-8469-b7dcd3e9a7ea" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-171fddf0-f63f-4e21-8469-b7dcd3e9a7ea" class="preview-modal"><div class="modal-header"><div id="x-171fddf0-f63f-4e21-8469-b7dcd3e9a7ea" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a List Filter?</div><div class="preview-modal-description">A List Filter is the SQL-like string that is provided as the parameter to an advanced Visibility List API.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>.
...
- For Temporal Server versions 1.19.1 and earlier, you must [integrate with ElasticSearch](/cluster-deployment-guide#elasticsearch) <span id="i-13673d7e-7090-4411-b2ae-164f3236c6b5" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-13673d7e-7090-4411-b2ae-164f3236c6b5" class="preview-modal"><div class="modal-header"><div id="x-13673d7e-7090-4411-b2ae-164f3236c6b5" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to integrate Elasticsearch into a Temporal Cluster</div><div class="preview-modal-description">To integrate Elasticsearch with your Temporal Cluster, edit the `persistence` section of your `development.yaml` configuration file and run the index schema setup commands.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> to use advanced Visibility.
...
For details on migrating your Visibility store databases, see [Dual Visibility](/cluster-deployment-guide#dual-visibility) <span id="i-717063c8-307b-4c44-b3ec-1ba2be9cb32d" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-717063c8-307b-4c44-b3ec-1ba2be9cb32d" class="preview-modal"><div class="modal-header"><div id="x-717063c8-307b-4c44-b3ec-1ba2be9cb32d" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to set up Dual Visibility</div><div class="preview-modal-description">To enable Dual Visibility, set up a secondary Visibility store with your primary Visibility, and configure your Temporal Cluster to enable read and/or write operations on the secondary Visibility store.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>.

## What is a List Filter? {#list-filter}

A List Filter is the SQL-like string that is provided as the parameter to a [Visibility](/clusters#visibility) <span id="i-d33fb4ba-9b73-4184-9ac5-3454595f4422" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d33fb4ba-9b73-4184-9ac5-3454595f4422" class="preview-modal"><div class="modal-header"><div id="x-d33fb4ba-9b73-4184-9ac5-3454595f4422" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is Visibility?</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span></div></div> List API.

A List Filter contains [Search Attribute](#search-attribute) <span id="i-6965c63a-8d6c-4990-9bc7-11b8120dec03" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6965c63a-8d6c-4990-9bc7-11b8120dec03" class="preview-modal"><div class="modal-header"><div id="x-6965c63a-8d6c-4990-9bc7-11b8120dec03" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Search Attribute?</div><div class="preview-modal-description">A Search Attribute is an indexed name used in List Filters to filter a list of Workflow Executions that have the Search Attribute in their metadata.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> names, Search Attribute values, and [operators](#supported-operators) to pull a filtered list of Workflow Executions from the Visibility store.

List Filter [Search Attribute](#search-attribute) <span id="i-d4fef7c7-03b6-46c6-aa7a-d755c8e73dc5" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-d4fef7c7-03b6-46c6-aa7a-d755c8e73dc5" class="preview-modal"><div class="modal-header"><div id="x-d4fef7c7-03b6-46c6-aa7a-d755c8e73dc5" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Search Attribute?</div><div class="preview-modal-description">A Search Attribute is an indexed name used in List Filters to filter a list of Workflow Executions that have the Search Attribute in their metadata.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> names are case sensitive, and each List Filter is scoped by a single [Namespace](/namespaces#) <span id="i-70e5ce80-0c27-4c69-b8ff-0f2e11e2c4b6" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-70e5ce80-0c27-4c69-b8ff-0f2e11e2c4b6" class="preview-modal"><div class="modal-header"><div id="x-70e5ce80-0c27-4c69-b8ff-0f2e11e2c4b6" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Namespace?</div><div class="preview-modal-description">A Namespace is a unit of isolation within the Temporal Platform</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.

A List Filter that uses a time range has a resolution of 1 ns on [Elasticsearch](/cluster-deployment-guide#elasticsearch) <span id="i-deae39c5-d148-4fba-b413-9c7be882d0e4" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-deae39c5-d148-4fba-b413-9c7be882d0e4" class="preview-modal"><div class="modal-header"><div id="x-deae39c5-d148-4fba-b413-9c7be882d0e4" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to integrate Elasticsearch into a Temporal Cluster</div><div class="preview-modal-description">To integrate Elasticsearch with your Temporal Cluster, edit the `persistence` section of your `development.yaml` configuration file and run the index schema setup commands.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> and 1 µs for [SQL databases](/cluster-deployment-guide#visibility-store) <span id="i-bfe87091-fd44-4ae7-b4c4-d3b46e27e656" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-bfe87091-fd44-4ae7-b4c4-d3b46e27e656" class="preview-modal"><div class="modal-header"><div id="x-bfe87091-fd44-4ae7-b4c4-d3b46e27e656" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to set up Visibility in a Temporal Cluster</div><div class="preview-modal-description">Visibility storage is set up as a part of your Persistence store to enable listing and filtering details about Worklfow Executions that exist on your Temporal Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>.

### Supported operators

A List Filter contains [Search Attribute](#search-attribute) <span id="i-6633051c-59fc-4e06-874f-4e405411b131" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6633051c-59fc-4e06-874f-4e405411b131" class="preview-modal"><div class="modal-header"><div id="x-6633051c-59fc-4e06-874f-4e405411b131" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Search Attribute?</div><div class="preview-modal-description">A Search Attribute is an indexed name used in List Filters to filter a list of Workflow Executions that have the Search Attribute in their metadata.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> names, Search Attribute values, and the following supported operators:
...
With Temporal Server v1.20 and later, you can use the `CountWorkflow` API to efficiently count the number of [Workflow Executions](/workflows#workflow-execution) <span id="i-efafe0db-93f0-4e09-a2f9-cd6c6c396fef" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-efafe0db-93f0-4e09-a2f9-cd6c6c396fef" class="preview-modal"><div class="modal-header"><div id="x-efafe0db-93f0-4e09-a2f9-cd6c6c396fef" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Workflow Execution?</div><div class="preview-modal-description">A Temporal Workflow Execution is a durable, scalable, reliable, and reactive function execution. It is the main unit of execution of a Temporal Application.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>.
...
The following is a List Filter set with [`tctl`](/tctl-v1/workflow#list) <span id="i-17a02f10-37a8-4d86-be2d-04f966276ccb" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-17a02f10-37a8-4d86-be2d-04f966276ccb" class="preview-modal"><div class="modal-header"><div id="x-17a02f10-37a8-4d86-be2d-04f966276ccb" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">tctl workflow list</div><div class="preview-modal-description">How to list open or closed Workflow Executions using tctl.</div><div class="preview-modal-tags"><span class="preview-modal-tag">tctl</span> <span class="preview-modal-tag">cli reference</span></div></div>:
...
A Search Attribute is an indexed field used in a [List Filter](#list-filter) <span id="i-6628dd72-4e01-4f8e-b6dc-24fb11acac4a" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-6628dd72-4e01-4f8e-b6dc-24fb11acac4a" class="preview-modal"><div class="modal-header"><div id="x-6628dd72-4e01-4f8e-b6dc-24fb11acac4a" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a List Filter?</div><div class="preview-modal-description">A List Filter is the SQL-like string that is provided as the parameter to an advanced Visibility List API.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> to filter a list of [Workflow Executions](/workflows#workflow-execution) that have the Search Attribute in their metadata.
...
When using [Continue-As-New](/workflows#continue-as-new) <span id="i-02f676a2-b642-40e0-a33b-b58bcbc957d8" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-02f676a2-b642-40e0-a33b-b58bcbc957d8" class="preview-modal"><div class="modal-header"><div id="x-02f676a2-b642-40e0-a33b-b58bcbc957d8" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is Continue-As-New?</div><div class="preview-modal-description">Continue-As-New is the mechanism by which all relevant state is passed to a new Workflow Execution with a fresh Event History.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">continue-as-new</span></div></div> or a [Temporal Cron Job](/workflows#temporal-cron-job) <span id="i-71e4b7d0-e65f-4bbf-9d1a-3d5afb2cbb03" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-71e4b7d0-e65f-4bbf-9d1a-3d5afb2cbb03" class="preview-modal"><div class="modal-header"><div id="x-71e4b7d0-e65f-4bbf-9d1a-3d5afb2cbb03" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a Temporal Cron Job?</div><div class="preview-modal-description">A Temporal Cron Job is the series of Workflow Executions that occur when a Cron Schedule is provided in the call to spawn a Workflow Execution.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span></div></div>, Search Attribute keys are carried over to the new Workflow Run by default.
...
You can [create custom Search Attributes](/cluster-deployment-guide#create-custom-search-attributes) <span id="i-caebb6e0-555f-4524-a559-5cc07f2d703f" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-caebb6e0-555f-4524-a559-5cc07f2d703f" class="preview-modal"><div class="modal-header"><div id="x-caebb6e0-555f-4524-a559-5cc07f2d703f" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to create custom Search Attributes</div><div class="preview-modal-description">Add custom Search Attributes to your Visibility store using `tctl` for self-hosted Temporal Cluster, and `tcld` for Temporal Cloud.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> with unique key names that are relevant to your business needs.
...
- With advanced Visibility, you can create multiple custom Search Attributes and use them in combinations with List Filters to get a list of specific Workflow Executions.
  ...
  - With Temporal Server v1.19 and earlier, you must [integrate Elasticsearch](/cluster-deployment-guide#elasticsearch) <span id="i-faccfd10-1c18-4094-b6a6-031481815388" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-faccfd10-1c18-4094-b6a6-031481815388" class="preview-modal"><div class="modal-header"><div id="x-faccfd10-1c18-4094-b6a6-031481815388" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to integrate Elasticsearch into a Temporal Cluster</div><div class="preview-modal-description">To integrate Elasticsearch with your Temporal Cluster, edit the `persistence` section of your `development.yaml` configuration file and run the index schema setup commands.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div> to use custom Search Attributes with List Filters.
...
To actually have results from the use of a [List Filter](#list-filter) <span id="i-979788c6-247e-4844-9a0a-773d0807d7d9" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-979788c6-247e-4844-9a0a-773d0807d7d9" class="preview-modal"><div class="modal-header"><div id="x-979788c6-247e-4844-9a0a-773d0807d7d9" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">What is a List Filter?</div><div class="preview-modal-description">A List Filter is the SQL-like string that is provided as the parameter to an advanced Visibility List API.</div><div class="preview-modal-tags"><span class="preview-modal-tag">term</span> <span class="preview-modal-tag">explanation</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>, Search Attributes must be added to a Workflow Execution as metadata.

- To create custom Search Attributes in your Visibility store, see [Create custom Search Attributes](/cluster-deployment-guide#create-custom-search-attributes) <span id="i-cb2779fd-fff3-4a3d-a9d1-5e7818d684d0" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-cb2779fd-fff3-4a3d-a9d1-5e7818d684d0" class="preview-modal"><div class="modal-header"><div id="x-cb2779fd-fff3-4a3d-a9d1-5e7818d684d0" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to create custom Search Attributes</div><div class="preview-modal-description">Add custom Search Attributes to your Visibility store using `tctl` for self-hosted Temporal Cluster, and `tcld` for Temporal Cloud.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>.
- To remove a custom Search Attribute from the Visbility store, see [Remove custom Search Attributes](/cluster-deployment-guide#remove-custom-search-attributes) <span id="i-188e5c5c-953b-4404-80e2-b40d20ed3101" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-188e5c5c-953b-4404-80e2-b40d20ed3101" class="preview-modal"><div class="modal-header"><div id="x-188e5c5c-953b-4404-80e2-b40d20ed3101" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to remove custom Search Attributes</div><div class="preview-modal-description">Remove custom Search Attributes from your self-hosted Temporal Cluster Visibility store using `tctl`.</div><div class="preview-modal-tags"><span class="preview-modal-tag">operation-guide</span> <span class="preview-modal-tag">filtered-lists</span> <span class="preview-modal-tag">visibility</span></div></div>.
...
- [How to manage Search Attributes using the Go SDK](/dev-guide/go/observability#visibility) <span id="i-4f347516-75c9-478d-a495-c35b41239711" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-4f347516-75c9-478d-a495-c35b41239711" class="preview-modal"><div class="modal-header"><div id="x-4f347516-75c9-478d-a495-c35b41239711" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to use Visibility APIs</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">developer-guide-doc-type</span> <span class="preview-modal-tag">go sdk</span> <span class="preview-modal-tag">visibility</span> <span class="preview-modal-tag">api</span></div></div>
- [How to manage Search Attributes using the Java SDK](/dev-guide/java/observability#visibility) <span id="i-70ca39d3-cce0-4527-a3c3-7499e65c97e4" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-70ca39d3-cce0-4527-a3c3-7499e65c97e4" class="preview-modal"><div class="modal-header"><div id="x-70ca39d3-cce0-4527-a3c3-7499e65c97e4" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to use Visibility APIs</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [How to manage Search Attributes using the PHP SDK](/dev-guide/php/observability#visibility) <span id="i-56036f78-6be0-4666-8ae3-3bb5130160d3" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-56036f78-6be0-4666-8ae3-3bb5130160d3" class="preview-modal"><div class="modal-header"><div id="x-56036f78-6be0-4666-8ae3-3bb5130160d3" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to use Visibility APIs</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [How to manage Search Attributes using the Python SDK](/dev-guide/python/observability#visibility) <span id="i-f248018a-ea97-49a7-bc82-4dffdd1b925e" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-f248018a-ea97-49a7-bc82-4dffdd1b925e" class="preview-modal"><div class="modal-header"><div id="x-f248018a-ea97-49a7-bc82-4dffdd1b925e" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to use Visibility APIs</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
- [How to manage Search Attributes using the TypeScript SDK](/dev-guide/typescript/observability#visibility) <span id="i-1da0358b-4c2a-4c33-a4bc-99ba822d17ff" class="clickable-i clickable-link-preview">🔗</span><div id="preview-modal-1da0358b-4c2a-4c33-a4bc-99ba822d17ff" class="preview-modal"><div class="modal-header"><div id="x-1da0358b-4c2a-4c33-a4bc-99ba822d17ff" class="clickable-x clickable-link-preview">x</div><b>Link preview</b></div><div class="preview-modal-title">How to use Visibility APIs</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><span class="preview-modal-tag">guide-context</span></div></div>
