...
might want to send a Query to return the current call stack.
You do not need to do any special handling in you Workflow code for the `__stack_trace` Query name.
