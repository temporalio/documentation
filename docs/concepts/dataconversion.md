...
The Data Converter encodes data from your application to a [Payload](#payload) <span id="i-4ce25c5e-e091-4f4f-a626-cb8d4e9a7e1c" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4ce25c5e-e091-4f4f-a626-cb8d4e9a7e1c" class="preview-modal"><div class="modal-header"><div id="x-4ce25c5e-e091-4f4f-a626-cb8d4e9a7e1c" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> before it is sent to the Temporal Cluster in the Client call.
...
Each piece of data (like a single argument or return value) is encoded as a [Payload](#payload) <span id="i-fb570f61-44f8-4889-90f1-0908f0f581fb" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-fb570f61-44f8-4889-90f1-0908f0f581fb" class="preview-modal"><div class="modal-header"><div id="x-fb570f61-44f8-4889-90f1-0908f0f581fb" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> Protobuf message, which consists of binary data and key-value metadata.
...
When processed through the SDK, the [default Data Converter](#default-data-converter) <span id="i-63063eba-b7c0-4ef0-8eb1-f4198afefcd6" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-63063eba-b7c0-4ef0-8eb1-f4198afefcd6" class="preview-modal"><div class="modal-header"><div id="x-63063eba-b7c0-4ef0-8eb1-f4198afefcd6" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#default-data-converter">#default-data-converter</a></div><div class="preview-modal-title">What is a default Data Converter?</div><div class="preview-modal-description">The default Data Converter is used by the Temporal SDK to convert objects into bytes using a series of Payload Converters.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> serializes your data/value to a Payload before sending it to the Temporal Server.
The default Data Converter processes supported type values to Payloads, and you can create a custom [Payload Converter](#payload-converter) <span id="i-ccb47f12-5a12-468a-bc54-0088d3ef0271" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-ccb47f12-5a12-468a-bc54-0088d3ef0271" class="preview-modal"><div class="modal-header"><div id="x-ccb47f12-5a12-468a-bc54-0088d3ef0271" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-converter">#payload-converter</a></div><div class="preview-modal-title">What is a Payload Converter?</div><div class="preview-modal-description">A Payload Converter serializes data, converting objects or values to bytes and back.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> to convert your custom object types.

You can additionally apply [custom codecs](#payload-codec) <span id="i-9955c80a-f4f7-4b22-b1b4-0f14cfe42c9b" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-9955c80a-f4f7-4b22-b1b4-0f14cfe42c9b" class="preview-modal"><div class="modal-header"><div id="x-9955c80a-f4f7-4b22-b1b4-0f14cfe42c9b" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> (such as for encryption or compression) on your Payloads to wrap them into new encoded Payloads.
...
A custom Data Converter extends the default [Data Converter](#) <span id="i-460f0e54-45a4-461c-987e-9dba2e716133" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-460f0e54-45a4-461c-987e-9dba2e716133" class="preview-modal"><div class="modal-header"><div id="x-460f0e54-45a4-461c-987e-9dba2e716133" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#">#</a></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> with custom logic for [Payload](#payload) <span id="i-19a1570c-5a27-4b95-8122-0fb31fdba1bd" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-19a1570c-5a27-4b95-8122-0fb31fdba1bd" class="preview-modal"><div class="modal-header"><div id="x-19a1570c-5a27-4b95-8122-0fb31fdba1bd" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> conversion or encoding.
...
- A Payload Converter serializes data, converting objects to bytes and back.
  To convert custom objects or data types to [Payloads](#payload) <span id="i-78fd2a5e-aeba-4240-a1ac-c2120bb9bd2a" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-78fd2a5e-aeba-4240-a1ac-c2120bb9bd2a" class="preview-modal"><div class="modal-header"><div id="x-78fd2a5e-aeba-4240-a1ac-c2120bb9bd2a" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and back, use a custom Payload Converter and set it on a Data Converter.
- A Payload Codec encodes and decodes [Payloads](#payload) <span id="i-d808ce01-5b4a-4a46-8c7a-0b6a02146822" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-d808ce01-5b4a-4a46-8c7a-0b6a02146822" class="preview-modal"><div class="modal-header"><div id="x-d808ce01-5b4a-4a46-8c7a-0b6a02146822" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>, with bytes-to-bytes conversion.
...
Custom Data Converters are not applied to all data; for example, [Search Attributes](/visibility#search-attribute) <span id="i-385cb0f9-c2d5-468a-b58e-35cbb3f2774c" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-385cb0f9-c2d5-468a-b58e-35cbb3f2774c" class="preview-modal"><div class="modal-header"><div id="x-385cb0f9-c2d5-468a-b58e-35cbb3f2774c" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/visibility#search-attribute">/visibility#search-attribute</a></div><div class="preview-modal-title">What is a Search Attribute?</div><div class="preview-modal-description">A Search Attribute is an indexed name used in List Filters to filter a list of Workflow Executions that have the Search Attribute in their metadata.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a> <a class="preview-modal-tag" href="/tags/filtered-lists">filtered-lists</a> <a class="preview-modal-tag" href="/tags/visibility">visibility</a></div></div> are simple values and persisted unencoded so they can be indexed for searching.
...
- [Payload Converter](#payload-converter) <span id="i-526649d5-a231-4054-806f-b733f10386ed" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-526649d5-a231-4054-806f-b733f10386ed" class="preview-modal"><div class="modal-header"><div id="x-526649d5-a231-4054-806f-b733f10386ed" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-converter">#payload-converter</a></div><div class="preview-modal-title">What is a Payload Converter?</div><div class="preview-modal-description">A Payload Converter serializes data, converting objects or values to bytes and back.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>
- [Failure Converter](#failure-converter) <span id="i-c60c7e61-e532-4018-a84a-a3e61c2b6a1d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c60c7e61-e532-4018-a84a-a3e61c2b6a1d" class="preview-modal"><div class="modal-header"><div id="x-c60c7e61-e532-4018-a84a-a3e61c2b6a1d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#failure-converter">#failure-converter</a></div><div class="preview-modal-title">What is a Failure Converter?</div><div class="preview-modal-description">A Failure Converter converts error objects to proto Failures and back.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>
- [Payload Codec](#payload-codec) <span id="i-15d38a37-f671-4379-88df-1358c792571c" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-15d38a37-f671-4379-88df-1358c792571c" class="preview-modal"><div class="modal-header"><div id="x-15d38a37-f671-4379-88df-1358c792571c" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>
...
- [How to implement custom Payload convesion in Go](/dev-guide/go/features#custom-payload-conversion) <span id="i-4f314b38-bee4-4644-896c-9300b2d9ca3d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4f314b38-bee4-4644-896c-9300b2d9ca3d" class="preview-modal"><div class="modal-header"><div id="x-4f314b38-bee4-4644-896c-9300b2d9ca3d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dev-guide/go/features#custom-payload-conversion">/dev-guide/go/features#custom-payload-conversion</a></div><div class="preview-modal-title">How to use custom payload conversion</div><div class="preview-modal-description">Create your custom `PayloadConverter` and set it on a `DataConverter` in your Client options.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go sdk">go sdk</a> <a class="preview-modal-tag" href="/tags/developer-guide-doc-type">developer-guide-doc-type</a> <a class="preview-modal-tag" href="/tags/payload conversion">payload conversion</a> <a class="preview-modal-tag" href="/tags/data converter">data converter</a></div></div>
- [How to implement custom Payload conversion in Java](/dev-guide/java/features#custom-payload-conversion) <span id="i-4ae5bfd1-5690-4c10-ab0e-021469061ce5" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-4ae5bfd1-5690-4c10-ab0e-021469061ce5" class="preview-modal"><div class="modal-header"><div id="x-4ae5bfd1-5690-4c10-ab0e-021469061ce5" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dev-guide/java/features#custom-payload-conversion">/dev-guide/java/features#custom-payload-conversion</a></div><div class="preview-modal-title">How to use custom payload conversion</div><div class="preview-modal-description">Create your custom `PayloadConverter` and set it on a `DataConverter` in your Client options.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
...
- [How to implement custom Payload convesion in Go](/dev-guide/go/features#custom-payload-conversion) <span id="i-e0a45b9f-3347-41ba-aa07-74627c6277a4" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e0a45b9f-3347-41ba-aa07-74627c6277a4" class="preview-modal"><div class="modal-header"><div id="x-e0a45b9f-3347-41ba-aa07-74627c6277a4" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dev-guide/go/features#custom-payload-conversion">/dev-guide/go/features#custom-payload-conversion</a></div><div class="preview-modal-title">How to use custom payload conversion</div><div class="preview-modal-description">Create your custom `PayloadConverter` and set it on a `DataConverter` in your Client options.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/go sdk">go sdk</a> <a class="preview-modal-tag" href="/tags/developer-guide-doc-type">developer-guide-doc-type</a> <a class="preview-modal-tag" href="/tags/payload conversion">payload conversion</a> <a class="preview-modal-tag" href="/tags/data converter">data converter</a></div></div>
- [How to implement custom Payload conversion in Java](/dev-guide/java/features#custom-payload-conversion) <span id="i-e160cac9-1411-4671-ab67-11fe6bbe42fe" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e160cac9-1411-4671-ab67-11fe6bbe42fe" class="preview-modal"><div class="modal-header"><div id="x-e160cac9-1411-4671-ab67-11fe6bbe42fe" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/dev-guide/java/features#custom-payload-conversion">/dev-guide/java/features#custom-payload-conversion</a></div><div class="preview-modal-title">How to use custom payload conversion</div><div class="preview-modal-description">Create your custom `PayloadConverter` and set it on a `DataConverter` in your Client options.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/guide-context">guide-context</a></div></div>
...
If your errors might contain sensitive information, you can encrypt the message and stack trace by configuring the default Failure Converter to use your encoded attributes, in which case it moves your `message` and `stack_trace` fields to a Payload that's run through your [codec](#payload-codec) <span id="i-f1668ae0-137a-498b-b5f8-ed6328af2b13" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f1668ae0-137a-498b-b5f8-ed6328af2b13" class="preview-modal"><div class="modal-header"><div id="x-f1668ae0-137a-498b-b5f8-ed6328af2b13" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.

## What is a Payload Codec? {#payload-codec}

A Payload Codec transforms an array of [Payloads](#payload) <span id="i-3291e1c1-58cd-4290-a253-c2ec040efb7b" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-3291e1c1-58cd-4290-a253-c2ec040efb7b" class="preview-modal"><div class="modal-header"><div id="x-3291e1c1-58cd-4290-a253-c2ec040efb7b" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> (for example, a list of Workflow arguments) into another array of Payloads.

The Payload Codec is an optional step that happens between the wire and the [Payload Converter](#payload-converter) <span id="i-f01c6d93-2e37-4265-bac2-3d956d88ce26" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-f01c6d93-2e37-4265-bac2-3d956d88ce26" class="preview-modal"><div class="modal-header"><div id="x-f01c6d93-2e37-4265-bac2-3d956d88ce26" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-converter">#payload-converter</a></div><div class="preview-modal-title">What is a Payload Converter?</div><div class="preview-modal-description">A Payload Converter serializes data, converting objects or values to bytes and back.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>:
...
To run data encoding/decoding remotely, use a [Codec Server](#codec-server) <span id="i-895d4d28-1997-40e7-951c-3a7c48354303" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-895d4d28-1997-40e7-951c-3a7c48354303" class="preview-modal"><div class="modal-header"><div id="x-895d4d28-1997-40e7-951c-3a7c48354303" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#codec-server">#codec-server</a></div><div class="preview-modal-title">What is a Codec Server?</div><div class="preview-modal-description">A Codec Server is an HTTP server that uses your custom Payload Codec to encode and decode your data remotely through endpoints.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div>. A Codec Server is an HTTP server that is configured to use your custom Payload Codec.
...
If you use custom encoding in your custom Data Converter, Payload data handled by the Temporal Cluster is encoded. Since the Web UI uses the [Visibility](/clusters#visibility) <span id="i-0d24923d-b085-4151-a82d-5a9764251e2e" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-0d24923d-b085-4151-a82d-5a9764251e2e" class="preview-modal"><div class="modal-header"><div id="x-0d24923d-b085-4151-a82d-5a9764251e2e" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/clusters#visibility">/clusters#visibility</a></div><div class="preview-modal-title">What is Visibility?</div><div class="preview-modal-description">The term Visibility, within the Temporal Platform, refers to the subsystems and APIs that enable an operator to view Workflow Executions that currently exist within a Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div> database to show events and data stored on the Temporal Server, all data in the Workflow Execution History in your Web UI or tctl shows in the encoded format.

To see the original format of data in your Web UI and tctl, create a [Codec Server](#codec-server) <span id="i-c2f55498-e493-46eb-844c-b1a8d4c1391d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-c2f55498-e493-46eb-844c-b1a8d4c1391d" class="preview-modal"><div class="modal-header"><div id="x-c2f55498-e493-46eb-844c-b1a8d4c1391d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#codec-server">#codec-server</a></div><div class="preview-modal-title">What is a Codec Server?</div><div class="preview-modal-description">A Codec Server is an HTTP server that uses your custom Payload Codec to encode and decode your data remotely through endpoints.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a></div></div> with a remote data encoder and use the Payload Codec to decode your data locally.
...
Each endpoint receives and responds with a JSON body that has a `payloads` property with an array of [Payloads](#payload) <span id="i-e0433e37-8c64-483e-b465-a2cdf0490a76" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e0433e37-8c64-483e-b465-a2cdf0490a76" class="preview-modal"><div class="modal-header"><div id="x-e0433e37-8c64-483e-b465-a2cdf0490a76" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>.
The endpoints run the Payloads through a [Payload Codec](#payload-codec) <span id="i-8dcbc531-af8b-4434-bfef-c01c39051bb7" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-8dcbc531-af8b-4434-bfef-c01c39051bb7" class="preview-modal"><div class="modal-header"><div id="x-8dcbc531-af8b-4434-bfef-c01c39051bb7" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Data Converter?</div><div class="preview-modal-description">A Data Converter is a Temporal SDK component that serializes and encodes data entering and exiting a Temporal Cluster.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> before returning them.
...
<!-- You can set your Codec Server endpoints to encode data sent to the Temporal Server (see [Remote data encoding](#remote-data-encoding) <span id="i-94c88182-fdcf-452e-9954-09ca3a7a8bc6" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-94c88182-fdcf-452e-9954-09ca3a7a8bc6" class="preview-modal"><div class="modal-header"><div id="x-94c88182-fdcf-452e-9954-09ca3a7a8bc6" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#remote-data-encoding">#remote-data-encoding</a></div><div class="preview-modal-title">What is remote data encoding?</div><div class="preview-modal-description">Remote data encding is using your custom Data Converter to decode (and encode) your Payloads remotely through endpoints.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div>).
...
Use a Codec Server to decode your encoded [payloads](#payload) <span id="i-8345e242-6ca1-4477-8d84-66347dc7fdd1" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-8345e242-6ca1-4477-8d84-66347dc7fdd1" class="preview-modal"><div class="modal-header"><div id="x-8345e242-6ca1-4477-8d84-66347dc7fdd1" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload">#payload</a></div><div class="preview-modal-title">What is a Payload?</div><div class="preview-modal-description">A Payload represents binary data such as input and output from Activities and Workflows.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/payloads">payloads</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> and integrate it with the Temporal Web UI and CLI commands when debugging your Workflows.

A Codec Server is an HTTP or HTTPS Server that you create and host.
It must be configured to use a [Payload Codec](#payload-codec) <span id="i-7ff66e10-04bf-4560-ad68-79033a2eeeb9" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-7ff66e10-04bf-4560-ad68-79033a2eeeb9" class="preview-modal"><div class="modal-header"><div id="x-7ff66e10-04bf-4560-ad68-79033a2eeeb9" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> with the required decode logic and encryption keys.
...
- A [Payload Codec](#payload-codec) <span id="i-984b1395-f8e1-4058-9055-b4f6a185983d" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-984b1395-f8e1-4058-9055-b4f6a185983d" class="preview-modal"><div class="modal-header"><div id="x-984b1395-f8e1-4058-9055-b4f6a185983d" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="#payload-codec">#payload-codec</a></div><div class="preview-modal-title">What is a Payload Codec?</div><div class="preview-modal-description">A Payload Codec transforms an array of Payloads into another array of Payloads.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/term">term</a> <a class="preview-modal-tag" href="/tags/explanation">explanation</a></div></div> with the requisite keys and logic to decode your encrypted payloads.
...
On self-hosted Temporal Clusters, configure [authorization in the Web UI configuration](/references/web-ui-configuration#auth) <span id="i-e505ce5c-dbfe-4693-9de2-be82f7f207f3" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-e505ce5c-dbfe-4693-9de2-be82f7f207f3" class="preview-modal"><div class="modal-header"><div id="x-e505ce5c-dbfe-4693-9de2-be82f7f207f3" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/references/web-ui-configuration#auth">/references/web-ui-configuration#auth</a></div><div class="preview-modal-title">Temporal Web UI configuration reference</div><div class="preview-modal-description">The Temporal Web UI Server uses a configuration file for many of the UI's settings.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/reference">reference</a> <a class="preview-modal-tag" href="/tags/web-ui">web-ui</a></div></div> in your Temporal Cluster setup.
...
In self-hosted Temporal Clusters where you set up your UI Server, you can also set the codec endpoint in the UI server [configuration file](/references/web-ui-configuration#codec) <span id="i-6b528734-265d-4c46-a176-898b428d4a83" class="clickable-i clickable-link-preview">i</span><div id="preview-modal-6b528734-265d-4c46-a176-898b428d4a83" class="preview-modal"><div class="modal-header"><div id="x-6b528734-265d-4c46-a176-898b428d4a83" class="clickable-x clickable-link-preview">x</div><b>Link preview:</b>&nbsp;&nbsp<a href="/references/web-ui-configuration#codec">/references/web-ui-configuration#codec</a></div><div class="preview-modal-title">Temporal Web UI configuration reference</div><div class="preview-modal-description">The Temporal Web UI Server uses a configuration file for many of the UI's settings.</div><div class="preview-modal-tags"><a class="preview-modal-tag" href="/tags/reference">reference</a> <a class="preview-modal-tag" href="/tags/web-ui">web-ui</a></div></div>, as shown in the following example.
