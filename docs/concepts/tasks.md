...
A Task Queue is a lightweight, dynamically allocated queue that one or more <a class="tdlp" href="/workers#worker-entity">Worker Entities<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">What is a Worker Entity?</span><br /><br /><span class="tdlppd">A Worker Entity is the individual Worker within a Worker Process that listens to a specific Task Queue.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/workers#worker-entity">Learn more</a></span></span></a> poll for <a class="tdlp" href="#">Tasks<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">What is a Task?</span><br /><br /><span class="tdlppd">A Task is the context needed to make progress with a specific Workflow Execution or Activity Execution.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="#">Learn more</a></span></span></a>.
...
- <a class="tdlp" href="/application-development/golang/foundations#develop-worker">How to run a development Worker using the Go SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to develop a Worker in Go</span><br /><br /><span class="tdlppd">Develop an instance of a Worker by calling worker.New(), available via the go.temporal.io/sdk/worker package.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/golang/foundations#develop-worker">Learn more</a></span></span></a>
- <a class="tdlp" href="/application-development/java/foundations#run-a-dev-worker">How to run a development Worker using the Java SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to develop a Worker Program in Java</span><br /><br /><span class="tdlppd">Use the `newWorker` method on an instance of a `WorkerFactory` to create a new Worker in Java.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/java/foundations#run-a-dev-worker">Learn more</a></span></span></a>
- <a class="tdlp" href="/application-development/php/foundations#run-a-dev-worker">How to run a development Worker using the PHP SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to run Worker Processes</span><br /><br /><span class="tdlppd">The Worker Process is where Workflow Functions and Activity Functions are executed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/php/foundations#run-a-dev-worker">Learn more</a></span></span></a>
- <a class="tdlp" href="/application-development/python/foundations#run-a-dev-worker">How to run a development Worker using the Python SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to run Worker Processes</span><br /><br /><span class="tdlppd">The Worker Process is where Workflow Functions and Activity Functions are executed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/python/foundations#run-a-dev-worker">Learn more</a></span></span></a>
- <a class="tdlp" href="/application-development/typescript/foundations#run-a-dev-worker">How to run a development Worker using the TypeScript SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to run Worker Processes</span><br /><br /><span class="tdlppd">The Worker Process is where Workflow Functions and Activity Functions are executed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/typescript/foundations#run-a-dev-worker">Learn more</a></span></span></a>

- <a class="tdlp" href="/application-development/golang/foundations#run-a-temporal-cloud-worker">How to run a Temporal Cloud Worker using the Go SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to run a Temporal Cloud Worker</span><br /><br /><span class="tdlppd">The Worker Process is where Workflow Functions and Activity Functions are executed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/golang/foundations#run-a-temporal-cloud-worker">Learn more</a></span></span></a>
- <a class="tdlp" href="/application-development/typescript/foundations#run-a-temporal-cloud-worker">How to run a Temporal Cloud Worker using the TypeScript SDK<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to run a Temporal Cloud Worker</span><br /><br /><span class="tdlppd">The Worker Process is where Workflow Functions and Activity Functions are executed.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/typescript/foundations#run-a-temporal-cloud-worker">Learn more</a></span></span></a>
