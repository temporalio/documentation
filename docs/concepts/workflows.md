...
- **Description**: This is the maximum amount of time that the Server will wait for the Worker to start processing a [Workflow Task](/docs/reference/glossary/#workflow-task) after the Task has been pulled from the Task Queue.
