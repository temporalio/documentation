...
- `TERMINATE`: When the parent stops, immediately terminate the Child Workflow.
- `REQUEST_CANCEL`: When the parent stops, request cancellation on the child workflow.
