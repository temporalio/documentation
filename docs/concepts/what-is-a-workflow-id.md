...
The Temporal Platform guarantees uniqueness of the Workflow Id within a [Namespace](/docs/concepts/what-is-a-namespace) based on the Workflow Id Reuse Policy.
