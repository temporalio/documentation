...
<PatternCards items={[
  ...
  {
    href: "/integrations?tags=Agent+framework",
    title: "SDK integrations",
    description: "Framework integrations for OpenAI Agents SDK, LangGraph, Google ADK, Vercel AI SDK, Strands Agents, Spring AI, and more.",
  },
  {
