...
Understand how to stop a Workflow cleanly with cancellation, allowing for proper cleanup and state management, making it the preferred approach in most cases.
