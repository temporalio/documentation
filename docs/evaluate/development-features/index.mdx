...
- **[Interrupt a Workflow](/evaluate/development-features/interrupt-workflow)**: Cancel and terminate a business process (Workflow) that is already in progress and compensate for any steps already taken.
