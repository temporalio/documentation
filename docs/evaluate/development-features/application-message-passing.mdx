...
- [Go SDK application message passing feature guide](/develop/go/messages)
- [Java SDK application message passing feature guide](/develop/java/messages)
- [Python SDK application message passing feature guide](/develop/python/messages)
- [TypeScript application message passing feature guide](/develop/typescript/messages)
- [.NET SDK application message passing feature guide](/develop/typescript/messages)
