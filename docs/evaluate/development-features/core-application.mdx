...
- [PHP SDK Core application feature guide](/develop/php/temporal-clients#connect-to-a-dev-cluster)
- [Python SDK Core application feature guide](/develop/python/temporal-clients#connect-to-a-dev-cluster)
