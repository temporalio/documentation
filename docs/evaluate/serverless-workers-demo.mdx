---
id: serverless-workers-demo
title: Serverless Workers Interactive Demo
sidebar_label: Serverless Workers (Interactive)
...
- [Serverless workers - Go SDK](/develop/go/workers/serverless-workers) for SDK-specific configuration, defaults, and lifecycle details.
