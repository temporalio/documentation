...
Pricing starts at $50 per million Actions with volume discounts as you scale and through commitments.
...
Four tiers—Developer, Business, Enterprise, and Mission Critical—with increasing support levels, included Actions/Storage.
