...
- **Workflow Update received**. An [Update](/encyclopedia/workflow-message-passing#sending-updates) is received when you handle it or when your [Update Validator](/encyclopedia/workflow-message-passing#update-validators) rejects it.
