...
- **Query received by Worker**.
  Includes viewing the call stack in the Temporal Cloud UI, which results in a [Query](/encyclopedia/workflow-message-passing#sending-queries) behind the scenes.
- **Update received by Worker**.
  Includes successful [Updates](/encyclopedia/workflow-message-passing#sending-updates) and [rejected](/encyclopedia/workflow-message-passing#update-validators) Updates.
