...
Your total invoice each calendar month is the combination of Temporal Cloud consumption ([Actions](#action) and [Storage](#storage)), and a [Base Plan](#base-plans) that includes [Support](/cloud/support#support).
...
Your Base Plan pricing is the greater of the minimum monthly price or a percent (%) of your consumption spend:
...
Temporal Credits are used to pay your Temporal Cloud consumption, including support and base plan charges.
