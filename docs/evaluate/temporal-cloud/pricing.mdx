...
These states are retained by the Temporal Cloud service until execution, and their metadata and configurations contribute to overall active and retained storage consumption. For cost optimization, consider managing the lifecycle of these entities carefully.
