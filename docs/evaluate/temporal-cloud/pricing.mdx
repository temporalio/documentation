...
Your total invoice each calendar month is the combination of Temporal Cloud consumption ([Actions](#action) and [Storage](#storage)), and a [Base Plan](#base_plans) that includes [Support](/cloud/support#support).
