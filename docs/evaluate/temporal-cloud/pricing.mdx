...
- [Schedules](https://docs.temporal.io/schedule): Each scheduled workflow that is yet to be triggered contributes to storage usage. Supplied inputs, outputs, and failures all account for the storage usage incurred from scheduled workflows.
