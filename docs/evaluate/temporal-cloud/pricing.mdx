...
An invoice for a Namespace with High Availability features will include:

- An Actions row, showing the Action count from the primary Namespace.
- A Replicated Actions row, showing the Action count from the replica.
...
- If your High Availability features adoption began mid-month, expect to see more Actions than Replicated Actions and more Storage than Replicated Storage on your invoice.
