...
Temporal Cloud pricing structures will update to align with this page in February 2025 for existing customers.
Until then, if you're an existing customer, please refer to our [legacy pricing](/cloud/legacy_pricing) page.
...
| Pricing           | Greater of<li>&#36;100/mo; or</li><li>5% of Usage Spend</li>                   | Greater of<li>&#36;500/mo; or</li><li>10% of Usage Spend</li>                                                                     | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                    | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                    |
...
Account Owners can view their detailed [billing](https://cloud.temporal.io/billing) & [usage](https://cloud.temporal.io/usage) data at any time.
Finance Admins can view billing information at [https://cloud.temporal.io/billing](https://cloud.temporal.io/billing).
Visit the [Usage and Billing](/cloud/billing-and-cost) page for more details.
