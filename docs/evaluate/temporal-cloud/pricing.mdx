...
Temporal Cloud credits are also available for purchase through AWS and GCP Marketplaces.
...
### Storage Credit pricing {#prepaid-storage}
...
Invoices are normally emailed to the designated billing contact.
By default, this is the Account Owner.
...
If you used our self sign-up feature to create your Temporal Account, and you are an Account Owner, you can cancel your account from the Temporal Cloud [Billing](https://cloud.temporal.io/billing) page under the Plan tab.
You need appropriate administrative permissions to access this section.
Select the "Delete Account" button.
Otherwise, to delete your Temporal Cloud account, please [contact Support](https://temporalsupport.zendesk.com/).

See [this overview](/cloud/billing-and-cost#account-cancellation) for more details.
