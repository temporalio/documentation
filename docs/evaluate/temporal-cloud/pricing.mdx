...
Your total invoice each calendar month is the combination of Temporal Cloud consumption ([Actions](#action) and [Storage](#storage)), and a Base Plan that includes [Support](/cloud/support#support).

### Base Plans {#base_plans}

**How Temporal Base Plans work**

Each Temporal Cloud account includes a Base Plan that includes Support, Actions, Active Storage, Retained Storage and other features for a complete Temporal solution.
Base allocations help you get started on the Temporal platform, so you can better estimate costs.

- Packages are charged monthly.
- Actions or Storage allocations are reset each calendar month.

Temporal offers four service tiers to match your usage and reliability needs: Essential, Business, Enterprise, Mission Critical.
Choose the tier that aligns best with your current demands.
Temporal grows with your business, ensuring you're never stuck at a tier that doesn't fit
...
| ----------------- | ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Support Targeting | General use                                                                    | Production deployments<br />that scale                                                                                            | Enterprise deployments<br/>w/ stringent uptime demands                                                                          | Mission-critical applications<br />w/ the highest support needs                                                                 |
| Support Features  | 24h ticket desk                                                                | <li>P0 Response Times</li>                                                                                                        | <li>P0: \<30 Min, 24/7</li><li>Private Slack</li>                                                                               | <li>P0: \<15 Min, 24/7</li><li>Private Slack</li><li>Dedicated DSE</li>                                                         |
| Product Features  | <li>1M Actions</li><li>1GBh Active Storage</li><li>40 GB Retained Storage</li> | <li>Commit discounts</li><li>SSO (Add-on)</li><li>2.5M Actions</li><li>2.5GBh Active Storage</li><li>100 GB Retained Storage</li> | <li>Commit discounts</li><li>SSO included</li><li>10M Actions</li><li>10GBh Active Storage</li><li>400 GB Retained Storage</li> | <li>Commit discounts</li><li>SSO included</li><li>10M Actions</li><li>10GBh Active Storage</li><li>400 GB Retained Storage</li> |
| Pricing           | Greater of<li>&#36;100/mo; or</li><li>5% of Usage Spend</li>                   | Greater of<li>&#36;500/mo; or</li><li>5% of Usage Spend</li>                                                                      | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                    | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                    |

:::info Converting GB to GBH
...
Both models meter and bill for three primary components: [Actions](#action), [Storage](#storage), and [Support](/cloud/support#support).
...
- With Commitments, you pre-purchase your Temporal Cloud spend with Temporal Credits.
  Temporal Credits pay for your Temporal Cloud consumption, including Support charges.

## Pay-as-you-go {#payg}

**How does pay-as-you-go pricing work?**

Pay-as-you-go is based on consumption.
This section explains how you're billed each calendar month and gives examples.

### Action pricing {#payg-action-pricing}

Temporal Cloud prices actions based on usage, starting at &#36;50 per million actions (&#36;0.00005 per action).
...
If you consume 11.25M Actions in excess of your base tier allocation in one calendar month, your bill for Actions will be:
...
Most accounts’ storage needs are met by our Base Plans.
...
Your Base Plan costs are the greater of the minimum monthly Price or a Percent (%) of your Consumption Spend:
...
- The Enterprise and Mission Critical Support tiers must be paid annually. Contact [Sales](mailto:sales@temporal.io) to discuss your needs.
...
Meet your commitments with any Temporal Cloud spend, including Actions, Storage and your Base Plan.
...
You must pay for commitments with Temporal Credits.
These Credits pay towards your Temporal Cloud consumption, including support and base plan charges.
Each Temporal Credit is equivalent to &#36;1 USD.
A credit purchase of &#36;20,000 converts to 20,000 Temporal Credits, a 1:1 conversion.

:::note Minimum Purchase Requirements

We require a minimum credit purchase equivalent to the first year of your commitment.
...
For multi-year commitments, accelerated credit purchases offset remaining annual credit requirements.

<div style={{backgroundColor: '#ffff00',padding: '0px 15px',borderRadius: '5px',border: '1px solid #cccccc',display: 'inline-block'}}>**IS THIS A SPEND OR DRAWING DOWN FROM CREDITS FOR THE NEXT YEAR?**</div>
...
When you renew a commitment of the same or larger amount, Temporal Cloud rolls over any unused credits into your new commitment.
Should you need to downsize your commitment, Temporal Cloud rolls over up to 10% of your unused initial credit purchase amount into the new commitment.
...
<div style={{backgroundColor: '#ffff00',padding: '0px 15px',borderRadius: '5px',border: '1px solid #cccccc',display: 'inline-block'}}>**TLO will update this**</div>
...
The Essentials Base plan starts at &#36;100/month.
Consumption in excess of your base plans allocations are billed on a consumption basis.
