...
- **Workflow reset**.
  ...
  (Actions that occur before a [Reset](/workflows#reset) are counted even if they are no longer visible in [Event History](/workflow-execution/event#event-history).)
- **Timer started**.
