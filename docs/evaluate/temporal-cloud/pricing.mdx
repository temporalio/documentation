...
- **Update received by Worker**.
  An Action occurs for every successful [Update](/sending-messages#sending-updates) and every [rejected](/encyclopedia/workflow-message-passing#update-validators) Update.
