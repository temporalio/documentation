...
import { DiscoverableDisclosure, DocsTable, NewDocsCell } from '@site/src/components';
...
Production deployments<br />that scale
<NewDocsCell />

Enterprise deployments<br/>w/ stringent uptime demands
<NewDocsCell />

Mission-critical applications<br />w/ the highest support needs
<NewDocsCell />
...
Greater of &#36;100/mo<br />
or 5% of Usage Spend
<NewDocsCell />

Greater of &#36;500/mo<br />or 10% of Usage Spend
<NewDocsCell />

Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details
<NewDocsCell />
...
Choose from <br /> [Pay-As-You-Go](#payg) or [Commitment Pricing](#commitment-pricing)
<NewDocsCell />
