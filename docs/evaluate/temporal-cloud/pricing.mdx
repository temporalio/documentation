...
[Reach out to our team](https://pages.temporal.io/contact-us) for more information or to help size your number of Actions.
...
Each account must select a support plan.
We offer two support tiers: Basic and Premium.
Support costs are outlined in the table below
You'll find a complete description of our support plans in our [Support](/cloud/support#support) documentation.
...
**How can I view invoice and usage details?**

Account Owners and Finance Admin can view detailed billing data at any time in the [Usage and Billing dashboards](/cloud/billing-and-cost) in Temporal Cloud.
...
Credits cover your Action and storage costs for Temporal Cloud, as well as support fees.
...
Each calendar month, your invoice balance is paid from your Temporal Credits balance.
...
Pricing tiers are applied per Namespace per calendar month:
...
Say that you have two Namespaces.
Last month, `namespace1` consumed 100 million Actions and `namespace2` consumed 500 million Actions.
...
Say that you have two Namespaces.
Last month, `namespace1` consumed 5,000 GBh of active storage and 5,000GBh of retained storage.
`namespace2` consumed 15,000 GBh of active storage and 15,000GBh of retained storage.
...
- `namespace1` is charged at the &#36;0.039 per GBh tier for active storage:
  ...
  ```
  5,000 GBh ⨉ $0.039 per GBh = $117 (Active Storage)
  ```
...
- `namespace2` is charged at the &#36;0.039 per GBh tier for the first 7,000 GBh, and at the &#36;0.031 per GBh tier for the remaining 8,000 GBh:
