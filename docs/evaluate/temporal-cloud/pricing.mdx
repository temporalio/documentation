...
**Enabling and disabling Fairness: calendar-hour boundaries**
...
|--------------|---------------------|-------------------------|-------|
| 2:45 PM | Fairness enabled | 2:00–3:00 PM | Entire window is billed even though Fairness was only on for 15 minutes of it. |
| 3:20 PM | Fairness disabled | 3:00–4:00 PM | Billing continues through the end of the current hour. The disable takes effect for billing purposes at 4:00 PM. |
| 4:00–4:49 PM | Fairness off | 4:00–5:00 PM | No surcharge accrues during this gap. |
| 4:50 PM | Fairness re-enabled | 4:00–5:00 PM | Re-enabling restarts the 1-hour minimum; the entire 4:00–5:00 PM window is billed. |

With 10,000 Actions per hour, the Namespace is billed for 3 full hours of Fairness (2:00–3:00, 3:00–4:00, and 4:00–5:00 PM), for a total surcharge of 3 × 10,000 × 0.1 = 3,000 additional Actions.
...
| Hour           | Backlogged Actions (pre-Fairness) | New Actions | Total Actions | Surcharge (10%) | Total billed |
|----------------|-----------------------------------|-------------|---------------|-----------------|--------------|
| 10:00–11:00 AM | 30,000                            | 10,000      | 40,000        | +4,000          | 44,000       |

If your Namespace has a large backlog when you enable Fairness, expect a higher-than-usual bill for the hours during which the backlog drains.
