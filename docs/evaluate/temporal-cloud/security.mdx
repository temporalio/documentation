...
### Code execution boundaries {/* #code-execution-boundaries */}
...
### Data Converter: Client-side encryption {/* #data-converter-client-side-encryption */}
...
#### Logical segregation {/* #logical-segregation */}
...
### Internal Temporal access {/* #internal-temporal-access */}
