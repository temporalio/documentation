...
Billable Actions are visible in the [OpenMetrics endpoint](https://metrics.temporal.io), Workflow History and [Usage](https://cloud.temporal.io/usage) Dashboards, and the [Billing API](/cloud/billing-api).
