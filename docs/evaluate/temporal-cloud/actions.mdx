...
reconstructs Workflow state from Event History and does not generate new server-side operations.

Billable Actions are visible in the [OpenMetrics endpoint](https://metrics.temporal.io),
[Workflow History](/cloud/actions-usage#actions-in-workflows) and [Usage](https://cloud.temporal.io/usage) Dashboards,
...
Usage and Billing data will have the most complete Actions data while Workflow history and metrics will help with
