...
![Temporal Cloud Workflow history, showing events that represent Billable Actions]()

This Billable Action estimate is useful for projecting the cost of workflows.
For example, if you ran a test workflow that generated 20 Billable Actions and anticipated that it would be run 100 times
...
You can also use the Billable Action estmate to help optimize workflows by better understanding your cost drivers.
...
The estimated Billable Actions should only be treated as an estimate. I
