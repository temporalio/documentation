...
Billable Actions are visible in the [OpenMetrics endpoint](https://metrics.temporal.io), [Workflow History](/cloud/actions-usage#actions-in-workflows) and [Usage](https://cloud.temporal.io/usage) Dashboards, and the [Billing API](/cloud/billing-api).
...
Usage and Billing data will have the most complete Actions data while Workflow history and metrics will help with detailed _estimates_.
...
Actions usage can be tracked in multiple areas depending on the needed granularity. 
Refer to the [Billing and Usage](/cloud/billing-and-usage) documentation for more information.
