...
### Actions per second {/* #actions-per-second */}
...
### Schedules rate limit {/* #schedules-rate-limit */}
...
### Visibility API Rate Limit {/* #visibility-api-rate-limit */}
...
### Concurrent Task pollers {/* #concurrent-task-pollers */}
...
### Number of Custom Search Attributes {/* #number-of-custom-search-attributes */}
...
### Custom Search Attribute names {/* #custom-search-attribute-names */}
...
## Nexus Endpoint level {/* #nexus-endpoint-level */}

### Nexus Endpoints limits {/* #nexus-endpoints-limits */}
...
## Programming model level {/* #programming-model-level */}
...
### Identifier length limit {/* #identifier-length-limit */}
...
### Per message gRPC limit {/* #per-message-grpc-limit */}

Each gRPC message received has a limit of 4 MB.
This limit applies to all gRPC endpoints across the Temporal Platform.

### Event History transaction size limit {/* #event-history-transaction-size-limit */}
...
### Transaction Payload size limit {/* #transaction-payload-size-limit */}
...
### Per Workflow Execution concurrency limits {/* #per-workflow-execution-concurrency-limits */}
...
### Per Workflow Execution Signal limit {/* #per-workflow-execution-signal-limit */}
...
### Per Workflow Execution Update limits {/* #per-workflow-execution-update-limits */}

A single Workflow Execution can have a maximum of 10 in-flight Updates and 2000 total Updates in History.

### Workflow Execution Event History limits {/* #workflow-execution-event-history-limits */}
...
### Timer duration limit {/* #timer-duration-limit */}

Timers have a maximum duration of 100 years in Temporal Cloud.

## Worker Versioning level {/* #worker-versioning-level */}
