...
- Scope: Account
- Default allowance: 10 namespaces
- Auto-scales: Automatically increases as you actively use Namespaces, up to 100 — no action needed.
- To go higher: [Contact support](/cloud/support#support-ticket)
