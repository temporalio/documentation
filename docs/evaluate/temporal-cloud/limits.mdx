...
| APIs that rely on Visibility            | APIs that do not rely on Visibility      |
|-----------------------------------------|-----------------------------------------|
| CountWorkflowExecutions                 | GetWorkerTaskReachability              |
| ScanWorkflowExecutions                  | ListSchedules                          |
| ListOpenWorkflowExecutions              | ListBatchOperations                    |
| ListClosedWorkflowExecutions            | DescribeTaskQueueWithReachability      |
| ListWorkflowExecutions                  | ListDeployments                        |
| ListArchivedWorkflowExecutions          | GetDeploymentReachability              |
