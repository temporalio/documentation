---
id: aws-privatelink
title: Private Communication - AWS PrivateLink
...
2. Search for "VPC" in _Services_ and select the option.
   ...
   ![AWS console showing services, features, resources](/img/aws-privatelink/aws-console.png)
...
7. Confirm your service by clicking on the _Verify service_ button. AWS should respond "Service name verified."
   ...
   ![The service name field is filled out and the Verify service button is shown](/img/aws-privatelink/service-settings.png)
...
10. Click the _Create endpoint_ button at the bottom of the screen.
    ...
    ![The created endpoint appears in the Endpoints list](/img/aws-privatelink/endpoint-created.png)
...
12. Once available, you can use AWS PrivateLink.
    ...
    ![Highlighted DNS names section shows your hostname](/img/aws-privatelink/details.png)
