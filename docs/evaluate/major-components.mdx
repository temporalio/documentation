...
description: "Temporal is an open-source workflow automation platform consisting of four components: SDKs for building applications, Service for state maintenance, CLI for management, and UI for application state viewing and metadata access."
