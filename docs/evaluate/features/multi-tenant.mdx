...
- **Inter-namespace communication**: Use [Nexus](/evaluate/features/nexus) for controlled communication between Namespaces.
...
See the [multi-tenant application patterns guide](/best-practices/multi-tenant-patterns) for detailed recommendations on architecting multi-tenant applications with Temporal.
