...
Our pricing reflects your use of [_Actions_](#action), [_Storage_](#storage), and [_Support_](/evaluate/cloud/support#support).
...
Your total invoice each calendar month is the combination of Temporal Cloud consumption ([Actions](#action) and [Storage](#storage)), and a [Temporal Cloud Support Plan](#base_plans).

### Temporal Cloud Support plans {/* #base_plans */}

**How plans work**


Each Temporal Cloud account includes a plan with Support. Higher tiers include Actions, Active Storage, Retained Storage and add-on features for the platform.
...
| Plan Pricing      | No base fee<br />- 10% of Usage Spend                                          | Greater of<br />- &#36;500/mo or<br />- 10% of Usage Spend                                                                        | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                                               | Priced annually:<br /> [contact Sales](mailto:sales@temporal.io) for details                                                                               |
...
Find a complete description of Support offerings and response times in the [Support](/evaluate/cloud/support) documentation.
...
**Specific Billable Actions are discussed on the [Actions](/evaluate/cloud/actions) page.**
...
Both models meter and bill for three primary components: [Actions](#action), [Storage](#storage), and [your Temporal Cloud Plan](/evaluate/cloud/support#support).

- With Pay-As-You-Go, you are invoiced each calendar month based on your consumption.
  On the Business plan and above, Pay-As-You-Go pricing automatically applies volume prices as your Actions scale.
...
The Developer plan is billed at &#36;50 per million Actions at every volume.
On the Business, Enterprise, and Mission Critical plans, you gain progressive volume discounts as you scale.
Greater discounts are available through commitments.
Discounts are based on your account's total usage, metered and billed for each calendar month:

| Actions (Business, Enterprise, and Mission Critical) | Price per Million Actions                                                                 |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| First 5M                                             | &#36;50                                                                                   |
...
If you are on the Business plan and consume 11.25M Actions in excess of your plan's allocation in one calendar month, your bill for Actions will be:
...
You are billed for Active and Retained Storage as follows:
...
- The Developer tier is priced at the greater of &#36;0/month or 10% of your Temporal Cloud consumption.
...
If you are signed up for Business, with &#36;6,000 of monthly spend, your bill will be:
...
You can also purchase Temporal Cloud commitment credits through [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-xx2x66m6fp2lo) and [GCP Marketplace](https://console.cloud.google.com/marketplace/product/temporal-public/temporal-cloud-pay-as-you-go).
...
If you have a namespace that requests 4 TRUs (that is, 2,000 APS) for 4 hours and have usage as follows:
...
This lets a replica take over automatically when incidents or outages occur.
...
Single sign-on (SSO) integration using SAML is included for all customers on the Developer, Business, Enterprise, and Mission Critical Plans.

**What costs are associated with SCIM?**

SCIM (System for Cross-domain Identity Management) is included in the Enterprise or Mission Critical support plans. SCIM is available as an add-on for the Developer or Business plan (+$500/month).
...
To pay with an AWS or Google Cloud account, sign up in the [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-xx2x66m6fp2lo) or [GCP Marketplace](https://console.cloud.google.com/marketplace/product/temporal-public/temporal-cloud-pay-as-you-go).
...
The Developer plan starts at &#36;0/month.
This means you only pay for what you use.
For example, running a test Workflow with 10,000 Actions costs 10,000 ⨉ &#36;50 per million Actions = &#36;0.50, plus 10% for support, for a total of &#36;0.55.
For tiers with included Actions and Storage, consumption in excess of your plan's allocations is billed on a consumption basis.

**Can I purchase Temporal Cloud through AWS Marketplace or Google Cloud Marketplace?**

Yes.
Both marketplaces offer the same two purchase paths:

- **Pay-As-You-Go**: subscribe directly in [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-xx2x66m6fp2lo) or [GCP Marketplace](https://console.cloud.google.com/marketplace/product/temporal-public/temporal-cloud-pay-as-you-go).
- **Credits**: available via private offer. Contact our team at [sales@temporal.io](mailto:sales@temporal.io).

Billing goes through your AWS or Google Cloud account.
