...
An Action is a billable operation in the Temporal Cloud Service, such as starting a Workflow, sending a Signal, recording a Heartbeat, or scheduling an Activity.
Pricing starts at $50 per million Actions, with volume discounts as usage grows.
...
Four plans, Essentials, Business, Enterprise, and Mission Critical, differ in support level, included Actions and Storage, and features such as SAML and SCIM.
The Essentials plan starts at $100/month.
Sign up and manage your plan at [cloud.temporal.io](https://cloud.temporal.io).

See [Pricing](/cloud/pricing) for rates and worked examples.
