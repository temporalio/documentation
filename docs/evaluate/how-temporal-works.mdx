...
Thousands of developers trust Temporal for use cases like order processing, customer onboarding, and payment handling because it enables them to build invincible applications that are resilient, durable, and *just work*. 
...
Your data is also protected with your encryption libraries and keys, ensuring that even Temporal never sees your data in clear text. 
...
Or jump straight into an [Introduction to Temporal 101](https://learn.temporal.io/courses/temporal_101/) course in Go, Java, Python, or Typescript.
