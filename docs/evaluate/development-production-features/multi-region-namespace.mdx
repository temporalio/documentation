...
title: Multi-region Replication - Temporal Cloud production feature
description: Temporal Cloud's Multi-region Replication offers automated failover, synchronized data replication, and high availability for workloads requiring disaster-tolerant deployment and 99.99% uptime.
sidebar_label: Multi-region replication
tags:
  - Temporal Cloud
  - High availability
keywords:
