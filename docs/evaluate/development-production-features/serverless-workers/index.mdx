...
Serverless Workers reduce this burden.
You still deploy the function and configure the compute provider, but Temporal handles invocation and scaling. There is no need to manage always-on infrastructure or configure autoscaling policies.
