...
### Get started faster {/* #get-started-faster */}
...
### Scale automatically {/* #scale-automatically */}
...
## When to use Serverless Workers {/* #when-to-use-serverless-workers */}
...
## How Serverless Workers compare to long-lived Workers {/* #how-serverless-workers-compare-to-long-lived-workers */}
