...
description: Discover Temporal's Workflow, Activity, and Worker framework; orchestrate steps, encapsulate business logic, and execute code efficiently using the Temporal SDK in your favorite language. [TODO] update as part of core apps
...
<RelatedReadContainer>
  ...
  <RelatedReadItem path="/develop/typescript/client/temporal-client#connect-to-development-service" text="TypeScript SDK Core application feature guide" archetype="feature-guide" />
