...
**Workflows**, **Activities**, **Standalone Activities**, and **Workers** form the core parts of a Temporal Application.
...
**Activities**: An Activity is a method or function that encapsulates business logic prone to failure (for example, calling a service that may go down).
...
<RelatedReadContainer>
  ...
  <RelatedReadItem path="/develop/java" text="Java SDK Core application feature guide" archetype="feature-guide" />
  ...
  <RelatedReadItem path="/develop/rust" text="Rust SDK Core application feature guide" archetype="feature-guide" />
