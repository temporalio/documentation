...
| **High availability and failover** | ✅ [Multi-region Namespaces](/evaluate/development-production-features/high-availability) | ✅ [Global Namespaces & Multi-Cluster Replication](/evaluate/development-production-features/high-availability) |
