...
It promotes a more modular architecture for sharing a subset of your team’s capabilities through a well-defined service API contracts for other teams to use which abstract underlying Temporal primitives, like Workflows, or execute arbitrary code.
...
Nexus is available in Public Preview with the [Temporal Go SDK](https://learn.temporal.io/getting_started/go) <img src="/img/golang.svg" alt="Go Icon" width="40" height="10"/>