...
- **[Temporal Nexus](/evaluate/nexus)**: Nexus allows you to connect Temporal Applications across isolated namespaces. This provides all of the benefits of Durable Execution across team and application boundaries for improved modularity, security, troubleshooting, and fault isolation.
