...
<Components.RelatedReadContainer>
    <Components.RelatedReadItem path="/develop/go/observability" text="Observability using the Go SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/dotnet/observability" text="Observability using the .NET SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/java/observability" text="Observability using the Java SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/php/observability" text="Observability using the PHP SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/python/observability" text="Observability using the Python SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/typescript/observability" text="Observability using the TypeScript SDK" archetype="feature-guide" />
</Components.RelatedReadContainer>
