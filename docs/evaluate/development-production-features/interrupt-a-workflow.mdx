...
description: Manage Workflow interruptions in Temporal; understand how to gracefully handle Workflow cancellations and terminations to ensure proper cleanup and state management.
...
<RelatedReadContainer>
    ...
    <RelatedReadItem path="/develop/java/cancellation" text="Handling Cancellation and Termination using the Go SDK" archetype="feature-guide" />
