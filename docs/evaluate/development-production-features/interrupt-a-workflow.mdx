...
<Components.RelatedReadContainer>
    <Components.RelatedReadItem path="/develop/go/cancellation" text="Handling Cancellation and Termination using the Go SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/php/cancellation" text="Handling Cancellation and Termination using the PHP SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/python/cancellation" text="Handling Cancellation and Termination using the Python SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/typescript/cancellation" text="Handling Cancellation and Termination using the TypeScript SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/dotnet/cancellation" text="Handling Cancellation and Termination using the .NET SDK" archetype="feature-guide" />
</Components.RelatedReadContainer>
