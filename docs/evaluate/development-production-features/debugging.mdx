...
<Components.RelatedReadContainer>
    <Components.RelatedReadItem path="/develop/go/debugging" text="Debugging using the Go SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/java/debugging" text="Debugging using the Java SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/php/debugging" text="Debugging using the PHP SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/python/debugging" text="Debugging using the Python SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/typescript/debugging" text="Debugging using the TypeScript SDK" archetype="feature-guide" />
    <Components.RelatedReadItem path="/develop/dotnet/debugging" text="Debugging using the .NET SDK" archetype="feature-guide" />
</Components.RelatedReadContainer>
