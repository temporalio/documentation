...
<RelatedReadContainer>
  ...
  <RelatedReadItem path="/develop/php/message-passing" text="PHP SDK Workflow message passing feature guide" archetype="feature-guide" />
  ...
  <RelatedReadItem path="/develop/ruby/message-passing" text="Ruby SDK Workflow message passing feature guide" archetype="feature-guide" />
</RelatedReadContainer>
