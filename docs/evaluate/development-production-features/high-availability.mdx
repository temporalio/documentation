...
<Components.RelatedReadContainer>
    <Components.RelatedReadItem path="/cloud/high-availability" text=" Namespaces with High Availability features for Temporal Cloud" archetype="encyclopedia" />
    <Components.RelatedReadItem path="/global-namespace" text="Global Namespace for self-hosted deployments" archetype="encyclopedia" />
    <Components.RelatedReadItem path="/cloud/pricing" text="Multi-region Pricing" archetype="encyclopedia" />
    <Components.RelatedReadItem path="/cloud/high-availability/private-link" text="PrivateLink routing for Multi-region replication" archetype="encyclopedia" />
</Components.RelatedReadContainer>
