...
#### Unified programming model & worker deployment {/* #unified-programming-model--worker-deployment */}
...
#### Observability & lifecycle controls {/* #observability--lifecycle-controls */}
