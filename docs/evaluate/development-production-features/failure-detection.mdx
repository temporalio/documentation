...
<RelatedReadContainer>
    ...
    <RelatedReadItem path="/develop/dotnet/failure-detection#workflow-timeouts" text="Set Workflow timeouts and Retry Policies using the .NET SDK" archetype="feature-guide" />
    <RelatedReadItem path="/develop/ruby/failure-detection#workflow-timeouts" text="Set Workflow timeouts and Retry Policies using the Ruby SDK" archetype="feature-guide" />
</RelatedReadContainer>
...
<RelatedReadContainer>
  ...
  <RelatedReadItem path="/develop/dotnet/failure-detection#activity-timeouts" text="Set Activity timeouts and Retry Policies using the .NET SDK" archetype="feature-guide" />
  <RelatedReadItem path="/develop/ruby/failure-detection#activity-timeouts" text="Set Activity timeouts and Retry Policies using the Ruby SDK" archetype="feature-guide" />
</RelatedReadContainer>
