...
<RelatedReadContainer>
    ...
    <RelatedReadItem path="/develop/rust/workflows/timeouts" text="Set Workflow timeouts and Retry Policies using the Rust SDK" archetype="feature-guide" />
</RelatedReadContainer>
...
<RelatedReadContainer>
  ...
  <RelatedReadItem path="/develop/rust/activities/timeouts" text="Set Activity timeouts and Retry Policies using the Rust SDK" archetype="feature-guide" />
</RelatedReadContainer>
