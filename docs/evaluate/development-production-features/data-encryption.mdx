...
<RelatedReadContainer>
    <RelatedReadItem path="/develop/go/best-practices/converters-and-encryption" text="Data Encryption using the Go SDK" archetype="feature-guide" />
    ...
    <RelatedReadItem path="/develop/python/best-practices/converters-and-encryption" text="Data Encryption using the Python SDK" archetype="feature-guide" />
