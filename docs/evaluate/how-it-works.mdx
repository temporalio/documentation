...
### Activities
Activities are the individual tasks in your Workflow - functions or methods depending on the programming language.
...
Since Activities often rely on external systems, transient issues can occur - temporary but critical problems like network failures, timeouts, or service outages. 
