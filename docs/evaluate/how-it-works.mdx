...
Software Engineers spend a lot of time ensuring that their applications are reliable.
...
## Observability
To recap, the Temporal SDK is used to build and run your Temporal applications. 
...
Both tools are powerful for debugging uses. 

### The Temporal UI 
The Temporal UI is a powerful tool for developers to monitor and debug their applications. 
It's a browser-based user interface that allows you to see the progress and state of the your application. 
The Web UI can also help you to quickly isolate, debug, and resolve production problems.

![Recent Workflows page](/img/how-it-works/workflow-details-page-hiw.avif)

### The Temporal CLI 
The Temporal CLI is a command-line interface is another tool for managing, monitoring, and debugging Temporal Applications.
