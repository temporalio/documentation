...
description: Temporal Cloud is a SaaS platform that ensures the durability and reliable execution of your Temporal Applications, offering high availability with multi-region Namespaces for seamless failover.
sidebar_position:
  1
tags:
