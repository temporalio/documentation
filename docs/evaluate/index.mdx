...
description: "Temporal is a platform for building distributed applications, providing a clear code structure, visibility, fault-tolerance, and execution guarantees, making it an ideal choice for companies of all sizes handling mission-critical and standard workloads."
collapsed: false
