...
- With tctl: <a class="tdlp" href="/cli/operator#delete">`tctl namespace delete`<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">temporal operator delete</span><br /><br /><span class="tdlppd">Deletes an existing Namespace.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/cli/operator#delete">Learn more</a></span></span></a>.
