...
[common/authorization/claimMapper.go](https://github.com/temporalio/temporal/blob/master/common/authorization/claimMapper.go)
```go
...
[common/authorization/tokenKeyProvider.go](https://github.com/temporalio/temporal/blob/master/common/authorization/tokenKeyProvider.go)
```go
