...
`clusterMetadata` contains the local cluster information. The information will be used in [Multi-cluster Replication](/docs/concepts/what-is-multi-cluster-replication).
