...
<PatternCards items={[
  {
    ...
    description: "Models a long-lived business entity — a user account, device, or order — as a single Workflow, with Signals and Updates driving every state transition.",
  },
  {
