...
description: "Pattern selection guide for controlling execution rate, protecting downstream services from overload, and distributing dispatch across tenants."
---
...
<PatternCards items={[
  ...
  },
  {
    ...
    title: "Fairness",
    description: "Distributes Task dispatches across tenants or users so a burst from one caller does not starve the others.",
  },
]} />
