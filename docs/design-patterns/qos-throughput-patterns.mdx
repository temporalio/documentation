...
description: "Pattern selection guide for controlling execution rate, protecting downstream services from overload, and providing fair dispatch across tenants."
---
...
<PatternCards items={[
  ...
  },
  {
    ...
    title: "Priority",
    description: "Assigns a priority level to Workflows and Activities so time-sensitive work dispatches ahead of lower-priority work on the same Task Queue.",
  },
  {
