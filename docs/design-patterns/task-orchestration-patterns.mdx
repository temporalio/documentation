...
description: "Compares Child Workflows, Parallel Execution, and Pick First (Race) for decomposing, running concurrently, and racing work inside a single Workflow."
---
...
<PatternCards items={[
  ...
  },
  {
    ...
    description: "Races multiple Activities in parallel, takes the first result to arrive, and cancels the rest.",
  },
]} />
