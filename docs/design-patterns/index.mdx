...
<PatternCards items={[
  ...
  },
  {
    ...
    title: "Priority",
    description: "Assigns a priority level to Workflows and Activities so that time-sensitive work dispatches ahead of lower-priority work within a single Task Queue.",
  },
  {
    href: "/design-patterns/fairness",
    icon: "fairness-icon.svg",
    title: "Fairness",
    description: "Distributes Task dispatches across tenants or users so that a burst from one caller does not starve the others.",
  },
]} />
