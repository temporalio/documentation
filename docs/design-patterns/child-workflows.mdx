...
import * as Child from '@site/src/components/elements/AnnotatedCode/annotations/childWorkflows';
...
<Tabs groupId="language" queryString>
<TabItem value="python" label="Python">
<AnnotatedCode annotations={Child.python}>
```python
from temporalio import workflow
...
<TabItem value="go" label="Go">
<AnnotatedCode annotations={Child.go}>
```go
func ParentWorkflow(ctx workflow.Context, input string) (string, error) {
    cwo := workflow.ChildWorkflowOptions{
...
<TabItem value="java" label="Java">
<AnnotatedCode annotations={Child.java}>
```java
public class ParentWorkflowImpl implements ParentWorkflow {
  @Override
...
<TabItem value="typescript" label="TypeScript">
<AnnotatedCode annotations={Child.typescript}>
```typescript
