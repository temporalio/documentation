...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <video src="/video/human-in-the-loop.mp4" poster="/img/design-patterns/human-in-the-loop-poster.jpg" width="704" height="396" controls></video>
</div>
...
Because all decisions are recorded in the event history, the Workflow's code is deterministic and replay-safe.
