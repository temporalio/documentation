...
description: "Temporal provides SDKs for .Net, Go, Java, PHP, Python, and TypeScript to build applications, offering a range of options for developers to get started with Temporal development."
