...
sidebar_label: "Build Your First Temporal Application"
...
You'll build a money transfer app that withdraws from one account, deposits to another, and refunds if the deposit fails. You'll run it against a local Temporal server and watch it complete in the UI.
