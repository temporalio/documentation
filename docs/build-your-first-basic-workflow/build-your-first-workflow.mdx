...
A **Task Queue** is where Temporal Workers look for Tasks about Workflows and Activities to execute. Each Task Queue is identified by a name, which you specify when you configure the Worker and again in the code that starts the Workflow Execution.
