...
<TemporalProgress steps={[
  { id: 'part1', label: 'Part 1: Build Your First Workflow', status: 'completed', href: '/build-your-first-basic-workflow/build-your-first-workflow' },
  { id: 'part2', label: 'Part 2: Failure Simulation', status: 'active', href: '/build-your-first-basic-workflow/failure-simulation' }
]} />
