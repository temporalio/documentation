...
We've all been there: a seemingly harmless deployment brings down production, a database connection times out during peak traffic, or a third-party service decides to have an outage right when you need it most. 
