...
<TemporalProgress steps={[
  { id: 'part1', label: 'Part 1: Build a Financial Transaction Application', status: 'completed', href: '/build-your-first-basic-workflow/build-your-first-workflow' },
  { id: 'part2', label: 'Part 2: Simulate Failure', status: 'active', href: '/build-your-first-basic-workflow/simulate-failure' }
]} />
...
<AnimatedTerminal 
  lines={[
    ...
    "Doing a withdrawal from A1001 for 100",
