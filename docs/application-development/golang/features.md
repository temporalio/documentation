...
See <a class="tdlp" href="/application-development/golang/foundations#connect-to-temporal-cloud">how to set Namespace in a Client in Go<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">How to connect to Temporal Cloud</span><br /><br /><span class="tdlppd">Use a compatible mTLS CA certificate and mTLS private key and your Cloud Namespace to connect to Temporal Cloud.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="/application-development/golang/foundations#connect-to-temporal-cloud">Learn more</a></span></span></a> for details.
