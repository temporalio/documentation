...
The observability section of the Temporal Application development guide covers the many ways to view the current state of your [Temporal Application](/temporal#temporal-application) – that is, ways to view what [Workflow Executions](/workflows#workflow-executions) are tracked by the [Temporal Platform](/temporal#temporal-platform) and the state of any given Workflow Execution, either currently or at points of an execution.
