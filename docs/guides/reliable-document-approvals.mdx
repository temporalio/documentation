...
- [Signals](/signals) — the mechanism for sending data to a running Workflow
- [Queries](/queries) — the mechanism for reading Workflow state without affecting execution
- [Workers](/workers) — the processes that execute Workflow and Activity code
- [Task Queues](/task-queues) — the named queues that route work to Workers
