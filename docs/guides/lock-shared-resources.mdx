...
- **Required concepts**:
    ...
    - Child Workflows and parent close policies ([docs](/encyclopedia/child-workflows)).
    - Signals and Queries ([docs](/encyclopedia/workflow-message-passing)).
    - Workflow determinism ([docs](/workflows#workflow-determinism)).
...
- [Child Workflow Executions](/encyclopedia/child-workflows). How parent and child Workflows interact, including parent close policies.
