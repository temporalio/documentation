...
- [Temporal Task Queues](/task-queues): The named queues that route work from the Temporal Server to Workers
...
- [Message Passing — Signals, Queries, Updates](/develop/python/message-passing)
...
- [Failure Detection — Timeouts, Activity Heartbeating, and Retry Policies](/develop/python/failure-detection)
