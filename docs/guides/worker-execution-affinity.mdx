...
- **Go SDK** has a built-in [Worker Sessions API](/develop/go/sessions) that handles Worker-specific routing automatically
...
- [Temporal Documentation - Worker Sessions (Go SDK)](/develop/go/sessions)
