...
- **Reject Duplicate**: The Workflow Execution cannot exist if there is a previous Workflow Execution with the same Workflow Id, regardless of the Closed status.
