...
### When and why you should use Worker Versioning {/* #when-and-why-you-should-use-worker-versioning */}
...
#### Decommission old Workers {/* #decommission-old-workers */}
...
#### Deploy code changes to Workers {/* #deploy-code-changes-to-workers */}
...
### How to use Worker Versioning {/* #how-to-use-worker-versioning */}
...
#### Defining the version sets {/* #defining-the-version-sets */}
...
#### Permitted and forbidden operations on version sets {/* #permitted-and-forbidden-operations-on-version-sets */}
...
### Build ID reachability {/* #build-id-reachability */}
...
### Unversioned Workers {/* #unversioned-workers */}
