...
For newer revisions of this feature set, please see [Safe Deploys](/production-deployment/worker-deployments/safe-deploys) instead.
...
This section is for a deprecated Worker Versioning API. Please redirect your attention to [Safe Deploys](/production-deployment/worker-deployments/safe-deploys).
...
This section is for a deprecated Worker Versioning API. See [Safe Deploys](/production-deployment/worker-deployments/safe-deploys).
