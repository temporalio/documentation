...
description: "Learn about child workflow executions, a feature in Temporal that allows workflows to spawn other workflows, with guides for Go, Java, PHP, Python, and TypeScript SDKs."
