...
- [Python SDK Child Workflow feature guide](//dev-guide/python/child-workflows)
...
- [How to set a Parent Close Policy using the Python SDK](/dev-guide/python/child-workflows#parent-close-policy)
