...
- [Java SDK - Standalone Nexus Operations](/develop/java/nexus/standalone-operations)
- [Python SDK - Standalone Nexus Operations](/develop/python/nexus/standalone-operations)
- [TypeScript SDK - Standalone Nexus Operations](/develop/typescript/nexus/standalone-operations)
- [.NET SDK - Standalone Nexus Operations](/develop/dotnet/nexus/standalone-operations)
...
[`temporal operator nexus endpoint create`](/cli/operator#nexus-endpoint-create).
