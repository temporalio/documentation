...
### Synchronous Operation lifecycle {/* #synchronous-operation-lifecycle */}
...
### At-least-once execution semantics and idempotency {/* #at-least-once-execution-semantics-and-idempotency */}
...
### Exactly-once execution semantics {/* #exactly-once-execution-semantics */}
