...
For language-specific examples, migration from earlier handler APIs, and Worker registration, see [How to use the Temporal Operation Handler](/develop/nexus/temporal-operation-handler).
...
- [How to use the Temporal Operation Handler](/develop/nexus/temporal-operation-handler) — SDK examples and migration
