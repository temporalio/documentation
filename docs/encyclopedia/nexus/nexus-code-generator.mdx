...
The Nexus Code Generator, [`nexgen`](https://github.com/temporalio/nex-gen), generates client code for Go, Java, Python, and TypeScript from a schema file that defines the contract.
