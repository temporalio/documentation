...
#### Authoring message handler patterns {/* #authoring-message-handler-patterns */}
...
#### Exceptions in Signals {/* #exceptions-in-signals */}
...
#### Exceptions in Updates {/* #exceptions-in-updates */}
...
#### Errors and panics in message handlers in the Go SDK {/* #errors-and-panics-in-message-handlers-in-the-go-sdk */}
