...
#### Send a Signal from a Temporal Client or the CLI {/* #send-a-signal-from-a-temporal-client-or-the-cli */}
...
#### Send a Signal from one Workflow to another {/* #send-a-signal-from-one-workflow-to-another */}
