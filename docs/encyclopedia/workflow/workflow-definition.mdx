...
**[Workflow Definition in Typescript](/develop/typescript/workflows/basic-workflow)**
...
- [Go: Develop Workflow logic](/develop/go/core-application#workflow-logic-requirements)
- [Java: Workflow logic requirements](/develop/java/core-application#workflow-logic-requirements)
- [Python: Develop Workflow logic](/develop/python/core-application#workflow-logic-requirements)
- [TypeScript: Develop Workflow logic](/develop/typescript/core-application#workflow-logic-requirements)
- [.NET: Workflow logic requirements](/develop/dotnet/core-application#workflow-logic-requirements)
- [Ruby: Workflow Logic Requirements](/develop/ruby/core-application#workflow-logic-requirements)
