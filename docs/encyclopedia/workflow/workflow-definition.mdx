...
- [How to version Workflow code in Go](/develop/go/versioning)
- [How to version Workflow code in Java](/develop/java/versioning)
- [How to version Workflow code in Python](/develop/python/versioning)
- [How to version Workflow code in PHP](/develop/php/versioning)
- [How to version Workflow code in TypeScript](/develop/typescript/versioning)
- [How to version Workflow code in .NET](/develop/dotnet/versioning)

Temporal also has a [Worker Versioning](/production-deployment/worker-deployments/worker-versioning) feature that allows you to tag your Workers and programmatically roll them out in pods tied to specific revisions, so that old Workers can run old code paths and new Workers can run new code paths. If you were using this method experimentally prior to summer 2025, refer to the [Worker Versioning Legacy](/encyclopedia/worker-versioning-legacy) docs.
