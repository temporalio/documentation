...
- [How to patch Workflow code in PHP](/develop/php/versioning#patching)
...
To learn more about Worker Versioning, see our [Worker Versioning](/product-deployment/worker-deployments/worker-versioning) page.
