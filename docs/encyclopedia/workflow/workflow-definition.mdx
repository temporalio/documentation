...
**[Workflow Definition in Java (Interface)](/develop/java/workflows/basic-workflow)**
...
**[Workflow Definition in Java (Implementation)](/develop/java/workflows/basic-workflow)**
