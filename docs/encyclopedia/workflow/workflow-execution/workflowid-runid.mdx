...
The `Principal` fields represent the authenticated principal responsible for a dataplane execution action. 
...
To enable Principal Atribution for a Namespace, contact [Temporal Cloud support](https://docs.temporal.io/cloud/support#support-ticket).