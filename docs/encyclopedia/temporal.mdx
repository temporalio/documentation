...
The Temporal Platform consists of a supervising software typically called a [Temporal Service](/clusters) and application code bundled as Worker Processes.
...
A Temporal Client is available in each SDK and provides a set of APIs to communicate with a [Temporal Service](/clusters).
