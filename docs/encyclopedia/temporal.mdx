...
sidebar_position: 1
description: Discover the Temporal Platform, a runtime for durable executions that consists of a Temporal Service and Worker Processes, plus SDKs in multiple languages.
slug: /temporal
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">The Temporal System</p>
  </div>
  <div class="tdiiw" height="740">
    <img class="img_ev3q" src="/diagrams/temporal-system-simple.svg" alt="The Temporal System" />
  </div>
</div>
...
The Temporal Platform consists of a supervising software typically called a [Temporal Service](/temporal-service) and application code bundled as Worker Processes.
Together these components create a runtime for your application.

<div class="tdiw">
  <div class="tditw">
    <p class="tdit">The Temporal Platform</p>
  </div>
  <div class="tdiiw" height="740">
    <img class="img_ev3q" src="/diagrams/temporal-platform-simple.svg" alt="The Temporal Platform" />
  </div>
</div>

A Temporal Service consists of the Temporal Server and a database.

Our software as a service (SaaS) offering, Temporal Cloud, offers an alternative to hosting a Temporal Service yourself.

Worker Processes are hosted and operated by you and execute your code. Workers run using one of our SDKs.

<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Basic component topology of the Temporal Platform</p>
  </div>
  <div class="tdiiw" height="1121">
    <img
      class="img_ev3q"
...
A Temporal Client is available in each SDK and provides a set of APIs to communicate with a [Temporal Service](/temporal-service).
