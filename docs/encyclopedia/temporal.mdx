...
description: "Temporal is a scalable and reliable runtime for durable function executions, ensuring business logic runs reliably even with failures, crashes, or outages, enabling application code to execute once and complete without losing progress."
slug: /temporal
