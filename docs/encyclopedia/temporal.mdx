...
This is achieved through Temporal's use of an [Event History](/workflow-execution#event-history), which records the state of a Workflow Execution at each step.
