...
<WalkthroughStep title="Internal steps" kind="internal" lines="7-8,14-17,21-25">
...
<WalkthroughStep title="Steps that reach the Temporal Service" kind="command" lines="10,19,27,31">
...
<WalkthroughStep title="Total the price of the order" kind="internal" lines="7-8">
...
<WalkthroughStep title="Evaluate the distance" kind="internal" lines="14-17">
...
<WalkthroughStep title="Start a Timer" kind="command" lines="19">
...
<WalkthroughStep title="Populate the bill" kind="internal" lines="21-25">
...
<WalkthroughStep title="Request the SendBill Activity" kind="command" lines="27-29">
...
<WalkthroughStep title="Return from the Workflow" kind="command" lines="31">
...
<WalkthroughStep title="The GetDistance Activity is scheduled" kind="command" lines="10-12">
...
<WalkthroughStep title="A Worker polls for the Activity Task" kind="service" lines="10-12">
...
<WalkthroughStep title="The Activity Task closes" kind="service" lines="10-12">
...
<WalkthroughStep title="The Activity reports its result" kind="service" lines="10-12">
...
<WalkthroughStep title="The Worker starts a Timer" kind="command" lines="19">
...
<WalkthroughStep title="The Timer fires" kind="service" lines="21-25">
...
<WalkthroughStep title="The SendBill Activity is scheduled" kind="command" lines="27-29">
...
<WalkthroughStep title="A Worker dequeues the Activity Task" kind="service" lines="27-29">
...
<WalkthroughStep title="The bill is sent" kind="service" lines="27-29">
...
<WalkthroughStep title="A Client requests the Workflow Execution" kind="service" phase="Original execution" lines="1-2,4-5">
...
<WalkthroughStep title="The Worker runs the Workflow code" kind="internal" phase="Original execution" lines="7-8">
...
<WalkthroughStep title="The Worker completes the Workflow Task" kind="command" phase="Original execution" lines="10-12">
...
<WalkthroughStep title="The GetDistance Activity Task is scheduled" kind="command" phase="Original execution" lines="10-12">
...
<WalkthroughStep title="A Worker starts the Activity Task" kind="service" phase="Original execution" lines="10-12">
...
<WalkthroughStep title="The Activity returns a distance of 15" kind="service" phase="Original execution" lines="10-12">
...
<WalkthroughStep title="The result goes back to the Workflow" kind="service" phase="Original execution" lines="14-17">
...
<WalkthroughStep title="The Worker starts a Timer" kind="command" phase="Original execution" lines="19">
...
<WalkthroughStep title="The Timer fires" kind="service" phase="Original execution" lines="19">
...
<WalkthroughStep title="The Worker crashes" kind="crash" phase="Worker crash" lines="21-25">
...
<WalkthroughStep title="Replay re-executes the code" kind="replay" phase="History Replay" lines="7-8">
...
<WalkthroughStep title="The Activity result comes from the History" kind="replay" phase="History Replay" lines="10-12">
...
<WalkthroughStep title="Replay assigns the stored result" kind="replay" phase="History Replay" lines="14-17">
...
<WalkthroughStep title="The Timer is already done" kind="replay" phase="History Replay" lines="19">
...
<WalkthroughStep title="State is restored to the point of the crash" kind="replay" phase="History Replay" lines="21-25">
...
<WalkthroughStep title="Execution moves past the crash" kind="command" phase="Execution resumes" lines="27-29">
...
<WalkthroughStep title="The SendBill Activity runs" kind="command" phase="Execution resumes" lines="27-29">
...
<WalkthroughStep title="One more Workflow Task delivers the result" kind="service" phase="Execution resumes" lines="31">
...
<WalkthroughStep title="The Workflow Execution completes" kind="command" phase="Execution resumes" lines="31">
...
<WalkthroughStep title="The ImportSalesData Activity runs" kind="command" phase="First execution" lines="9-12">
...
<WalkthroughStep title="The Workflow starts a 4-hour Timer" kind="command" phase="First execution" lines="16">
...
<WalkthroughStep title="The Worker crashes" kind="crash" phase="First execution" lines="19">
...
<WalkthroughStep title="The first Command matches" kind="replay" phase="History Replay" lines="10-12">
...
<WalkthroughStep title="The random number returns something different" kind="replay" phase="History Replay" lines="14-17">
...
<WalkthroughStep title="The next Command does not match" kind="crash" phase="History Replay" lines="21-23">
...
<WalkthroughStep title="Replay fails with a non-determinism error" kind="crash" phase="History Replay" lines="14-17">
