...
[deterministic](https://docs.temporal.io/workflows#deterministic-constraints) in order for Replay to work.
...
[versioning](https://docs.temporal.io/develop/typescript/versioning) to learn more.
