...
<PhotoCarousel
  ...
  captions={[
    ...
    "Some steps are internal to the Workflow which do not involve interaction with the Service.",
...
Now that the codewalkthrough has covered how code maps to Commands, and how Commands map to Events, this next waltkthrough will take a look at how Temporal uses Replay with the Events to provide Durable Execution and restore a Workflow Execution in the case of a failure.
