...
<WalkthroughStep title="Internal steps" kind="internal" lines="5,13-15,20-25">
...
<WalkthroughStep title="Steps that reach the Temporal Service" kind="command" lines="7,18,27,33">
...
<WalkthroughStep title="Total the price of the order" kind="internal" lines="5">
...
<WalkthroughStep title="Request the GetDistance Activity" kind="command" lines="7-11">
...
<WalkthroughStep title="Evaluate the distance" kind="internal" lines="13-15">
...
<WalkthroughStep title="Start a Timer" kind="command" lines="17-18">
...
<WalkthroughStep title="Populate the bill" kind="internal" lines="20-25">
...
<WalkthroughStep title="Request the SendBill Activity" kind="command" lines="27-31">
...
<WalkthroughStep title="The GetDistance Activity is scheduled" kind="command" lines="7-11">
...
<WalkthroughStep title="A Worker polls for the Activity Task" kind="service" lines="7-11">
...
<WalkthroughStep title="The Activity Task closes" kind="service" lines="7-11">
...
<WalkthroughStep title="The Activity reports its result" kind="service" lines="7-11">
...
<WalkthroughStep title="The Worker starts a Timer" kind="command" lines="17-18">
...
<WalkthroughStep title="The Timer fires" kind="service" lines="20-25">
...
<WalkthroughStep title="The SendBill Activity is scheduled" kind="command" lines="27-31">
...
<WalkthroughStep title="A Worker dequeues the Activity Task" kind="service" lines="27-31">
...
<WalkthroughStep title="The bill is sent" kind="service" lines="27-31">
...
<WalkthroughStep title="A Client requests the Workflow Execution" kind="service" phase="Original execution" lines="1-4">
...
<WalkthroughStep title="The Worker runs the Workflow code" kind="internal" phase="Original execution" lines="5">
...
<WalkthroughStep title="The Worker completes the Workflow Task" kind="command" phase="Original execution" lines="7-11">
...
<WalkthroughStep title="The GetDistance Activity Task is scheduled" kind="command" phase="Original execution" lines="7-11">
...
<WalkthroughStep title="A Worker starts the Activity Task" kind="service" phase="Original execution" lines="7-11">
...
<WalkthroughStep title="The Activity returns a distance of 15" kind="service" phase="Original execution" lines="7-11">
...
<WalkthroughStep title="The result goes back to the Workflow" kind="service" phase="Original execution" lines="13-15">
...
<WalkthroughStep title="The Worker starts a Timer" kind="command" phase="Original execution" lines="17-18">
...
<WalkthroughStep title="The Timer fires" kind="service" phase="Original execution" lines="17-18">
...
<WalkthroughStep title="The Worker crashes" kind="crash" phase="Worker crash" lines="20-25">
...
<WalkthroughStep title="Replay re-executes the code" kind="replay" phase="History Replay" lines="5">
...
<WalkthroughStep title="The Activity result comes from the History" kind="replay" phase="History Replay" lines="7-11">
...
<WalkthroughStep title="Replay assigns the stored result" kind="replay" phase="History Replay" lines="13-15">
...
<WalkthroughStep title="The Timer is already done" kind="replay" phase="History Replay" lines="17-18">
...
<WalkthroughStep title="State is restored to the point of the crash" kind="replay" phase="History Replay" lines="20-25">
...
<WalkthroughStep title="Execution moves past the crash" kind="command" phase="Execution resumes" lines="27-31">
...
<WalkthroughStep title="The SendBill Activity runs" kind="command" phase="Execution resumes" lines="27-31">
...
<WalkthroughStep title="The import_sales_data Activity runs" kind="command" phase="First execution" lines="5-8">
...
<WalkthroughCommand label="ScheduleActivityTask" details="(import_sales_data)" tone="command" />
<WalkthroughEvent label="ActivityTaskScheduled" details="(import_sales_data)" tone="direct" />
<WalkthroughEvent label="ActivityTaskStarted" tone="indirect" />
<WalkthroughEvent label="ActivityTaskCompleted" tone="indirect" />

</WalkthroughStep>

<WalkthroughStep title="A random number decides the next branch" kind="internal" phase="First execution" lines="10">
...
<WalkthroughStep title="The Workflow starts a 4-hour Timer" kind="command" phase="First execution" lines="12">
...
<WalkthroughStep title="The Worker crashes" kind="crash" phase="First execution" lines="14">
...
<WalkthroughStep title="The first Command matches" kind="replay" phase="History Replay" lines="5-8">
...
<WalkthroughCommand label="ScheduleActivityTask" details="(import_sales_data) — created during Replay" tone="command" status="matched" />

</WalkthroughStep>

<WalkthroughStep title="The random number returns something different" kind="replay" phase="History Replay" lines="10-12">
...
<WalkthroughStep title="The next Command does not match" kind="crash" phase="History Replay" lines="16-20">
...
<WalkthroughCommand label="ScheduleActivityTask" details="(run_daily_report) — created during Replay" tone="command" status="mismatch" expected="StartTimer (4 hours)" />

</WalkthroughStep>

<WalkthroughStep title="Replay fails with a non-determinism error" kind="crash" phase="History Replay" lines="10-12">
