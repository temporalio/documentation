...
It executes concurrently to all other Workflow Executions, and communicates with other Workflow Executions through [Signals](/encyclopedia/application-message-passing#signals) and the environment through [Activities](/activities).
...
- Sending a [Signal](/encyclopedia/application-message-passing#signals): Progress can block on confirmation that the Signal sent.
