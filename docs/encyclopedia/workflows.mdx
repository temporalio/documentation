...
- [How to use Replay APIs using the Python SDK](/develop/python/test-suites#replay)
...
- Available in [Python SDK](https://docs.temporal.io/develop/python/messages#updates) since [v1.4.0](https://github.com/temporalio/sdk-python/releases/tag/1.4.0)
...
- [How to develop, and send Updates in Python](/develop/python/messages#updates)
