...
**[Workflow Definition in Go](/dev-guide/go/foundations#develop-workflows)**
...
**[Workflow Definition in Java (Interface)](/dev-guide/java/foundations#develop-workflows)**
...
**[Workflow Definition in Java (Implementation)](/dev-guide/java/foundations#develop-workflows)**
...
**[Workflow Definition in PHP (Interface)](/dev-guide/php/foundations#develop-workflows)**
...
**[Workflow Definition in PHP (Implementation)](/dev-guide/php/foundations#develop-workflows)**
...
**[Workflow Definition in Python](/dev-guide/python/foundations#develop-workflows)**
...
**[Workflow Definition in Typescript](/dev-guide/typescript/foundations#develop-workflows)**
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Type cardinality with Workflow Definitions and Workflow Executions</p>
  </div>
  <div class="tdiiw" height="440">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Command generation and waiting</p>
  </div>
  <div class="tdiiw" height="440">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Execution statuses</p>
  </div>
  <div class="tdiiw" height="524">
    <img class="img_ev3q" src="/diagrams/workflow-execution-statuses.svg" alt="Workflow Execution statuses" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Execution</p>
  </div>
  <div class="tdiiw" height="1246">
    <img class="img_ev3q" src="/diagrams/workflow-execution-swim-lane-01.svg" alt="Workflow Execution" />
  </div>
</div>
...
A Command is a requested action issued by a [Worker](/workers#worker) to the [Temporal Service](/temporal-service) after a [Workflow Task Execution](/workers#workflow-task-execution) completes.
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Commands are generated by the use of Workflow APIs in your code</p>
  </div>
  <div class="tdiiw" height="1480">
    <img
      class="img_ev3q"
...
A Temporal Service stores the full Event History of a Workflow Execution for the duration of a Namespace's retention period.
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Execution Timeout period</p>
  </div>
  <div class="tdiiw" height="1886">
    <img class="img_ev3q" src="/diagrams/workflow-execution-timeout.svg" alt="Workflow Execution Timeout period" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Run Timeout period</p>
  </div>
  <div class="tdiiw" height="1047">
    <img class="img_ev3q" src="/diagrams/workflow-run-timeout.svg" alt="Workflow Run Timeout period" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Workflow Task Timeout period</p>
  </div>
  <div class="tdiiw" height="1047">
    <img class="img_ev3q" src="/diagrams/workflow-task-timeout.svg" alt="Workflow Task Timeout period" />
  </div>
</div>
...
- [How to develop, send, and handle Updates in PHP](/dev-guide/php/features#updates)
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Parent and Child Workflow Execution entity relationship</p>
  </div>
  <div class="tdiiw" height="600">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Parent and Child Workflow Execution entity relationship with Continue As New</p>
  </div>
  <div class="tdiiw" height="700">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Parent Close Policy entity relationship</p>
  </div>
  <div class="tdiiw" height="543">
    <img class="img_ev3q" src="/diagrams/parent-close-policy.svg" alt="Parent Close Policy entity relationship" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Temporal Cron Job timeline</p>
  </div>
  <div class="tdiiw" height="1113">
    <img class="img_ev3q" src="/diagrams/temporal-cron-job.svg" alt="Temporal Cron Job timeline" />
  </div>
</div>
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Temporal Cron Job Run Failure with a Retry Policy</p>
  </div>
  <div class="tdiiw" height="1203">
    <img
      class="img_ev3q"
