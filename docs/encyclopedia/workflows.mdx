...
These limits are set with the following [dynamic configuration keys](https://github.com/temporalio/temporal/blob/main/components/nexusoperations/config.go#L52):
