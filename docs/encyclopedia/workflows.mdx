...
Depending on the programming language, it's typically a primary function or object method and specifies the end to end series of steps of a Temporal application.
...
public class YourWorkflow {
    ...
    [WorkflowRun]
    public async Task<string> workflowExample(string name) {
        // ...
    }
}
```
