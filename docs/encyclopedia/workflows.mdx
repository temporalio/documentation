...
- [How to develop, send, and handle Signals in Java](/dev-guide/java/messages#signals)
...
- [How to Signal-With-Start in Java](/dev-guide/java/messages#signal-with-start)
...
- [How to send and handle Queries with the Java SDK](/dev-guide/java/messages#queries)
