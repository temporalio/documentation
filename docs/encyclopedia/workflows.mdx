...
**[Workflow Definition in C# and .NET](https://github.com/temporalio/sdk-dotnet?tab=readme-ov-file#implementing-a-workflow-and-activity)**
...
- [How to version Workers in Go](/develop/go/versioning#worker-versioning)
- [How to version Workers in Java](/develop/java/versioning#worker-versioning)
- [How to version Workers in Python](/develop/python/versioning#worker-versioning)
- [How to version Workers in TypeScript](/develop/typescript/versioning#worker-versioning)
...
- [How to start a Workflow Execution using the PHP SDK](/develop/php/core-application#start-workflow-execution)
- [How to start a Workflow Execution using the Python SDK](/develop/python/core-application#start-workflow-execution)
- [How to start a Workflow Execution using the TypeScript SDK](/develop/typescript/core-application#start-workflow-execution)
...
- [How to use Replay APIs using the Go SDK](/develop/go/test-suites#replay)
- [How to use Replay APIs using the Java SDK](/develop/java/test-suites#replay)
- [How to use Replay APIs using the Python SDK](/develop/python/testing-suite#replay)
- [How to use Replay APIs using the TypeScript SDK](/develop/typescript/test-suites#replay)
...
- If the Activity function throws an error or retryable Failure, the Temporal Service schedules an Activity Task retry to be added to the Task Queue (unless you've reached the Maximum Attempts value of the [Retry Policy](/retry-policies), in which case the Temporal Service adds [ActivityTaskStarted](/references/events#activitytaskstarted) and [ActivityTaskFailed](/references/events#activitytaskfailed) to Event History).
- If the Activity's [Start-to-Close Timeout](/activities#start-to-close-timeout) passes before the Activity function returns or throws, the Temporal Service schedules a retry.
- If the Activity's [Schedule-to-Close Timeout](/activities#schedule-to-close-timeout) passes before Activity Execution is complete, or if [Schedule-to-Start Timeout](/activities#schedule-to-start-timeout) passes before a Worker gets the Activity Task, the Temporal Service writes [ActivityTaskTimedOut](/references/events#activitytasktimedout) to Event History.
...
- [How to set a Workflow Execution Timeout using the Go SDK](/develop/go/failure-detection#workflow-timeout)
- [How to set a Workflow Execution Timeout using the Java SDK](/develop/java/failure-detection#workflow-timeout)
- [How to set a Workflow Execution Timeout using the PHP SDK](/develop/php/failure-detection#workflow-timeouts)
- [How to set a Workflow Execution Timeout using the Python SDK](/develop/python/failure-detection#workflow-timeouts)
- [How to set a Workflow Execution Timeout using the TypeScript SDK](/develop/typescript/failure-detection#workflow-timeout)
...
- [How to set a Workflow Run Timeout using the Go SDK](/develop/go/failure-detection#workflow-timeout)
- [How to set a Workflow Run Timeout using the Java SDK](/develop/java/failure-detection#workflow-timeout)
- [How to set a Workflow Run Timeout using the PHP SDK](/develop/php/failure-detection#workflow-timeouts)
- [How to set a Workflow Run Timeout using the Python SDK](/develop/python/failure-detection#workflow-timeouts)
- [How to set a Workflow Run Timeout using the TypeScript SDK](/develop/typescript/failure-detection#workflow-timeout)
...
- [How to set a Workflow Task Timeout using the Go SDK](/develop/go/failure-detection#workflow-timeout)
- [How to set a Workflow Task Timeout using the Java SDK](/develop/java/failure-detection#workflow-timeout)
- [How to set a Workflow Task Timeout using the PHP SDK](/develop/php/failure-detection#workflow-timeouts)
- [How to set a Workflow Task Timeout using the Python SDK](/develop/python/failure-detection#workflow-timeouts)
- [How to set a Workflow Task Timeout using the TypeScript SDK](/develop/typescript/failure-detection#workflow-timeout)
...
- [How to send a Signal using the Temporal CLI](/cli/workflow#signal)
- [How to develop, send, and handle Signals in Go](/develop/go/messages#signals)
- [How to develop, send, and handle Signals in Java](/develop/java/messages)
- [How to develop, send, and handle Signals in PHP](/develop/php/messages#signals)
- [How to develop, send, and handle Signals in Python](/develop/python/messages#signalst)
- [How to develop, send, and handle Signals in TypeScript](/develop/typescript/messages#signals)
...
When a Signal is sent, it is received by the Temporal Service and recorded as an Event to the Workflow Execution [Event History](#event-history).
...
- [How to Signal-With-Start in Go](/develop/go/messages#signal-with-start)
- [How to Signal-With-Start in Java](/develop/java/messages#signal-with-start)
- [How to Signal-With-Start in PHP](/develop/php/messages#signal-with-start)
- [How to Signal-With-Start in Python](/develop/python/messages#signal-with-start)
- [How to Signal-With-Start in TypeScript](/develop/typescript/messages#signal-with-start)
...
- [How to send a Query using the Temporal CLI](/cli/workflow#query)
- [How to send and handle Queries with the Go SDK](/develop/go/messages#queries)
- [How to send and handle Queries with the Java SDK](/develop/java/messages)
- [How to send and handle Queries with the PHP SDK](/develop/php/messages#queries)
- [How to send and handle Queries with the Python SDK](/develop/python/messages#queries)
- [How to send and handle Queries with the TypeScript SDK](/develop/typescript/messages#queries)
...
An Update is a request and response from a Temporal Client to a [Workflow Execution](#workflow-execution).

- [How to develop, send, and handle Updates in Go](/develop/go/messages#updates)
- [How to develop, send, and handle Updates in Java](/develop/java/messages#updates)
- [How to develop, send, and handle Updates in PHP](/develop/php/messages#updates)
- [How to develop, send, and handle Updates in Python](/develop/go/messages#updates)
...
The Update handler can mutate workflow state (like a [Signal](#signal) but unlike a [Query](#query)) and return a value to the caller (like a Query but unlike a Signal).
...
To avoid losing Updates when using [Continue-As-New](#continue-as-new), ensure that all Update handlers have completed before calling Continue-As-New.
...
- [Java](/develop/java/messages#dynamic-handler)
- [Python](/develop/python/messages#dynamic-handler)
- .NET
...
- Is [Generally Available](https://docs.temporal.io/evaluate/release-stages#general-availability) as of Nov 2023
...
- In [Public Preview](/evaluate/release-stages#public-preview)
