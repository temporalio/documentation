...
- [How to set a Workflow Execution Timeout using the .NET SDK](/develop/dotnet/failure-detection#workflow-timeouts)
...
- [How to set a Workflow Run Timeout using the .NET SDK](/develop/dotnet/failure-detection#workflow-timeouts)
...
- [How to set a Workflow Task Timeout using the .NET SDK](/develop/dotnet/failure-detection#workflow-timeouts)
...
- [How to develop, send, and handle Signals in .NET](/develop/dotnet/message-passing#define-a-signal)
...
- [How to Signal-With-Start in .NET](/develop/dotnet/message-passing#signal-with-start)
...
- [How to send and handle Queries with the .NET SDK](/develop/dotnet/message-passing#define-query)
...
- [How to develop, send, and handle Updates in .NET](/develop/dotnet/message-passing#updates)
