...
## Why use a Codec Server {/* #why-use-a-codec-server */}
...
## How a Codec Server works {/* #how-a-codec-server-works */}
...
## Codec Server vs. Payload Codec {/* #codec-server-vs-payload-codec */}
...
## Securing a Codec Server {/* #securing-a-codec-server */}
...
### Network-level restrictions {/* #network-level-restrictions */}
...
### Namespace-level authorization {/* #namespace-level-authorization */}
...
## SDK Codec Server samples {/* #sdk-codec-server-samples */}
