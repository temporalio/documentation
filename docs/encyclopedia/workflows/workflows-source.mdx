...
#
id: workflows-source
title: Old Workflow Material Source
sidebar_label: Old Workflow Material Source
slug: /workflows-source
description: This is material to be reused
...
This page is being taken apart piece by piece and re-constructed.
The original version of this page is available at the top of this section and its inbound links will not be edited or redirected until this work is done.
...
<!-- Move dynamic handlers out from Workflow Messaging -->
...
Commands are issued and Awaitables are provided by the use of Workflow APIs in the [Workflow Definition](/workflows#workflow-definition).
