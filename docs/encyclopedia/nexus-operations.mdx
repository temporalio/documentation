...
The circuit breaker state is surfaced in a caller Workflow's [Pending Nexus Operations](/nexus/execution-debugging#pending-operations) and [Pending Nexus Callbacks](/nexus/execution-debugging#pending-callbacks).
...
![Nexus Overview](/img/nexus/circuit-breaking.png)
