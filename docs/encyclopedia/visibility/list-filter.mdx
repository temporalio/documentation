...
Temporal supports aliasing of [default search attributes](/search-attribute#default-search-attribute) with the `Temporal` prefix. This allows custom search attributes that would previously collide with reserved search attributes.
