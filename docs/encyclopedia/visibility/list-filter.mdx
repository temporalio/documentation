...
This means that if you define a custom Search Attribute with the same name as a default Search Attribute, the unprefixed name will refer to your custom attribute. You can still search by the default Search Attribute by using the Temporal prefix.
