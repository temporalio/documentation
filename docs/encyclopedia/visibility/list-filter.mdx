...
Temporal supports aliasing of [default search attributes](/temporal-service/visibilty#default-search-attributes) with the `Temporal` prefix. This allows custom search attributes that would previously collide with reserved search attributes.
