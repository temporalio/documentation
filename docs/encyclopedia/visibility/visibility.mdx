...
This guide provides an overview of Temporal Visibility.
...
[Custom Search Attributes](https://docs.temporal.io/visibility#custom-search-attributes) are not supported with Standard Visibility.
