...
- [How to manage Search Attributes using the Go SDK](/develop/go/workers/observability#visibility)
- [How to manage Search Attributes using the Java SDK](/develop/java/workers/observability#visibility)
- [How to manage Search Attributes using the PHP SDK](/develop/php/workers/observability#visibility)
- [How to manage Search Attributes using the Python SDK](/develop/python/workers/observability#visibility)
- [How to manage Search Attributes using the TypeScript SDK](/develop/typescript/workers/observability#visibility)
- [How to manage Search Attributes using the .NET SDK](/develop/dotnet/workers/observability#search-attributes)
