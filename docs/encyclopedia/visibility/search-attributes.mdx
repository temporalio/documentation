...
Storing a list of values in a non-list Search Attribute type (for example, multiple integers in an **Int** attribute or multiple strings in a **Keyword** attribute) is deprecated and will be enforced after September 30, 2026.
