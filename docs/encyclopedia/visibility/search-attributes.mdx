...
:::caution
The `BuildIds` and `BinaryChecksums` Search Attributes are deprecated. They will stop being propagated for new workflows starting in Temporal Server 1.32. And will be fully removed from query support in Temporal Server 1.34.
