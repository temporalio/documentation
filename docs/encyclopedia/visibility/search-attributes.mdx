...
| TemporalWorkerDeploymentName       | Keyword      | Indicates the name of the associated Worker Deployment, in the format `<deployment name>:<build id>`.                                                                                                          |
| TemporalWorkerDeploymentVersion    | Keyword      | Indicates the Version string of the associated Worker Deployment.                                                                                                                                            |
