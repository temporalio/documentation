...
Setting up Dual Visibility is optional and can be used to [migrate your Visibility database](/self-hosted-guide/visibility/migrate#migrating-visibility-database) or create a backup Visibility store.
...
For configuration details, see [Dual Visibility setup](/self-hosted-guide/visibility/dual-visibility#dual-visibility).
...
For details on migrating your Visibility store databases, see [Dual Visibility](/self-hosted-guide/visibility/dual-visibility#dual-visibility).
