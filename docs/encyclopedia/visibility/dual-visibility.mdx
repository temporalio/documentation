...
For configuration details, see [Dual Visibility setup](/self-hosted-guide/dual-visibility).
...
For details on migrating your Visibility store databases, see [Dual Visibility](/self-hosted-guide/dual-visibility).
