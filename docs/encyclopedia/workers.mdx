...
A Nexus Operation Task provides the context needed to proceed with an Nexus Operation Task Execution.
Nexus Operation Tasks largely represent the Nexus Operation Scheduled Event, containing the data needed to execute a Nexus Operation handler.
