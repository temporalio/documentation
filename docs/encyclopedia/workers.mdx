...
- [How to run a development Worker using the Python SDK](/dev-guide/python/core-application#run-a-dev-worker)
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Task Queue component</p>
  </div>
  <div class="tdiiw" height="500">
    <img
      class="img_ev3q"
...
- [How to start a Child Workflow Execution using the Python SDK](//dev-guide/python/child-workflows)
