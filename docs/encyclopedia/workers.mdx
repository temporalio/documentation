...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Component diagram of a Worker Process and the Temporal Server</p>
  </div>
...
A Worker Process is responsible for polling a [Task Queue](#task-queue), dequeueing a [Task](#task), executing your code in response to a Task, and responding to the [Temporal Service](/temporal-service) with the results.
...
<div class="tdiw">
  ...
  <div class="tdiiw" height="500">
    <img class="img_ev3q" src="/diagrams/task-queue.svg" alt="Task Queue component" />
  </div>
</div>
