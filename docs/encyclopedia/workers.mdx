...
A Task is the context that a Worker needs to progress with a specific [Workflow Execution](/workflows#workflow-execution), [Activity Execution](/activities#activity-execution), or [Nexus Operation Task](/workflows#nexus-workflow-execution).
