...
Temporal Cloud has built-in Endpoint access controls. For self-hosted deployments you can implement [custom Authorizers](/self-hosted-guide/security#authorizer-plugin).
