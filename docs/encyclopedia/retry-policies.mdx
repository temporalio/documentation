...
### Default values for Retry Policy {/* #default-values-for-retry-policy */}
...
### Backoff Coefficient {/* #backoff-coefficient */}
...
#### Non-Retryable Errors for Activities {/* #non-retryable-errors-for-activities */}
...
### Per-error next Retry delay {/* #per-error-next-retry-delay */}
