...
- [Activity retry simulator](/develop/activity-retry-simulator)

---

- [How to set a custom Retry Policy for an Activity in Go](/develop/go/failure-detection#activity-retries)
- [How to set a custom Retry Policy for an Activity in Java](/develop/java/failure-detection#activity-retries)
- [How to set a custom Retry Policy for an Activity in PHP](develop/php/failure-detection#activity-retries)
- [How to set a custom Retry Policy for an Activity in Python](develop/python/failure-detection#activity-retries)
- [How to set a custom Retry Policy for an Activity in TypeScript](/develop/typescript/failure-detection#activity-retries)

---

- [How to set a Retry Policy for a Workflow in Go](/develop/go/failure-detection#workflow-retries)
- [How to set a Retry Policy for a Workflow in Java](/develop/java/failure-detection#workflow-retries)
- [How to set a Retry Policy for a Workflow in PHP](/develop/php/failure-detection#workflow-retries)
- [How to set a Retry Policy for a Workflow in Python](/develop/python/failure-detection#workflow-retries)
- [How to set a Retry Policy for a Workflow in TypeScript](/develop/typescript/failure-detection#workflow-retries)

<div className="tdiw">
  <div className="tditw">
    <p className="tdit">Diagram that shows the retry interval and its formula</p>
  </div>
  <div className="tdiiw" height="233">
    <img
      className="img_ev3q"
      src="/img/retry-interval-diagram.png"
      alt="Diagram that shows the retry interval and its formula"
    />
  </div>
</div>
