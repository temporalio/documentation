...
- [How to set a custom Retry Policy for an Activity in Python](/dev-guide/python/failure-detection#activity-retries)
...
- [How to set a Retry Policy for a Workflow in Python](/dev-guide/python/failure-detection#workflow-retries)
