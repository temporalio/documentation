...
- [How to set a custom Retry Policy for an Activity in .NET](/develop/dotnet/failure-detection#activity-retries)
...
- [How to set a Retry Policy for a Workflow in .NET](/develop/dotnet/failure-detection#workflow-retries)
