...
||||||| fae7e961
    ...
    <RelatedReadItem path="/develop/dotnet/message-passing#validate-update" text="Validate updates in .NET" archetype="feature-guide" />
=======
    <RelatedReadItem path="/develop/go/message-passing#handle-update" text="Validate updates in Go" archetype="feature-guide" />
    <RelatedReadItem path="/develop/java/message-passing#handle-update" text="Validate updates in Java" archetype="feature-guide" />
