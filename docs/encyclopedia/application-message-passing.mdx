...
- Coming soon: Available in Public Preview as of Open Source Temporal Server version 1.25.  (Available in re-release as of 1.21.)
...
- Available in [Python SDK](/python/message-passing#send-update-from-client) since [v1.7.0](https://github.com/temporalio/sdk-python/releases/tag/1.7.0)
