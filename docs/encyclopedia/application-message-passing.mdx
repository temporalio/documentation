...
- Available in [TypeScript SDK](https://typescript.temporal.io/api/interfaces/client.WorkflowHandle#executeupdate) since [v1.12.0](https://github.com/temporalio/sdk-typescript/releases/tag/v1.12.0)
