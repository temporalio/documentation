...
### Persistence
Temporal Server uses a persistence store to store the state of Workflow Executions.
Temporal Server supports the following persistence stores:
- Cassandra
- MySQL
- PostgreSQL
- CockroachDB
...
Temporal Server uses a persistence store
