...
The [Nexus Registry](/glossary#nexus-registry) is used to view and manage Nexus Endpoints.
...
![Edit Nexus Endpoint](/img/nexus/target-namespace-ss.png)
...
![Configure runtime access controls](/img/nexus/create-nexus-endpoint-ss.png)
