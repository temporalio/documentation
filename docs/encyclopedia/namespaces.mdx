...
description: "Learn about Temporal Namespaces, a unit of isolation for workflow executions, providing resource isolation and scalability, with features like registration, configuration, and management."
slug: /namespaces
...
- If no other Namespace is specified, the Temporal Cluster uses the Namespace "default" for all Temporal SDKs and the Temporal CLI.
...
- [How to list Namespaces in a Cluster using the Temporal CLI](/cli/operator#list)
