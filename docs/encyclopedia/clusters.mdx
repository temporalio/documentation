...
- Calls from a remote related to [Multi-Cluster Replication](#multiion)
...
### What is Temporal Service security configuration? {#temporal-temporal-service-security-configuration}
...
- The version in the Namespace belongs to this Temporal Service, i.e.
