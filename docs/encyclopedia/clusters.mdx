...
- [How to set the Retention Period for a Namespace](/cli/operator#register)
...
If you don't set the Retention Period value when using the [`temporal operator namespace register`](/cli/operator#register) command, it defaults to 3 days.
