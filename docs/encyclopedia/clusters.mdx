...
<div class="tdiw"><div class="tditw"><p class="tdit">Frontend Service</p></div><div class="tdiiw" height="1040"><img class="img_ev3q" src="/diagrams/temporal-frontend-service.svg" alt="Frontend Service" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Block diagram of how the History Service relates to the other services of the Temporal Server and to a Temporal Cluster</p></div><div class="tdiiw" height="1040"><img class="img_ev3q" src="/diagrams/temporal-history-service.svg" alt="Block diagram of how the History Service relates to the other services of the Temporal Server and to a Temporal Cluster" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Matching Service</p></div><div class="tdiiw" height="980"><img class="img_ev3q" src="/diagrams/temporal-matching-service.svg" alt="Matching Service" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Worker Service</p></div><div class="tdiiw" height="740"><img class="img_ev3q" src="/diagrams/temporal-worker-service.svg" alt="Worker Service" /></div></div>
...
<div class="tdiw"><div class="tditw"><p class="tdit">Persistence</p></div><div class="tdiiw" height="620"><img class="img_ev3q" src="/diagrams/temporal-database.svg" alt="Persistence" /></div></div>
...
This feature must be enabled through a Dynamic Config flag per [Multi-region Namespace](/namespaces#multi-region-namespace).
...
This enables [Temporal UI](https://docs.temporal.io/web-ui) to work seamlessly for Multi-region Namespaces.
Applications making API calls directly to the Temporal Visibility API continue to work even if a Multi-region Namespace is in standby mode.
