...
description: Learn about Workflow Activities in Temporal - Activities started as a step in a Workflow, scoped to that Workflow's lifetime and recorded in its Event History.
