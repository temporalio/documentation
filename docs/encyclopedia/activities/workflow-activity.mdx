...
result, compensating a failure, waiting on a Signal or Timer between steps.
To execute a single Activity, use a [Standalone Activity](/standalone-activity) instead.
...
These commands are in [Public Preview](/evaluate/product-release-stages#public-preview).
