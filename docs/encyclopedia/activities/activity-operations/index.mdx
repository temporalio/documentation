...
Activity Operations are in [Public Preview](/evaluate/product-release-stages#public-preview), 
...
Unpause, Reset, and Update Options are available in Server v1.32.0+ and Temporal CLI v1.9.1+.
...
[Action](/evaluate/cloud/actions#activity). Unpause is free.
