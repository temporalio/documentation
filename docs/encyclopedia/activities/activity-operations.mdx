...
### What happens when you Pause an Activity {/* #what-happens-when-you-pause-an-activity */}
...
### Detect Pause in Activity code {/* #detect-pause-in-activity-code */}
...
### When to Unpause {/* #when-to-unpause */}
...
### What happens when you Unpause an Activity {/* #what-happens-when-you-unpause-an-activity */}
...
### What happens when you Reset an Activity {/* #what-happens-when-you-reset-an-activity */}
...
### Detect Reset in Activity code {/* #detect-reset-in-activity-code */}
...
### When to Update Options {/* #when-to-update-options */}
...
### What happens when you Update an Activity's Options {/* #what-happens-when-you-update-an-activitys-options */}
...
### Check Activity state {/* #check-activity-state */}
...
### Find Paused Activities {/* #find-paused-activities */}
