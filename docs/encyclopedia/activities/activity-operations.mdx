...
=======
See the [CLI reference for `temporal activity pause`](/cli/command-reference/activity#pause) for all options, including `--activity-type` for targeting by type.
>>>>>>> 46557d0d50baf24602938376b5a84e87e7366307
