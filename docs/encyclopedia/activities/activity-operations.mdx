...
For [Workflow Activities](/activities#workflow-activities), Pause, Unpause, and Reset are available in Server
v1.28.0+. Self-hosted UI requires v2.47.0+. For [Standalone Activities](/activities#standalone-activities), Pause,
...
- Your Worker can accept the request and stop processing the current attempt, or carry on and complete the Activity
  successfully. To write Activity code that responds to the request, see "Respond to interruption requests in Activity
  code" for your SDK:
  [Go](/develop/go/activities/standalone-activities#interruption-requests),
  [Java](/develop/java/activities/standalone-activities#interruption-requests),
  [Python](/develop/python/activities/standalone-activities#interruption-requests),
  [TypeScript](/develop/typescript/activities/standalone-activities#interruption-requests),
  [.NET](/develop/dotnet/activities/standalone-activities#interruption-requests),
  [Ruby](/develop/ruby/activities/standalone-activities#interruption-requests).
