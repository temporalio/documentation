...
- [Temporal Go SDK](/dev-guide/go)
- [Temporal Java SDK](/dev-guide/java/introduction)
- [Temporal PHP SDK](/dev-guide/php)
- [Temporal Python SDK](/dev-guide/python/introduction)
- [Temporal TypeScript SDK](/dev-guide/typescript/introduction)
...
<div className="tdiw">
  ...
  <div className="tdiiw" height="338">
    <img
      className="img_ev3q"
...
The "Developing for Durable Execution" chapter of the Background Check tutorials covers this concept in more detail.

- [Go SDK Background Check tutorial](https://learn.temporal.io/tutorials/go/background-check/durable-execution/)
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">
      Temporal SDK components create a runtime across your environment and a
      Temporal Service
    </p>
  </div>
  <div className="tdiiw" height="870">
    <img
      ...
      alt="Temporal SDK components create a runtime across your environment and a Temporal Service"
    />
  </div>
</div>
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">A Worker long polls for Tasks</p>
  </div>
  <div className="tdiiw" height="661">
    <img
      className="img_ev3q"
      src="/diagrams/how-sdk-works-1.svg"
      alt="A Worker long polls for Tasks"
    />
  </div>
</div>
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">Start a Workflow using a Temporal Client</p>
  </div>
  <div className="tdiiw" height="901">
    <img
      className="img_ev3q"
      src="/diagrams/how-sdk-works-2.svg"
      alt="Start a Workflow using a Temporal Client"
    />
  </div>
</div>
...
<div className="tdiw">
  ...
  <div className="tdiiw" height="661">
    <img
      ...
      alt="Worker suspends code execution and sends a Command to the Temporal Service"
    />
  </div>
</div>
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">The Worker reports that the Activity Execution completed</p>
  </div>
  <div className="tdiiw" height="661">
    <img
      className="img_ev3q"
...
<div className="tdiw">
  <div className="tditw">
    <p className="tdit">The Worker picks up the new Task</p>
  </div>
  <div className="tdiiw" height="661">
    <img
      className="img_ev3q"
      src="/diagrams/how-sdk-works-1.svg"
      alt="The Worker picks up the new Task"
    />
  </div>
</div>
