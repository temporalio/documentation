...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Temporal SDK components create a runtime across your environment and a Temporal Service</p>
  </div>
...
We discuss this more in detail in [The SDK and Temporal Service relationship](/encyclopedia/temporal-sdks#sdk-and-temporal-service-relationship) section.
...
## The SDK and Temporal Service relationship {#sdk-and-temporal-service-relationship}
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Worker suspends code execution and sends a Command to the Temporal Service</p>
  </div>
  <div class="tdiiw" height="661">
    <img
      class="img_ev3q"
