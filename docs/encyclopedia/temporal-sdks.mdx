...
- [PHP SDK Temporal Client feature guide](/develop/php/temporal-client)
- [Python SDK Temporal Client feature guide](/develop/python/temporal-client)
- [TypeScript SDK Temporal Client feature guide](/develop/typescript/core-application)
