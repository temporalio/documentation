...
An individual Workflow Execution has an [Event History](/workflow-execution#event-history) size limit, which imposes a couple of considerations for using Child Workflows.
