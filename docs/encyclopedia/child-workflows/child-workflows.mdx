...
## When to use Child Workflows {/* #when-to-use-child-workflows */}
...
### Create a separate service {/* #create-a-separate-service */}
...
### Partition problems into smaller chunks {/* #partition-problems-into-smaller-chunks */}
...
### Represent a single resource {/* #represent-a-single-resource */}
...
### Periodic logic execution {/* #periodic-logic-execution */}
...
### Child Workflow versus an Activity {/* #child-workflow-versus-an-activity */}
