---
id: task-routing-sticky-execution
title: Task Routing and Sticky Execution
sidebar_label: Task Routing and Sticky Execution
description: Learn about routing Tasks to specific Worker Processes and managing Sticky Executions.
slug: /task-routing
