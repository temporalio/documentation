...
- [How serverless Workers differ from traditional Workers](#differences)
...
3. Temporal uses the compute provider configuration to invoke the serverless function. For example, this could be calling AWS Lambda's `InvokeFunction` API.
