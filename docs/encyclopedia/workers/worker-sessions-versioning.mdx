---
id: worker-sessions-versioning
title: Worker Sessions and Versioning
sidebar_label: Worker Sessions and Versioning
description: Understand Worker Sessions and how Worker Versioning facilitates deployment changes.
