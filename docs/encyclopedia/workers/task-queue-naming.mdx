...
**[Excerpt of code used to define a constant with the Task Queue name in Python (in a shared.py file)](/develop/java/core-application#develop-workflows)**
...
defined with the Task Queue name in Python](/develop/java/core-application#develop-workflows)**
...
**[Excerpt of code used to define a constant with the Task Queue name in Go](/develop/php/core-application#develop-workflows)**
...
**[Excerpt of code used to start the Workflow, referencing the constant defined with the Task Queue name in Go](/develop/php/core-application#develop-workflows)**
...
**[Excerpt of code used to configure the Worker, referencing the constant defined with the Task Queue name in Go](/develop/php/core-application#develop-workflows)**
...
**[Excerpt of code used to define a constant with the Task Queue name in Java](/develop/python/core-application#develop-workflows)**
...
**[Excerpt of code used to start the Workflow, referencing the constant defined with the Task Queue name in Java](/develop/python/core-application#develop-workflows)**
...
**[Excerpt of code used to configure the Worker, referencing the constant defined with the Task Queue name in Java](/develop/python/core-application#develop-workflows)**
...
**[Excerpt of code used to define a constant with the Task Queue name in TypeScript](/develop/typescript/core-application#develop-workflows)**

```typescript
const TASK_QUEUE_NAME = "my-taskqueue-name"
```

**[Excerpt of code used to start the Workflow, referencing the constant defined with the Task Queue name in TypeScript](/develop/typescript/core-application#develop-workflows)**
...
**[Excerpt of code used to configure the Worker, referencing the constant defined with the Task Queue name in TypeScript](/develop/typescript/core-application#develop-workflows)**
...
**[Excerpt of code used to define a constant with the Task Queue name in C# and .NET](/develop/dotnet/core-application#develop-workflow)**
...
**[Excerpt of code used to start the Workflow, referencing the constant defined with the Task Queue name in C# and .NET](/develop/dotnet/core-application#develop-workflow)**
...
**[Excerpt of code used to configure the Worker, referencing the constant defined with the Task Queue name in C# and .NET](/develop/dotnet/core-application#develop-workflow)**
...
However, it’s not always possible to do this, such as when the Client used
