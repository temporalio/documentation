...
This change is safe as long as you don't enable Worker Versioning on that deployment. See the Worker Versioning docs for information on preparing your deployment system.
