...
The server automatically registers new Deployments and Deployment Versions when a Worker connects.

Per-SDK documentation will be available soon.

This change is safe as long as you don't enable Versioning on that deployment. See the [Worker Versioning](/worker-versioning) docs for information on preparing your deployment system.
