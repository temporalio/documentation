...
Developers create Temporal applications by writing code, just like any other software.

A Temporal SDK (software development kit) is the open-source library you add to your application to use Temporal. It provides everything needed to build Workflows, Activities, and other Temporal features in a specific programming language including APIs to configure a [Temporal Client](#temporal-client), develop your [Temporal Application](#temporal-application), and run horizontally scalable [Workers](/workers#worker).
...
<SdkGuideLinks
  links={[
    { name: 'goLangBlock', href: '/develop/go', label: 'Go SDK feature guides' },
    { name: 'javaBlock', href: '/develop/java', label: 'Java SDK feature guides' },
    { name: 'pythonBlock', href: '/develop/python', label: 'Python SDK feature guides' },
    { name: 'typeScriptBlock', href: '/develop/typescript', label: 'TypeScript SDK feature guides' },
    { name: 'dotnetBlock', href: '/develop/dotnet', label: '.NET SDK feature guides' },
    { name: 'rubyBlock', href: '/develop/ruby', label: 'Ruby SDK feature guides' },
    { name: 'phpBlock', href: '/develop/php', label: 'PHP SDK feature guides' },
    { name: 'rustBlock', href: '/develop/rust', label: 'Rust SDK feature guides' },
  ]}
/>
>>>>>>> 3e6f8e918 (update the about the sdks page)
...
We discuss this more in detail in [The SDK and Temporal Service relationship](/encyclopedia/architecture/temporal-sdks#sdk-and-cluster-relationship) section.
