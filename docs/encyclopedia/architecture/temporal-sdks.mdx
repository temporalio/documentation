...
- [Go SDK Temporal Client developer guide](/develop/go/client/temporal-client)
- [Java SDK Temporal Client developer guide](/develop/java/client/temporal-client)
- [PHP SDK Temporal Client developer guide](/develop/php/client/temporal-client)
- [Python SDK Temporal Client developer guide](/develop/python/client)
- [TypeScript SDK Temporal Client developer guide](/develop/typescript/client)
