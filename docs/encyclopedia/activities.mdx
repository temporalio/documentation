...
- [How to set a Schedule-To-Start Timeout using the .NET SDK](/develop/dotnet/failure-detection#activity-timeouts)
...
- [How to set a Start-To-Close Timeout using the .NET SDK](/develop/dotnet/failure-detection#activity-timeouts)
...
- [How to set a Schedule-To-Close Timeout using the .NET SDK](/develop/dotnet/failure-detection#activity-timeouts)
...
- [How to Heartbeat an Activity using the .NET SDK](/develop/dotnet/failure-detection#activity-heartbeat)
...
- [How to set a Heartbeat Timeout using the .NET SDK](/develop/dotnet/failure-detection#heartbeat-timeout)
