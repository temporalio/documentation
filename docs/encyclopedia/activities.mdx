...
- [How to develop an Activity Definition using the Python SDK](/dev-guide/python/core-applicaton#develop-activities)
...
- [How to start an Activity Execution using the Python SDK](/dev-guide/python/core-applicaton#activity-execution)
