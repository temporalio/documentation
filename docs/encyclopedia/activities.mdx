...
- [How to set a Schedule-To-Start Timeout using the Go SDK](/develop/go/failure-detection)
- [How to set a Schedule-To-Start Timeout using the Java SDK](/develop/java/failure-detection)
- [How to set a Schedule-To-Start Timeout using the PHP SDK](/develop/php/failure-detection#activity-timeouts)
- [How to set a Schedule-To-Start Timeout using the Python SDK](/develop/python/failure-detection#activity-timeouts)
- [How to set a Schedule-To-Start Timeout using the TypeScript SDK](/develop/typescript/failure-detection)
...
- [How to set a Start-To-Close Timeout using the Go SDK](/develop/go/failure-detection)
- [How to set a Start-To-Close Timeout using the Java SDK](/develop/java/failure-detection)
- [How to set a Start-To-Close Timeout using the PHP SDK](/develop/php/failure-detection#activity-timeouts)
- [How to set a Start-To-Close Timeout using the Python SDK](/develop/python/failure-detection#activity-timeouts)
- [How to set a Start-To-Close Timeout using the TypeScript SDK](/develop/typescript/failure-detection)
...
- [How to set a Schedule-To-Close Timeout using the Go SDK](/develop/go/failure-detection)
- [How to set a Schedule-To-Close Timeout using the Java SDK](/develop/java/failure-detection)
- [How to set a Schedule-To-Close Timeout using the PHP SDK](/develop/go/failure-detection)
- [How to set a Schedule-To-Close Timeout using the Python SDK](/develop/go/failure-detection)
- [How to set a Schedule-To-Close Timeout using the TypeScript SDK](/develop/typescript/failure-detection)
...
- [How to Heartbeat an Activity using the Go SDK](/develop/go/failure-detection#activity-heartbeats)
- [How to Heartbeat an Activity using the Java SDK](/develop/java/failure-detection#activity-heartbeats)
- [How to Heartbeat an Activity using the PHP SDK](/develop/php/failure-detection#activity-heartbeats)
- [How to Heartbeat an Activity using the Python SDK](/develop/python/failure-detection#activity-heartbeats)
- [How to Heartbeat an Activity using the TypeScript SDK](/develop/typescript/failure-detection#activity-heartbeats)
...
- [How to set a Heartbeat Timeout using the Go SDK](/develop/go/failure-detection#heartbeat-timeout)
- [How to set a Heartbeat Timeout using the Java SDK](/develop/go/failure-detection#heartbeat-timeout)
- [How to set a Heartbeat Timeout using the PHP SDK](/develop/php/failure-detection#heartbeat-timeout)
- [How to set a Heartbeat Timeout using the Python SDK](/develop/python/failure-detection#heartbeat-timeout)
- [How to set a Heartbeat Timeout using the TypeScript SDK](/develop/typescript/failure-detection#heartbeat-timeout)
