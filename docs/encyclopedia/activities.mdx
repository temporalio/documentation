...
- [How to develop an Activity Definition using the Python SDK](/dev-guide/python/core-application#develop-activities)
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Activity Definition</p>
  </div>
  <div class="tdiiw" height="680">
    <img
      class="img_ev3q"
...
- [How to start an Activity Execution using the Python SDK](/dev-guide/python/core-application#activity-execution)
- [How to start an Activity Execution using the TypeScript SDK](/dev-guide/typescript/foundations#activity-execution)

<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Activity Execution</p>
  </div>
  <div class="tdiiw" height="1780">
    <img
      class="img_ev3q"
...
- [How to set a Schedule-To-Start Timeout using the Python SDK](/dev-guide/python/failure-detection#activity-timeouts)
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Schedule-To-Start Timeout period</p>
  </div>
  <div class="tdiiw" height="666">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Start-To-Close Timeout period with retries</p>
  </div>
...
- [How to set a Start-To-Close Timeout using the Python SDK](/dev-guide/python/failure-detection#activity-timeouts)
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Start-To-Close Timeout period</p>
  </div>
  <div class="tdiiw" height="666">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Schedule-To-Close Timeout period</p>
  </div>
  <div class="tdiiw" height="666">
    <img
      class="img_ev3q"
...
<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Schedule-To-Close Timeout period with a retry</p>
  </div>
  <div class="tdiiw" height="1246">
    <img
      class="img_ev3q"
...
- [How to Heartbeat an Activity using the Python SDK](/dev-guide/python/failure-detection#activity-heartbeats)
...
- [How to set a Heartbeat Timeout using the Python SDK](/dev-guide/python/failure-detection#heartbeat-timeout)
- [How to set a Heartbeat Timeout using the TypeScript SDK](/dev-guide/typescript/features#heartbeat-timeout)

<div class="tdiw">
  <div class="tditw">
    <p class="tdit">Heartbeat Timeout periods</p>
  </div>
  <div class="tdiiw" height="866">
    <img
      class="img_ev3q"
...
- [Python](/dev-guide/python/asynchronous-activity-completion#asynchronously-complete-an-activity)
