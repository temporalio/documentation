...
The execution semantics of a Workflow Execution include the re-execution of a Workflow Function, which is called a <a class="tdlp" href="#replays">Replay<span class="tdlpiw"><img src="/img/link-preview-icon.svg" alt="Link preview icon" /></span><span class="tdlpc"><span class="tdlppt">What is a Workflow Replay?</span><br /><br /><span class="tdlppd">A Temporal Workflow Replay is the method by which a Workflow Execution resumes making progress.</span><span class="tdlplm"><br /><br /><a class="tdlplma" href="#replays">Learn more</a></span></span></a>.
