...
> Background reading: [Data Converters in Temporal](/security#data-converter)
...
Data Converters have [two parts](/security#payload-codecs):
...
> Background: [Data Converter ➡️ Encryption](/security#encryption)
