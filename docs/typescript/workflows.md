...
- Signals are only guaranteed to arrive in order **per Signal**, not across Signals. If you need strict ordering across multiple Signals, combine them into one Signal and use a `switch` statement.
