...
### Nexus
Nexus lets different teams share Temporal's capabilities such as Workflows, Signals, Queries, and Updates - across team, Namespace, region, and cloud boundaries, without exposing internal implementation details.
