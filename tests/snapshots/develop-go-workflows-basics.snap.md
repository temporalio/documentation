...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/yourapp/worker/main_dacx.go) in the context of the rest of the application code.
