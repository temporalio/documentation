...
5. **Usage monitoring**:
   ...
   - **Metrics**: Export related metrics are available in `temporal_cloud_v0_total_action_count` with the label `is_background`. For more information, see [Cloud metrics](/cloud/metrics).
